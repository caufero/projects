...
<head>
  ...
  <title>Subconscious — Caufero Workspace</title>
</head>
<body>
  <div class="page" data-theme="auto">
      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text">Subconscious</span>
          </div>
        </div>
    ...
    <div class="shell" id="shell">
            ...
            <div class="nav-group-body">
              ...
              <div class="nav-subgroup" data-label="Tailwind-Designed Websites AI Agents and Automation">
                ...
                <div class="nav-subgroup-body">
                  ...
                  <a class="nav-item sub" href="https://caufero.github.io/projects/_Misc/Sites/Relevance%20AI.md" data-label="Tailwind-Designed Websites AI Relevance AI"><span class="dot"></span><span class="nav-text">Relevance AI</span></a>
                  <a class="nav-item sub active" href="https://caufero.github.io/projects/_Misc/Sites/Subconscious.md" data-label="Tailwind-Designed Websites AI Subconscious"><span class="dot"></span><span class="nav-text">Subconscious</span></a>
      ...
      <!-- ═══════════════════════════════════════════ CENTER CONTENT (Subconscious) -->
      <main class="content" id="content" role="main">
        <div class="content-inner">

          <!-- iframe viewer — fills the full column height -->
          <section class="iframe-card card">
            <div class="iframe-wrap">
              <iframe
                src="https://www.subconscious.dev"
                title="Subconscious"
                loading="lazy"
      ...
      <!-- ═══════════════════════════════════════════ RIGHT RAIL (Subconscious-specific) -->
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          <div class="rail-title">Subconscious</div>
          <div class="rail-sub">Email infrastructure for AI agents</div>
          <div class="rail-actions">
            <a class="rail-btn" href="https://www.subconscious.dev" target="_blank" rel="noopener noreferrer">Visit Site</a>
            <a class="rail-btn" href="https://docs.subconscious.dev" target="_blank" rel="noopener noreferrer">Docs</a>
          </div>
        </div>
        ...
        <div class="rail-body">
          ...
          <div class="panel-card">
            ...
            <div class="about-text">Email inboxes, sending, and webhooks purpose-built for AI agents. Let agents send, receive, and act on email — without touching your real inbox.</div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              <span class="pill2">AI Agents</span>
              <span class="pill2">Email API</span>
              <span class="pill2">Automation</span>
              <span class="pill2">Webhooks</span>
              <span class="pill2">Inbox</span>
              <span class="pill2">SMTP</span>
              <span class="pill2">SaaS</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              <div class="stack-item">
                <div class="stack-feature-title">Programmatic Inboxes</div>
                <div class="stack-sub">Create isolated email inboxes per agent or task on the fly</div>
              </div>
              <div class="stack-item">
                <div class="stack-feature-title">Send &amp; Receive</div>
                <div class="stack-sub">Full send / receive API so agents can act on real emails</div>
              </div>
              <div class="stack-item">
                <div class="stack-feature-title">Webhooks</div>
                <div class="stack-sub">Real-time push notifications when new mail arrives</div>
              </div>
              <div class="stack-item">
                <div class="stack-feature-title">No Real Inbox Needed</div>
                <div class="stack-sub">Keeps agent traffic isolated from personal or business mail</div>
              </div>
              <div class="stack-item">
                <div class="stack-feature-title">Developer-First API</div>
                <div class="stack-sub">Simple REST API with clear docs for quick integration</div>
              </div>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="side-grid">
              <a class="side-pill" href="https://www.subconscious.dev" target="_blank" rel="noopener noreferrer">Home</a>
              <a class="side-pill" href="https://docs.subconscious.dev" target="_blank" rel="noopener noreferrer">Docs</a>
              <a class="side-pill" href="https://www.subconscious.dev/pricing" target="_blank" rel="noopener noreferrer">Pricing</a>
              <a class="side-pill" href="https://www.subconscious.dev/blog" target="_blank" rel="noopener noreferrer">Blog</a>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">
                ...
                Also in AI Agents &amp; Automation
              </div>
              <div class="panel-sub">Other sites in the same category</div>
            </div>
            <div class="side-grid">
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/Sites/AI%20Agents%20Hub.md">AI Agents Hub</a>
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/Sites/AI%20Agents%20List.md">AI Agents List</a>
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/Sites/AutoGPT.md">AutoGPT</a>
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/Sites/Browser%20Use.md">Browser Use</a>
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/Sites/Composio.md">Composio</a>
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/Sites/CrewAI.md">CrewAI</a>
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/Sites/Dify.md">Dify</a>
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/Sites/LlamaIndex.md">LlamaIndex</a>
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/Sites/Relevance%20AI.md">Relevance AI</a>
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/Sites/Tavily.md">Tavily</a>
            </div>
          </div>
  ...
  <style>
    ...
    *{box-sizing:border-box;}
    ...
    .icon-btn{
      ...
      color:inherit;box-shadow:0 1px 0 rgba(15,23,42,.04);
    ...
    /* ── Content column — matches rail height exactly ── */
    .content{
      min-width:0;
      position:sticky;
    ...
    .site-header-left{display:flex;flex-direction:column;gap:8px;}
    .site-badge-row{display:flex;gap:8px;flex-wrap:wrap;}
    .site-title{font-size:22px;font-weight:950;letter-spacing:.2px;}
    .site-url{
      display:inline-flex;align-items:center;gap:8px;
      font-size:13px;font-weight:650;color:var(--slate-600);
    }
    .page[data-theme="dark"] .site-url{color:rgba(241,245,249,.66);}
    .site-url a{color:var(--teal-600);font-weight:750;}
    .page[data-theme="dark"] .site-url a{color:var(--teal-500);}
    ...
    /* ── iframe card — fills the full column height ── */
    .iframe-card{
      flex:1 1 0;
      min-height:0;
      overflow:hidden;
    ...
    /* Zoom the iframe content to ~72% while keeping the container full-size */
    .iframe-wrap iframe{
      position:absolute;
      top:0;
      left:0;
      /* Wider/taller than 100% so after scaling it fills the container exactly */
      width:138.9%;
      height:138.9%;
      border:0;
      display:block;
    ...
    .panel-title{font-weight:950;letter-spacing:.15px;display:flex;align-items:center;gap:8px;}
    .panel-sub{font-size:12px;color:var(--slate-600);line-height:1.35;}
    .page[data-theme="dark"] .panel-sub{color:rgba(241,245,249,.66);}

    .about-text{font-size:12.5px;line-height:1.6;color:var(--slate-700);}
    .page[data-theme="dark"] .about-text{color:rgba(241,245,249,.78);}
    ...
    .stack-item{border:1px solid var(--line);background:var(--surface2);border-radius:14px;padding:10px 12px;font-size:12.5px;color:inherit;}
    .stack-feature-title{font-weight:850;margin-bottom:2px;}
    .stack-sub{font-size:11px;font-weight:750;color:var(--slate-600);}
