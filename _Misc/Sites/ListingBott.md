...
<head>
  ...
  <title>ListingBott — Caufero Workspace</title>
</head>
<body>
  <div class="page" data-theme="auto">
      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text">ListingBott</span>
          </div>
        </div>
    ...
    <div class="shell" id="shell">
            ...
            <div class="nav-group-body">
              ...
              <div class="nav-subgroup" data-label="Tailwind-Designed Websites Marketing and Growth">
                ...
                <div class="nav-subgroup-body">
                  ...
                  <a class="nav-item sub active" href="https://caufero.github.io/projects/_Misc/Sites/ListingBott.md" data-label="Tailwind-Designed Websites Marketing ListingBott"><span class="dot"></span><span class="nav-text">ListingBott</span></a>
      ...
      <!-- ═══════════════════════════════════════════ RIGHT RAIL (ListingBott-specific) -->
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          <div class="rail-title">ListingBott</div>
          <div class="rail-sub">Email infrastructure for AI agents</div>
          <div class="rail-actions">
            <a class="rail-btn" href="https://listingbott.com" target="_blank" rel="noopener noreferrer">Visit Site</a>
            <a class="rail-btn" href="https://docs.listingbott.com" target="_blank" rel="noopener noreferrer">Docs</a>
          </div>
        </div>
        ...
        <div class="rail-body">
          ...
          <div class="panel-card">
            ...
            <div class="side-grid">
              <a class="side-pill" href="https://listingbott.com" target="_blank" rel="noopener noreferrer">Home</a>
              <a class="side-pill" href="https://docs.listingbott.com" target="_blank" rel="noopener noreferrer">Docs</a>
              <a class="side-pill" href="https://listingbott.com/pricing" target="_blank" rel="noopener noreferrer">Pricing</a>
              <a class="side-pill" href="https://listingbott.com/blog" target="_blank" rel="noopener noreferrer">Blog</a>
            </div>
          </div>
