...
<head>
  ...
  <title>Decipher AI — Caufero Workspace</title>
</head>
<body>
  <div class="page" data-theme="auto">
      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text">Decipher AI</span>
          </div>
        </div>
    ...
    <div class="shell" id="shell">
          ...
          <div class="nav-group" data-label="Tailwind-Designed Websites">
            ...
            <div class="nav-group-body">
              ...
              <div class="nav-subgroup" data-label="Tailwind-Designed Websites Dev Tools and Docs">
                ...
                <div class="nav-subgroup-body">
                <a class="nav-item sub active" href="https://caufero.github.io/projects/_Misc/Sites/Decipher%20AI.md" data-label="Tailwind-Designed Websites Dev Decipher AI"><span class="dot"></span><span class="nav-text">Decipher AI</span></a>
      ...
      <!-- ═══════════════════════════════════════════ RIGHT RAIL (Decipher AI-specific) -->
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          <div class="rail-title">Decipher AI</div>
          <div class="rail-sub">Email infrastructure for AI agents</div>
          <div class="rail-actions">
            <a class="rail-btn" href="https://getdecipher.com" target="_blank" rel="noopener noreferrer">Visit Site</a>
            <a class="rail-btn" href="https://docs.getdecipher.com" target="_blank" rel="noopener noreferrer">Docs</a>
          </div>
        </div>
        ...
        <div class="rail-body">
          ...
          <div class="panel-card">
            ...
            <div class="side-grid">
              <a class="side-pill" href="https://getdecipher.com" target="_blank" rel="noopener noreferrer">Home</a>
              <a class="side-pill" href="https://docs.getdecipher.com" target="_blank" rel="noopener noreferrer">Docs</a>
              <a class="side-pill" href="https://getdecipher.com/pricing" target="_blank" rel="noopener noreferrer">Pricing</a>
              <a class="side-pill" href="https://getdecipher.com/blog" target="_blank" rel="noopener noreferrer">Blog</a>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="side-grid">
              ...
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/Sites/Decipher AI.md">Decipher AI</a>
