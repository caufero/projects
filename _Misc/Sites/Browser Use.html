...
<head>
  ...
  <title>Browser Use — Caufero Workspace</title>
</head>
<body>
  <div class="page" data-theme="auto">
    ...
    <div class="shell" id="shell">
            ...
            <div class="nav-group-body">
              ...
              <div class="nav-subgroup" data-label="Tailwind-Designed Websites AI Agents and Automation">
                ...
                <div class="nav-subgroup-body">
                  ...
                  <a class="nav-item sub active" href="https://caufero.github.io/projects/_Misc/Sites/Browser%20Use.md" data-label="Tailwind-Designed Websites AI Browser Use"><span class="dot"></span><span class="nav-text">Browser Use</span></a>
      ...
      <!-- ═══════════════════════════════════════════ RIGHT RAIL (Browser Use-specific) -->
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          <div class="rail-title">Browser Use</div>
          <div class="rail-sub">Email infrastructure for AI agents</div>
          <div class="rail-actions">
            <a class="rail-btn" href="https://browser-use.com" target="_blank" rel="noopener noreferrer">Visit Site</a>
            <a class="rail-btn" href="https://docs.browser-use.com" target="_blank" rel="noopener noreferrer">Docs</a>
          </div>
        </div>
        ...
        <div class="rail-body">
          ...
          <div class="panel-card">
            ...
            <div class="side-grid">
              <a class="side-pill" href="https://browser-use.com" target="_blank" rel="noopener noreferrer">Home</a>
              <a class="side-pill" href="https://docs.browser-use.com" target="_blank" rel="noopener noreferrer">Docs</a>
              <a class="side-pill" href="https://browser-use.com/pricing" target="_blank" rel="noopener noreferrer">Pricing</a>
              <a class="side-pill" href="https://browser-use.com/blog" target="_blank" rel="noopener noreferrer">Blog</a>
            </div>
          </div>
