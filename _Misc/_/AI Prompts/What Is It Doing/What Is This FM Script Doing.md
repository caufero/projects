...
<head>
  ...
  <title>Prompt To Find Out What A FileMaker Script Is Doing</title>
</head>
<body>
            ...
            <div class="nav-group-body">
              ...
              <div class="nav-subgroup open" data-label="AI Prompts Explain">
                ...
                <div class="nav-subgroup-body">
                  ...
                  <a class="nav-item sub active" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/What%20Is%20It%20Doing/What%20Is%20This%20FM%20Script%20Doing.md" data-label="AI Prompts Explain What Is This FileMaker Script Doing"><span class="dot"></span><span class="nav-text">What Is This FileMaker Script Doing?</span></a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="content-inner">
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">What Is This FileMaker Script Doing?</div>
                <div class="hero-sub">Paste a FileMaker script to infer its intent, step-by-step workflow, data touchpoints, dependencies, and risks.</div>
              </div>
              ...
              <div class="hero-meta">
                ...
                <span class="chip teal">Script Analysis</span>
          ...
          <section class="card section" id="steps-section">
            ...
            <div class="steps-body">
              <ol class="steps-list">
                <li class="step-item">Copy the script from FileMaker (including comments if present).</li>
                <li class="step-item">Paste the full script steps in one go (avoid screenshots if possible).</li>
                <li class="step-item">If the script calls sub-scripts, paste those too (or at least the called script names).</li>
                <li class="step-item">Use the prompt below to infer what the script was written to handle.</li>
              </ol>
              <div class="steps-tip">
                <span class="tip-badge">Tip</span>
                <span class="tip-text">Include the script name and the context where the button/menu item runs it. That usually reveals the real purpose.</span>
              </div>
            </div>
          </section>
          ...
          <section class="card section" id="prompt-section">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">📋</span>
                <span>Prompt</span>
                <span class="section-sub">Paste script steps, then send.</span>
              </div>
            ...
            <div class="prompt-wrap">
              <textarea class="prompt-box" id="promptBox" readonly spellcheck="false"># Prompt To Find Out What A FileMaker Script Is Doing
What do you think this FileMaker script was written to handle?
Hard Rules:
1) Use ONLY the content from the pasted script (and any pasted supporting scripts). Do not invent features.
2) If anything is unclear, label it as "Unknown from pasted script" and state what's missing.
3) Be specific. Mention the actual script steps, tables, layouts, fields, variables, custom functions, value lists, and script names you see.
4) If multiple interpretations are possible, list the top 2 most likely interpretations and explain why.
Deliverables (in this exact order):
A) One Sentence Summary
- One tight sentence describing what the script is for.
B) Trigger &amp; Context
- How it is likely launched (button, menu, script trigger, scheduled, OnOpen, etc.)
- What layout/context it probably expects (evidence from the script)
C) What It Does Step-by-Step
- Numbered steps describing the flow from start to finish.
- Mention key decisions (If/Else), loops, found sets, record creation, commits, windows, error handling.
D) Inputs, Outputs, Side Effects
- Inputs: parameters, globals, variables, context fields.
- Outputs: created/updated records, UI changes, exports, emails, JSON, web viewer content, navigation, dialogs.
- Side effects: deletes, replaces, overwrites, commits, re-login, window switching, context changes.
E) Data Touchpoints
- Tables/TOs affected and what changes happen.
- Fields referenced, set, validated, or used in calculations.
F) Dependencies
- Called scripts, custom functions, external files, plugins, web viewer JS, Insert from URL, ExecuteSQL, Data API.
G) Risks &amp; Edge Cases
- Where it can break: missing context, empty found set, permissions, locked records, uncommitted data, error capture gaps.
H) What I Need Next (If Anything)
- The smallest extra info that would remove uncertainty (e.g., script parameter, called scripts, layout name, related table schema).
Output Format Rules:
- Output must be clean Markdown.
- Use clear headings (H1/H2/H3).
- Use short paragraphs and bullet lists.
- Include evidence references like:
  - "Seen in step: &lt;Step name&gt;"
  - "Seen variable: &lt;$var&gt;"
...
> ...Pasted FileMaker Script...</textarea>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">What Is This FM Script Doing?</div>
        ...
        <div class="rail-body">
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Infer what a single FM script does</div>
            </div>
            <div class="stack">
              <div class="stack-item">Paste a FileMaker script (with comments and sub-scripts if available)</div>
              <div class="stack-item">The AI infers purpose, trigger, step-by-step flow, inputs/outputs, and risks</div>
              <div class="stack-item">Output is 8 structured sections (A–H) in clean Markdown</div>
              <div class="stack-item">Unknowns are labelled with the smallest extra info needed to resolve them</div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">8 sections A–H</div>
            </div>
            <div class="pill-row">
              <span class="pill2">A) One Sentence Summary</span>
              <span class="pill2">B) Trigger &amp; Context</span>
              <span class="pill2">C) Step-by-Step Flow</span>
              <span class="pill2">D) Inputs, Outputs, Side Effects</span>
              <span class="pill2">E) Data Touchpoints</span>
              <span class="pill2">F) Dependencies</span>
              <span class="pill2">G) Risks &amp; Edge Cases</span>
              <span class="pill2">H) What I Need Next</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              <span class="pill2">Script steps</span>
              <span class="pill2">Trigger</span>
              <span class="pill2">Variables</span>
              <span class="pill2">Context</span>
              <span class="pill2">Tables</span>
              <span class="pill2">Layouts</span>
              <span class="pill2">Dependencies</span>
              <span class="pill2">Edge cases</span>
              <span class="pill2">Evidence refs</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="side-grid">
              <span class="side-pill">Pasted script steps (full text)</span>
              <span class="side-pill">Script name + button context</span>
              <span class="side-pill">Sub-scripts (if called)</span>
              <span class="side-pill">Comments (if present)</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="side-grid">
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/What%20Is%20It%20Doing/What%20Is%20This%20FM%20App%20Doing.md">What Is This FM App Doing?</a>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              <div class="stack-item">1. Copy the script from FileMaker (include comments)</div>
              <div class="stack-item">2. Copy the prompt above and paste into the AI</div>
              <div class="stack-item">3. Paste the script below the prompt</div>
              <div class="stack-item">4. The AI returns a structured 8-section analysis</div>
              <div class="stack-item">5. Check section H for what extra info would help</div>
            </div>
          </div>
        </div>
