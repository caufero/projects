...
<head>
  ...
  <title>Prompt To Find Out What A FileMaker Application Is Doing</title>
</head>
<body>
      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text">AI Prompts › Explain</span>
          </div>
        </div>
        ...
        <nav class="rail-body" id="navTree">
          ...
          <div class="nav-group open" data-label="AI Prompts">
            ...
            <div class="nav-group-body">
              ...
              <div class="nav-subgroup open" data-label="AI Prompts Explain">
                <button class="nav-subgroup-head" type="button" data-toggle="subgroup">
        ...
        <div class="content-inner">
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">What Is This FileMaker Application Doing?</div>
                <div class="hero-sub">Upload docs and paste scripts to get a structured explanation of what a FileMaker solution does — modules, workflows, data model, and integrations.</div>
              </div>
              ...
              <div class="hero-meta">
                ...
                <span class="chip teal">App Analysis</span>
          ...
          <section class="card section" id="steps-section">
            ...
            <div class="steps-body">
              <ol class="steps-list">
                <li class="step-item">Upload documentation files (PDF, Word, Markdown, TXT, screenshots, etc.).</li>
                <li class="step-item">Paste the most relevant FileMaker scripts or calculations (especially navigation scripts and core workflows).</li>
                <li class="step-item">Use the prompt below to generate a clear explanation of what the solution does.</li>
              </ol>
              <div class="steps-tip">
                <span class="tip-badge">Tip</span>
                <span class="tip-text">If you paste only one script, pick a "hub script" that calls other scripts or builds a page, report, or workflow.</span>
              </div>
            </div>
          </section>
          ...
          <section class="card section" id="prompt-section">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">📋</span>
                <span>Prompt</span>
                <span class="section-sub">Upload docs, paste scripts, then send.</span>
              </div>
            ...
            <div class="prompt-wrap">
              <textarea class="prompt-box" id="promptBox" readonly spellcheck="false"># Prompt To Find Out What A FileMaker Application Is Doing
Go through the uploaded documentation and tell me what this FileMaker application is for.
The user will paste one or more FileMaker scripts (and possibly calculations). Use the scripts to infer workflows, modules, and intent.
Hard Rules:
1) Use ONLY the content provided in the uploaded documentation and the pasted scripts. Do not invent features or modules.
2) If anything is unclear or missing, clearly label it as "Unknown from provided docs" and state what is missing.
3) Be specific. Mention the actual table names, layout names, script names, field names, and value lists you see.
4) If multiple interpretations are possible, list the top 2 most likely interpretations and explain why.
Deliverables (in this exact order):
A) One Sentence Summary
- One tight sentence describing what the app is for.
B) What The App Helps The Business Do
- Bullet list of the real-world business outcomes (based on evidence from docs/scripts).
C) Core Modules / Areas
- List modules inferred from naming and structure.
- For each module: what it does, key tables, key layouts, key scripts.
D) Key Workflows (End-to-End)
- Describe the main workflows as numbered steps.
- For each workflow:
  - Trigger (where it starts)
  - What records get created/edited
  - Key scripts involved
  - Outputs (reports, emails, invoices, exports, dashboards, etc.)
E) Users &amp; Roles (If Evident)
- Who uses the app (front desk, nurse, manager, accountant, admin, etc.)
- What each role likely does inside the app (tie to layouts/scripts if possible).
F) Data Model Quick Map
- List the main entities (tables) and what they represent.
- Mention obvious relationships (parent-child links, join tables, "log/history" tables).
G) UI / Navigation Model
- How navigation seems to work (menus, dashboards, buttons, cards, tabs).
- Mention any "page generator" patterns, web viewers, or modular layout patterns.
H) Integrations &amp; External Systems (Only If Present)
- Insert from URL, Data API, SMTP, webhooks, JS web viewers, plugins, external file references.
I) What's Missing / What I Need Next
- A short list of missing docs/scripts that would allow a more accurate explanation.
Output Format Rules:
- Output must be clean Markdown.
- Use clear headings (H1/H2/H3).
- Use short paragraphs and bullet lists.
- Include evidence references like:
  - "Seen in script: &lt;Script Name&gt;"
  - "Seen in layout: &lt;Layout Name&gt;"
  - "Seen in table: &lt;Table Name&gt;"
- Do not ask me to describe the app. Work only from what I provided.
Input Placeholder (the user will replace this):
> ...Pasted FileMaker Script...</textarea>
            </div>
          </section>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">What Is This FM App Doing?</div>
        ...
        <div class="rail-body">
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Find out what an FM app does from docs + scripts</div>
            </div>
            <div class="stack">
              <div class="stack-item">Upload documentation and paste scripts from a FileMaker solution</div>
              <div class="stack-item">The AI infers purpose, modules, workflows, and data model from evidence</div>
              <div class="stack-item">Output is 9 structured sections (A–I) in clean Markdown</div>
              <div class="stack-item">Unknowns are clearly labelled with what's missing</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Deliverable Sections</div>
              <div class="panel-sub">9 sections A–I</div>
            </div>
            <div class="pill-row">
              <span class="pill2">A) One Sentence Summary</span>
              <span class="pill2">B) Business Outcomes</span>
              <span class="pill2">C) Core Modules</span>
              <span class="pill2">D) Key Workflows</span>
              <span class="pill2">E) Users &amp; Roles</span>
              <span class="pill2">F) Data Model Quick Map</span>
              <span class="pill2">G) UI / Navigation</span>
              <span class="pill2">H) Integrations</span>
              <span class="pill2">I) What's Missing</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              <span class="pill2">Documentation</span>
              ...
              <span class="pill2">Evidence references</span>
              <span class="pill2">Unknowns</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="side-grid">
              <span class="side-pill">Documentation files (PDF, Word, MD, TXT)</span>
              <span class="side-pill">Screenshots (optional)</span>
              <span class="side-pill">Pasted FileMaker scripts</span>
              <span class="side-pill">Calculations (optional)</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Similar analysis prompts</div>
            </div>
            <div class="side-grid">
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/What%20Is%20It%20Doing/What%20Is%20This%20FM%20Script%20Doing.md">What Is This FM Script Doing?</a>
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Generate%20Documentations/FM%20App%20Documentation.md">FM App Documentation</a>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              <div class="stack-item">1. Upload all available documentation files</div>
              <div class="stack-item">2. Paste the most relevant scripts (pick hub scripts first)</div>
              <div class="stack-item">3. Copy the prompt above and paste into the AI</div>
              <div class="stack-item">4. The AI returns a structured 9-section analysis</div>
              <div class="stack-item">5. Check section I for what's missing and provide more if needed</div>
            </div>
          </div>
        </div>
