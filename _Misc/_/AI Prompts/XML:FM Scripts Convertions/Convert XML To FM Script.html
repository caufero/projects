...
<head>
  ...
  <title>Convert XML To FM Script Prompt</title>
</head>
<body>
            ...
            <div class="nav-group-body">
              ...
              <div class="nav-subgroup open" data-label="AI Prompts FM Script <-> XML">
                ...
                <div class="nav-subgroup-body">
                  ...
                  <a class="nav-item sub active" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/XML:FM%20Scripts%20Convertions/Convert%20XML%20To%20FM%20Script.md" data-label="AI Prompts FM Script XML XML To FM Script"><span class="dot"></span><span class="nav-text">XML To FM Script</span></a>
                </div>
              </div>
        ...
        <div class="content-inner">
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Convert XML To FM Script Prompt</div>
                <div class="hero-sub">Convert FileMaker clipboard XML back into readable FileMaker script steps, output fully in Markdown code.</div>
              </div>
              ...
              <div class="hero-meta">
                ...
                <span class="chip teal">XML → Script</span>
          ...
          <section class="card section" id="prompt-section">
            <div class="section-head">
              <div class="section-title">
                ...
                <span>Prompt</span>
                <span class="section-sub">Paste XML right after the prompt.</span>
              </div>
            ...
            <div class="prompt-wrap">
              <textarea class="prompt-box" id="promptBox" readonly spellcheck="false">Convert this XML to its equivalent FileMaker script steps. The result should be fully in markdown code.
Be precise and it should look like how it will look like in FileMaker

PASTE_XML_HERE</textarea>
            </div>
          </section>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">XML To FM Script</div>
        ...
        <div class="rail-body">
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Reverse-convert clipboard XML to readable script steps</div>
            </div>
            <div class="stack">
              <div class="stack-item">Paste FileMaker clipboard XML after the one-line instruction</div>
              <div class="stack-item">The AI converts it into human-readable FileMaker script steps</div>
              <div class="stack-item">Output is fully in Markdown code for easy copying</div>
              <div class="stack-item">This is the reverse of the FM Script To XML prompt</div>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              ...
              <span class="pill2">Markdown code</span>
              <span class="pill2">Convert</span>
              <span class="pill2">Clipboard</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">The reverse conversion</div>
            </div>
            <div class="side-grid">
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/XML:FM%20Scripts%20Convertions/Convert%20FM%20Script%20To%20XML.md">FM Script To XML</a>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              ...
              <div class="stack-item">2. Replace PASTE_XML_HERE with your FileMaker clipboard XML</div>
              <div class="stack-item">3. Paste into the AI and send</div>
              <div class="stack-item">4. The AI returns readable script steps in a Markdown code block</div>
            </div>
          </div>
        </div>
