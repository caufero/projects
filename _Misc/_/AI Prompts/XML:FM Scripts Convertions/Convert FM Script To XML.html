...
<head>
  ...
  <title>Clipboard XML Generator Prompt</title>
</head>
<body>
      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text">AI Prompts › FM Script &lt;-&gt; XML</span>
          </div>
        </div>
        ...
        <nav class="rail-body" id="navTree">
          ...
          <div class="nav-group open" data-label="AI Prompts">
            ...
            <div class="nav-group-body">
              ...
              <div class="nav-subgroup open" data-label="AI Prompts FM Script <-> XML">
                <button class="nav-subgroup-head" type="button" data-toggle="subgroup">
                ...
                <div class="nav-subgroup-body">
                  <a class="nav-item sub active" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/XML:FM%20Scripts%20Convertions/Convert%20FM%20Script%20To%20XML.md" data-label="AI Prompts FM Script XML FM Script To XML"><span class="dot"></span><span class="nav-text">FM Script To XML</span></a>
        ...
        <div class="content-inner">
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Clipboard XML Generator Prompt</div>
                <div class="hero-sub">Convert FileMaker script steps into fmxmlsnippet clipboard XML for direct import into Script Workspace.</div>
              </div>
              ...
              <div class="hero-meta">
                ...
                <span class="chip teal">fmxmlsnippet</span>
                <span class="chip amber">Clipboard XML</span>
              </div>
            </div>
          </section>
          ...
          <section class="card section" id="prompt-section">
            <div class="section-head">
              <div class="section-title">
                ...
                <span>Prompt</span>
                <span class="section-sub">Paste script steps at the end.</span>
              </div>
            ...
            <div class="prompt-wrap">
              <textarea class="prompt-box" id="promptBox" readonly spellcheck="false">You are a FileMaker Clipboard XML generator.
Your job:
Convert the FileMaker script steps I paste below into FileMaker "clipboard XML" so I can paste/import the steps into FileMaker Script Workspace using a clipboard-XML workflow.
Hard rules:
1) OUTPUT ONLY ONE THING: a single Markdown fenced code block that contains ONLY the XML.
2) The fenced code block language must be `xml`.
3) Preserve EVERY comment exactly as a Comment script step, in the same position in the step order.
   - Any line that starts with `#` is a Comment step.
   - If the comment line is blank after `#`, still keep it as a Comment step.
4) Preserve step order exactly.
5) Preserve indentation meaning:
   - Steps that have parameter blocks or nested sections must stay nested correctly in XML.
6) Escape XML characters correctly in all text values:
   - `&` becomes `&amp;`
   - `<` becomes `&lt;`
   - `>` becomes `&gt;`
   - `"` becomes `&quot;`
   - Apostrophes handled safely.
7) Treat anything inside FileMaker calc parentheses as literal calc text (do not "simplify" the calc).
8) Keep object names, field references, and variable names exactly as written.
9) Keep bracket formatting meaning:
   - Example: `Set Variable [ $x ; expression ]`
   - Example: `Export Field Contents [ table::field ; $path ]`
   - Example: `Set Web Viewer [ Object Name: "wvPreview" ; Action: "Set HTML" ; HTML: Substitute ( ... ) ]`
10) Maintain spaces that were put between script steps
XML format requirements:
- Produce FileMaker clipboard XML in the fmxmlsnippet format used by "Copy" from Script Workspace.
- The root must be an fmxmlsnippet object list suitable for script steps.
- Each script step must be represented as a Step node with the correct structure, including:
  - the step type identifier (step id or canonical name, whichever is required by fmxmlsnippet)
  - the step options / parameters for that step
  - calculation text where applicable
  - target fields and variable names where applicable
- Comments must be real FileMaker Comment steps (not XML-only comments).
- If a step supports "With dialog" or similar options, include them only if explicitly present in my text. Otherwise omit.
Accuracy rule:
- Do not invent steps.
- Do not rename steps.
- Do not reorder.
- Do not drop anything.
If you are uncertain about a specific internal step id:
- Still output the XML with your best known mapping for FileMaker Pro 19+.
- Add an XML comment at the very bottom like:
  &lt;!-- UNCERTAIN: StepId for 'Set Web Viewer' --&gt;
  Keep that comment OUTSIDE the FileMaker Comment steps (it is an XML comment, not a script step).
Now convert this script text into fmxmlsnippet clipboard XML:
PASTE_SCRIPT_STEPS_HERE</textarea>
            </div>
          </section>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">Clipboard XML Generator</div>
        ...
        <div class="rail-body">
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Convert FM script steps to clipboard XML</div>
            </div>
            <div class="stack">
              <div class="stack-item">Paste FileMaker script steps in plain text at the end of the prompt</div>
              <div class="stack-item">The AI converts them into fmxmlsnippet clipboard XML</div>
              <div class="stack-item">Output is a single Markdown code block with valid XML you can import into Script Workspace</div>
              <div class="stack-item">Comments, step order, variable names, and calc expressions are preserved exactly</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Hard Rules</div>
              <div class="panel-sub">10 non-negotiable rules enforced</div>
            </div>
            <div class="pill-row">
              <span class="pill2">Single XML output</span>
              <span class="pill2">Preserve comments</span>
              <span class="pill2">Preserve step order</span>
              <span class="pill2">Correct nesting</span>
              <span class="pill2">Escape XML chars</span>
              <span class="pill2">Literal calc text</span>
              <span class="pill2">Exact names</span>
              <span class="pill2">Bracket formatting</span>
              <span class="pill2">Maintain spacing</span>
              <span class="pill2">No invention</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              <span class="pill2">fmxmlsnippet</span>
              <span class="pill2">clipboard XML</span>
              <span class="pill2">Script Workspace</span>
              <span class="pill2">Comment steps</span>
              <span class="pill2">Step node</span>
              <span class="pill2">XML escaping</span>
              <span class="pill2">FileMaker Pro 19+</span>
              <span class="pill2">UNCERTAIN marker</span>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">XML Escape Rules</div>
              <div class="panel-sub">Character mappings</div>
            </div>
            <div class="side-grid">
              ...
              <span class="side-pill">&gt; → &amp;gt;</span>
              <span class="side-pill">" → &amp;quot;</span>
              <span class="side-pill">Apostrophes → safe</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Other XML conversion prompts</div>
            </div>
            <div class="side-grid">
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/XML:FM%20Scripts%20Convertions/Convert%20XML%20To%20FM%20Script.md">XML To FM Script</a>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              ...
              <div class="stack-item">2. Replace PASTE_SCRIPT_STEPS_HERE with your FileMaker script steps in plain text</div>
              <div class="stack-item">3. Paste into the AI and send</div>
              <div class="stack-item">4. Copy the XML output from the code block</div>
              <div class="stack-item">5. Use clipboard-XML import to paste into FileMaker Script Workspace</div>
            </div>
          </div>
        </div>
