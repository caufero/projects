...
<head>
  ...
  <title>Do Changes In Solution Based On Development Documentation</title>
</head>
<body>
            ...
            <div class="nav-group-body">
              ...
              <div class="nav-subgroup open" data-label="AI Prompts Development">
                ...
                <div class="nav-subgroup-body">
                  ...
                  <a class="nav-item sub active" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Do%20Changes%20In%20Solution%20Based%20On%20Development%20Documentation.md" data-label="AI Prompts Development Do Changes In Solution Based On Development Documentation"><span class="dot"></span><span class="nav-text">Do Changes In Solution Based On Development Documentation</span></a>
        ...
        <div class="content-inner">
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Do Changes In Solution Based On Development Documentation</div>
                <div class="hero-sub">Upload your app documentation and CauferoAppStarter technical docs, then paste a client request to get context-aware development guidance.</div>
              </div>
          ...
          <section class="card section" id="prompt-section">
            ...
            <div class="prompt-wrap">
              <textarea class="prompt-box" id="promptBox" readonly spellcheck="false">
I've uploaded:
- The full documentation of **Some_App_Name** solution
- The full technical documentation on how to approach development in **CauferoAppStarter** (from which the solution was built)
Thoroughly go through the 2 files so we can address the following request from the client:
[ PASTE_THE_REQUEST_HERE ]
</textarea>
            </div>
          </section>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">Do Changes Based On Docs</div>
        ...
        <div class="rail-body">
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Addresses client requests using uploaded app documentation and CauferoAppStarter technical docs</div>
            </div>
            <div class="stack">
              <div class="stack-item">Upload 2 files: your app's documentation + CauferoAppStarter technical docs</div>
              <div class="stack-item">Paste the client's request or change request into the prompt</div>
              <div class="stack-item">AI reviews both documents to provide context-aware development guidance</div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">What to upload and paste</div>
            </div>
            <div class="pill-row">
              <span class="pill2">App documentation</span>
              <span class="pill2">CauferoAppStarter docs</span>
              <span class="pill2">Client request</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="side-grid">
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/How%20To%20Go%20About%20Some%20Development%20Task.md">How To Go About Some Dev Task</a>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              ...
              <div class="stack-item">2. Replace <strong>Some_App_Name</strong> with your actual app name</div>
              <div class="stack-item">3. Upload the app's full documentation file</div>
              <div class="stack-item">4. Upload the CauferoAppStarter technical documentation</div>
              <div class="stack-item">5. Replace [ PASTE_THE_REQUEST_HERE ] with the client's request</div>
              <div class="stack-item">6. Paste the prompt into the AI and send</div>
            </div>
          </div>
        </div>
