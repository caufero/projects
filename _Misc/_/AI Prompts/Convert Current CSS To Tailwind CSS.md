...
<head>
  ...
  <title>Convert Current CSS To Tailwind CSS</title>
</head>
<body>
            ...
            <div class="nav-group-body">
              <div class="nav-subgroup open" data-label="AI Prompts CSS">
                ...
                <div class="nav-subgroup-body">
                  <a class="nav-item sub active" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Convert%20Current%20CSS%20To%20Tailwind%20CSS.md" data-label="AI Prompts CSS Convert Current CSS to Tailwind CSS"><span class="dot"></span><span class="nav-text">Convert Current CSS to Tailwind CSS</span></a>
        ...
        <div class="content-inner">
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Convert Current CSS To Tailwind CSS</div>
                <div class="hero-sub">Paste your existing CSS classes and get Tailwind-style values back. One prompt. Copy and go.</div>
              </div>
              ...
              <div class="hero-meta">
                ...
                <span class="chip teal">CSS → Tailwind</span>
                <span class="chip amber">FileMaker-friendly</span>
              </div>
            </div>
          </section>
          ...
          <section class="card section" id="prompt-section">
            ...
            <div class="prompt-wrap">
              <textarea class="prompt-box" id="promptBox" readonly spellcheck="false">I've noticed that modern websites, especially of businesses that offer AI services, all have the same look and feel when it comes to the items on the page. With the research I did, I found that it's so because they all use the same UI kits and frameworks: Tailwind
Uploaded are screenshots of solution. The solution has 7 CSS areas:
1) Splash Screen
2) Banner
3) Dashboard
4) Menu
5) List Page (for list pages)
6) Details Page (for details pages)
Pasted below are the CSS classes of the ______.
Update the values of these CSS classes so they look more like Tailwind CSS. Keep the current CSS classes' colour ideas but implement them using Tailwind CSS look and feel.
...
Note:
- Where you feel the colours are not looking put together well in regards to the whole scope of the software's design, implement your own colouring concept that you feel will look great; they should however look like Tailwind CSS
- Do not change the layout mechanics, just the visual values to use Tailwind CSS values.
- Leave the output in FileMaker calculation-friendly code, making sure that double-quotes are not used in a way that is not friendly to FileMaker Calculation
- Your full output should be in markdown code
[PASTE CSS CLASSES HERE]
Great. Now do same for the _____ of the same software. Remember to update the values of these CSS classes so they look more like Tailwind CSS. Keep the current CSS classes' colour ideas but implement them using Tailwind CSS look and feel.
TAILWIND-ISH BEAUTY GUIDELINES:
sharp SaaS UI with crisp edges, 1px hairline borders used as structure, low-to-medium border radius (6px to 10px), minimal blur shadows (very subtle, not "soft UI"), strong grid alignment with consistent spacing scale (8px base), clean typography hierarchy (tight line-height, clear weights), fast subtle transitions (150ms to 220ms), outline icons with consistent stroke, high color richness allowed, vibrant accent palette (teal/cyan/indigo/purple/orange options), use colorful gradients in hero and key CTAs, allow tinted card backgrounds (very light brand tints), buttons with solid brand fills plus hover darken, focus rings in brand color (not blue-only), hover states include slight border color shift toward brand, support both light and dark mode with brand-forward accents, avoid "everything gray" look, keep neutrals only for layout and text legibility, keep backgrounds clean but permit colorful sections and highlights, maintain sharp lines even with color by keeping borders and spacing consistent
Note:
- Where you feel the colours are not looking put together well in regards to the whole scope of the software's design, implement your own colouring concept that you feel will look great; they should however look like Tailwind CSS
...
---
For Splash Screen:
Great. Now do same for the splash screen. Remember to update the values of these CSS classes so they look more like Tailwind CSS. Keep the current CSS classes' colour ideas but implement them using Tailwind CSS look and feel.
TAILWIND-ISH BEAUTY GUIDELINES:
sharp SaaS UI with crisp edges, 1px hairline borders used as structure, low-to-medium border radius (6px to 10px), minimal blur shadows (very subtle, not "soft UI"), strong grid alignment with consistent spacing scale (8px base), clean typography hierarchy (tight line-height, clear weights), fast subtle transitions (150ms to 220ms), outline icons with consistent stroke, high color richness allowed, vibrant accent palette (teal/cyan/indigo/purple/orange options), use colorful gradients in hero and key CTAs, allow tinted card backgrounds (very light brand tints), buttons with solid brand fills plus hover darken, focus rings in brand color (not blue-only), hover states include slight border color shift toward brand, support both light and dark mode with brand-forward accents, avoid "everything gray" look, keep neutrals only for layout and text legibility, keep backgrounds clean but permit colorful sections and highlights, maintain sharp lines even with color by keeping borders and spacing consistent
Note:
- Where you feel the colours are not looking put together well in regards to the whole scope of the software's design, implement your own colouring concept that you feel will look great; they should however look like Tailwind CSS
- Where possible, if there are any special ideas you have based on Tailwind CSS, implement them.
- Do not change the layout mechanics, just the visual values to use Tailwind CSS values.
- Leave the output in FileMaker calculation-friendly code, making sure that double-quotes are not used in a way that is not friendly to FileMaker Calculation
- Your full output should be in markdown code
[PASTE CSS CLASSES HERE]</textarea>
            </div>
          </section>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">Convert CSS → Tailwind CSS</div>
        ...
        <div class="rail-body">
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Converts existing CSS class values to Tailwind CSS look and feel</div>
            </div>
            <div class="stack">
              <div class="stack-item">Targets 7 CSS areas: Splash Screen, Banner, Dashboard, Menu, List Page, Details Page</div>
              <div class="stack-item">Keeps existing colour ideas but applies Tailwind visual values</div>
              <div class="stack-item">Output is FileMaker calculation-friendly (no double-quote conflicts)</div>
              <div class="stack-item">Output format is Markdown code blocks</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Tailwind Guidelines</div>
              <div class="panel-sub">Key design rules enforced by this prompt</div>
            </div>
            <div class="pill-row">
              <span class="pill2">Sharp SaaS UI</span>
              ...
              <span class="pill2">Brand-forward</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="side-grid">
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/CSS_Theme_Mapper_Prompt.md">Map CSS To Some Theme</a>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              ...
              <div class="stack-item">2. Replace [PASTE CSS CLASSES HERE] with your CSS</div>
              <div class="stack-item">3. Replace the ______ blanks with the CSS area name (e.g. "Banner")</div>
              <div class="stack-item">4. Upload screenshots of your solution to the AI</div>
              <div class="stack-item">5. Paste the prompt and send</div>
            </div>
          </div>
        </div>
