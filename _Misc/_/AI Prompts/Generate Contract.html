...
<head>
  ...
  <title>Generate Contract Prompt</title>
</head>
<body>
          ...
          <div class="nav-group open" data-label="AI Prompts">
            ...
            <div class="nav-group-body">
              ...
              <div class="nav-subgroup open" data-label="AI Prompts Documents">
                ...
                <div class="nav-subgroup-body">
                  <a class="nav-item sub active" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Generate%20Contract.md" data-label="AI Prompts Documents Software Contract"><span class="dot"></span><span class="nav-text">Software Contract</span></a>
        ...
        <div class="content-inner">
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Generate Contract Prompt</div>
                <div class="hero-sub">Copy-ready prompt for a step-by-step contract drafting flow. The AI asks minimum questions, then outputs a complete contract in one Markdown code block.</div>
              </div>
              ...
              <div class="hero-meta">
                ...
                <span class="chip teal">Contract</span>
                <span class="chip amber">Plain English</span>
              </div>
            </div>
          </section>
          ...
          <section class="card section" id="prompt-section">
            <div class="section-head">
              <div class="section-title">
                ...
                <span>Prompt</span>
                <span class="section-sub">Full workflow prompt. Ready to copy.</span>
              </div>
...
You draft simple, real-world business contracts in plain English.
You are not a lawyer.

GOAL
Ask the minimum questions, then output a complete contract in one Markdown code block.

RULES
- Do not assume the contract type or industry.
- Use short sentences and clear headings.
- Avoid the em dash character (—).
- Avoid "not X but Y" sentence structures.
- Include signature + witness blocks.
- Use ____________________ placeholders where needed.
- Final output must be ONLY ONE Markdown code block. No extra commentary.

WORKFLOW

Step 1 (ask 1 question only)
What is the contract type and industry?

Step 2 (Parties only)
Provide:
1) Party A legal name + address
2) Party B legal name + address
3) Party A signatory name + title
4) Party B signatory name + title
5) Optional: phone + email for each party

Step 3 (ask the rest in ONE batch, grouped A to G)
A) Contract Type (missing details only)
B) Parties (missing details only)
C) Scope / Deliverables
D) Fees / Pricing / Payment triggers
E) Timeline / Term / Termination
F) Confidentiality / IP / Liability (as needed)
G) Special clauses + Jurisdiction

Step 4 (assumptions)
- If non-critical, assume and list it.
- If critical, ask exactly 1 follow-up question.

Step 5 (generate contract)
Output the full contract.

START
Begin Step 1 now.</textarea>
            </div>
          </section>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">Generate Contract</div>
        ...
        <div class="rail-body">
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Step-by-step contract drafting with AI</div>
            </div>
            <div class="stack">
              <div class="stack-item">A structured 5-step workflow that guides the AI through drafting a business contract</div>
              <div class="stack-item">The AI asks minimal questions in batches, then outputs a complete contract in one Markdown code block</div>
              <div class="stack-item">Written in plain English — no legal jargon, short sentences, clear headings</div>
              <div class="stack-item">Includes signature and witness blocks with placeholders</div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">The 5-step process</div>
            </div>
            <div class="pill-row">
              <span class="pill2">Step 1 — Contract type</span>
              <span class="pill2">Step 2 — Parties</span>
              <span class="pill2">Step 3 — Details A–G</span>
              <span class="pill2">Step 4 — Assumptions</span>
              <span class="pill2">Step 5 — Generate</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              <span class="pill2">ROLE</span>
              <span class="pill2">GOAL</span>
              <span class="pill2">RULES</span>
              <span class="pill2">WORKFLOW</span>
              <span class="pill2">Plain English</span>
              <span class="pill2">Markdown output</span>
              <span class="pill2">Signature blocks</span>
              <span class="pill2">Placeholders</span>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Step 3 Detail Groups</div>
              <div class="panel-sub">Batched questions A through G</div>
            </div>
            <div class="side-grid">
              <span class="side-pill">A) Contract Type</span>
              <span class="side-pill">B) Parties</span>
              <span class="side-pill">C) Scope / Deliverables</span>
              <span class="side-pill">D) Fees / Payment</span>
              <span class="side-pill">E) Timeline / Termination</span>
              <span class="side-pill">F) Confidentiality / IP</span>
              <span class="side-pill">G) Special clauses</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="side-grid">
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Generate%20Software%20Proposal.md">Software Proposal</a>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              ...
              <div class="stack-item">2. Paste into the AI and send</div>
              <div class="stack-item">3. Answer Step 1: contract type and industry</div>
              <div class="stack-item">4. Answer Step 2: provide party details</div>
              <div class="stack-item">5. Answer Step 3: fill in grouped details A–G</div>
              <div class="stack-item">6. The AI generates the full contract as a Markdown code block</div>
            </div>
          </div>
        </div>
