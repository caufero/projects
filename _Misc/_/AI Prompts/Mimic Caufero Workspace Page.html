...
<head>
  ...
  <title>Build New Page Prompt</title>
</head>
<body>
      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text">AI Prompts</span>
          </div>
        </div>
            ...
            <div class="nav-group-body">
              ...
              <div class="nav-subgroup open" data-label="AI Prompts Development">
                ...
                <div class="nav-subgroup-body">
                  ...
                  <a class="nav-item sub active" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Mimic%20Caufero%20Workspace%20Page.md" data-label="AI Prompts Development Mimic Caufero Workspace Page"><span class="dot"></span><span class="nav-text">Mimic Caufero Workspace Page</span></a>
          ...
          <div class="nav-group" data-label="Tailwind-Designed Websites">
            ...
            <div class="nav-group-body">
              ...
              <div class="nav-subgroup" data-label="Tailwind-Designed Websites AI Agents and Automation">
                <button class="nav-subgroup-head" type="button" data-toggle="subgroup">
                  <span class="mini-pill teal">AI</span><span class="nav-text">AI Agents &amp; Automation</span>
                  <span class="chev" aria-hidden="true"><svg viewBox="0 0 24 24" class="ico sm" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18l6-6-6-6"></path></svg></span>
                </button>
                <div class="nav-subgroup-body">
              ...
              <div class="nav-subgroup" data-label="Tailwind-Designed Websites Builders and Platforms">
                <button class="nav-subgroup-head" type="button" data-toggle="subgroup">
                  <span class="mini-pill violet">BLD</span><span class="nav-text">Builders &amp; Platforms</span>
                  <span class="chev" aria-hidden="true"><svg viewBox="0 0 24 24" class="ico sm" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18l6-6-6-6"></path></svg></span>
                </button>
                <div class="nav-subgroup-body">
              ...
              <div class="nav-subgroup" data-label="Tailwind-Designed Websites Dev Tools and Docs">
                <button class="nav-subgroup-head" type="button" data-toggle="subgroup">
                  <span class="mini-pill">DEV</span><span class="nav-text">Dev Tools &amp; Docs</span>
                  <span class="chev" aria-hidden="true"><svg viewBox="0 0 24 24" class="ico sm" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18l6-6-6-6"></path></svg></span>
                </button>
                <div class="nav-subgroup-body">
              ...
              <div class="nav-subgroup" data-label="Tailwind-Designed Websites Marketing and Growth">
                <button class="nav-subgroup-head" type="button" data-toggle="subgroup">
                  <span class="mini-pill amber">GRW</span><span class="nav-text">Marketing &amp; Growth</span>
                  <span class="chev" aria-hidden="true"><svg viewBox="0 0 24 24" class="ico sm" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18l6-6-6-6"></path></svg></span>
                </button>
                <div class="nav-subgroup-body">
              ...
              <div class="nav-subgroup" data-label="Tailwind-Designed Websites Misc and Reference">
                <button class="nav-subgroup-head" type="button" data-toggle="subgroup">
                  <span class="mini-pill slate">MISC</span><span class="nav-text">Misc &amp; Reference</span>
                  <span class="chev" aria-hidden="true"><svg viewBox="0 0 24 24" class="ico sm" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18l6-6-6-6"></path></svg></span>
                </button>
                <div class="nav-subgroup-body">
        ...
        <div class="content-inner">
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Mimic Caufero Workspace Reference Page</div>
                <div class="hero-sub">The master instruction set for generating any new Caufero Workspace page. Upload this alongside the Workspace reference HTML and the new page content and the AI builds a fully wired, pixel-consistent page in one pass.</div>
              </div>
              ...
              <div class="hero-meta">
                ...
                <span class="chip teal">Page Builder</span>
                <span class="chip violet">Caufero System</span>
              </div>
            </div>
          </section>
          ...
          <section class="card section" id="prompt-section">
            <div class="section-head">
              <div class="section-title">
                ...
                <span>Prompt</span>
                <span class="section-sub">Upload with the Workspace HTML and new page content.</span>
              </div>
            ...
            <div class="prompt-wrap">
              <textarea class="prompt-box" id="promptBox" readonly spellcheck="false">[TO DESIGN WEB PAGES]
Caufero Workspace page is going to be the point of reference in creating other pages. To design a new page, just change the main content canvas (center column) of the Caufero Workspace page. You will also change the items on the right side panel to reflect the new page you're creating. Every other thing should remain the same:
- Top banner should remain the same, including the items on the top banner
- Everything on the side menu should remain the same. Nothing changes on the side menu. All links should be implemented in full like they have been implemented in the original
- I've uploaded the two pages: The Caufero Workspace page and the contents of the new page (the contents of the new page will determine what will be inside the main content canvas (center column) for the new page).
- Every formatting of Caufero Workspace page should not change. Just implement the contents of the new page into the main content canvas (center column)</textarea>
            </div>

            <div class="prompt-wrap">
              <textarea class="prompt-box-2" id="promptBox" readonly spellcheck="false">[TO DESIGN FILES LIKE PDFs]
I have 2 markdown pages:
    - One has been designed with html
    - The other is just raw markdown

I want you to update the one with the raw markdown and design it with html, using the html page as a reference to how the formatting should be and how everything should look like.</textarea>
            </div>
          </section>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">Build Totally New Page</div>
        ...
        <div class="rail-body">
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">The Caufero page generation contract</div>
            </div>
            <div class="stack">
              <div class="stack-item">Send this prompt alongside the Caufero Workspace HTML reference and the new page content file</div>
              <div class="stack-item">AI replaces only the center column and right panel to match the new page</div>
              <div class="stack-item">Everything else — topbar, left nav, all links, CSS, JS — stays untouched</div>
              <div class="stack-item">Works for any type of new page: prompt pages, app pages, documentation, tools</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">What Changes</div>
              <div class="panel-sub">The two zones the AI must update</div>
            </div>
            <div class="side-grid">
              <span class="side-pill">Center column content</span>
              <span class="side-pill">Right panel details</span>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">What Stays Locked</div>
              <div class="panel-sub">Must not change under any circumstance</div>
            </div>
            <div class="pill-row">
              <span class="pill2">Top banner</span>
              <span class="pill2">Brand mark</span>
              <span class="pill2">Left nav tree</span>
              <span class="pill2">All nav links (full)</span>
              <span class="pill2">CSS variables</span>
              <span class="pill2">JS behaviors</span>
              <span class="pill2">Theme toggle</span>
              <span class="pill2">Nav search</span>
              <span class="pill2">Footer structure</span>
              <span class="pill2">Shell grid</span>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Inputs to Provide</div>
              <div class="panel-sub">Files to attach when sending this prompt</div>
            </div>
            <div class="side-grid">
              <span class="side-pill">Caufero Workspace HTML (reference)</span>
              <span class="side-pill">New page content (text, prompt, or spec)</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Key concepts in this prompt</div>
            </div>
            <div class="pill-row">
              <span class="pill2">Reference page</span>
              <span class="pill2">Center column swap</span>
              <span class="pill2">Right panel update</span>
              <span class="pill2">Full link fidelity</span>
              <span class="pill2">No banner changes</span>
              <span class="pill2">No nav changes</span>
              <span class="pill2">Formatting lock</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Other page generation tools</div>
            </div>
            <div class="side-grid">
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Beautify%20Markdown%20File.md">Beautify Markdown File</a>
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Make%20A%20Page%20ChatGPT%20Generated%20Become%20Better/Make%20A%20Page%20ChatGPT%20Generated%20Become%20Better.md">Make A Page Better</a>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              ...
              <div class="stack-item">2. Attach the Caufero Workspace HTML as the reference file</div>
              <div class="stack-item">3. Attach or paste the new page content (prompt, spec, doc, or notes)</div>
              <div class="stack-item">4. Send to the AI and receive a complete ready-to-use HTML page</div>
              <div class="stack-item">5. Save the output as a new .html file in your AI Prompts folder</div>
            </div>
          </div>
        </div>
  ...
  <script>
    (function(){
      ...
      function setTheme(mode){if(!root)return;root.setAttribute("data-theme",mode);try{localStorage.setItem("cwf_theme",mode);}catch(e){}}
      function getTheme(){try{return localStorage.getItem("cwf_theme")||"auto";}catch(e){return"auto";}}
      function toggleTheme(){var cur=root.getAttribute("data-theme")||"auto";if(cur==="auto")return setTheme("dark");if(cur==="dark")return setTheme("light");return setTheme("auto");}
      ...
      function setOpen(panelEl,open){if(!panelEl)return;if(open)panelEl.classList.add("open");else panelEl.classList.remove("open");}
      ...
      function highlightKeywords(){var main=document.querySelector(".content-inner");if(!main)return;var keywords=["Caufero Workspace","center column","right panel","top banner","side menu","reference page","Build New Page","left nav"];var skipSel="a,pre,code,script,style,input,textarea,button";function walk(node){if(!node||node.nodeType!==1)return;if(node.matches(skipSel))return;var children=Array.prototype.slice.call(node.childNodes);for(var i=0;i<children.length;i++){var c=children[i];if(c.nodeType===3){var text=c.nodeValue;if(!text||!text.trim())continue;var replaced=text;var changed=false;for(var k=0;k<keywords.length;k++){var kw=keywords[k];var re=new RegExp("\\b"+kw.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")+"\\b","g");if(re.test(replaced)){replaced=replaced.replace(re,function(m){return"%%KW_START%%"+m+"%%KW_END%%";});changed=true;}}if(changed){var span=document.createElement("span");span.innerHTML=replaced.replace(/%%KW_START%%/g,'<mark class="kw">').replace(/%%KW_END%%/g,"</mark>");c.parentNode.replaceChild(span,c);}}else if(c.nodeType===1){walk(c);}}}walk(main);}
      ...
      function setStatus(msg){if(!copyStatus)return;copyStatus.textContent=msg||"";if(!msg)return;window.setTimeout(function(){copyStatus.textContent="";},1400);}
      function selectAll(){if(!promptBox)return;promptBox.focus();promptBox.select();try{promptBox.setSelectionRange(0,promptBox.value.length);}catch(e){}}
      function execCopyFallback(text){try{var ta=document.createElement("textarea");ta.value=text;ta.setAttribute("readonly","");ta.style.position="fixed";ta.style.left="-9999px";ta.style.top="0";document.body.appendChild(ta);ta.focus();ta.select();try{ta.setSelectionRange(0,ta.value.length);}catch(e){}var ok=document.execCommand("copy");document.body.removeChild(ta);return ok;}catch(e){return false;}}
      function doCopy(){var text=promptBox?promptBox.value:"";if(!text){setStatus("Nothing to copy");return;}selectAll();if(navigator.clipboard&&navigator.clipboard.writeText){navigator.clipboard.writeText(text).then(function(){setStatus("Copied!");}).catch(function(){var ok=execCopyFallback(text);setStatus(ok?"Copied!":"Selected — press Cmd+C");});}else{var ok=execCopyFallback(text);setStatus(ok?"Copied!":"Selected — press Cmd+C");}}
      if(copyBtn)copyBtn.addEventListener("click",doCopy);
      if(heroCopyBtn)heroCopyBtn.addEventListener("click",doCopy);
      function init(){setTheme(getTheme());wireDisclosure();highlightKeywords();if(btnTheme)btnTheme.addEventListener("click",toggleTheme);if(btnMenu)btnMenu.addEventListener("click",function(){var isMobile=window.matchMedia("(max-width: 980px)").matches;if(isMobile){toggleLeftRail();}else{document.body.classList.toggle("compact-rails");}});if(navClear)navClear.addEventListener("click",function(){if(!navSearch)return;navSearch.value="";filterNav("");navSearch.focus();});if(navSearch)navSearch.addEventListener("input",function(){filterNav(navSearch.value||"");});document.addEventListener("click",closeMobileRailsOnOutsideClick,true);filterNav("");}
  ...
  <style>
    ...
    *{box-sizing:border-box;}
    ...
    .prompt-box{width:100%;height:calc(100vh - 700px);min-height:157px;resize:vertical;border-radius:16px;border:1px solid rgba(15,23,42,.12);background:linear-gradient(to bottom, rgba(2,6,23,.92), rgba(2,6,23,.86));color:#e5e7eb;padding:14px;font-family:ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,"Liberation Mono","Courier New",monospace;font-size:12px;line-height:1.55;outline:none;box-shadow:0 14px 34px rgba(2,6,23,.18);overflow:auto;white-space:pre;}
    .prompt-box-2{width:100%;height:calc(100vh - 800px);min-height:150px;resize:vertical;border-radius:16px;border:1px solid rgba(15,23,42,.12);background:linear-gradient(to bottom, rgba(2,6,23,.92), rgba(2,6,23,.86));color:#e5e7eb;padding:14px;font-family:ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,"Liberation Mono","Courier New",monospace;font-size:12px;line-height:1.55;outline:none;box-shadow:0 14px 34px rgba(2,6,23,.18);overflow:auto;white-space:pre;}
