...
<head>
  ...
  <title>AI Agent Training Prompt</title>
</head>
<body>
          ...
          <div class="nav-group open" data-label="AI Prompts">
            ...
            <div class="nav-group-body">
              ...
              <div class="nav-subgroup open" data-label="AI Prompts Docs">
                ...
                <div class="nav-subgroup-body">
                  <a class="nav-item sub active" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Generate%20Documentations/AI_AgentTraining.md" data-label="AI Prompts Docs Documentation To Train Agent To Do Something"><span class="dot"></span><span class="nav-text">Documentation To Train Agent To Do Something</span></a>
        ...
        <div class="content-inner">
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">AI Agent Training Prompt</div>
                <div class="hero-sub">Write documentation that trains an AI Agent to build applications using the FileMaker file CauferoAppStarter. Includes sub-prompts for script analysis and task execution.</div>
              </div>
              ...
              <div class="hero-meta">
                ...
                <span class="chip teal">AI Agent</span>
                <span class="chip amber">CauferoAppStarter</span>
              </div>
            </div>
          </section>
          ...
          <section class="card section" id="prompt-section">
            <div class="section-head">
              <div class="section-title">
                ...
                <span>Prompt</span>
                <span class="section-sub">Main prompt + two sub-prompts.</span>
              </div>
            ...
            <div class="prompt-wrap">
              <textarea class="prompt-box" id="promptBox" readonly spellcheck="false">I want to write documentations that will be used to train an AI Agent to build applications using the FileMaker file CauferoAppStarter.
Currently I want to write a documentation for ________. Write the full documentation that can train the AI to ________.
Below is a sample code that ________. Take all the time you need to thoroughly go through the code to give you an idea what the content should be and how the content should best be written to achieve the best results.
The documentation should be perfect to train the AI Agent. If you find any ambiguities you'll need clarity on or if you find any contradictions you'll need clarification on, point them out to me so I give you clarity on or so I clarify.
---
## Hard Rule: Output Must Be Raw Markdown Code Only (No Rendered Text)
Everything you generate for this documentation must be returned inside one single outer Markdown code block that starts with ```md and ends with ```.
---
This means:
- Do not write any text outside that outer ```md block.
- The entire response must be copy-paste ready into a `.md` file.
- All headings, lists, and inner code blocks (example: ```filemaker) must appear as literal text inside the outer ```md block.
- If you need to include inner code blocks, you must format them in a way that does not break the outer block (example: indent inner fences or use alternative fencing like `~~~` for inner blocks).
---
If this rule is not followed, the response is invalid and must be rewritten immediately.
---
# Prompt To Find Out What A FileMaker Script Is Doing
What do you think this filemaker script was written to handle:
---
> ...*Pasted FileMaker Script*...
---
# Prompt To Do A Task Based On A Documentation
---
> Based on the documentation below, ______:</textarea>
            </div>
          </section>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">AI Agent Training</div>
        ...
        <div class="rail-body">
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Write AI-training documentation for CauferoAppStarter</div>
            </div>
            <div class="stack">
              <div class="stack-item">Generates documentation to train an AI Agent to build apps using CauferoAppStarter</div>
              <div class="stack-item">You provide sample code and describe what area the documentation should cover</div>
              <div class="stack-item">The AI writes thorough documentation, flags ambiguities and contradictions</div>
              <div class="stack-item">Output is raw Markdown inside a single outer code block, ready for .md files</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Included Sub-Prompts</div>
              <div class="panel-sub">Two bonus prompts at the bottom</div>
            </div>
            <div class="pill-row">
              <span class="pill2">Script Analysis — "What is this script doing?"</span>
              <span class="pill2">Task Execution — "Based on documentation, do ___"</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Non-negotiable output requirements</div>
            </div>
            <div class="side-grid">
              <span class="side-pill">Single outer ```md block</span>
              <span class="side-pill">No text outside code block</span>
              <span class="side-pill">Copy-paste ready into .md file</span>
              <span class="side-pill">Inner code blocks use ~~~ or indent</span>
              <span class="side-pill">Invalid if rule broken</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              ...
              <div class="stack-item">2. Fill in the blanks: what area to document and what the AI should learn</div>
              <div class="stack-item">3. Paste sample code below the prompt</div>
              <div class="stack-item">4. The AI writes full documentation and flags any ambiguities</div>
              <div class="stack-item">5. Use the sub-prompts for script analysis or task execution</div>
            </div>
          </div>
        </div>
