...
<head>
  ...
  <title>Update ExecuteSQL Query</title>
</head>
<body>
            ...
            <div class="nav-group-body">
              ...
              <div class="nav-subgroup open" data-label="AI Prompts Development">
                ...
                <div class="nav-subgroup-body">
                  ...
                  <a class="nav-item sub active" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Update%20ExecuteSQL%20Query.md" data-label="AI Prompts Development Update ExecuteSQL Query"><span class="dot"></span><span class="nav-text">Update ExecuteSQL Query</span></a>
                </div>
              </div>
        ...
        <div class="content-inner">
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Update ExecuteSQL Query</div>
                <div class="hero-sub">Paste an existing ExecuteSQL query, upload the CauferoAppStarter documentation, and describe your new requirements to get an updated query.</div>
              </div>
          ...
          <section class="card section" id="prompt-section">
            <div class="section-head">
              <div class="section-title">
                ...
                <span>Prompt</span>
                <span class="section-sub">Paste query + describe changes.</span>
              </div>
            ...
            <div class="prompt-wrap">
              <textarea class="prompt-box" id="promptBox" readonly spellcheck="false">[PASTE_SOME_QUERY]

Update the query above based on the uploaded technical documentation of CauferoAppStarter (to know the available database structure in the file, and also how to write queries in the file), with these new requests:
...
- </textarea>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">Update ExecuteSQL Query</div>
        ...
        <div class="rail-body">
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Modify an existing ExecuteSQL query using AI</div>
            </div>
            <div class="stack">
              <div class="stack-item">Paste an existing ExecuteSQL query you want modified</div>
              <div class="stack-item">Upload the CauferoAppStarter documentation so the AI knows the database structure</div>
              <div class="stack-item">List your new requirements under "New Requests"</div>
              <div class="stack-item">The AI returns an updated query that follows the documentation's conventions</div>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              <span class="pill2">Existing SQL query</span>
              <span class="pill2">CauferoAppStarter docs</span>
              <span class="pill2">New requirements list</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              <span class="pill2">Update</span>
              <span class="pill2">Query</span>
              <span class="pill2">ExecuteSQL</span>
              <span class="pill2">CauferoAppStarter</span>
              <span class="pill2">Database structure</span>
              <span class="pill2">New Requests</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Referenced documents</div>
            </div>
            <div class="side-grid">
              <a class="side-pill" href="https://caufero.github.io/projects/Apps/CauferoAppStarter/_Misc/Full%20Documentation%20-%20CauferoAppStarter.md">Full Documentation — CauferoAppStarter</a>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="side-grid">
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Do%20Changes%20In%20Solution%20Based%20On%20Development%20Documentation.md">Do Changes In Solution</a>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              ...
              <div class="stack-item">2. Replace [PASTE_SOME_QUERY] with your existing ExecuteSQL query</div>
              <div class="stack-item">3. Upload the CauferoAppStarter documentation file</div>
              <div class="stack-item">4. Add your new requirements as bullet points under "New Requests"</div>
              <div class="stack-item">5. Paste into the AI and send</div>
            </div>
          </div>
        </div>
