...
<head>
  ...
  <title>Format JS Of Working FM Script Into Preferred Components</title>
</head>
<body>
            ...
            <div class="nav-group-body">
              ...
              <div class="nav-subgroup open" data-label="AI Prompts Development">
                ...
                <div class="nav-subgroup-body">
                  ...
                  <div class="nav-subgroup open" data-label="AI Prompts Development Make Page Generation Better">
        ...
        <div class="content-inner">
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Format JS Of Working FM Script Into Preferred Components</div>
                <div class="hero-sub">Study a FileMaker script's JavaScript and break it into chunked variables matching the preferred Set Variable pattern.</div>
              </div>
              ...
              <div class="hero-meta">
                ...
                <span class="chip teal">WebViewer JS</span>
                <span class="chip amber">FileMaker Variables</span>
              </div>
            </div>
          </section>
          ...
          <section class="card section" id="prompt-section">
            <div class="section-head">
              <div class="section-title">
                ...
                <span class="section-sub">Copy and paste into ChatGPT with your JS.</span>
              </div>
            ...
            <div class="prompt-wrap">
              <textarea class="prompt-box" id="promptBox" readonly spellcheck="false">I want you to study the FileMaker script above. I want you to put the js below that I'm using for the report filter page into chunks (variables) just like I've done in the filemaekr script above. take your time so you dont miss anything.

PASTE_JS_TO_BE_WORKED_ON_HERE</textarea>
            </div>
          </section>

          <section class="card section" id="code-reference">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">📂</span>
                <span>Reference: FileMaker Script JS Variables</span>
                <span class="section-sub">Example of the chunked variable pattern this prompt produces.</span>
              </div>
            </div>

            <div class="code-ref-wrap">
              <pre class="code-ref"><code>Set Variable [ $Show Content Script ; Value: "function showContent(contentId, tabElement) {
...
Set Variable [ $Choose File ; Value: "/* Prevent the file dialog from opening by intercepting the 'click' event */
document.getElementById('materialPhoto').addEventListener('click', function(event) {
    ...
    /* Show an alert to confirm the click event is intercepted */
...
document.getElementById('materialPhoto').addEventListener('change', function(event) {
    ...
    event.preventDefault(); 
    /* Show an alert to confirm the change event is intercepted */
    alert('Change event triggered, but file dialog didn't open.');
});
" ]
Set Variable [ $Image Modal ; Value: "
...
" ]
Set Variable [ $Cancel Action Script ; Value: "function cancelAction() {
         FileMaker.PerformScript('" &amp; $Cancel Script &amp; "');
}" ]
Set Variable [ $Toggle Script ; Value: "function preselectToggle(statusValue) {
...
Set Variable [ $Select Segmented Control Script ; Value: "function selectSegmentedControl(button) {
      const buttons = document.querySelectorAll('.segmented-control button');
      buttons.forEach(btn =&gt; btn.classList.remove('active'));
      button.classList.add('active');
}" ]
Set Variable [ $Datepicker Script ; Value: "
...
" ]
Set Variable [ $Grant System Access Script ; Value: "function grantSystemAccess() {
         ...
         FileMaker.PerformScript('" &amp; $Grant System Access Script &amp; "', parameters);
}" ]
Set Variable [ $View Education Script ; Value: "function viewEducation(parameters) {
         FileMaker.PerformScript('" &amp; $View Education FM Script &amp; "', parameters);
}" ]
Set Variable [ $View Emergency Contact Script ; Value: "function viewEmergencyContactDetails(parameters) {
         FileMaker.PerformScript('" &amp; $View Emergency Contact FM Script &amp; "', parameters);
}" ]
Set Variable [ $DepartmentsJobTitlesNotches Script ; Value: "document.addEventListener('DOMContentLoaded', function() {
    const departments = { " &amp; $Departments JS &amp;" };
    const jobTitles = { " &amp; $Job Titles JS &amp;" };
    const notches = { " &amp; $Notches JS &amp;" };
    const departmentDropdown = document.getElementById('department');
    const jobTitleDropdown = document.getElementById('job_title');
    const notchDropdown = document.getElementById('notch');
    const selectedDepartment = '" &amp; $Department ID &amp; "';
    const selectedJobTitle = '" &amp; $Job Title ID &amp; "';
    const selectedNotch = '" &amp; $Notch ID &amp; "';
    ...
    /* Populate job titles dropdown if department is preselected */
    ...
    /* Populate notches dropdown if job title is preselected */
...
" ]
Set Variable [ $Get Attendance Script ; Value: "function getAttendance() {
...
Set Variable [ $View Document Script ; Value: "function viewDocument(parameters) {
         FileMaker.PerformScript('" &amp; $View Document FM Script &amp; "', parameters);
}" ]
Set Variable [ $Add Document Script ; Value: "function addDocument(parameters) {
         FileMaker.PerformScript('" &amp; $Add Document FM Script &amp; "', parameters);
}" ]
Set Variable [ $Line Graph 2 JS ; Value: "
    /* Get the canvas context */
    const ctxLineAlt = document.getElementById('lineChartAlt').getContext('2d');
    /* Define the chart data */
    const dataLineAlt = {
        labels: [" &amp; $$Appraisal Periods &amp; "],
        datasets: [
            {
                label: 'My Performance Graph',
                data: [" &amp; $$Scores &amp; "],
                " &amp; GetValue ( $Line Graph Colours ; 1 ) &amp; ",
                tension: 0.4,
                fill: true
            }
        ]
        ...
        options: {
            ...
            scales: {
                x: {
                    title: {
                        display: true,
                        text: 'Appraisal Periods',
                        color: '" &amp; $AxisColours _X &amp; "',
                        font: { size: 14, weight: 'bold' },
                        padding: { top: 5 }
                    },
                    ticks: { color: '" &amp; $AxisColours _X &amp; "' },
                    grid: { color: '" &amp; $GridColours &amp; "' }
                },
                y: {
                    min: 0, max: 100,
                    title: {
    ...
    const lineChartAlt = new Chart(ctxLineAlt, configLineAlt);
" ]
If [ IsEmpty ( $Username ) ]
    Set Variable [ $Save Item Info Script ; Value: "function saveItemInfo() {
         /* ... collect all form fields ... */
         const parameters = [ staff_number, title, first_name, other_names, last_name,
           gender, dob, hometown, hometown_region, nationality, phone, email, gps,
           residential_address, postal_address, department, job_title, notch,
           bank, branch, account_number ].join('|');
         FileMaker.PerformScript('" &amp; $Save Record Script &amp; "', parameters);
}" ]
Else
    Set Variable [ $Save Item Info Script ; Value: "function saveItemInfo() {
         /* ... collect all form fields + role ... */
         const parameters = [ staff_number, title, first_name, other_names, last_name,
           gender, dob, hometown, hometown_region, nationality, phone, email, gps,
           residential_address, postal_address, department, job_title, notch,
           bank, branch, account_number, role ].join('|');
         FileMaker.PerformScript('" &amp; $Save Record Script &amp; "', parameters);
}" ]
End If
Set Variable [ $Scripts ; Value: "&lt;script&gt; " &amp; 
$Show Content Script &amp; "¶¶" &amp; 
$Choose File &amp; "¶¶" &amp;
$Image Modal &amp; "¶¶" &amp;
...
$Wizard Script &amp; "¶¶" &amp; 
$Datepicker Script &amp; "¶¶" &amp; 
$View Education Script &amp; "¶¶" &amp; 
$View Emergency Contact Script &amp; "¶¶" &amp; 
$DepartmentsJobTitlesNotches Script &amp; "¶¶" &amp; 
$Grant System Access Script &amp; "¶¶" &amp; 
$Get Attendance Script &amp; "¶¶" &amp; 
 ...
 &amp; " &lt;/script&gt; " ]</code></pre>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">Format JS Into FM Variables</div>
          <div class="rail-actions">
            ...
            <a class="rail-btn" href="#code-reference">Code Reference</a>
          </div>
        </div>
        ...
        <div class="rail-body">
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">A prompt + reference for chunking WebViewer JS into FileMaker Set Variable steps</div>
            </div>
            <div class="stack">
              <div class="stack-item">Paste the instruction prompt into ChatGPT along with a working FileMaker script</div>
              <div class="stack-item">Then paste the JS you want chunked — the AI breaks it into Set Variable blocks</div>
              <div class="stack-item">The code reference below shows the exact pattern the output should follow</div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Key concepts in this document</div>
            </div>
            <div class="pill-row">
              <span class="pill2">Set Variable</span>
              <span class="pill2">FileMaker.PerformScript</span>
              <span class="pill2">showContent</span>
              <span class="pill2">Datepicker</span>
              <span class="pill2">Chart.js</span>
              <span class="pill2">Cascading Dropdowns</span>
              <span class="pill2">Image Modal</span>
              <span class="pill2">saveItemInfo</span>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">JS Functions in Reference</div>
              <div class="panel-sub">Variables shown in the code block</div>
            </div>
            <div class="side-grid">
              <span class="side-pill">$Show Content Script</span>
              <span class="side-pill">$Choose File</span>
              <span class="side-pill">$Image Modal</span>
              <span class="side-pill">$Cancel Action Script</span>
              <span class="side-pill">$Toggle Script</span>
              <span class="side-pill">$Segmented Control</span>
              <span class="side-pill">$Datepicker Script</span>
              <span class="side-pill">$Grant System Access</span>
              <span class="side-pill">$Departments/Jobs/Notches</span>
              <span class="side-pill">$Line Graph 2 JS</span>
              <span class="side-pill">$Save Item Info Script</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Other page generation prompts</div>
            </div>
            <div class="side-grid">
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              <div class="stack-item">1. Copy the instruction prompt above</div>
              <div class="stack-item">2. First show ChatGPT the FileMaker script you want it to study as a pattern</div>
              <div class="stack-item">3. Then paste the prompt with your JS in place of PASTE_JS_TO_BE_WORKED_ON_HERE</div>
              <div class="stack-item">4. The AI chunks your JS into Set Variable blocks matching the pattern below</div>
              <div class="stack-item">5. Final $Scripts variable wires them all into a single &lt;script&gt; block</div>
            </div>
          </div>
        </div>
