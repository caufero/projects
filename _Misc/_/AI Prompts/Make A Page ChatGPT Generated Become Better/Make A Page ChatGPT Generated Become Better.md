...
<head>
  ...
  <title>Make A Page ChatGPT Generated Become Better</title>
</head>
<body>
        ...
        <div class="content-inner">
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Make A Page ChatGPT Generated Become Better</div>
                <div class="hero-sub">Take an existing FileMaker WebViewer page, review its CSS + HTML + JS, and redesign it into something professional and polished.</div>
              </div>
              ...
              <div class="hero-meta">
                ...
                <span class="chip teal">Polish UI</span>
          ...
          <section class="card section" id="prompt-section">
            ...
            <div class="prompt-wrap">
              <textarea class="prompt-box" id="promptBox" readonly spellcheck="false">In FileMaker WebViewer, I have a page where the user can ___________. This page looks really ugly. I have added below the whole HTML, Javascript for the page. I want you to make the page way better than it is now, professional, nice, very well done. Add objects you think should be on that page as a report filter page. I have also added below the whole CSS that is called to build pages in this software. You can look for the part of the css that controls that part and edit the css and or even add new css classes for the report. Separate the codes into CSS components, HTML Components and Javascript components. Let the generated code be in markdown code so i can copy and paste easily in the application. I've attached a screenshot of how the page currently looks like

Below is the css of the page:
[PASTE CSS HERE]

Below is the HTML of the page:
[PASTE HTML HERE]

Below is the Javascript of the page:
[PASTE JS HERE]</textarea>
            </div>
          </section>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">Make A Page Better</div>
        ...
        <div class="rail-body">
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Beautify a FileMaker WebViewer page with AI</div>
            </div>
            <div class="stack">
              <div class="stack-item">Paste your existing page's CSS, HTML, and JavaScript into the prompt</div>
              <div class="stack-item">Attach a screenshot of how the page currently looks</div>
              <div class="stack-item">AI redesigns it into a professional, polished page and adds missing UI elements</div>
              <div class="stack-item">Output is separated into CSS, HTML, and JavaScript components in Markdown</div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">What to paste and attach</div>
            </div>
            <div class="pill-row">
              <span class="pill2">Page CSS</span>
              <span class="pill2">Page HTML</span>
              <span class="pill2">Page JavaScript</span>
              <span class="pill2">Screenshot</span>
              <span class="pill2">Page description</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              ...
              <span class="pill2">HTML</span>
              <span class="pill2">JavaScript</span>
              <span class="pill2">CSS</span>
              <span class="pill2">Components</span>
          ...
          <div class="panel-card">
            ...
            <div class="side-grid">
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Make%20A%20Page%20ChatGPT%20Generated%20Become%20Better/Format%20JS%20Of%20Working%20FM%20Script%20Into%20Preferred%20Components.md">Format JS Into FM Variables</a>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              ...
              <div class="stack-item">2. Fill in the blank: "the user can ___________"</div>
              <div class="stack-item">3. Replace [PASTE CSS HERE] with the page's full CSS</div>
              <div class="stack-item">4. Replace [PASTE HTML HERE] with the page's full HTML</div>
              <div class="stack-item">5. Replace [PASTE JS HERE] with the page's full JavaScript</div>
              <div class="stack-item">6. Attach a screenshot of the current page</div>
              <div class="stack-item">7. Paste into the AI and send</div>
            </div>
          </div>
        </div>
