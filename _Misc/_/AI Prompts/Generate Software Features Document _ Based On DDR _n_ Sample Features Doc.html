          ...
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                ...
                <div class="hero-sub">DDR-grounded features document generator. Paste a FileMaker DDR XML export, optionally add a design sample, and get a complete features document with screenshot placeholders in raw Markdown.</div>
              </div>
              ...
              <div class="hero-meta">
                ...
                <span class="chip copper">DDR</span>
              </div>
            </div>
          </section>
...
You will receive a **FileMaker DDR XML export**. You will also receive a **Software Features Document Sample** when you want the generated document to match a specific visual design and layout system.
You will generate a Features Document grounded strictly in what the DDR proves.
The product is already built, so the document will include screenshot placeholders throughout.
No fluff. No marketing. No pricing. No guessing.

INPUT

* Required: DDR XML (FileMaker Database Design Report export)
* Optional: Software Features Document Sample (HTML/Markdown/CSS)

DESIGN AND SKIN RULE (CRITICAL)

* If a Software Features Document Sample is provided, the output will follow the sample's **document skin**:

  * HTML structure patterns (cover, grids, cards, feature rows, tables)
  * CSS styling approach (theme variables, spacing, borders, print rules)
  * Visual arrangement and placement of content and images
* The output will not copy the sample's product content. It will copy only the **layout system and styling approach** and fill it with DDR-derived content.
* If no sample is provided, the output will use the default Markdown-only structure defined in this instruction.

OUTPUT FORMAT RULE (CRITICAL)

* The output will be a single Markdown document that contains:

  1. An HTML wrapper container for the document (like `&lt;div class="doc"&gt;...&lt;/div&gt;`)
  2. The full CSS skin in a final `&lt;style&gt;...&lt;/style&gt;` block, following the sample's pattern
  3. Markdown headings where appropriate, consistent with the sample's mixed Markdown + HTML approach
* The output will remain print-friendly for PDF export using the sample's `@media print` rules.

EVIDENCE RULE
Every feature claim will include DDR evidence:

* Layout(s)
* Script(s)
* Table(s) and field(s)
* Value list(s) or custom function(s)
  If a claim cannot be backed by DDR evidence, it will be marked "TBD" and the missing DDR evidence will be stated.

SCREENSHOT PLACEHOLDER RULES (VERY IMPORTANT)

* The document will include screenshot placeholders in the specified locations.
...
SCREENSHOT PLACEMENT + DESIGN INTEGRATION RULE

* Screenshot placeholders will be placed inside the sample's visual components:

  * Use `.feature-row` blocks for sections that pair text with a main screenshot
  * Use `.link-grid` + `.link-card` blocks for grouped benefits/features
  * Use `.media-card` blocks for screenshot galleries or side-by-side screens
  * Use styled tables for module summaries and report listings
* Screenshot placeholders will replace image tags in the sample pattern.

  * Example: where the sample uses `&lt;img ...&gt;`, the output will insert the placeholder block instead.

SCREENSHOT CODES
Screenshot codes will be consistent and structured like:
...
* For each workflow, include placeholders for key steps.

HOW TO INFER FROM DDR

* Layouts = user-facing screens and module boundaries
* Scripts = workflows, actions, automations, validation logic, and user-facing screens and module boundaries (UI rendered via WebViewer scripts)
...
* Module names will be inferred from layout naming patterns and confirmed by script naming patterns.

STRUCTURE RULE

* If a sample is provided: the document will follow the sample's **section ordering and visual arrangement style**, while still outputting the required DDR-based sections below.
* If the sample's section ordering conflicts with the required section order below, the required order below wins, but the sample's **skin and layout components** are still used to render each section.
...
* Roadmap beyond current build</textarea>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">Generate Software Features Document</div>
        ...
        <div class="rail-body">
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">DDR-grounded features document for FileMaker solutions</div>
            </div>
            <div class="stack">
              <div class="stack-item">Paste a FileMaker DDR XML export as input</div>
              <div class="stack-item">Optionally add a Software Features Document Sample for visual skin matching</div>
              <div class="stack-item">AI extracts modules, features, workflows, roles, and reports from the DDR evidence</div>
              <div class="stack-item">Generates a full 14-section features document with screenshot placeholders and appendices</div>
              <div class="stack-item">Output is raw Markdown with HTML/CSS skin, ready for PDF export</div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">14 sections + appendices generated in order</div>
            </div>
            <div class="pill-row">
              ...
              <span class="pill2">9. Settings &amp; Config</span>
              ...
              <span class="pill2">A. DDR Inventory</span>
              <span class="pill2">Missing Info Checklist</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              ...
              <span class="pill2">SCREENSHOTS</span>
              <span class="pill2">MODULES</span>
              <span class="pill2">FEATURES</span>
              <span class="pill2">WORKFLOWS</span>
              <span class="pill2">SKIN</span>
              <span class="pill2">TBD</span>
              <span class="pill2">PRINT-FRIENDLY</span>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">DDR Inference Rules</div>
              <div class="panel-sub">How the AI reads the DDR</div>
            </div>
            <div class="side-grid">
              <span class="side-pill">Layouts = Screens</span>
              <span class="side-pill">Scripts = Workflows</span>
              <span class="side-pill">Tables = Entities</span>
              <span class="side-pill">Value Lists = Config</span>
              <span class="side-pill">Privilege Sets = Roles</span>
              <span class="side-pill">Custom Funcs = Logic</span>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Screenshot Code Format</div>
              <div class="panel-sub">Structured codes for easy search-and-replace</div>
            </div>
            <div class="stack">
              <div class="stack-item">SS-OV-001 <div class="stack-sub">Overview screens</div></div>
              <div class="stack-item">SS-ROLE-001 <div class="stack-sub">Roles and access</div></div>
              <div class="stack-item">SS-MOD-&lt;code&gt;-001 <div class="stack-sub">Module screens</div></div>
              <div class="stack-item">SS-FEAT-&lt;mod&gt;-&lt;feat&gt;-001 <div class="stack-sub">Feature screens</div></div>
              <div class="stack-item">SS-FLOW-&lt;code&gt;-001 <div class="stack-sub">Workflow steps</div></div>
              <div class="stack-item">SS-REP-&lt;code&gt;-001 <div class="stack-sub">Reports and dashboards</div></div>
              <div class="stack-item">SS-SET-&lt;code&gt;-001 <div class="stack-sub">Settings and config</div></div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Non-negotiable constraints</div>
            </div>
            <div class="stack">
              <div class="stack-item">Every feature claim must include DDR evidence (layouts, scripts, tables, value lists)</div>
              <div class="stack-item">Unproven claims must be marked TBD with the missing evidence stated</div>
              <div class="stack-item">No fluff. No marketing. No pricing. No guessing.</div>
              <div class="stack-item">If a design sample is provided, match its skin/layout system only, not its content</div>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              ...
              <div class="stack-item">2. Paste into the AI and send along with your DDR XML export</div>
              <div class="stack-item">3. Optionally attach a Software Features Document Sample for skin matching</div>
              <div class="stack-item">4. The AI generates the full features document grounded in DDR evidence</div>
              <div class="stack-item">5. Replace screenshot placeholders with actual screenshots from your app</div>
              <div class="stack-item">6. Export to PDF or paste into your document system</div>
            </div>
          </div>
        </div>
