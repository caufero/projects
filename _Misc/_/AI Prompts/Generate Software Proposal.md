...
<head>
  ...
  <title>Generate Software Proposal Prompt</title>
</head>
<body>
            ...
            <div class="nav-group-body">
              ...
              <div class="nav-subgroup open" data-label="AI Prompts Documents">
                ...
                <div class="nav-subgroup-body">
                  ...
                  <a class="nav-item sub active" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Generate%20Software%20Proposal.md" data-label="AI Prompts Documents Software Proposal"><span class="dot"></span><span class="nav-text">Software Proposal</span></a>
                </div>
              </div>
        ...
        <div class="content-inner">
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Generate Software Proposal Prompt</div>
                <div class="hero-sub">Copy-ready prompt for a discovery-to-proposal flow. Paste discovery notes, answer clarifying questions, and get a full client-ready FileMaker proposal in raw Markdown.</div>
              </div>
              ...
              <div class="hero-meta">
                ...
                <span class="chip teal">Proposal</span>
          ...
          <section class="card section" id="prompt-section">
            <div class="section-head">
              <div class="section-title">
                ...
                <span>Prompt</span>
                <span class="section-sub">Discovery notes in, proposal out.</span>
              </div>
...
You generate client-ready software proposals for Claris FileMaker solutions.
You write in my voice: direct, Ghanaian, clear, persuasive.

INPUT
I will paste discovery notes at the bottom.

YOUR JOB
1) Extract and organize requirements from the discovery notes.
2) Ask me only the minimum clarifying questions needed for a high-quality proposal (aim 8 to 15).
3) After I answer, generate the full proposal.

CRITICAL OUTPUT RULE
- Final proposal must be RAW Markdown only.
- Return it inside ONE single outer Markdown code block that starts with ```md and ends with ```.
- Do not write any text outside that outer ```md block.
- Inner code blocks are allowed inside the outer block if needed.

WRITING RULES
- Professional, confident, specific. No fluff.
- No em dash character. Do not use it at all.
- Avoid "not X but Y" sentence style.
- State scope boundaries and assumptions clearly.
- Use phased delivery: MVP then iterations with a practical timeline.
- Include pricing structure options with placeholders where needed.
- Include risks and mitigations.
- Include what the client must provide.
- Include acceptance criteria and change request process.
- Output must be ready to paste into a proposal document without edits.

WORKFLOW

Step 1 (Questions only)
Ask clarifying questions in a numbered list, grouped under:
A) Client and context
B) Users, roles, and locations
C) Inventory, production, bespoke flow details
D) Sales, commission, payroll, finance specifics
E) Reporting and dashboard expectations
F) Integrations, devices, and hosting
G) Implementation approach, timeline, and budget

Step 2 (After I answer)
Generate the proposal using these exact sections, in this exact order:
...
3. Understanding of Your Operations (Discovery Summary)
   - Administrative needs
   - Daily workflow (inventory, bespoke, production, sales, payroll)

4. Proposed Solution Overview
   - High-level architecture (FileMaker Pro, FileMaker Server or Claris Connect if needed)
...
8. Non-negotiable Requirements Mapping
   - Create a checklist mapping each non-negotiable item to the module(s) that satisfy it

9. Deliverables
   - What the client receives (apps, admin console, documentation, training)

10. Implementation Plan
    - Phase 0: Kickoff and confirmation
    - Phase 1: MVP build
    - Phase 2: Enhancements
    - Phase 3: Stabilization, training, go-live
    - Include a timeline table with weeks and deliverables
...
14. Risks and Mitigations
    - At least 8 realistic risks for this project and how we reduce them
...
START
Begin Step 1 now. Ask only the clarifying questions.</textarea>
            </div>
          </section>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">Generate Software Proposal</div>
        ...
        <div class="rail-body">
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Discovery-to-proposal workflow for FileMaker solutions</div>
            </div>
            <div class="stack">
              <div class="stack-item">Paste discovery notes at the bottom of the prompt</div>
              <div class="stack-item">AI extracts requirements and asks 8–15 clarifying questions grouped A–G</div>
              <div class="stack-item">After you answer, it generates a full 17-section proposal in raw Markdown</div>
              <div class="stack-item">Output is ready to paste directly into a proposal document</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Proposal Sections</div>
              <div class="panel-sub">17 sections generated in order</div>
            </div>
            <div class="pill-row">
              <span class="pill2">1. Cover Page</span>
              <span class="pill2">2. Executive Summary</span>
              <span class="pill2">3. Discovery Summary</span>
              <span class="pill2">4. Solution Overview</span>
              <span class="pill2">5. Scope of Work</span>
              <span class="pill2">6. Key Workflows</span>
              <span class="pill2">7. Reports &amp; Dashboards</span>
              <span class="pill2">8. Requirements Map</span>
              <span class="pill2">9. Deliverables</span>
              <span class="pill2">10. Implementation</span>
              <span class="pill2">11. Testing &amp; Acceptance</span>
              <span class="pill2">12. Client Responsibilities</span>
              <span class="pill2">13. Assumptions</span>
              <span class="pill2">14. Risks</span>
              <span class="pill2">15. Pricing</span>
              <span class="pill2">16. Hosting &amp; Licensing</span>
              <span class="pill2">17. Next Steps</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              <span class="pill2">INPUT</span>
              <span class="pill2">QUESTIONS</span>
              <span class="pill2">PROPOSAL</span>
              <span class="pill2">RAW MARKDOWN</span>
              <span class="pill2">MVP</span>
              <span class="pill2">PHASES</span>
              <span class="pill2">RISKS</span>
              <span class="pill2">PRICING</span>
              <span class="pill2">ACCEPTANCE</span>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Question Groups (Step 1)</div>
              <div class="panel-sub">Clarifying questions grouped A–G</div>
            </div>
            <div class="side-grid">
              <span class="side-pill">A) Client and context</span>
              <span class="side-pill">B) Users, roles, locations</span>
              <span class="side-pill">C) Inventory, production, bespoke</span>
              <span class="side-pill">D) Sales, commission, payroll</span>
              <span class="side-pill">E) Reporting and dashboards</span>
              <span class="side-pill">F) Integrations, devices, hosting</span>
              <span class="side-pill">G) Timeline and budget</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="side-grid">
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Generate%20Contract.md">Software Contract</a>
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Generate%20Software%20Features%20Document%20_%20Based%20On%20DDR%20_n_%20Sample%20Features%20Doc.md">Software Features Document</a>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              ...
              <div class="stack-item">2. Replace [PASTE DISCOVERY NOTES HERE] with your actual discovery notes</div>
              <div class="stack-item">3. Paste into the AI and send</div>
              <div class="stack-item">4. Answer the 8–15 clarifying questions</div>
              <div class="stack-item">5. The AI generates the full 17-section proposal in one Markdown block</div>
              <div class="stack-item">6. Copy the output and paste into your proposal document</div>
            </div>
          </div>
        </div>
