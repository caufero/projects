...
<head>
  ...
  <title>How To Go About Some Development Task</title>
</head>
<body>
  <div class="page" data-theme="auto">
      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text">AI Prompts › Development</span>
          </div>
        </div>
    ...
    <div class="shell" id="shell">
      ...
      <!-- ========== MAIN CONTENT CANVAS (CENTER COLUMN) — NEW PAGE ========== -->
        ...
        <div class="content-inner">
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">How To Go About Some Development Task</div>
                <div class="hero-sub">A document router prompt — upload your _Stuff index file and get directed to the right docs for any development task.</div>
              </div>
              ...
              <div class="hero-meta">
                ...
                <span class="chip teal">STUFF_ROUTER v1</span>
                <span class="chip amber">Document Router</span>
              </div>
            </div>
          </section>
          ...
          <section class="card section" id="prompt-section">
            <div class="section-head">
              <div class="section-title">
                ...
                <span>Prompt</span>
                <span class="section-sub">One box. Ready to copy.</span>
              </div>
            ...
            <div class="prompt-wrap">
              <textarea class="prompt-box" id="promptBox" readonly spellcheck="false">CHATGPT_COMMAND: STUFF_ROUTER v1
ROLE
You are my document router. This file is an index of my working documents and their relative paths.
AUTO-TRIGGER
If I upload this file and my message is empty (or I say nothing meaningful), immediately ask:
"What do you want to do?"
WORKFLOW (after I tell you the task)
1) Understand the task.
   - Restate it in one crisp line.
2) Scan this index and select the best document(s) for the task.
3) Decide if there is a DIRECT match.
   - A direct match means the doc clearly teaches or contains what is needed to do the task.
4) Reply with a short "Use these docs" list:
   - Doc title
   - Relative path exactly as shown here
   - Why it is relevant (one line)
   - What I should do next with it (open, copy a section, paste a script, etc.)
5) If the task is unclear, ask up to 3 targeted questions that help you choose the right docs.
6) If there is NO direct match to an AI prompts documentation that can give you the prompt to do this, say so plainly and advise me to create a document for it.
   - Start with: "No direct ai prompts doc found for this task."
   - Then propose a new prompt document to create:
     - Suggested prompt doc name
     - Suggested path relative to _Stuff.md
     - What contents it should have: prompt(s) to give ChatGPT to help produce this
   - If there are near matches, you may list them as "Closest prompt docs" and explain the gap in one line each.
OUTPUT FORMAT
- No long lecture.
- Always include paths.
- Paths must be PLAIN TEXT ONLY.
  - Do NOT format paths as markdown links.
  - Do NOT wrap paths in []() or make them clickable.
  - Put every path inside inline code backticks like this: `path/here/file.md`
  - Never add anything after the path on the same line (no extra characters).
- You may recommend multiple docs.
- If you propose a new doc, include a clear section list for it.
- If a doc looks like a template/prompt, tell me exactly what to paste into ChatGPT next.
END_COMMAND</textarea>
            </div>
          </section>

          <section class="card section" id="docs-index">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">📂</span>
                <span>Index of Working Documents</span>
                <span class="section-sub">Each item includes a short purpose summary.</span>
              </div>
            </div>
            ...
            <div class="docs-list">
              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/Apps/CauferoAppStarter/_Misc/Full%20Documentation%20-%20CauferoAppStarter.md">Full Documentation - CauferoAppStarter</a>
                  <span class="doc-pill">DDR blueprint</span>
                </div>
                <div class="doc-desc">A complete technical dump and walkthrough of the CauferoAppStarter FileMaker file, generated from the DDR XML export. A full "blueprint" of the solution: tables, table occurrences, scripts, layouts, custom functions, value lists, privilege sets, and external references.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/Apps/CauferoAppStarter/_Misc/Build%20Apps%20With%20CauferoAppStarter.md">Build Apps With CauferoAppStarter</a>
                  <span class="doc-pill">Build rules</span>
                </div>
                <div class="doc-desc">A build manual and rulebook for creating FileMaker solutions inside the CauferoAppStarter framework. Lays down non-negotiable standards for tables, fields, naming, schema preflight, SQL-driven data retrieval, and WebViewer-based UI patterns.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/Apps/CauferoAppStarter/_Misc/AI%20Agent%20Playbook.md">AI Agent Playbook</a>
                  <span class="doc-pill">Phased build</span>
                </div>
                <div class="doc-desc">A step-by-step operating system for building apps with an AI Agent in phases. Enforces a strict Doc-First rule and maps each task type to the exact documentation the agent must consult.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/Apps/CauferoAppStarter/_Misc/My%20Playbook.md">My Playbook</a>
                  <span class="doc-pill">How to drive</span>
                </div>
                <div class="doc-desc">A builder's playbook for driving the CauferoAppStarter AI Agent. Defines the "one phase at a time" rule, full workflow from Phase 0 through Phase 5, copy-paste prompts, approval phrases, and verification checklists.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/Apps/CauferoAppStarter/_Misc/Startup.md">Startup</a>
                  <span class="doc-pill">Boot rules</span>
                </div>
                <div class="doc-desc">Technical reference for the "Startup" script. Explains how the app boots into a stable session, what must be initialized (UI state, WebViewer shell, role-based navigation), and canonical $$ global variables.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/Apps/CauferoAppStarter/_Misc/PopulateAvailableLinks.md">PopulateAvailableLinks</a>
                  <span class="doc-pill">Nav payload</span>
                </div>
                <div class="doc-desc">Spec for the "Populate Available Links" script. Explains how it generates a "Link Records" text payload for downstream WebViewer/UI code to build navigation menus.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/Apps/CauferoAppStarter/_Misc/Get%20Value%20List.md">Get Value List</a>
                  <span class="doc-pill">Dropdown engine</span>
                </div>
                <div class="doc-desc">The master "Get Value List" generator script. A single reusable engine that powers all dropdowns, searchable dropdowns, checklists, mini-lists, notes history, master-details views, grids, receipt items, and JSON payloads.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/Apps/CauferoAppStarter/_Misc/SelectLink.md">SelectLink</a>
                  <span class="doc-pill">Router</span>
                </div>
                <div class="doc-desc">Documentation for Select Link — the app's central navigation router. Receives a Link ID, looks up the target destination, applies UI housekeeping, then routes by calling the correct +++ Page script.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/Apps/CauferoAppStarter/_Misc/GoToAppSection.md">GoToAppSection</a>
                  <span class="doc-pill">State restore</span>
                </div>
                <div class="doc-desc">Documentation for the navigation router script that uses $$App Section as "single source of truth" to route back to the correct page after leaving the WebViewer context.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/Apps/CauferoAppStarter/_Misc/Implement_Entity_Management_Page.md">Implement_Entity_Management_Page</a>
                  <span class="doc-pill">Build checklist</span>
                </div>
                <div class="doc-desc">Step-by-step implementation checklist for building a full Entity Management module. Covers navigation links, filter page, list page, details page, and related-record modal pages.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/Apps/CauferoAppStarter/_Misc/_Entity%20Filter%20Page.md">_Entity Filter Page</a>
                  <span class="doc-pill">Filter template</span>
                </div>
                <div class="doc-desc">Reusable template for building a filter page script. Explains two ways to drive the filter, date filter rules (dd/mm/yyyy), value lists via "Get Value List", and includes a full sample HTML/JS UI structure.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/Apps/CauferoAppStarter/_Misc/+++Entity%20List%20Page.md">+++Entity List Page</a>
                  <span class="doc-pill">List template</span>
                </div>
                <div class="doc-desc">Build template for an "Entity List" page. Defines required variables (title, columns, number columns, summary, back button) and provides a full sample FileMaker script for HTML list output.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/Apps/CauferoAppStarter/_Misc/Implement%20Report%20Generation.md">Implement Report Generation</a>
                  <span class="doc-pill">Report flow</span>
                </div>
                <div class="doc-desc">Build sequence for implementing a complete report feature: load playbooks, update navigation, implement _Report module, build Report Filter Page, design printable report layout.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/Apps/CauferoAppStarter/_Misc/+++%20Report%20Filter%20Page.md">+++ Report Filter Page</a>
                  <span class="doc-pill">Filter script</span>
                </div>
                <div class="doc-desc">Full FileMaker script template for building a report filter page — sets up the app section, pulls dropdown value lists, assembles HTML and JavaScript for the WebViewer filter UI.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/Apps/CauferoAppStarter/_Misc/_Report.md">_Report</a>
                  <span class="doc-pill">Report template</span>
                </div>
                <div class="doc-desc">Template prompt plus sample FileMaker script for building any +++ Report script. Defines SQL, data types, column headers, widths, number columns, and summary totals.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/Apps/CauferoAppStarter/_Misc/ExecuteSQL.md">ExecuteSQL</a>
                  <span class="doc-pill">SQL contract</span>
                </div>
                <div class="doc-desc">Standard playbook for how scripts must build and use ExecuteSQL() in FileMaker. The official style guide and parsing contract for consistent script generation.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Convert%20Current%20CSS%20To%20Tailwind%20CSS.md">Convert Current CSS To Tailwind CSS</a>
                  <span class="doc-pill">UI refresh</span>
                </div>
                <div class="doc-desc">Reusable prompt for refreshing a FileMaker WebViewer UI to look like modern Tailwind-ish SaaS interfaces. Covers 7 CSS areas while keeping class names and layout mechanics.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/CSS_Theme_Mapper_Prompt.md">Map CSS To Some Theme</a>
                  <span class="doc-pill">Palette map</span>
                </div>
                <div class="doc-desc">Instruction template for mapping CSS 1's colour values onto CSS 2's palette, keeping everything else (sizes, spacing, selectors, structure) exactly the same.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Do%20Changes%20In%20Solution%20Based%20On%20Development%20Documentation.md">Do Changes In Solution Based On Development Documentation</a>
                  <span class="doc-pill">Change workflow</span>
                </div>
                <div class="doc-desc">Setup prompt for a support or change-request session. Upload app docs + CauferoAppStarter playbook, then paste client request for grounded analysis and response.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Generate%20Software%20Features%20Document%20_%20Based%20On%20DDR.md">Generate Software Features Document (Based on DDR)</a>
                  <span class="doc-pill">DDR features</span>
                </div>
                <div class="doc-desc">DDR-only features-document generator. Upload FileMaker DDR XML and generate a full structured Features Document strictly grounded in what the DDR proves.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Generate%20Software%20Features%20Document%20_%20Based%20On%20DDR%20_n_%20Sample%20Features%20Doc.md">Generate Software Features Document (DDR + Sample)</a>
                  <span class="doc-pill">Premium skin</span>
                </div>
                <div class="doc-desc">DDR-driven features document generator with a high-end document skin sample. Produces a fully structured Features Document with DDR evidence and premium print-friendly layout.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Generate%20Software%20Proposal.md">Generate Software Proposal</a>
                  <span class="doc-pill">Proposal</span>
                </div>
                <div class="doc-desc">Proposal-generator prompt. Upload solution docs + CauferoAppStarter docs, paste client request, produce a complete project proposal with scope, modules, timelines, pricing, and next steps.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Generate%20Contract.md">Generate Contract</a>
                  <span class="doc-pill">Contract</span>
                </div>
                <div class="doc-desc">Rules and step-by-step interview flow for generating simple, practical business contracts in plain English. Includes party details, grouped essentials, and copy-paste ready Markdown output.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/XML:FM%20Scripts%20Convertions/Convert%20FM%20Script%20To%20XML.md">Convert FM Script To XML</a>
                  <span class="doc-pill">fmxmlsnippet</span>
                </div>
                <div class="doc-desc">Prompt template for converting plain-text FileMaker script steps into fmxmlsnippet clipboard XML that can be pasted directly into FileMaker Script Workspace.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/XML:FM%20Scripts%20Convertions/Convert%20XML%20To%20FM%20Script.md">Convert XML To FM Script</a>
                  <span class="doc-pill">Decode</span>
                </div>
                <div class="doc-desc">Instruction prompt for turning FileMaker fmxmlsnippet / clipboard XML back into human-readable script steps, output in Markdown code block.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Generate%20Documentations/AI_AgentTraining.md">AI_AgentTraining</a>
                  <span class="doc-pill">Cheat sheet</span>
                </div>
                <div class="doc-desc">Prompt template + formatting rules cheat sheet for working with ChatGPT on FileMaker projects. Reusable prompt starters for script analysis and documentation-based tasks.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Generate%20Documentations/FM%20App%20Documentation.md">FM App Documentation</a>
                  <span class="doc-pill">Docs pack</span>
                </div>
                <div class="doc-desc">"How to document a FileMaker solution" prompt. Export DDR as XML, feed to ChatGPT with strict rules to generate a full developer-grade documentation pack in Markdown.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Make%20A%20Page%20ChatGPT%20Generated%20Become%20Better/Format%20JS%20Of%20Working%20FM%20Script%20Into%20Preferred%20Components.md">Format JS Of Working FM Script Into Preferred Components</a>
                  <span class="doc-pill">WebViewer JS</span>
                </div>
                <div class="doc-desc">FileMaker WebViewer scripting bundle — JavaScript that controls a UI flow inside a WebViewer, wiring button clicks and page behavior to FileMaker script calls via fmPerformScript.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Make%20A%20Page%20ChatGPT%20Generated%20Become%20Better/Make%20A%20Page%20ChatGPT%20Generated%20Become%20Better.md">Make A Page ChatGPT Generated Become Better</a>
                  <span class="doc-pill">Polish UI</span>
                </div>
                <div class="doc-desc">Prompt/spec for improving a FileMaker WebViewer page UI. Take existing CSS + HTML + JS, redesign into something professional, output cleanly separated components in Markdown.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/What%20Is%20It%20Doing/What%20Is%20This%20FM%20App%20Doing.md">What Is This FM App Doing</a>
                  <span class="doc-pill">App intent</span>
                </div>
                <div class="doc-desc">Analysis prompt — upload app docs, paste a FileMaker script, get a quick summary of what the application does based on its workflows, features, and business problem.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/What%20Is%20It%20Doing/What%20Is%20This%20FM%20Script%20Doing.md">What Is This FM Script Doing</a>
                  <span class="doc-pill">Script intent</span>
                </div>
                <div class="doc-desc">Reusable prompt template for interpreting a specific FileMaker script — paste a script and get a clear explanation of its purpose, workflow, and how it fits the bigger app flow.</div>
              </div>

              <div class="doc-item">
                <div class="doc-top">
                  <a class="doc-link" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Update%20ExecuteSQL%20Query.md">Update ExecuteSQL Query</a>
                  <span class="doc-pill">Query edits</span>
                </div>
                <div class="doc-desc">Prompt template for taking an SQL or reporting query and rewriting it to match CauferoAppStarter conventions — correct table/field names, ExecuteSQL style, and quoting rules.</div>
              </div>
            </div>
          </section>
      ...
      <!-- ========== RIGHT PANEL — UPDATED FOR THIS PAGE ========== -->
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          <div class="rail-title">Page Details</div>
          <div class="rail-sub">STUFF_ROUTER + Docs Index</div>
          <div class="rail-actions">
            ...
            <a class="rail-btn" href="#docs-index">Docs Index</a>
          </div>
        </div>
        ...
        <div class="rail-body">
          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">About this page</div>
              <div class="panel-sub">A document router + index of all working docs</div>
            </div>
            <div class="stack">
              <div class="stack-item">Upload the _Stuff index file to ChatGPT with the STUFF_ROUTER prompt</div>
              <div class="stack-item">Tell the AI what you want to do — it routes you to the right doc(s)</div>
              <div class="stack-item">If no doc matches, it suggests a new prompt document to create</div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Key words across the index</div>
            </div>
            <div class="pill-row">
              <span class="pill2">STUFF_ROUTER</span>
              <span class="pill2">CauferoAppStarter</span>
              <span class="pill2">AI Agent</span>
              <span class="pill2">Startup</span>
              <span class="pill2">ExecuteSQL</span>
              <span class="pill2">Report Filter</span>
              <span class="pill2">Entity List</span>
              <span class="pill2">Get Value List</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Core documents</div>
            </div>
            <div class="side-grid">
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/_/_Stuff.md">_Stuff</a>
              <a class="side-pill" href="https://caufero.github.io/projects/Apps/CauferoAppStarter/_Misc/Full%20Documentation%20-%20CauferoAppStarter.md">Full Documentation</a>
              <a class="side-pill" href="https://caufero.github.io/projects/Apps/CauferoAppStarter/_Misc/Build%20Apps%20With%20CauferoAppStarter.md">Build Apps Manual</a>
              <a class="side-pill" href="https://caufero.github.io/projects/Apps/CauferoAppStarter/_Misc/AI%20Agent%20Playbook.md">AI Agent Playbook</a>
              <a class="side-pill" href="https://caufero.github.io/projects/Apps/CauferoAppStarter/_Misc/Get%20Value%20List.md">Get Value List</a>
              <a class="side-pill" href="https://caufero.github.io/projects/Apps/CauferoAppStarter/_Misc/ExecuteSQL.md">ExecuteSQL</a>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              <div class="stack-item">1. Copy the STUFF_ROUTER prompt above</div>
              <div class="stack-item">2. Paste it into ChatGPT along with the _Stuff index file</div>
              <div class="stack-item">3. Describe your development task</div>
              <div class="stack-item">4. The AI will route you to the correct doc(s) with paths and next steps</div>
              <div class="stack-item">5. If no match, it proposes a new prompt document to create</div>
            </div>
          </div>
        </div>
...
function filterNav(q){
  ...
  <style>
    ...
    *{box-sizing:border-box;}
    ...
    /* Document index */
    .docs-list{padding:12px 16px 18px 16px;display:flex;flex-direction:column;gap:10px;}
    .doc-item{
      padding:12px 14px;
      border:1px solid var(--line);
      border-radius:14px;
      background:linear-gradient(to bottom,rgba(255,255,255,.70),rgba(255,255,255,.48));
      box-shadow:0 1px 0 rgba(15,23,42,.04);
      transition:border-color 180ms;
    }
    .page[data-theme="dark"] .doc-item{
      background:linear-gradient(to bottom,rgba(30,41,59,.52),rgba(30,41,59,.36));
      border-color:rgba(241,245,249,.10);
    }
    .doc-item:hover{border-color:rgba(37,99,235,.22);}
    .page[data-theme="dark"] .doc-item:hover{border-color:rgba(65,197,224,.30);}
    .doc-top{display:flex;align-items:center;justify-content:space-between;gap:10px;flex-wrap:wrap;}
    .doc-link{
      color:var(--accent);
      text-decoration:none;
      font-size:13px;
    ...
    .page[data-theme="dark"] .doc-link{color:rgba(65,197,224,.95);}
    ...
    .doc-desc{
      margin-top:8px;
      padding:10px 12px;
      border-left:3px solid rgba(65,197,224,.40);
      background:rgba(65,197,224,.05);
      border-radius:10px;
      color:var(--slate-700);
      font-size:12.5px;
      line-height:1.55;
    ...
    .page[data-theme="dark"] .doc-desc{
      border-left-color:rgba(65,197,224,.30);
