...
<head>
  ...
  <title>FileMaker Project Details Page Prompt</title>
</head>
<body>
            ...
            <div class="nav-group-body">
              ...
              <div class="nav-subgroup open" data-label="AI Prompts Development">
                ...
                <div class="nav-subgroup-body">
                  ...
                  <a class="nav-item sub active" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Build%20Totally%20New%20Page.md" data-label="AI Prompts Development Build Totally New Page"><span class="dot"></span><span class="nav-text">Build Totally New Page</span></a>
        ...
        <div class="content-inner">
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Build Totally New Page In FileMaker Prompt</div>
                <div class="hero-sub">Prompt to generate a highly professional FileMaker WebViewer main content area for a project details layout, complete with project metadata, navigation controls, and a dual-tab requests management section.</div>
              </div>
              ...
              <div class="hero-meta">
                ...
                <span class="chip copper">Project Details</span>
              </div>
            </div>
          </section>
          ...
          <section class="card section" id="prompt-section">
            <div class="section-head">
              <div class="section-title">
                ...
                <span>Prompt</span>
                <span class="section-sub">Send to AI with a screenshot of your banner WebViewer.</span>
              </div>
            ...
            <div class="prompt-wrap">
              <textarea class="prompt-box" id="promptBox" readonly spellcheck="false">- I have a filemaker layout that is going to be used for a page.
- The page has a banner and the main content area
- The layout has 2 webviewers: one short one at the top of the layout to be used to generate the banner and another bigger one just below the top one for the main content area
- I have generated the banner in the top webviewer (uploaded screenshot)
- Now I need to generate the main content in the second webviewer.
- Details of the main content area
  - It is details of a project. The project was selected from a different page
    1) The top section has the details of the project. It takes up about a quarter of the overall height of the main content area:
           - Project Full Code. Eg: PRJ24002-JPM-KOH-ASTUCCIO
           - Project Code. Eg: PRJ24002
           - Project Date. Eg: 4th February, 2026
           - Client Name. Eg: JPM System Italy Ltd
           - Project Type. Eg: New Product
           - Colour Line. Eg: Rabina Oat Anti-Aging
           - Project Description. Eg: New client, the collaboration and production will continue with the current supplier. They will keep us in mind for new projects.
           - Person Responsible. Eg: Cristian
           - Project Status. Eg: Cancelled
         - There should be some features there that will allow the user to do the following:
           - Edit the details above (This will lead to a modal window. But the modal window will be a FileMaker modal window. So just put the feature there without an actual modal. we will later prepare a FileMaker script that can open a FileMake modal window for the editing)
           - Add Project
           - A button to go to a folder from this project view. The folder to go to will be in Google Sheet. So just implement the feature display but dont implement a script yet to do that
           - Navigation buttons to move to the next project and the previous project, and also to the first project and to the last project
           - Feature to delete the project
         - It should be designed well (classy, professional, modern)
    2) Below the top section, is the requests section. It takes up about 3/4 of the overall height of the main content area. It should be divided into 2 sections: Client Requests and Technical Requests
       - Each section has a table of requests: Client Requests has a table of client requests and technical requests has a table of technical requests
       - The 2 sections might be implemented in the form of a tab control or something
       - Each tables details are as follows:
         - Date of request. Eg: 4th February, 2026
         - Request code. Eg: RCH24007
         - Description of request. Eg: The client likes proposal 3: doors with wavy "ciocche bandierina" (flag-style locks of hair) - model PTC60. Please prepare and send me the TRP in Pantone, ready so we can assemble/mount the graphics. If possible, can you send some photos of the same model/product?
         - Responsible person. Eg: Luca
         - Operator. Eg: Toni
         - Priority. Eg: Urgent
         - Status. Eg: Closed
       - There should be some features there that will allow the user to do the following:
           - Add new request (Add Client Request for client requests section and Add Technical Request for technical requests section)
           - On every request row, have feature to:
               - Edit the details request
               - (For every row of the client requests table) Add a technical request (because technical requests can be added for a specific client request)
               - A button to go to a folder from a particular request row. The folder to go to will be in Google Sheet. So just implement the feature display but dont implement a script yet to do that
               - Feature to delete the request


BASED ON THE INFORMATION ABOVE, AND THE SCREENSHOT OF HOW THE BANNER IS LOOKING CURRENTLY, I WANT YOU GENERATE A VERY PROFESSIONALLY DONE HTML/CSS/JS PAGE OF THE MAIN CONTENT AREA. MAKE IT LOOK HIGHLY PROFESSIONAL AND HIGHLY MODERN. MAKE IT VERY BEAUTIFUL

NOTES:
- the full page should fit inside window being viewed. Nothing should spill beyond the current window (so we wont need to scroll the page)
- Strictly adhere to the height dimensions of the top section (project details) and the bottom section (requests).
    - Top Section: 1/4 of overall height
    - Bottom Section: 3/4 of overall height
- For the operations that will be featured on the table rows, use icon only for the buttons so that the buttons wont take too much space
- The height of the table rows will be single line. which means descriptions will include ellipsis if they're too long for their designated allowed space
- Make the UI look modern, clean, sleek and very simple. Implement with Tailwind look. I love those compact, well organized tailwind websites out there. I really love them.

## TAILWIND-ISH BEAUTY GUIDELINES
sharp SaaS UI with crisp edges, 1px hairline borders used as structure, low-to-medium border radius (6px to 10px), minimal blur shadows (very subtle, not "soft UI"), strong grid alignment with consistent spacing scale (8px base), clean typography hierarchy (tight line-height, clear weights), fast subtle transitions (150ms to 220ms), outline icons with consistent stroke, high color richness allowed, vibrant accent palette (teal/cyan/indigo/purple/orange options), use colorful gradients in hero and key CTAs, allow tinted card backgrounds (very light brand tints), buttons with solid brand fills plus hover darken, focus rings in brand color (not blue-only), hover states include slight border color shift toward brand, support both light and dark mode with brand-forward accents, avoid "everything gray" look, keep neutrals only for layout and text legibility, keep backgrounds clean but permit colorful sections and highlights, maintain sharp lines even with color by keeping borders and spacing consistent</textarea>
            </div>
          </section>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">FM Project Details Page</div>
        ...
        <div class="rail-body">
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">FileMaker WebViewer main content area</div>
            </div>
            <div class="stack">
              <div class="stack-item">Send this prompt along with a screenshot of the existing banner WebViewer</div>
              <div class="stack-item">AI generates a complete HTML/CSS/JS page for the main content WebViewer</div>
              <div class="stack-item">Output must fit within the viewport with no scrolling required on the page</div>
              <div class="stack-item">Top quarter shows project details with full CRUD controls and navigation</div>
              <div class="stack-item">Bottom three-quarters holds a tabbed requests panel for client and technical requests</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Layout Structure</div>
              <div class="panel-sub">Height distribution rules</div>
            </div>
            <div class="side-grid">
              <span class="side-pill">Top 1/4 &rarr; Project Details</span>
              <span class="side-pill">Bottom 3/4 &rarr; Requests</span>
              <span class="side-pill">No page scroll</span>
              <span class="side-pill">Viewport-fit only</span>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Project Details Fields</div>
              <div class="panel-sub">Top section data points</div>
            </div>
            <div class="pill-row">
              <span class="pill2">Full Code</span>
              <span class="pill2">Project Code</span>
              <span class="pill2">Date</span>
              <span class="pill2">Client Name</span>
              <span class="pill2">Project Type</span>
              <span class="pill2">Colour Line</span>
              <span class="pill2">Description</span>
              <span class="pill2">Responsible</span>
              <span class="pill2">Status</span>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Project Controls</div>
              <div class="panel-sub">Actions on the top section</div>
            </div>
            <div class="side-grid">
              <span class="side-pill">Edit (FM modal)</span>
              <span class="side-pill">Add Project</span>
              <span class="side-pill">Open Folder (GSheets)</span>
              <span class="side-pill">First / Prev / Next / Last</span>
              <span class="side-pill warn">Delete Project</span>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Requests Table Columns</div>
              <div class="panel-sub">Applies to both Client and Technical tabs</div>
            </div>
            <div class="pill-row">
              <span class="pill2">Date</span>
              <span class="pill2">Request Code</span>
              <span class="pill2">Description</span>
              <span class="pill2">Responsible</span>
              <span class="pill2">Operator</span>
              <span class="pill2">Priority</span>
              <span class="pill2">Status</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Row-Level Actions</div>
              <div class="panel-sub">Icon-only buttons per row</div>
            </div>
            <div class="side-grid">
              <span class="side-pill">Edit request</span>
              <span class="side-pill">Add Tech Request (client rows only)</span>
              <span class="side-pill">Open Folder (GSheets)</span>
              <span class="side-pill warn">Delete request</span>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Design Guidelines</div>
              <div class="panel-sub">Style targets for the AI</div>
            </div>
            <div class="pill-row">
              <span class="pill2">Tailwind-ish SaaS</span>
              <span class="pill2">1px hairline borders</span>
              <span class="pill2">6–10px radius</span>
              <span class="pill2">8px spacing scale</span>
              <span class="pill2">Vibrant accents</span>
              <span class="pill2">Single-line rows + ellipsis</span>
              <span class="pill2">150–220ms transitions</span>
              <span class="pill2">Light + dark mode</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              ...
              <div class="stack-item">2. Take a screenshot of your existing banner WebViewer</div>
              <div class="stack-item">3. Send the prompt plus the screenshot to the AI</div>
              <div class="stack-item">4. Paste the returned HTML into your FileMaker main content WebViewer</div>
              <div class="stack-item">5. Wire up the button callbacks to FileMaker scripts as needed</div>
            </div>
          </div>
        </div>
  ...
  for (var g=0; g<groups.length; g++){
    ...
    if (query && anyHit){
      ...
      function highlightKeywords(){
        ...
        if (!main) return;
        var keywords = ["FileMaker","WebViewer","Project Details","Client Requests","Technical Requests","Navigation","CRUD","Tailwind","Banner","Requests"];
