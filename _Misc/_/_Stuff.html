      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text">Home</span>
          </div>
        </div>
    ...
    <div class="shell" id="shell">
      <aside class="rail rail-left" id="railLeft" aria-label="Side menu">
        ...
        <nav class="rail-body" id="navTree">
          <a class="nav-item active" href="https://caufero.github.io/projects/_Misc/_/_Stuff.md#" data-label="Home">
        ...
        <div class="content-inner">
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Home</div>
                <div class="hero-sub">Everything you touch in Caufero lives here: apps, AI prompts, chats, and modular blocks.</div>
              </div>
              <div class="hero-actions">
                <a class="cta ghost" href="../../Apps/CauferoAppStarter/_NewAdditions.md">
                  ...
                  Open CauferoAppStarter
                </a>
                <a class="cta" href="../../Apps/CauferoAppStarter/_NewAdditions.md">
                  <span class="cta-ico" aria-hidden="true">
                    <svg viewBox="0 0 24 24" class="ico" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              ...
              <div class="hero-meta">
                <span class="chip">Primary template</span>
                <span class="chip teal">Docs-driven builds</span>
                <span class="chip amber">Fast iterations</span>
                <span class="chip copper">Sharp UI</span>
              </div>
            </div>
          </section>

          <section class="card section" id="apps">
            <div class="section-head">
              <div class="section-title">
                <img class="section-icon" src="./Images/apps.png" alt="Apps" />
                <a href="../../Apps">Apps</a>
              </div>
              <div class="section-actions">
                <a class="btn ghost" href="../../Apps/CauferoAppStarter/_NewAdditions.md">Open CauferoAppStarter</a>
                <a class="btn primary" href="../../Apps/CauferoAppStarter/_NewAdditions.md">Develop</a>
              </div>
            </div>

            <div class="grid grid-3">
              <a class="tile app" href="../../Apps/4KPAINT/_NewAdditions.md">
                <div class="tile-top"><div class="badge">App</div><div class="tile-title">4KPAINT</div></div>
                <div class="tile-sub">New additions, tasks, updates</div>
              </a>

              <a class="tile app accent-teal" href="../../Apps/CarePort/_NewAdditions.md">
                <div class="tile-top"><div class="badge teal">App</div><div class="tile-title">CarePort</div></div>
                <div class="tile-sub">Hospital workflow, billing, patient ops</div>
              </a>

              <a class="tile app accent-violet" href="../../Apps/Elimes Outfit/_NewAdditions.md">
                <div class="tile-top"><div class="badge violet">App</div><div class="tile-title">Elimes Outfit</div></div>
                <div class="tile-sub">Production + inventory ops</div>
              </a>

              <a class="tile app accent-sky" href="../../Apps/Giftera/_NewAdditions.md">
                <div class="tile-top"><div class="badge sky">App</div><div class="tile-title">Giftera</div></div>
                <div class="tile-sub">Gifting platform updates</div>
              </a>

              <a class="tile app accent-amber" href="../../Apps/I2D/_NewAdditions.md">
                <div class="tile-top"><div class="badge amber">App</div><div class="tile-title">I2D</div></div>
                <div class="tile-sub">Partner builds + integration work</div>
              </a>

              <a class="tile app accent-copper" href="../../Apps/KoolTool/_NewAdditions.md">
                <div class="tile-top"><div class="badge copper">App</div><div class="tile-title">KoolTool</div></div>
                <div class="tile-sub">Theme + UI system updates</div>
              </a>
            </div>
            ...
            <div class="subsection">
              <div class="subhead">
                <div>
                  <div class="subtitle">Temp Text Files</div>
                  <div class="subnote">Quick scratch pads</div>
                </div>
                <div class="subtools">
                  <span class="micro">Tip: keep Temp10 for dangerous experiments</span>
                </div>
              </div>

              <div class="temp-grid">
                <a class="temp danger" href="vscode://file/Users/cyril/Documents/Caufero%20Apps/Projects/_Misc/_/Temp1.md">Temp 1</a>
                <a class="temp" href="vscode://file/Users/cyril/Documents/Caufero%20Apps/Projects/_Misc/_/Temp2.md">Temp 2</a>
                <a class="temp" href="vscode://file/Users/cyril/Documents/Caufero%20Apps/Projects/_Misc/_/Temp3.md">Temp 3</a>
                <a class="temp" href="vscode://file/Users/cyril/Documents/Caufero%20Apps/Projects/_Misc/_/Temp4.md">Temp 4</a>
                <a class="temp" href="vscode://file/Users/cyril/Documents/Caufero%20Apps/Projects/_Misc/_/Temp5.md">Temp 5</a>
                <a class="temp" href="vscode://file/Users/cyril/Documents/Caufero%20Apps/Projects/_Misc/_/Temp6.md">Temp 6</a>
                <a class="temp" href="vscode://file/Users/cyril/Documents/Caufero%20Apps/Projects/_Misc/_/Temp7.md">Temp 7</a>
                <a class="temp" href="vscode://file/Users/cyril/Documents/Caufero%20Apps/Projects/_Misc/_/Temp8.md">Temp 8</a>
                <a class="temp" href="vscode://file/Users/cyril/Documents/Caufero%20Apps/Projects/_Misc/_/Temp9.md">Temp 9</a>
                <a class="temp danger" href="vscode://file/Users/cyril/Documents/Caufero%20Apps/Projects/_Misc/_/Temp10.md">Temp 10</a>
              </div>
            </div>
          </section>

          <section class="card section" id="ai-prompts">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">🤖</span>
                <span>AI Prompts</span>
                <span class="section-sub">(Automated Actions)</span>
              </div>
            </div>

            <div class="grid grid-3">
              <div class="pad">
                <div class="pad-top"><div class="badge">CSS</div><div class="pad-title">Styling &amp; Themes</div></div>
                <ul class="ul">
                  <li><a href="AI Prompts/Convert Current CSS To Tailwind CSS.md">Convert Current CSS to Tailwind CSS</a></li>
                  <li><a href="AI Prompts/CSS_Theme_Mapper_Prompt.md">Map CSS To Some Theme</a></li>
                </ul>
              </div>

              <div class="pad">
                <div class="pad-top"><div class="badge violet">Development</div><div class="pad-title">Build &amp; Change</div></div>
                <ul class="ul">
                  <li><a href="AI Prompts/Build Totally New Page.md">Build Totally New Page</a></li>
                  <li><a href="AI Prompts/Do Changes In Solution Based On Development Documentation.md">Do Changes In Solution Based On Development Documentation</a></li>
                  <li><a href="AI Prompts/How To Go About Some Development Task.md">How To Go About Some Development Task</a></li>
                  <li>
                    <a href="AI Prompts/Generate Documentations">Make Page Generation Better</a>
                    <ul class="ul ul-sub">
                      <li><a href="AI Prompts/Make A Page ChatGPT Generated Become Better/Format JS Of Working FM Script Into Preferred Components.md">Format JS Of Working FM Script Into Preferred Components</a></li>
                      <li><a href="AI Prompts/Make A Page ChatGPT Generated Become Better/Make A Page ChatGPT Generated Become Better.md">Make A Page ChatGPT Generated Become Better</a></li>
                    </ul>
                  </li>
                  <li><a href="AI Prompts/Mimic Caufero Workspace Page.md">Mimic Caufero Workspace Page</a></li>
                  <li><a href="AI Prompts/Update ExecuteSQL Query.md">Update ExecuteSQL Query</a></li>
                </ul>
              </div>

              <div class="pad">
                <div class="pad-top"><div class="badge amber">Documents</div><div class="pad-title">Contracts &amp; Proposals</div></div>
                <ul class="ul">
                  <li><a href="AI Prompts/Generate Contract.md">Software Contract</a></li>
                  <li><a href="AI Prompts/Generate Software Features Document.md">Software Features Document</a></li>
                  <li class="muted">⏳ <a href="#">Invoice</a></li>
                  <li><a href="AI Prompts/Generate Software Proposal.md">Software Proposal</a></li>
                </ul>
              </div>

              <div class="pad">
                <div class="pad-top"><div class="badge slate">FM Script &lt;-&gt; XML</div><div class="pad-title"><a href="AI Prompts/XML:FM Scripts Convertions">Converters</a></div></div>
                <ul class="ul">
                  <li><a href="AI Prompts/XML:FM Scripts Convertions/Convert FM Script To XML.md">FM Script To XML</a></li>
                  <li><a href="AI Prompts/XML:FM Scripts Convertions/Convert XML To FM Script.md">XML To FM Script</a></li>
                </ul>
              </div>

              <div class="pad">
                <div class="pad-top"><div class="badge teal">Docs</div><div class="pad-title"><a href="AI Prompts/Generate Documentations">Generate Documentations</a></div></div>
                <ul class="ul">
                  <li><a href="AI Prompts/Generate Documentations/AI_AgentTraining.md">Documentation To Train Agent To Do Something</a></li>
                  <li><a href="AI Prompts/Generate Documentations/FM App Documentation.md">Documentation For A FileMaker Application</a></li>
                </ul>
              </div>

              <div class="pad">
                <div class="pad-top"><div class="badge rose">Explain</div><div class="pad-title"><a href="AI Prompts/What Is It Doing">What Is It Doing?</a></div></div>
                <ul class="ul">
                  <li><a href="AI Prompts/What Is It Doing/What Is This FM App Doing.md">What Is This FileMaker Application Doing?</a></li>
                  <li><a href="AI Prompts/What Is It Doing/What Is This FM Script Doing.md">What Is This FileMaker Script Doing?</a></li>
                </ul>
              </div>
            </div>
          </section>

          <section class="card section" id="modular-solutions">
            <div class="section-head">
              <div class="section-title">
                <img class="section-icon" src="./Images/modular_solutions.png" alt="Modular Solutions" />
                <a href="../../ModularSolutions">Modular Solutions</a>
              </div>
            </div>

            <div class="grid grid-3">
              <div class="pad">
                <div class="pad-top"><div class="badge">Blue Collar</div><div class="pad-title">Core blocks</div></div>
                <ul class="ul">
                  <li><a href="../../ModularSolutions/barcode_test.md">barcode_test</a></li>
                  <li>Coffee Break</li>
                  <li><a href="../../ModularSolutions/Item Collection.md">Item Collection</a></li>
                  <li><a href="../../ModularSolutions/Time_Picker.md">Time_Picker</a></li>
                </ul>
              </div>

              <div class="pad">
                <div class="pad-top"><div class="badge amber">PerformanceBTS</div><div class="pad-title">Ops modules</div></div>
                <ul class="ul">
                  <li><a href="../../ModularSolutions/ActionTrack_R1.md">ActionTrack_R1</a></li>
                  <li><a href="../../ModularSolutions/BCS_d1.md">BCS_d1</a></li>
                  <li><a href="../../ModularSolutions/BCS_StyleSheetTheme.md">BCS_StyleSheetTheme</a></li>
                  <li><a href="../../ModularSolutions/FM Virtual Menu List.md">FM Virtual Menu List</a></li>
                  <li><a href="../../ModularSolutions/InfoTools Helper.md">InfoTools Helper</a></li>
                  <li><a href="../../ModularSolutions/Task_List.md">Task_List</a></li>
                </ul>
              </div>

              <div class="pad">
                <div class="pad-top"><div class="badge violet">Geist</div><div class="pad-title">Advanced tools</div></div>
                <ul class="ul">
                  <li><a href="../../ModularSolutions/FMSVGInator.md">FMSVGInator</a></li>
                  <li><a href="../../ModularSolutions/LedgerLink.md">LedgerLink</a></li>
                  <li><a href="../../ModularSolutions/ModLog.md">ModLog</a></li>
                  <li><a href="../../ModularSolutions/OttoDeploy.md">OttoDeploy</a></li>
                  <li><a href="../../ModularSolutions/OttoFMS.md">OttoFMS</a></li>
                  <li><a href="../../ModularSolutions/ProofChat.md">ProofChat</a></li>
                  <li><a href="../../ModularSolutions/Raycast.md">Raycast</a></li>
                  <li><a href="../../ModularSolutions/SimpleQ.md">SimpleQ</a></li>
                </ul>
              </div>

              <div class="pad">
                <div class="pad-top"><div class="badge slate">Monkeybread</div><div class="pad-title">Small utilities</div></div>
                <ul class="ul">
                  <li><a href="../../ModularSolutions/CodeSnips.md">CodeSnips</a></li>
                </ul>
              </div>

              <div class="pad">
                <div class="pad-top"><div class="badge teal">Others</div><div class="pad-title">Reference stuff</div></div>
                <ul class="ul">
                  <li><a href="../../ModularSolutions/JSONQuery 2.1.md">JSONQuery 2.1</a></li>
                  <li><a href="../../ModularSolutions/OData Examples.md">OData Examples</a></li>
                  <li><a href="../../ModularSolutions/TaskControl.md">TaskControl</a></li>
                </ul>
              </div>
            </div>
          </section>

          <section class="card section" id="tailwind-designed-websites">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">🌬️</span>
                <span>Tailwind-Designed Websites</span>
              </div>
            </div>

            <div class="grid grid-4">
              <a class="mini" href="../Sites/AgentMail.md"><div class="mini-title">AgentMail</div></a>
              <a class="mini" href="../Sites/AI Agents Hub.md"><div class="mini-title">AI Agents Hub</div></a>
              <a class="mini" href="../Sites/AI Agents List.md"><div class="mini-title">AI Agents List</div></a>
              <a class="mini" href="../Sites/AllGPTs.md"><div class="mini-title">AllGPTs</div></a>
              <a class="mini" href="../Sites/AutoGPT.md"><div class="mini-title">AutoGPT</div></a>
              <a class="mini" href="../Sites/Best AI Agents.md"><div class="mini-title">Best AI Agents</div></a>
              <a class="mini" href="../Sites/Bolt.new.md"><div class="mini-title">Bolt.new</div></a>
              <a class="mini" href="../Sites/Browser Use.md"><div class="mini-title">Browser Use</div></a>
              <a class="mini" href="../Sites/Butter.md"><div class="mini-title">Butter</div></a>
              <a class="mini" href="../Sites/Cofondr.md"><div class="mini-title">Cofondr</div></a>
              <a class="mini" href="../Sites/Composio.md"><div class="mini-title">Composio</div></a>
              <a class="mini" href="../Sites/Continuum.md"><div class="mini-title">Continuum</div></a>
              <a class="mini" href="../Sites/CountVisits.md"><div class="mini-title">CountVisits</div></a>
              <a class="mini" href="../Sites/Cranston AI.md"><div class="mini-title">Cranston AI</div></a>
              <a class="mini" href="../Sites/CrewAI.md"><div class="mini-title">CrewAI</div></a>
              <a class="mini" href="../Sites/Cursor.md"><div class="mini-title">Cursor</div></a>
              <a class="mini" href="../Sites/Decipher AI.md"><div class="mini-title">Decipher AI</div></a>
              <a class="mini" href="../Sites/Dev Hunt.md"><div class="mini-title">Dev Hunt</div></a>
              <a class="mini" href="../Sites/Dify.md"><div class="mini-title">Dify</div></a>
              <a class="mini" href="../Sites/Factory.md"><div class="mini-title">Factory</div></a>
              <a class="mini" href="../Sites/Fast Search Engine Indexing.md"><div class="mini-title">Fast Search Engine Indexing</div></a>
              <a class="mini" href="../Sites/Filmgrail.md"><div class="mini-title">Filmgrail</div></a>
              <a class="mini" href="../Sites/Flowise.md"><div class="mini-title">Flowise</div></a>
              <a class="mini" href="../Sites/Graphed.md"><div class="mini-title">Graphed</div></a>
              <a class="mini" href="../Sites/Gravity.md"><div class="mini-title">Gravity</div></a>
              <a class="mini" href="../Sites/InboxBott.md"><div class="mini-title">InboxBott</div></a>
              <a class="mini" href="../Sites/Jack&Jill.md"><div class="mini-title">Jack&amp;Jill</div></a>
              <a class="mini" href="../Sites/John Rush.md"><div class="mini-title">John Rush</div></a>
              <a class="mini" href="../Sites/Kortix.md"><div class="mini-title">Kortix</div></a>
              <a class="mini" href="../Sites/ListingBott.md"><div class="mini-title">ListingBott</div></a>
              <a class="mini" href="../Sites/LlamaIndex.md"><div class="mini-title">LlamaIndex</div></a>
              <a class="mini" href="../Sites/Lorem.space.md"><div class="mini-title">Lorem.space</div></a>
              <a class="mini" href="../Sites/Lovable.md"><div class="mini-title">Lovable</div></a>
              <a class="mini" href="../Sites/Make.md"><div class="mini-title">Make</div></a>
              <a class="mini" href="../Sites/Marketsy.ai.md"><div class="mini-title">Marketsy.ai</div></a>
              <a class="mini" href="../Sites/MarsX.md"><div class="mini-title">MarsX</div></a>
              <a class="mini" href="../Sites/Mem0.md"><div class="mini-title">Mem0</div></a>
              <a class="mini" href="../Sites/MyMeet.md"><div class="mini-title">MyMeet</div></a>
              <a class="mini" href="../Sites/Naologic.md"><div class="mini-title">Naologic</div></a>
              <a class="mini" href="../Sites/NextJs Starters & Boilerplates.md"><div class="mini-title">NextJs Starters &amp; Boilerplates</div></a>
              <a class="mini" href="../Sites/Open Source Software.md"><div class="mini-title">Open Source Software</div></a>
              <a class="mini" href="../Sites/Pally.md"><div class="mini-title">Pally</div></a>
              <a class="mini" href="../Sites/Qurrent.md"><div class="mini-title">Qurrent</div></a>
              <a class="mini" href="../Sites/Saas Emailer.md"><div class="mini-title">Saas Emailer</div></a>
              <a class="mini" href="../Sites/Secondly.md"><div class="mini-title">Secondly</div></a>
              <a class="mini" href="../Sites/SEObot.md"><div class="mini-title">SEObot</div></a>
              <a class="mini" href="../Sites/StartClaw.md"><div class="mini-title">StartClaw</div></a>
              <a class="mini" href="../Sites/Startups Tools.md"><div class="mini-title">Startups Tools</div></a>
              <a class="mini" href="../Sites/Subconscious.md"><div class="mini-title">Subconscious</div></a>
              <a class="mini" href="../Sites/Tailwind CSS.md"><div class="mini-title">Tailwind CSS</div></a>
              <a class="mini" href="../Sites/TaskMaster.md"><div class="mini-title">TaskMaster</div></a>
              <a class="mini" href="../Sites/Tavily.md"><div class="mini-title">Tavily</div></a>
              <a class="mini" href="../Sites/TinyAdz.md"><div class="mini-title">TinyAdz</div></a>
              <a class="mini" href="../Sites/UI Generator.md"><div class="mini-title">UI Generator</div></a>
              <a class="mini" href="../Sites/Unicorn Platform.md"><div class="mini-title">Unicorn Platform</div></a>
              <a class="mini" href="../Sites/Zuludesk.md"><div class="mini-title">Zuludesk</div></a>
            </div>
          </section>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">Same feel as the left menu</div>
          <div class="rail-actions">
            <a class="rail-btn" href="#apps">Apps</a>
            <a class="rail-btn" href="#ai-prompts">AI Prompts</a>
            <a class="rail-btn" href="#modular-solutions">Modular</a>
            <a class="rail-btn" href="#tailwind-designed-websites">Sites</a>
          </div>
        </div>
        ...
        <div class="rail-body">
          <div class="panel-card">
            ...
            <div class="pill-row">
              <span class="pill2">CauferoAppStarter</span>
              <span class="pill2">Apps</span>
              <span class="pill2">AI Prompts</span>
              <span class="pill2">Themes</span>
              <span class="pill2">Contracts</span>
              <span class="pill2">Modular</span>
              <span class="pill2">Chats</span>
              <span class="pill2">YouTube</span>
              <span class="pill2">Tailwind</span>
            </div>
          </div>

          <div class="panel-card" id="chats">
            <div class="panel-head">
              <div class="panel-title">
                <img class="section-icon" src="./Images/chat.png" alt="Chats" />
                <a href="../../Chats">Chats</a>
              </div>
              <div class="panel-sub">(Update quickly when you notice more messages have been added in chat apps)</div>
            </div>

            <div class="side-grid">
              <a class="side-pill warn" href="../../Chats/_To Dos From Chats.md">_To Dos From Chats</a>
              <a class="side-pill" href="../../Chats/4K.md">4K</a>
              <a class="side-pill warn" href="../../Chats/AI.md">AI</a>
              <a class="side-pill warn" href="../../Chats/APIs &amp; Webhooks.md">APIs &amp; Webhooks</a>
              <a class="side-pill" href="../../Chats/Caufero .md">Caufero</a>
              <a class="side-pill" href="../../Chats/Deployment.md">Deployment</a>
              <a class="side-pill" href="../../Chats/Design UI_UX.md">Design UI_UX</a>
              <a class="side-pill warn" href="../../Chats/DEV.md">DEV</a>
              <a class="side-pill warn" href="../../Chats/Discussion.md">Discussion</a>
              <a class="side-pill warn" href="../../Chats/FileMaker Server.md">FileMaker Server</a>
              <a class="side-pill warn" href="../../Chats/Files Shared.md">Files Shared</a>
              <a class="side-pill warn" href="../../Chats/General.md">General</a>
              <a class="side-pill warn" href="../../Chats/Goodies 4U.md">Goodies 4U</a>
              <a class="side-pill" href="../../Chats/Javascript in FileMaker.md">Javascript in FileMaker</a>
              <a class="side-pill warn" href="../../Chats/JSON.md">JSON</a>
              <a class="side-pill warn" href="../../Chats/JS In DM.md">JS In DM</a>
              <a class="side-pill warn" href="../../Chats/Mobile.md">Mobile</a>
              <a class="side-pill warn" href="../../Chats/Model Context Protocol (MCP).md">Model Context Protocol (MCP)</a>
              <a class="side-pill warn" href="../../Chats/ModularFM.md">ModularFM</a>
              <a class="side-pill warn" href="../../Chats/OData.md">OData</a>
              <a class="side-pill" href="../../Chats/OTTO.md">OTTO</a>
              <a class="side-pill warn" href="../../Chats/Performance.md">Performance</a>
              <a class="side-pill" href="../../Chats/Raycast.md">Raycast</a>
              <a class="side-pill warn" href="../../Chats/ScriptsCalcs.md">ScriptsCalcs</a>
              <a class="side-pill warn" href="../../Chats/Security Items.md">Security Items</a>
              <a class="side-pill" href="../../Chats/Server.md">Server</a>
              <a class="side-pill" href="../../Chats/SQL.md">SQL</a>
              <a class="side-pill" href="../../Chats/Team Meetings.md">Team Meetings</a>
              <a class="side-pill warn" href="../../Chats/TipsTricksTraps.md">TipsTricksTraps</a>
              <a class="side-pill warn" href="../../Chats/Tools.md">Tools</a>
            </div>
          </div>

          <div class="panel-card" id="actions">
            <div class="panel-head">
              <div class="panel-title">⚙️ Actions To Automate</div>
              <div class="panel-sub">Things that should become buttons, forms, and scripts</div>
            </div>
            <div class="stack">
              <div class="stack-item">Contacting businesses to introduce our services to them</div>
              <div class="stack-item">Meeting clients for the first time</div>
              <div class="stack-item">Presentations to clients<div class="stack-sub">To prospective clients • To existing clients</div></div>
              <div class="stack-item">Generating software proposals for clients based on meetings that were had</div>
              <div class="stack-item">Pricing a solution</div>
              <div class="stack-item">Determining FileMaker license cost to clients</div>
              <div class="stack-item">Suggesting payment plans for a client</div>
              <div class="stack-item">Following up with a prospective client</div>
              <div class="stack-item">Generating a development project plan</div>
              <div class="stack-item">FileMaker Server<div class="stack-sub">Installing • Updating • Installing SSL Certficate</div></div>
              <div class="stack-item">Editing an existing FileMaker Layout</div>
              <div class="stack-item">Generating invoices and sending it to clients</div>
              <div class="stack-item">Sending clients details of payment when they want to pay Caufero</div>
              <div class="stack-item">Training clients on how to use an application we developed for them</div>
              <div class="stack-item">Training people on how to develop applications with and use FileMaker</div>
            </div>
          </div>

          <div class="panel-card" id="youtube">
            <div class="panel-head">
              <div class="panel-title">📺 YouTube</div>
              <div class="panel-sub">Quick lists</div>
            </div>

            <div class="yt">
              <div class="yt-block" id="yt-ghana">
                <div class="yt-title">Ghana</div>
                <div class="tags">
                  <span class="tag">22ACE</span><span class="tag">Chivicininspirations</span><span class="tag">Dela's World</span><span class="tag">Delicious Amy</span><span class="tag">Headless YouTuber</span><span class="tag">Ghana</span><span class="tag">Gossip24</span><span class="tag">KSS</span><span class="tag">Lily Ogini</span><span class="tag">NATURAL AFRICAN GIRL</span><span class="tag">Prince A Akortey</span><span class="tag">Prophet Telvin Sowah Adjei</span><span class="tag">Simply Lilian</span><span class="tag">Vanessa Kanbi</span><span class="tag">Yaw Obeng</span>
                </div>
              </div>

              <div class="yt-block" id="yt-sports">
                <div class="yt-title">Sports</div>
                <div class="tags">
                  <span class="tag">Boxing</span><span class="tag">DAZN Boxing</span><span class="tag">Dirty Boxing</span><span class="tag">MMA</span><span class="tag">Soccer</span><span class="tag">UFC</span><span class="tag">WWE</span>
                </div>
              </div>

              <div class="yt-block" id="yt-babies">
                <div class="yt-title">Babies &amp; Animals</div>
                <div class="tags">
                  <span class="tag">Babies</span><span class="tag">Doggo LOL World</span><span class="tag">Dogs</span><span class="tag">Puppies</span><span class="tag">The Dodo</span>
                </div>
              </div>

              <div class="yt-block" id="yt-tea">
                <div class="yt-title">Streamer Tea</div>
                <div class="tags">
                  <span class="tag">Agent00</span><span class="tag">Asmongold</span><span class="tag">DDG</span><span class="tag">Deshae Frost</span><span class="tag">ExtraEmily</span><span class="tag">Intentional Favour</span><span class="tag">IShowSpeed</span><span class="tag">Jay Cinco</span><span class="tag">Kai Cenat</span><span class="tag">Lala Baptiste</span><span class="tag">Lala Baptiste Jay Cinco</span><span class="tag">The Tea Room</span><span class="tag">Thevoice4dappl REACTS</span><span class="tag">Wode Maya</span>
                </div>
              </div>

              <div class="yt-block" id="yt-politics">
                <div class="yt-title">Politics</div>
                <div class="tags">
...
function filterNav(q){
  ...
  <style>
    ...
    *{box-sizing:border-box;}
    ...
    .subtitle{font-size:13px;font-weight:900;}
    .subnote{font-size:12px;color:var(--slate-600);margin-top:2px;}
    .page[data-theme="dark"] .subnote{color:rgba(241,245,249,.66);}
    .micro{font-size:11px;color:var(--slate-500);font-weight:650;}
    .page[data-theme="dark"] .micro{color:rgba(241,245,249,.58);}
    ...
    .temp.danger{
      border-color:rgba(213,67,46,.25);
      background:rgba(213,67,46,.10);
      color:var(--danger);
    }
    ...
    .ul li{margin:6px 0;}
    .ul a{color:inherit;}
    .ul-sub{margin-top:6px;opacity:.92;}
    ...
    .yt-title{font-weight:950;margin-bottom:8px;}
    ...
    .page[data-theme="dark"] .tag{background:rgba(255,255,255,.06);}
