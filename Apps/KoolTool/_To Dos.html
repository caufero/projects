  ...
  <div class="page" data-theme="auto">
      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text">KoolTool — To Dos</span>
          </div>
        </div>
    ...
    <div class="shell" id="shell">
        ...
        <div class="content-inner">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                  <span style="display:inline-flex;align-items:center;gap:10px;">
                    ...
                    <div class="hero-title">KoolTool — To Dos</div>
                  </span>   
                <div class="hero-sub">Working plan, task list, and workflow execution for the KoolTool project. Keep it tight, updated, and honest.</div>
              </div>
              ...
              <div class="hero-meta">
                ...
                <span class="chip teal">8 Done</span>
                <span class="chip amber">0 In Progress</span>
                <span class="chip copper">1 Pending</span>
              </div>
            </div>
          </section>
          ...
          <section class="card section" id="tasks">
            <div class="section-head">
              <div class="section-title">
                ...
                <span>To Dos Table</span>
                <span class="section-sub">9 tasks</span>
              </div>
            </div>
            ...
            <div class="task-list">
              ...
              <div class="task-item task-done">
                ...
                <div class="task-body">
                  <div class="task-label">Standardize the current application structure (naming, UI patterns, tables, scripts)</div>
                  <div class="task-note">Goal: make the file predictable before adding features</div>
                </div>
              ...
              <div class="task-item task-done">
                ...
                <div class="task-body">
                  <div class="task-label">Audit what the current application is doing (screens, scripts, relationships, data flows)</div>
                  <div class="task-note">Output: a clear walkthrough + a map of modules</div>
                </div>
                <div class="task-status ts-done">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:12px;height:12px;margin-right:5px;display:inline-block;vertical-align:middle;"><path d="M20 6L9 17l-5-5"></path></svg>
                  Done
              ...
              <div class="task-item task-done">
                ...
                <div class="task-body">
                  <div class="task-label">Tasks module: Add + Edit + Delete</div>
                  <div class="task-note">CRUD for tasks, validation, basic list + detail view</div>
                </div>
                <div class="task-status ts-done">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:12px;height:12px;margin-right:5px;display:inline-block;vertical-align:middle;"><path d="M20 6L9 17l-5-5"></path></svg>
                  Done
              ...
              <!-- TASK 4 -->
              <div class="task-item task-done">
                <div class="task-num done-num">4</div>
                <div class="task-body">
                  <div class="task-label">Users module: Add + Edit + Delete</div>
                  <div class="task-note">Users table, roles/permissions placeholder, basic profile</div>
                </div>
                <div class="task-status ts-done">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:12px;height:12px;margin-right:5px;display:inline-block;vertical-align:middle;"><path d="M20 6L9 17l-5-5"></path></svg>
                  Done
              ...
              <div class="task-item task-done">
                ...
                <div class="task-body">
                  <div class="task-label">Processes / Activities module</div>
                  <div class="task-note">Define what a process is, how activities link to projects/tasks</div>
                </div>
                <div class="task-status ts-done">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:12px;height:12px;margin-right:5px;display:inline-block;vertical-align:middle;"><path d="M20 6L9 17l-5-5"></path></svg>
                  Done
              ...
              <div class="task-item task-done">
                ...
                <div class="task-body">
                  <div class="task-label">Clients module: Add + Edit + Delete</div>
                  <div class="task-note">Client master data + link to projects/requests</div>
                </div>
                <div class="task-status ts-done">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:12px;height:12px;margin-right:5px;display:inline-block;vertical-align:middle;"><path d="M20 6L9 17l-5-5"></path></svg>
                  Done
              ...
              <!-- TASK 7 -->
              <div class="task-item task-done">
                <div class="task-num done-num">7</div>
                <div class="task-body">
                  <div class="task-label">Projects module: Add + Edit + Delete</div>
                  <div class="task-note">Project basics + links to client, processes, tasks</div>
                </div>
                <div class="task-status ts-done">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:12px;height:12px;margin-right:5px;display:inline-block;vertical-align:middle;"><path d="M20 6L9 17l-5-5"></path></svg>
                  Done
              ...
              <!-- TASK 8 -->
              <div class="task-item task-done">
                <div class="task-num done-num">8</div>
                <div class="task-body">
                  <div class="task-label">Requests module inside Projects: Add + Edit + Delete + Approvals</div>
                  <div class="task-note">Two tracks: Client + Technical requests; approvals workflow</div>
                </div>
                <div class="task-status ts-done">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:12px;height:12px;margin-right:5px;display:inline-block;vertical-align:middle;"><path d="M20 6L9 17l-5-5"></path></svg>
                  Done
              ...
              <div class="task-item task-pending">
                <div class="task-num pending-num">9</div>
                <div class="task-body">
                  <div class="task-label">Create a new file to capture the new structure (tables + menu + core lists)</div>
                  <div class="task-note">
                    <strong>Tables</strong>
                    <div class="mini-list">
                      Users • Tasks • Clients • Projects ✓ • Requests ✓
                      <div style="margin-top:6px;opacity:.9;">Requests breakdown: Clients ✓ • Technical (+Approvals) ✓</div>
                    </div>
                    <strong>Menu</strong>
                    <div class="mini-list">
                      Dashboard • Users • Clients • Tasks • Projects • SuperTable
                    </div>
                    <strong>Core fields</strong>
                    <div class="mini-list">
                      <em>Projects</em>: ID, Responsible User ID, Date Created, Time Created, Created By, Code, Client, Client Code, Type, Status, Priority, Colour Line, Description
                      <br><em>Requests</em>: ID, Responsible User ID, Date Created, Time Created, Created By, Code, Client, Client Code, Type, Status, Priority, Colour Line, Description
                      <br><em>Clients</em>: ID, Responsible User ID, Date Created, Time Created, Created By, Code, Name, VAT, Type
                    </div>
                  </div>
                </div>
                <div class="task-status ts-pending">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:12px;height:12px;margin-right:5px;display:inline-block;vertical-align:middle;"><circle cx="12" cy="12" r="10"></circle><path d="M12 8v4"></path><path d="M12 16h.01"></path></svg>
                  Pending
                </div>
              </div>
          ...
          <section class="card section" id="workflow">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">🧭</span>
                <span>Workflow of Actions</span>
                <span class="section-sub">5 sections</span>
              </div>
            </div>
            ...
            <div class="workflow-grid">
              <div class="wf-card">
                <div class="wf-head">
                  ...
                  <div class="wf-meta">
                    <div class="wf-title">Tables</div>
                    <div class="wf-desc">Users, Tasks, Clients, Projects, Requests (with Client Requests, Technical, and Approvals lists).</div>
                  </div>
                </div>
              </div>
              ...
              <div class="wf-card">
                <div class="wf-head">
                  ...
                  <div class="wf-meta">
                    <div class="wf-title">Banner + Menu</div>
                    <div class="wf-desc">Dashboard, Users, Clients, Tasks, Projects, SuperTable.</div>
                  </div>
                </div>
              </div>
              ...
              <div class="wf-card">
                <div class="wf-head">
                  ...
                  <div class="wf-meta">
                    <div class="wf-title">Clients</div>
                    <div class="wf-desc">Build Clients list + details (Code, Name, VAT, Type) plus Created/Responsible metadata.</div>
                  </div>
                </div>
              </div>
              ...
              <div class="wf-card">
                <div class="wf-head">
                  ...
                  <div class="wf-meta">
                    <div class="wf-title">Projects</div>
                    <div class="wf-desc">Selection of Projects, Project Hero headers, Edit headers, Add New Project.</div>
                  </div>
                </div>
              </div>
              ...
              <div class="wf-card">
                <div class="wf-head">
                  ...
                  <div class="wf-meta">
                    <div class="wf-title">Requests</div>
                    <div class="wf-desc">Client Requests list, Technical Requests list, Approvals list.</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section class="card section" id="overview">
            <div class="section-head">
              <div class="section-title">
                ...
                <span class="section-sub">1 item</span>
              </div>
            </div>

            <div class="task-list" style="margin-top:6px;">
              <div class="task-item task-pending">
                <div class="task-num pending-num">1</div>
                <div class="task-body">
                  <div class="task-label">Create the new file skeleton (tables + menu + Clients/Projects/Requests)</div>
                  <div class="task-note">All earlier items are completed. This is the new focus.</div>
                </div>
                <div class="task-status ts-pending">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:12px;height:12px;margin-right:5px;display:inline-block;vertical-align:middle;"><circle cx="12" cy="12" r="10"></circle><path d="M12 8v4"></path><path d="M12 16h.01"></path></svg>
                  Pending
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          <div class="rail-title">KoolTool — To Dos</div>
        ...
        <div class="rail-body">
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">9 tasks total (8 done, 1 pending)</div>
            </div>

            <div class="rp-stats">
              <div class="rp-stat">
                <div class="rp-stat-bar done-bar" style="width:89%;"></div>
                <div class="rp-stat-info">
                  <span class="rp-stat-label">Done</span>
                  <span class="rp-stat-val rp-done-val">8</span>
                </div>
              </div>
              ...
              <div class="rp-stat">
                <div class="rp-stat-bar pending-bar" style="width:11%;"></div>
                <div class="rp-stat-info">
                  <span class="rp-stat-label">Pending</span>
                  <span class="rp-stat-val rp-pending-val">1</span>
                </div>
              </div>
            </div>

            <div class="rp-track">
              <div class="rp-fill rp-fill-done" style="width:89%;"></div>
              <div class="rp-fill rp-fill-progress" style="width:0%;"></div>
            </div>
            <div class="rp-pct">89% complete</div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="active-task-card" style="opacity:.85;">
              <div class="active-task-num" style="background:rgba(148,163,184,.18);color:var(--slate-700);">–</div>
              <div class="active-task-body">
                <div class="active-task-label">No active task</div>
                <div class="active-task-note">When you start one, call it out here so the page tells you the truth.</div>
              </div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">1 target</div>
            </div>

            <div class="stack">
              <div class="stack-item">
                Build the new FileMaker file skeleton
                <div class="stack-sub">Create base tables + menu + core lists (Clients, Projects, Requests)</div>
              </div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">8 tasks wrapped up</div>
            </div>

            <div class="stack">
              <div class="stack-item">
                Standardize the current application structure (naming, UI patterns, tables, scripts)
              </div>
              <div class="stack-item">
                Audit what the current application is doing (screens, scripts, relationships, data flows)
              </div>
              <div class="stack-item">
                Tasks module: Add + Edit + Delete
              </div>
              <div class="stack-item">
                Users module: Add + Edit + Delete
              </div>
              <div class="stack-item">
                Processes / Activities module
              </div>
              <div class="stack-item">
                Clients module: Add + Edit + Delete
              </div>
              <div class="stack-item">
                Projects module: Add + Edit + Delete
              </div>
              <div class="stack-item">
                Requests module inside Projects: Add + Edit + Delete + Approvals
              </div>
            </div>
          </div>
    ...
    if (query && anyHit){
      ...
      function setActiveNav(label){
        ...
        if (!target){
          ...
          for (var j=0;j<all.length;j++){
            if (((all[j].textContent||"").trim().toLowerCase()) === "kooltool"){ target = all[j]; break; }
          }
        }
        if (target){
