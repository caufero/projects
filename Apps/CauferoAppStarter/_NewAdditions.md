...
<head>
  ...
  <title>Doing Development In CauferoAppStarter</title>
</head>
<body>
      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text">Dev · CauferoAppStarter</span>
          </div>
        </div>
      ...
      <aside class="rail rail-left" id="railLeft" aria-label="Side menu">
        ...
        <nav class="rail-body" id="navTree">
          ...
          <div class="nav-group" data-label="Apps">
            <button class="nav-group-head" type="button" data-toggle="group">
              ...
              <span class="chev" aria-hidden="true">
                <svg viewBox="0 0 24 24" class="ico sm" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18l6-6-6-6"></path></svg>
              </span>
            </button>
            <div class="nav-group-body">
              ...
              <a class="nav-item sub active" href="#" data-label="Apps KoolTool"><span class="dot" aria-hidden="true"></span><span class="nav-text">KoolTool</span></a>
            </div>
          </div>
          ...
          <div class="nav-group" data-label="Temp Text Files">
            ...
            <div class="nav-group-body">
              <a class="nav-item sub" href="#" data-label="Temp Text Files Temp 1"><span class="dot"></span><span class="nav-text">Temp 1</span></a>
            ...
            <div class="nav-group-body">
              ...
              <div class="nav-subgroup" data-label="AI Prompts Documents">
                ...
                <div class="nav-subgroup-body">
                  ...
                  <a class="nav-item sub" href="#" data-label="AI Prompts Documents Software Features Document"><span class="dot"></span><span class="nav-text">Software Features Document</span></a>
          ...
          <div class="nav-group" data-label="Modular Solutions">
            <button class="nav-group-head" type="button" data-toggle="group">
              <span class="nav-ico" aria-hidden="true">
                <svg viewBox="0 0 24 24" class="ico sm" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M4 4h7v7H4z"></path><path d="M13 4h7v7h-7z"></path><path d="M4 13h7v7H4z"></path><path d="M13 13h7v7h-7z"></path>
                </svg>
              </span>
            ...
            <div class="nav-group-body">
              <div class="nav-subgroup" data-label="Modular Solutions Blue Collar">
                <button class="nav-subgroup-head" type="button" data-toggle="subgroup">
                  <span class="mini-pill">BC</span><span class="nav-text">Blue Collar</span>
                  <span class="chev" aria-hidden="true"><svg viewBox="0 0 24 24" class="ico sm" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18l6-6-6-6"></path></svg></span>
                </button>
                <div class="nav-subgroup-body">
              ...
              <div class="nav-subgroup" data-label="Modular Solutions PerformanceBTS">
                <button class="nav-subgroup-head" type="button" data-toggle="subgroup">
                  <span class="mini-pill amber">PB</span><span class="nav-text">PerformanceBTS</span>
                  <span class="chev" aria-hidden="true"><svg viewBox="0 0 24 24" class="ico sm" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18l6-6-6-6"></path></svg></span>
                </button>
                <div class="nav-subgroup-body">
              ...
              <div class="nav-subgroup" data-label="Modular Solutions Geist">
                <button class="nav-subgroup-head" type="button" data-toggle="subgroup">
                  <span class="mini-pill violet">G</span><span class="nav-text">Geist</span>
                  <span class="chev" aria-hidden="true"><svg viewBox="0 0 24 24" class="ico sm" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18l6-6-6-6"></path></svg></span>
                </button>
                <div class="nav-subgroup-body">
              ...
              <div class="nav-subgroup" data-label="Modular Solutions Monkeybread">
                <button class="nav-subgroup-head" type="button" data-toggle="subgroup">
                  <span class="mini-pill slate">MB</span><span class="nav-text">Monkeybread</span>
                  <span class="chev" aria-hidden="true"><svg viewBox="0 0 24 24" class="ico sm" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18l6-6-6-6"></path></svg></span>
                </button>
                <div class="nav-subgroup-body">
              ...
              <div class="nav-subgroup" data-label="Modular Solutions Others">
                <button class="nav-subgroup-head" type="button" data-toggle="subgroup">
                  <span class="mini-pill teal">+</span><span class="nav-text">Others</span>
                  <span class="chev" aria-hidden="true"><svg viewBox="0 0 24 24" class="ico sm" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18l6-6-6-6"></path></svg></span>
                </button>
                <div class="nav-subgroup-body">
        ...
        <div class="content-inner">
          ...
          <section class="hero" id="overview">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Doing Development In CauferoAppStarter</div>
                <div class="hero-sub">One page. Everything you touch during a build: scripts, docs, CSS, pages, objects. Built to scan fast.</div>
              </div>
              <div class="hero-actions">
                <a class="cta ghost" href="_Misc/Full Documentation - CauferoAppStarter.md">
              ...
              <div class="dev-toolbar">
                <div class="dev-search">
                  ...
                  <input id="devQ" class="dev-search-input" type="search" placeholder="Search scripts, docs, pages… (e.g. ExecuteSQL, Report, Entity)" autocomplete="off" />
                  <button class="xbtn" id="devQClear" type="button" aria-label="Clear">
                ...
                <div class="dev-toggles" role="group" aria-label="Filter by kind">
                  <button class="dev-toggle is-on" data-filter="all" type="button">All</button>
                  <button class="dev-toggle" data-filter="script" type="button">Scripts</button>
                  <button class="dev-toggle" data-filter="doc" type="button">Docs</button>
                  <button class="dev-toggle" data-filter="css" type="button">CSS</button>
                  <button class="dev-toggle" data-filter="page" type="button">Pages</button>
                </div>
              </div>
              <div class="hero-meta">
                <a class="chip" href="#scripts">Scripts</a>
                <a class="chip teal" href="#docs">Documentations</a>
                <a class="chip amber" href="#sections">By Section</a>
                <span class="chip copper">CauferoAppStarter</span>
              </div>
            </div>
          </section>

          <!-- SCRIPTS -->
          <section class="card section" id="scripts" aria-label="Scripts">
            <div class="section-head">
              ...
              <div class="section-actions">
                <a class="btn ghost" href="Pages/">Open scripts folder</a>
              </div>
            </div>

            <div class="grid grid-2">
              <!-- Full scripts -->
              <div class="pad" data-kind="script">
                <div class="pad-top">
                  <div class="badge">Full Scripts</div>
                  <div class="pad-title">Plug-and-play</div>
                </div>
                <div class="dev-items">
                  <a class="dev-item" href="_Misc/Startup.md" data-kind="script">
                    <div class="dev-item-title">Startup</div>
                    <div class="dev-item-meta">Entry point · boot sequence</div>
                    <div class="dev-item-tags"><span class="badge">Core</span><span class="badge teal">System</span></div>
                  </a>
                  <a class="dev-item" href="_Misc/PopulateAvailableLinks.md" data-kind="script">
                    <div class="dev-item-title">PopulateAvailableLinks <span class="dev-muted">(as at 17th Jan, 2026)</span></div>
                    <div class="dev-item-meta">Builds available links list</div>
                    <div class="dev-item-tags"><span class="badge violet">Navigation</span></div>
                  </a>
                  <a class="dev-item" href="_Misc/Get Value List.md" data-kind="script">
                    <div class="dev-item-title">Get Value List <span class="dev-muted">(as at 16th Jan, 2026)</span></div>
                    <div class="dev-item-meta">Dropdowns + list HTML generator</div>
                    <div class="dev-item-tags"><span class="badge">Core</span><span class="badge sky">UI</span></div>
                  </a>
                  <a class="dev-item" href="_Misc/SelectLink.md" data-kind="script">
                    <div class="dev-item-title">SelectLink</div>
                    <div class="dev-item-meta">Link selection helper</div>
                    <div class="dev-item-tags"><span class="badge violet">Navigation</span></div>
                  </a>
                  <a class="dev-item" href="_Misc/GoToAppSection.md" data-kind="script">
                    <div class="dev-item-title">GoToAppSection</div>
                    <div class="dev-item-meta">Switches to app section</div>
                    <div class="dev-item-tags"><span class="badge amber">Routing</span></div>
                  </a>
                </div>

                <details class="dev-details">
                  <summary class="dev-details-sum">Entities: scripts bundle</summary>
                  <div class="dev-details-body">
                    <a class="dev-item" href="_Misc/Implement_Entity_Management_Page.md" data-kind="script">
                      <div class="dev-item-title">Implement Entity Management Page</div>
                      <div class="dev-item-meta">Creates entity pages and flow</div>
                    </a>
                    <div class="temp-grid" style="margin-top:10px;">
                      <a class="temp" href="_Misc/_Entity Filter Page.md" data-kind="script">+++Entity Filter Page <span class="dev-muted" style="font-weight:600;">(21st Jan, 2026)</span></a>
                      <a class="temp" href="_Misc/+++Entity List Page.md" data-kind="script">+++Entity List Page</a>
                      <a class="temp" href="_Misc/+++Entity Details Page.md" data-kind="script" style="opacity:.7;">⏳ +++Entity Details Page</a>
                      <a class="temp" href="_Misc/+++Entity Related Item Modal Page.md" data-kind="script" style="opacity:.7;">⏳ +++Entity Related Item Modal</a>
                    </div>
                  </div>
                </details>

                <details class="dev-details">
                  <summary class="dev-details-sum">Reports: generation scripts</summary>
                  <div class="dev-details-body">
                    <a class="dev-item" href="_Misc/Implement Report Generation.md" data-kind="script">
                      <div class="dev-item-title">Implement Report Generation</div>
                      <div class="dev-item-meta">Report framework + patterns</div>
                    </a>
                    <div class="temp-grid" style="margin-top:10px;">
                      <a class="temp" href="_Misc/+++ Report Filter Page.md" data-kind="script">+++ Report Filter Page <span class="dev-muted" style="font-weight:600;">(21st Jan)</span></a>
                      <a class="temp" href="_Misc/_Report.md" data-kind="script">+++ Report</a>
                      <a class="temp" href="_Misc/Sample Report Page.html" data-kind="script">Sample Report HTML Page</a>
                    </div>
                  </div>
                </details>
              </div>
              ...
              <div class="pad" data-kind="script">
                <div class="pad-top">
                  <div class="badge slate">Script Sections</div>
                  <div class="pad-title">Reusable patterns</div>
                </div>
                <div class="dev-items">
                  <a class="dev-item" href="_Misc/ExecuteSQL.md" data-kind="script">
                    <div class="dev-item-title">ExecuteSQL</div>
                    <div class="dev-item-meta">SQL patterns, guards, parsing</div>
                    <div class="dev-item-tags"><span class="badge amber">SQL</span><span class="badge">Core</span></div>
                  </a>
                </div>
                <div class="dev-callout">
                  <div class="dev-callout-title">Workflow tip</div>
                  <div class="dev-callout-text">Start with the section you are touching: scripts, then UI pages, then CSS. Keep it tight.</div>
                </div>
              </div>
            </div>
          </section>
          ...
          <!-- DOCS -->
          <section class="card section" id="docs" aria-label="Documentations">
            <div class="section-head">
              <div class="section-title">
            ...
            <div class="grid grid-2">
              <div class="pad" data-kind="doc">
                <div class="pad-top">
                  <div class="badge teal">Starter Docs</div>
                  <div class="pad-title">Foundation</div>
                </div>
                <a class="dev-big-link" href="_Misc/Full Documentation - CauferoAppStarter.md" data-kind="doc">
                  <div class="dev-big-title">Full Documentation — CauferoAppStarter</div>
                  <div class="dev-big-sub">As at 15th Jan, 2026</div>
                  <div class="dev-big-meta">System structure, tables, pages, patterns</div>
                </a>
              </div>

              <div class="pad" data-kind="doc">
                <div class="pad-top">
                  <div class="badge violet">AI Prompts Pack</div>
                  <div class="pad-title">Upload first when building</div>
                </div>
                <div class="dev-items">
                  <a class="dev-item" href="_Misc/Build Apps With CauferoAppStarter.md" data-kind="doc">
                    <div class="dev-item-title">Building Apps With CauferoAppStarter <span class="dev-muted">(as at 15th Jan, 2026)</span></div>
                    <div class="dev-item-meta">Build flow + principles</div>
                  </a>
                  <a class="dev-item" href="_Misc/AI Agent Playbook.md" data-kind="doc">
                    <div class="dev-item-title">AI Agent Playbook</div>
                    <div class="dev-item-meta">How to work with AI cleanly</div>
                  </a>
                  <a class="dev-item" href="_Misc/My Playbook.md" data-kind="doc">
                    <div class="dev-item-title">My Playbook</div>
                    <div class="dev-item-meta">Your personal rules + style</div>
                  </a>
                </div>
              </div>
            </div>
          ...
          <!-- BY SECTION -->
          <section class="card section" id="sections" aria-label="By section">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">🗂️</span>
                <span>By Section</span>
                <span class="section-sub">(Jump straight to what you're implementing)</span>
              </div>
            </div>

            <div class="grid grid-3">
              <a class="tile" href="_Misc/Tables.md" data-kind="doc">
                <div class="tile-top"><div class="badge">▦</div><div class="tile-title">Tables</div></div>
                <div class="tile-sub">Schema, naming, relationships</div>
              </a>
              <a class="tile" href="_Misc/CustomFunctions.md" data-kind="doc">
                <div class="tile-top"><div class="badge teal">ƒx</div><div class="tile-title">Custom Functions</div></div>
                <div class="tile-sub">CF library and patterns</div>
              </a>
              <a class="tile" href="_Misc/Valuelists.md" data-kind="doc">
                <div class="tile-top"><div class="badge violet">≡</div><div class="tile-title">Valuelists</div></div>
                <div class="tile-sub">Lists, dropdowns, semantics</div>
              </a>
              <a class="tile" href="_Misc/Layouts.md" data-kind="doc">
                <div class="tile-top"><div class="badge amber">▤</div><div class="tile-title">Layouts</div></div>
                <div class="tile-sub">Layout structure + conventions</div>
              </a>

              <!-- CSS tile — wide -->
              <div class="tile accent-sky" data-kind="css" style="grid-column: span 2;">
                <div class="tile-top"><div class="badge sky">✦</div><div class="tile-title">CSS</div></div>
                <div class="tile-sub">Core UI styles used across pages.</div>
                <div class="subsection" style="margin-top:12px;padding-top:10px;">
                  <div class="temp-grid" style="grid-template-columns:repeat(4,minmax(0,1fr));">
                    <a class="temp" href="CSS/SplashScreenCSS.md" data-kind="css">Splash</a>
                    <a class="temp" href="CSS/BannerCSS.md" data-kind="css">Banner</a>
                    <a class="temp" href="CSS/DashboardCSS.md" data-kind="css">Dashboard</a>
                    <a class="temp" href="CSS/MenuCSS.md" data-kind="css">Menu</a>
                    <a class="temp" href="CSS/ListCSS.md" data-kind="css">List</a>
                    <a class="temp" href="CSS/DetailsCSS.md" data-kind="css">Details</a>
                    <a class="temp" href="CSS/ModalCSS.md" data-kind="css">Modal</a>
                  </div>
                </div>
              </div>

              <!-- Pages tile — wide -->
              <div class="tile accent-teal" data-kind="page" style="grid-column: span 3;">
                <div class="tile-top"><div class="badge teal">⌗</div><div class="tile-title">Pages</div></div>
                <div class="tile-sub">Base pages and entity patterns.</div>
                <div class="subsection" style="margin-top:12px;padding-top:10px;">
                  <div class="temp-grid" style="grid-template-columns:repeat(4,minmax(0,1fr));">
                    <a class="temp" href="Pages/SplashPage.md" data-kind="page">Splash</a>
                    <a class="temp" href="Pages/BannerPage.md" data-kind="page">Banner</a>
                    <a class="temp" href="Pages/DashboardPage.md" data-kind="page">Dashboard</a>
                    <a class="temp" href="Pages/MenuPage.md" data-kind="page">Menu</a>
                    <a class="temp" href="Pages/ListPage.md" data-kind="page">List</a>
                    <a class="temp" href="Pages/DetailsPage.md" data-kind="page">Details</a>
                    <a class="temp" href="Pages/ModalPage.md" data-kind="page">Modal</a>
                    <a class="temp" href="Pages/ReportPage.md" data-kind="page">Report</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <footer class="footer">
            <div class="footer-left">
              <div class="footer-title">Doing Development In CauferoAppStarter</div>
              <div class="footer-sub">CauferoStarterApp · Built like Tailwind. Stored like Markdown.</div>
            </div>
            <div class="footer-right">
              <a class="footer-link" href="#overview">Top</a>
              <a class="footer-link" href="#scripts">Scripts</a>
              <a class="footer-link" href="#docs">Docs</a>
              <a class="footer-link" href="#sections">By Section</a>
            </div>
          </footer>
        </div>
      </main>

      <!-- ═══════════════════════ RIGHT RAIL (updated for new page) ═══════════════════════ -->
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          <div class="rail-title">Dev Panel</div>
          <div class="rail-sub">Jump to any section</div>
          <div class="rail-actions">
            <a class="rail-btn" href="#overview">Overview</a>
            <a class="rail-btn" href="#scripts">Scripts</a>
            <a class="rail-btn" href="#docs">Docs</a>
            <a class="rail-btn" href="#sections">By Section</a>
          </div>
        </div>
        ...
        <div class="rail-body">
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Click a pill to highlight matches</div>
            </div>
            <div class="pill-row" id="scanPills">
              <span class="pill2 scan-pill" data-kw="Scripts">Scripts</span>
              <span class="pill2 scan-pill" data-kw="Entities">Entities</span>
              <span class="pill2 scan-pill" data-kw="Reports">Reports</span>
              <span class="pill2 scan-pill" data-kw="ExecuteSQL">ExecuteSQL</span>
              <span class="pill2 scan-pill" data-kw="CSS">CSS</span>
              <span class="pill2 scan-pill" data-kw="Pages">Pages</span>
              <span class="pill2 scan-pill" data-kw="Tables">Tables</span>
              <span class="pill2 scan-pill" data-kw="Valuelists">Valuelists</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Top destinations</div>
            </div>
            <div class="side-grid" style="grid-template-columns:1fr;">
              <a class="side-pill" href="_Misc/Full Documentation - CauferoAppStarter.md">Full Documentation</a>
              <a class="side-pill" href="_Misc/Build Apps With CauferoAppStarter.md">Building Apps With CauferoAppStarter</a>
              <a class="side-pill warn" href="_Misc/Get Value List.md">Get Value List</a>
              <a class="side-pill warn" href="_Misc/PopulateAvailableLinks.md">PopulateAvailableLinks</a>
              <a class="side-pill warn" href="_Misc/+++ Report Filter Page.md">+++ Report Filter Page</a>
              <a class="side-pill" href="_Misc/AI Agent Playbook.md">AI Agent Playbook</a>
              <a class="side-pill" href="_Misc/ExecuteSQL.md">ExecuteSQL</a>
              <a class="side-pill" href="_Misc/My Playbook.md">My Playbook</a>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Active filter</div>
              <div class="panel-sub">Currently highlighted</div>
            </div>
            <div class="panel-card" id="activeFilterDisplay" style="padding:10px 12px;margin:0;border:1px solid var(--line);background:var(--surface2);font-size:13px;font-weight:800;letter-spacing:.05px;">
              None
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Key anchors at a glance</div>
            </div>
            <div class="stack" style="gap:8px;">
              <div class="stack-item">
                <span style="font-size:11px;text-transform:uppercase;letter-spacing:.2px;font-weight:800;color:var(--slate-500);">Start here</span>
                <div style="margin-top:4px;font-weight:900;font-size:13px;"><a href="_Misc/Full Documentation - CauferoAppStarter.md">Full Documentation</a></div>
                <div class="stack-sub">System overview + structure</div>
              </div>
              <div class="stack-item">
                <span style="font-size:11px;text-transform:uppercase;letter-spacing:.2px;font-weight:800;color:var(--slate-500);">Core script</span>
                <div style="margin-top:4px;font-weight:900;font-size:13px;"><a href="_Misc/Get Value List.md">Get Value List</a></div>
                <div class="stack-sub">Dropdowns + lists backbone</div>
              </div>
              <div class="stack-item">
                <span style="font-size:11px;text-transform:uppercase;letter-spacing:.2px;font-weight:800;color:var(--slate-500);">Report engine</span>
                <div style="margin-top:4px;font-weight:900;font-size:13px;"><a href="_Misc/+++ Report Filter Page.md">+++ Report Filter Page</a></div>
                <div class="stack-sub">Filters UI generator</div>
              </div>
            </div>
          </div>
    ...
    (function(){
      ...
      function filterNav(q){
        ...
        for (var g=0; g<groups.length; g++){
          ...
          if (query && anyHit){ group.classList.add("forced-open"); }
          else { group.classList.remove("forced-open"); }
        }
      }
      ...
      /* ── Keyword highlight (hero section auto-marks) ── */
      function highlightKeywords(){
        var main = document.querySelector(".content-inner");
        if (!main) return;
        var keywords = ["Scripts","Entities","Reports","ExecuteSQL","CSS","Pages","Tables","Valuelists","FileMaker","CauferoAppStarter"];
        var skipSel = "a,pre,code,script,style,input,textarea,button,.dev-toggles,.dev-toolbar";
        function walk(node){
      ...
      /* ── Dev page: filter by kind ── */
      function wireDevFilters(){
        var toggles = Array.from(document.querySelectorAll(".dev-toggle"));
        var activeDisplay = document.getElementById("activeFilterDisplay");
        toggles.forEach(function(t){
          t.addEventListener("click", function(){
            var which = t.getAttribute("data-filter") || "all";
            toggles.forEach(function(x){ x.classList.toggle("is-on", x === t); });
            var cards = Array.from(document.querySelectorAll("[data-kind]"));
            cards.forEach(function(el){
              var kind = el.getAttribute("data-kind");
              var show = (which === "all") || (kind === which);
              el.classList.toggle("is-hidden-kind", !show);
            });
            if (activeDisplay) activeDisplay.textContent = which === "all" ? "None" : which.charAt(0).toUpperCase() + which.slice(1);
          });
        });
      }

      /* ── Dev page: search ── */
      function wireDevSearch(){
        var q = document.getElementById("devQ");
        var qClear = document.getElementById("devQClear");
        function applySearch(){
          var term = (q ? q.value : "").trim().toLowerCase();
          var els = Array.from(document.querySelectorAll("[data-kind]"));
          if (!term){
            els.forEach(function(el){ el.classList.remove("is-dim"); });
            return;
          }
          els.forEach(function(el){
            var text = (el.textContent || "").toLowerCase();
            el.classList.toggle("is-dim", !text.includes(term));
          });
        }
      ...
      /* ── Dev page: scan pills ── */
      function wireScanPills(){
        var pills = Array.from(document.querySelectorAll(".scan-pill"));
        var activeDisplay = document.getElementById("activeFilterDisplay");
        var content = document.querySelector(".content-inner");
        function clearMarks(){
          var marks = content ? content.querySelectorAll("mark.kw-pill") : [];
          Array.from(marks).forEach(function(m){
        ...
        function markKw(kw){
          ...
          var walker = document.createTreeWalker(content, NodeFilter.SHOW_TEXT, {
            acceptNode: function(node){
              ...
              if (tag === "script" || tag === "style" || tag === "code" || tag === "pre" || tag === "input" || tag === "mark") return NodeFilter.FILTER_REJECT;
          ...
          if (activeDisplay) activeDisplay.textContent = kw;
        }
        pills.forEach(function(p){
          p.addEventListener("click", function(){
            var kw = p.getAttribute("data-kw");
            var isActive = p.classList.contains("scan-active");
            pills.forEach(function(x){ x.classList.remove("scan-active"); });
            if (isActive){
              clearMarks();
              if (activeDisplay) activeDisplay.textContent = "None";
            } else {
              p.classList.add("scan-active");
              markKw(kw);
            }
          });
        });
  ...
  <!-- ═══════════════════════ CSS (Caufero Workspace — unchanged + new additions) ═══════════════════════ -->
  <style>
    /* ─── Base tokens ─── */
    :root{
      --slate-950:#0b1220;
    ...
    *{box-sizing:border-box;}
    ...
    .page-chip{
      ...
      padding:7px 10px;border-radius:999px;box-shadow:0 1px 0 rgba(15,23,42,.04);
    }
    ...
    .nav-item,.nav-group-head,.nav-subgroup-head{
      ...
      color:inherit;background:transparent;cursor:pointer;user-select:none;text-align:left;
    }
    ...
    .chip{display:inline-flex;align-items:center;padding:6px 10px;border-radius:999px;border:1px solid var(--line);background:rgba(255,255,255,.55);font-size:11px;font-weight:750;color:var(--slate-700);text-decoration:none;}
    ...
    /* ─── Pads ─── */
    .pad{border:1px solid var(--line);background:linear-gradient(180deg, rgba(255,255,255,.78), rgba(255,255,255,.60));border-radius:16px;padding:14px;box-shadow:0 1px 0 rgba(15,23,42,.04);}
    .page[data-theme="dark"] .pad{background:linear-gradient(180deg, rgba(255,255,255,.06), rgba(255,255,255,.04));}
    ...
    /* ─── Subsection ─── */
    .subsection{margin-top:14px;border-top:1px solid var(--line);padding-top:14px;}

    /* ─── Temp grid ─── */
    .temp-grid{display:grid;grid-template-columns:repeat(5, minmax(0, 1fr));gap:10px;}
    .temp{display:flex;align-items:center;justify-content:center;text-align:center;padding:10px;border-radius:14px;border:1px solid var(--line);background:var(--surface2);font-size:12px;font-weight:800;color:inherit;text-decoration:none;box-shadow:0 1px 0 rgba(15,23,42,.04);}
    .temp:hover{text-decoration:none;box-shadow:var(--shadow-1);transform:translateY(-1px);transition:transform .12s ease, box-shadow .12s ease;}
    .temp:active{transform:translateY(0px);}
    .temp.danger{border-color:rgba(213,67,46,.25);background:rgba(213,67,46,.10);color:var(--danger);}

    /* ─── Mini ─── */
    .mini{border:1px solid var(--line);background:var(--surface2);border-radius:14px;padding:12px;text-decoration:none;color:inherit;box-shadow:0 1px 0 rgba(15,23,42,.04);display:flex;align-items:center;justify-content:center;text-align:center;min-height:44px;}
    ...
    .panel-title{font-weight:950;letter-spacing:.15px;}
    ...
    /* ─── Dev-page specific additions ─── */

    /* Dev toolbar (search + filter in hero) */
    .dev-toolbar{margin-top:14px;display:flex;gap:10px;align-items:center;flex-wrap:wrap;}
    .dev-search{flex:1;min-width:200px;display:flex;align-items:center;gap:8px;border:1px solid var(--line);border-radius:12px;padding:8px 10px;background:var(--surface2);}
    .dev-search-input{border:0;outline:none;width:100%;font-size:12.5px;background:transparent;color:inherit;}
    .dev-toggles{display:flex;gap:8px;flex-wrap:wrap;}
    .dev-toggle{display:inline-flex;align-items:center;padding:8px 10px;border-radius:999px;border:1px solid var(--line);background:var(--surface2);font-size:12px;font-weight:800;color:inherit;cursor:pointer;}
    .dev-toggle:hover{border-color:var(--line2);}
    .dev-toggle.is-on{background:linear-gradient(180deg, rgba(14,51,68,.14), rgba(14,51,68,.08));border-color:rgba(14,51,68,.22);color:var(--caufero-800);}
    .page[data-theme="dark"] .dev-toggle.is-on{background:linear-gradient(180deg, rgba(65,197,224,.14), rgba(65,197,224,.08));border-color:rgba(65,197,224,.22);color:#a7d7e3;}

    /* Dev items (script/doc cards) */
    .dev-items{display:flex;flex-direction:column;gap:10px;}
    .dev-item{display:block;padding:10px 12px;border:1px solid var(--line);border-radius:14px;background:linear-gradient(180deg, rgba(255,255,255,.82), rgba(255,255,255,.72));box-shadow:0 1px 0 rgba(15,23,42,.04);text-decoration:none;color:inherit;}
    .page[data-theme="dark"] .dev-item{background:linear-gradient(180deg, rgba(255,255,255,.06), rgba(255,255,255,.04));}
    .dev-item:hover{border-color:var(--line2);box-shadow:var(--shadow-1);transform:translateY(-1px);transition:transform .12s ease, box-shadow .12s ease;text-decoration:none;}
    .dev-item:active{transform:translateY(0px);}
    .dev-item-title{font-size:13px;font-weight:900;color:inherit;}
    .dev-item-meta{margin-top:4px;font-size:12px;color:var(--slate-600);}
    .page[data-theme="dark"] .dev-item-meta{color:rgba(241,245,249,.66);}
    .dev-item-tags{margin-top:8px;display:flex;flex-wrap:wrap;gap:6px;}
    .dev-muted{color:var(--slate-500);font-weight:650;}

    /* Dev details/summary (collapsible bundles) */
    .dev-details{margin-top:10px;border:1px dashed var(--line2);border-radius:14px;overflow:hidden;}
    .dev-details-sum{cursor:pointer;padding:10px 12px;font-size:12.5px;font-weight:900;color:inherit;list-style:none;display:flex;align-items:center;gap:8px;}
    .dev-details-sum::-webkit-details-marker{display:none;}
    .dev-details-sum::before{content:"▶";font-size:10px;opacity:.55;transition:transform .14s ease;}
    details[open] .dev-details-sum::before{transform:rotate(90deg);}
    .dev-details-sum:hover{background:rgba(15,23,42,.03);}
    .page[data-theme="dark"] .dev-details-sum:hover{background:rgba(241,245,249,.04);}
    .dev-details-body{padding:0 12px 12px 12px;border-top:1px solid var(--line);}

    /* Dev callout */
    .dev-callout{margin-top:12px;border:1px solid rgba(183,121,31,.20);background:rgba(183,121,31,.08);border-radius:14px;padding:10px 12px;}
    .dev-callout-title{font-size:12px;font-weight:900;color:var(--amber-600);}
    .dev-callout-text{margin-top:4px;font-size:12px;color:var(--slate-700);line-height:1.5;}
    .page[data-theme="dark"] .dev-callout-text{color:rgba(241,245,249,.75);}

    /* Dev big link (featured doc) */
    .dev-big-link{display:block;margin-top:6px;padding:14px;border:1px solid rgba(14,51,68,.18);border-radius:16px;background:linear-gradient(180deg, rgba(14,51,68,.10), rgba(14,51,68,.06));text-decoration:none;color:inherit;}
    .page[data-theme="dark"] .dev-big-link{border-color:rgba(65,197,224,.20);background:linear-gradient(180deg, rgba(65,197,224,.10), rgba(65,197,224,.06));}
    .dev-big-link:hover{border-color:rgba(14,51,68,.30);box-shadow:var(--shadow-1);transform:translateY(-1px);transition:transform .12s ease, box-shadow .12s ease;text-decoration:none;}
    .dev-big-title{font-size:14px;font-weight:900;letter-spacing:.1px;}
    .dev-big-sub{margin-top:4px;font-size:12px;color:var(--slate-500);font-weight:750;}
    .dev-big-meta{margin-top:8px;font-size:12px;color:var(--slate-600);line-height:1.5;}
    .page[data-theme="dark"] .dev-big-meta{color:rgba(241,245,249,.66);}

    /* Scan pills in right rail */
    .scan-pill{cursor:pointer;user-select:none;}
    .scan-pill:hover{border-color:var(--line2);}
    .scan-pill.scan-active{background:linear-gradient(180deg, rgba(216,116,61,.14), rgba(216,116,61,.08));border-color:rgba(216,116,61,.30);color:var(--copper-600);}
    .page[data-theme="dark"] .scan-pill.scan-active{background:rgba(65,197,224,.12);border-color:rgba(65,197,224,.28);color:#a7d7e3;}

    /* Hidden-kind (type filter) */
    .is-hidden-kind{display:none !important;}
    ...
    @media (max-width: 1180px){
      ...
      .temp-grid{grid-template-columns:repeat(4, minmax(0, 1fr));}
    }
