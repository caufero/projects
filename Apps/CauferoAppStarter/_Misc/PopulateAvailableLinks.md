...
<head>
  ...
  <title>Populate Available Links Script Documentation</title>
</head>
<body>
        ...
        <div class="content-inner">
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Populate Available Links Script Documentation</div>
                <div class="hero-sub">Navigation payload generator for CauferoAppStarter. Creates Link Records for sidebar menus, hamburger navigation, tiles, quick links, and module selectors. Uses strict delimiter contract (pipe-separated fields, paragraph-separated records) to ensure deterministic parsing by downstream UI renderers.</div>
              </div>
              ...
              <div class="hero-meta">
                ...
                <span class="chip violet">Link Records</span>
                <span class="chip amber">Menu Builder</span>
                <span class="chip copper">Permissions</span>
              </div>
            </div>
          </section>
          ...
          <section class="card section" id="overview-section">
            <div class="section-head">
              <div class="section-title">
                ...
                <span>Overview</span>
                <span class="section-sub">Purpose and Integration</span>
              </div>
            </div>

            <div style="padding: 20px; line-height: 1.6;">
              <h3 style="margin-top: 0; margin-bottom: 12px; font-weight: 750;">Purpose</h3>
              <p>The <strong>Populate Available Links</strong> script generates the app's navigation payload, called <strong>Link Records</strong>, used to build all navigation menus including sidebar, hamburger menu, tiles, quick links, and module selectors.</p>

              <p>This script outputs a single <strong>text blob</strong> containing multiple link records. Each record describes either:</p>
              <ul style="margin-left: 20px;">
                <li>A <strong>Section Header</strong> (top-level group)</li>
                <li>A <strong>Link Item</strong> (clickable screen under a section)</li>
              </ul>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">Where This Script Fits</h3>
              <p><strong>Typical Flow:</strong></p>
              <ol style="margin-left: 20px;">
                <li>User logs in or app loads a module selector</li>
                <li>App determines user's role, permissions, or enabled modules</li>
                <li><strong>Populate Available Links</strong> generates navigation payload based on permissions</li>
                <li>UI scripts render menus using the payload (often inside WebViewer HTML/JS)</li>
              </ol>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">Why The Contract Matters</h3>
              <p>Many scripts depend on exact separators and field positions. If the payload shape changes, UI rendering and click actions break.</p>
              <p style="background: rgba(213,67,46,0.1); border-left: 3px solid rgba(213,67,46,0.7); padding: 12px; border-radius: 8px; margin-top: 12px;"><strong>Hard Rule:</strong> Keep the delimiter contract stable. Change values only, never structure.</p>
            </div>
          </section>

          <section class="card section" id="contract-section">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">📋</span>
                <span>Output Data Contract</span>
                <span class="section-sub">Link Records Structure</span>
              </div>
            </div>

            <div style="padding: 20px; line-height: 1.6;">
              <h3 style="margin-top: 0; margin-bottom: 12px; font-weight: 750;">Record Separator</h3>
              <p>Each link record is one line, separated by paragraph mark delimiter <code>¶</code></p>
              <ul style="margin-left: 20px;">
                <li>Multiple consecutive ¶ may exist to visually separate groups</li>
                <li>Empty records (blank lines) must be ignored by parsers</li>
              </ul>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">Field Separator</h3>
              <p>Fields within each record are separated by pipe <code>|</code></p>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">Canonical Field Order (Version 1)</h3>
              <p>Each record has 5 required fields, plus up to 2 optional fields:</p>
              
              <table style="width: 100%; border-collapse: collapse; margin-top: 12px; font-size: 13px;">
                <thead>
                  <tr style="background: rgba(15,23,42,.06); border-bottom: 2px solid rgba(15,23,42,.1);">
                    <th style="padding: 10px; text-align: right; width: 80px;">Position</th>
                    <th style="padding: 10px; text-align: left;">Field Name</th>
                    <th style="padding: 10px; text-align: center; width: 100px;">Required</th>
                    <th style="padding: 10px; text-align: left;">Description</th>
                  </tr>
                </thead>
                <tbody>
                  <tr style="border-bottom: 1px solid rgba(15,23,42,.06);">
                    <td style="padding: 10px; text-align: right; font-weight: 650;">1</td>
                    <td style="padding: 10px; font-weight: 650;">LinkID</td>
                    <td style="padding: 10px; text-align: center;">✓</td>
                    <td style="padding: 10px;">Unique ID for this link record (UUID recommended)</td>
                  </tr>
                  <tr style="border-bottom: 1px solid rgba(15,23,42,.06);">
                    <td style="padding: 10px; text-align: right; font-weight: 650;">2</td>
                    <td style="padding: 10px; font-weight: 650;">OrderKey</td>
                    <td style="padding: 10px; text-align: center;">✓</td>
                    <td style="padding: 10px;">Sort and hierarchy code (e.g., 3, 3.1, 6.2)</td>
                  </tr>
                  <tr style="border-bottom: 1px solid rgba(15,23,42,.06);">
                    <td style="padding: 10px; text-align: right; font-weight: 650;">3</td>
                    <td style="padding: 10px; font-weight: 650;">Caption</td>
                    <td style="padding: 10px; text-align: center;">✓</td>
                    <td style="padding: 10px;">Display title in the menu (short label)</td>
                  </tr>
                  <tr style="border-bottom: 1px solid rgba(15,23,42,.06);">
                    <td style="padding: 10px; text-align: right; font-weight: 650;">4</td>
                    <td style="padding: 10px; font-weight: 650;">Subtitle</td>
                    <td style="padding: 10px; text-align: center;">✓</td>
                    <td style="padding: 10px;">Secondary label or expanded title (may be empty)</td>
                  </tr>
                  <tr style="border-bottom: 1px solid rgba(15,23,42,.06);">
                    <td style="padding: 10px; text-align: right; font-weight: 650;">5</td>
                    <td style="padding: 10px; font-weight: 650;">IconPath</td>
                    <td style="padding: 10px; text-align: center;">✓</td>
                    <td style="padding: 10px;">SVG path string (the M... path data)</td>
                  </tr>
                  <tr style="border-bottom: 1px solid rgba(15,23,42,.06);">
                    <td style="padding: 10px; text-align: right; font-weight: 650;">6</td>
                    <td style="padding: 10px; font-weight: 650;">ParentLinkID</td>
                    <td style="padding: 10px; text-align: center;">—</td>
                    <td style="padding: 10px;">The LinkID of the section header this item belongs to</td>
                  </tr>
                  <tr>
                    <td style="padding: 10px; text-align: right; font-weight: 650;">7</td>
                    <td style="padding: 10px; font-weight: 650;">Flags</td>
                    <td style="padding: 10px; text-align: center;">—</td>
                    <td style="padding: 10px;">UI directives (e.g., "After Section Divider")</td>
                  </tr>
                </tbody>
              </table>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">Record Shape Rules</h3>
              
              <h4 style="margin-top: 16px; margin-bottom: 8px; font-weight: 700;">Section Header Record (Top Level)</h4>
              <p>ParentLinkID is empty. Flags may exist.</p>
              <pre style="background: rgba(15,23,42,.06); padding: 12px; border-radius: 8px; overflow-x: auto; font-size: 12px; margin-top: 8px;">LinkID|OrderKey|Caption|Subtitle|IconPath¶
LinkID|OrderKey|Caption|Subtitle|IconPath||After Section Divider¶</pre>

              <h4 style="margin-top: 16px; margin-bottom: 8px; font-weight: 700;">Link Item Record (Child Under Section)</h4>
              <p>ParentLinkID is populated with the section's LinkID. Flags may exist.</p>
              <pre style="background: rgba(15,23,42,.06); padding: 12px; border-radius: 8px; overflow-x: auto; font-size: 12px; margin-top: 8px;">LinkID|OrderKey|Caption|Subtitle|IconPath|ParentLinkID¶
LinkID|OrderKey|Caption|Subtitle|IconPath|ParentLinkID|After Section Divider¶</pre>
            </div>
          </section>

          <section class="card section" id="hierarchy-section">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">🌳</span>
                <span>Hierarchy Rules</span>
                <span class="section-sub">Parent-Child Relationships</span>
              </div>
            </div>

            <div style="padding: 20px; line-height: 1.6;">
              <h3 style="margin-top: 0; margin-bottom: 12px; font-weight: 750;">Parent-Child Relationship</h3>
              <ul style="margin-left: 20px;">
                <li>A record becomes a <strong>child</strong> when <code>ParentLinkID</code> is present and matches a section's LinkID</li>
                <li>A record becomes a <strong>section</strong> when <code>ParentLinkID</code> is empty</li>
              </ul>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">OrderKey Meaning</h3>
              <p>OrderKey controls display order and implies hierarchy.</p>
              
              <p><strong>Examples:</strong></p>
              <ul style="margin-left: 20px;">
                <li><code>2</code> is a section</li>
                <li><code>2.1</code>, <code>2.2</code>, <code>2.3</code> are children under section <code>2</code></li>
                <li><code>6</code> is a section</li>
                <li><code>6.1</code>, <code>6.2</code>, <code>6.3</code> are children under section <code>6</code></li>
              </ul>

              <p style="background: rgba(213,67,46,0.1); border-left: 3px solid rgba(213,67,46,0.7); padding: 12px; border-radius: 8px; margin-top: 12px;"><strong>Hard Rule:</strong> The OrderKey must be consistent with ParentLinkID grouping. If a record has ParentLinkID pointing to section <code>2</code>, its OrderKey should start with <code>2.</code></p>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">Flags Rules</h3>
              <p><strong>Supported Flag: After Section Divider</strong></p>
              <ul style="margin-left: 20px;">
                <li>Used to insert a divider line after a section group in navigation</li>
                <li>Typically placed on the <strong>Section Header</strong> record using field 7</li>
                <li>If placed on a child record, UI behavior becomes ambiguous (avoid unless explicitly required)</li>
              </ul>

              <p><strong>Approved flag list:</strong></p>
              <ul style="margin-left: 20px;">
                <li><code>After Section Divider</code></li>
              </ul>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">IconPath Rules (SVG Path Data)</h3>
              <ul style="margin-left: 20px;">
                <li>IconPath is a string containing SVG <code>path d</code> instructions</li>
                <li>Must not contain the record separator ¶</li>
                <li>Must not contain unescaped pipe <code>|</code></li>
              </ul>
            </div>
          </section>

          <section class="card section" id="generation-section">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">⚙️</span>
                <span>Generation Logic</span>
                <span class="section-sub">5-Step Process</span>
              </div>
            </div>

            <div style="padding: 20px; line-height: 1.6;">
              <h3 style="margin-top: 0; margin-bottom: 12px; font-weight: 750;">Step 1: Determine Which Links Are Available</h3>
              <p>Build a list of allowed sections and items based on user permissions.</p>
              <p><strong>Core rule:</strong> If a section has zero allowed children, the section should not appear (unless a product rule says section headers can exist without children).</p>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">Step 2: Build Section Header Records</h3>
              <p>For each allowed section:</p>
              <ul style="margin-left: 20px;">
                <li>Create a LinkID (UUID)</li>
                <li>Assign OrderKey (e.g., <code>3</code>)</li>
                <li>Assign Caption (e.g., <code>Staff Management</code>)</li>
                <li>Subtitle can be empty for sections</li>
                <li>Assign IconPath for the section icon</li>
                <li>ParentLinkID must be empty</li>
                <li>Optional: add Flags (e.g., <code>After Section Divider</code>)</li>
              </ul>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">Step 3: Build Child Link Item Records</h3>
              <p>For each allowed child:</p>
              <ul style="margin-left: 20px;">
                <li>Create a LinkID (UUID)</li>
                <li>Assign OrderKey (e.g., <code>3.1</code>)</li>
                <li>Assign Caption (menu label)</li>
                <li>Subtitle (expanded label, often same as caption)</li>
                <li>IconPath for the item icon</li>
                <li>ParentLinkID must equal the LinkID of the parent section</li>
                <li>Optional: flags only if explicitly required</li>
              </ul>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">Step 4: Sort Records</h3>
              <p>Sort order is based on OrderKey.</p>
              <p><strong>Recommended approach:</strong></p>
              <ul style="margin-left: 20px;">
                <li>Sort sections by numeric value of OrderKey</li>
                <li>Sort children under each section by numeric value of the fractional part</li>
                <li>Preserve the final output order exactly as sorted</li>
              </ul>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">Step 5: Join Into One Payload</h3>
              <p>Join each record line with ¶.</p>
              <p><strong>Hard rules:</strong></p>
              <ul style="margin-left: 20px;">
                <li>Every record must end with ¶, including the last record</li>
                <li>Do not add extra spaces around pipes</li>
                <li>Keep empty Subtitle as empty field, not a literal word like <code>null</code></li>
              </ul>
            </div>
          </section>

          <section class="card section" id="validation-section">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">✅</span>
                <span>Validation Rules</span>
                <span class="section-sub">Must Pass Before Exit Script</span>
              </div>
            </div>

            <div style="padding: 20px; line-height: 1.6;">
              <h3 style="margin-top: 0; margin-bottom: 12px; font-weight: 750;">Record-level Validation</h3>
              <p>For each non-empty record line:</p>
              <ul style="margin-left: 20px;">
                <li>Must contain at least 5 pipe-separated fields</li>
                <li>Field 1 (LinkID) must be non-empty</li>
                <li>Field 2 (OrderKey) must be non-empty</li>
                <li>Field 3 (Caption) must be non-empty</li>
                <li>Field 5 (IconPath) must be non-empty</li>
              </ul>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">UUID Shape Validation (Recommended)</h3>
              <p>LinkID and ParentLinkID should be UUIDs.</p>
              <p><strong>Recommended shape:</strong> 36 characters with hyphens: <code>8-4-4-4-12</code></p>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">Parent Validation</h3>
              <p>If ParentLinkID is present, it must match a section LinkID in the same payload.</p>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">OrderKey Consistency</h3>
              <p>If ParentLinkID points to section <code>X</code>, the child OrderKey should start with <code>X.</code></p>
              <p><strong>Example:</strong></p>
              <ul style="margin-left: 20px;">
                <li>Parent is <code>2</code> section</li>
                <li>Child must be <code>2.1</code>, <code>2.2</code>, etc.</li>
              </ul>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">Flag Validation</h3>
              <p>If field 7 exists, it must be one of the approved flags.</p>
            </div>
          </section>

          <section class="card section" id="examples-section">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">📝</span>
                <span>Canonical Examples</span>
                <span class="section-sub">Reference Implementations</span>
              </div>
            </div>

            <div style="padding: 20px; line-height: 1.6;">
              <h3 style="margin-top: 0; margin-bottom: 12px; font-weight: 750;">Example A: One Section With Two Items</h3>
              <p>This example shows the canonical shape. IDs are illustrative.</p>
              <pre style="background: #0f1729; color: #e5e7eb; padding: 16px; border-radius: 12px; overflow-x: auto; font-size: 12px; line-height: 1.6; margin-top: 12px;">7bd28a51-3f49-4f7c-b8c5-13e7c3eae4f8|2|My Stuff||M4 4h5l3 3h8v12H4z¶
...
b9f3d4a7-1e62-4a6c-b8f1-d7c25e93a4c7|2.2|My Leave Requests|My Leave Requests|M14 1v3h-3v-3h-6v3h-3v-3h-2v15h16v-15h-2z|7bd28a51-3f49-4f7c-b8c5-13e7c3eae4f8¶</pre>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">Example B: Section Divider Flag</h3>
              <pre style="background: #0f1729; color: #e5e7eb; padding: 16px; border-radius: 12px; overflow-x: auto; font-size: 12px; line-height: 1.6; margin-top: 12px;">b9f4d2a7-6c3e-4a8f-a1b5-7e9c13d6f2a8|3|Company||M2 5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2h-7v2h3a1 1 0 1 1 0 2H8a1 1 0 1 1 0-2h3v-2H4a2 2 0 0 1-2-2V5zm18 11V5H4v11h16z||After Section Divider¶</pre>
            </div>
          </section>

          <section class="card section" id="implementation-section">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">🔧</span>
                <span>FileMaker Implementation</span>
                <span class="section-sub">Specification & Best Practices</span>
              </div>
            </div>

            <div style="padding: 20px; line-height: 1.6;">
              <h3 style="margin-top: 0; margin-bottom: 12px; font-weight: 750;">Recommended Script Outline</h3>
              <ol style="margin-left: 20px;">
                <li>Set context variables (current user, roles, permissions)</li>
                <li>Query allowed sections and items</li>
                <li>Generate records into <code>$LinkRecords</code></li>
                <li>Validate</li>
                <li>Exit Script with <code>$LinkRecords</code></li>
              </ol>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">Data Source Options</h3>
              
              <p><strong>Option 1: Static configuration (hardcoded in script)</strong></p>
              <ul style="margin-left: 20px;">
                <li>Fast to start</li>
                <li>Harder to maintain across many apps</li>
              </ul>

              <p><strong>Option 2: Configuration tables (recommended)</strong></p>
              <ul style="margin-left: 20px;">
                <li>A <code>Links</code> table that stores all potential links and metadata</li>
                <li>A <code>Permissions</code> table mapping roles to links</li>
                <li>The script queries allowed links</li>
              </ul>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">SQL Contract (If Using ExecuteSQL)</h3>
              <p>The SQL query should return fields in this exact order:</p>
              <ol style="margin-left: 20px;">
                <li>LinkID</li>
                <li>OrderKey</li>
                <li>Caption</li>
              ...
              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">Example SQL Pseudocode</h3>
              <pre style="background: #0f1729; color: #e5e7eb; padding: 16px; border-radius: 12px; overflow-x: auto; font-size: 12px; line-height: 1.6; margin-top: 12px;">Let ( [
  sql =
    "SELECT
       Links.ID,
       Links.OrderKey,
...
result
              ...
              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">Testing Checklist</h3>
              <ol style="margin-left: 20px;">
                <li>Output is not empty for a user with permissions</li>
                <li>Every non-empty record has at least 5 fields</li>
                <li>All LinkIDs are unique</li>
                <li>All ParentLinkIDs match a section LinkID</li>
                <li>Children are grouped under the correct section</li>
                <li>OrderKey sorting results in expected order</li>
                <li>Divider appears only where expected</li>
                <li>No record contains an unescaped <code>|</code> inside IconPath</li>
                <li>Payload ends with ¶</li>
              </ol>
            </div>
          </section>
          ...
          <section class="card section" id="script-section">
            <div class="section-head">
              <div class="section-title">
                ...
                <span class="section-sub">Reference implementation</span>
              </div>
            ...
            <div class="prompt-wrap">
              <textarea class="prompt-box" id="promptBox" readonly spellcheck="false"># Populate Available Links
# 
# Purpose: Generate navigation payload (Link Records) for menus
# Returns: Text blob with pipe-separated fields, paragraph-separated records
#
# Parameters: None (uses session/context variables)
# Output: $LinkRecords - complete navigation payload
#
# ================================================
# Step 1: Initialize and Set Context
# ================================================
#
Set Variable [ $LinkRecords ; Value: "" ]
Set Variable [ $CurrentUserID ; Value: Get ( AccountName ) ]
Set Variable [ $CurrentRoleID ; Value: $$User Role ID ]
#
# Get user permissions
Set Variable [ $PermittedLinkIDs ; Value: 
  Let ( [
    sql = "SELECT LinkID FROM Permissions WHERE RoleID = ?" ;
    result = ExecuteSQL ( sql ; "|" ; "¶" ; $CurrentRoleID )
  ] ;
  result
  )
]
#
# ================================================
# Step 2: Query All Permitted Links
# ================================================
#
Set Variable [ $AllLinks ; Value:
  Let ( [
    sql = 
      "SELECT
         Links.ID,
...
#
# ================================================
# Step 3: Separate Sections and Items
# ================================================
#
Set Variable [ $Sections ; Value: "" ]
Set Variable [ $Items ; Value: "" ]
Set Variable [ $i ; Value: 0 ]
Set Variable [ $Total ; Value: ValueCount ( $AllLinks ) ]
#
Loop [ Flush: Always ]
  Set Variable [ $i ; Value: $i + 1 ]
  Exit Loop If [ $i > $Total ]
  #
  Set Variable [ $Line ; Value: GetValue ( $AllLinks ; $i ) ]
  Set Variable [ $Fields ; Value: Substitute ( $Line ; "|" ; "¶" ) ]
  Set Variable [ $ParentID ; Value: GetValue ( $Fields ; 6 ) ]
  #
  # If ParentID is empty, it's a section
  If [ IsEmpty ( $ParentID ) ]
    Set Variable [ $Sections ; Value: 
      $Sections & 
      If ( not IsEmpty ( $Sections ) ; "¶" ) &
      $Line
    ]
  Else
    Set Variable [ $Items ; Value:
...
#
# ================================================
# Step 4: Build Final Payload (Sections + Items)
# ================================================
#
# Process sections
Set Variable [ $i ; Value: 0 ]
Set Variable [ $SectionCount ; Value: ValueCount ( $Sections ) ]
#
Loop [ Flush: Always ]
  Set Variable [ $i ; Value: $i + 1 ]
  Exit Loop If [ $i > $SectionCount ]
  #
  Set Variable [ $SectionLine ; Value: GetValue ( $Sections ; $i ) ]
  Set Variable [ $SectionFields ; Value: Substitute ( $SectionLine ; "|" ; "¶" ) ]
  Set Variable [ $SectionID ; Value: GetValue ( $SectionFields ; 1 ) ]
  #
  # Add section to output
  Set Variable [ $LinkRecords ; Value:
    $LinkRecords &
    If ( not IsEmpty ( $LinkRecords ) ; "¶" ) &
    $SectionLine & "¶"
  ]
  #
  # Add child items for this section
  Set Variable [ $j ; Value: 0 ]
  Set Variable [ $ItemCount ; Value: ValueCount ( $Items ) ]
  #
  Loop [ Flush: Always ]
    Set Variable [ $j ; Value: $j + 1 ]
    Exit Loop If [ $j > $ItemCount ]
    #
    Set Variable [ $ItemLine ; Value: GetValue ( $Items ; $j ) ]
    Set Variable [ $ItemFields ; Value: Substitute ( $ItemLine ; "|" ; "¶" ) ]
    Set Variable [ $ItemParentID ; Value: GetValue ( $ItemFields ; 6 ) ]
    #
    # If this item belongs to current section
    If [ $ItemParentID = $SectionID ]
      Set Variable [ $LinkRecords ; Value:
        $LinkRecords &
        $ItemLine & "¶"
      ]
...
# ================================================
#
# Validation: Check that output is not empty
If [ IsEmpty ( $LinkRecords ) ]
  Show Custom Dialog [ "Error" ; "No links available for current user" ]
  Exit Script [ Text Result: "" ]
End If
#
# Validation: Check record structure (at least 5 fields per line)
Set Variable [ $i ; Value: 0 ]
Set Variable [ $ValidatedRecords ; Value: ValueCount ( $LinkRecords ) ]
#
Loop [ Flush: Always ]
  Set Variable [ $i ; Value: $i + 1 ]
  Exit Loop If [ $i > $ValidatedRecords ]
  #
  Set Variable [ $Line ; Value: GetValue ( $LinkRecords ; $i ) ]
  #
  # Skip empty lines
  If [ not IsEmpty ( $Line ) ]
    Set Variable [ $FieldCount ; Value: 
      ValueCount ( Substitute ( $Line ; "|" ; "¶" ) )
    ]
    #
    # Each record must have at least 5 fields
    If [ $FieldCount < 5 ]
      Show Custom Dialog [ "Validation Error" ; 
        "Invalid record format at line " & $i & ": " & $Line 
      ]
      Exit Script [ Text Result: "" ]
    End If
  End If
...
#
# ================================================
# Step 6: Return Link Records
# ================================================
#
Exit Script [ Text Result: $LinkRecords ]</textarea>
            </div>
          </section>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">Populate Available Links</div>
          <div class="rail-actions">
            <a class="rail-btn" href="#">Home</a>
            <a class="rail-btn" href="#overview-section">Overview</a>
            <a class="rail-btn" href="#contract-section">Contract</a>
        ...
        <div class="rail-body">
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Navigation payload generator</div>
            </div>
            <div class="stack">
              <div class="stack-item">Generates Link Records for all navigation menus</div>
              <div class="stack-item">Outputs pipe-separated, paragraph-delimited text</div>
              <div class="stack-item">Permission-based filtering by user role</div>
              <div class="stack-item">Supports hierarchical menu structure</div>
              <div class="stack-item">Used by sidebar, hamburger, tiles, quick links</div>
              <div class="stack-item">Critical: Maintains stable delimiter contract</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Field Structure (7 fields)</div>
              <div class="panel-sub">Required and optional fields</div>
            </div>
            <div class="stack">
              <div class="stack-item">1. LinkID - Unique identifier (UUID)</div>
              <div class="stack-item">2. OrderKey - Sort/hierarchy (e.g., 3, 3.1)</div>
              <div class="stack-item">3. Caption - Display title</div>
              <div class="stack-item">4. Subtitle - Secondary label</div>
              <div class="stack-item">5. IconPath - SVG path data</div>
              <div class="stack-item">6. ParentLinkID - Section parent (optional)</div>
              <div class="stack-item">7. Flags - UI directives (optional)</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Delimiter Contract</div>
              <div class="panel-sub">Critical separators</div>
            </div>
            <div class="stack">
              <div class="stack-item">Field separator: Pipe (|)</div>
              <div class="stack-item">Record separator: Paragraph (¶)</div>
              <div class="stack-item">Records end with ¶</div>
              <div class="stack-item">Empty lines ignored by parsers</div>
              <div class="stack-item">No spaces around pipes</div>
              <div class="stack-item">Empty fields remain empty (not "null")</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Record Types</div>
              <div class="panel-sub">Section vs Item</div>
            </div>
            <div class="stack">
              <div class="stack-item">Section Header: ParentLinkID is empty</div>
              <div class="stack-item">Link Item: ParentLinkID points to section</div>
              <div class="stack-item">OrderKey must match parent hierarchy</div>
              <div class="stack-item">Sections can have "After Section Divider" flag</div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Pre-exit checks</div>
            </div>
            <div class="stack">
              <div class="stack-item">✓ Output not empty for permitted users</div>
              <div class="stack-item">✓ All records have 5+ fields</div>
              <div class="stack-item">✓ LinkIDs are unique</div>
              <div class="stack-item">✓ ParentLinkIDs match existing sections</div>
              <div class="stack-item">✓ OrderKey consistent with hierarchy</div>
              <div class="stack-item">✓ No unescaped pipes in IconPath</div>
              <div class="stack-item">✓ Payload ends with ¶</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Common Mistakes</div>
              <div class="panel-sub">What to avoid</div>
            </div>
            <div class="stack">
              <div class="stack-item">❌ Inconsistent OrderKey vs ParentLinkID</div>
              <div class="stack-item">❌ Malformed or missing UUIDs</div>
              <div class="stack-item">❌ Pipes inside IconPath</div>
              <div class="stack-item">❌ Changing delimiter contract</div>
              <div class="stack-item">❌ Adding/removing fields</div>
              <div class="stack-item">❌ Extra spaces around separators</div>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              <span class="pill2">LINK RECORDS</span>
              <span class="pill2">NAVIGATION</span>
              <span class="pill2">PERMISSIONS</span>
              <span class="pill2">HIERARCHY</span>
              <span class="pill2">ORDERKEY</span>
              <span class="pill2">UUID</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="side-grid">
              <a class="side-pill" href="#">Menu Rendering</a>
              <a class="side-pill" href="#">Permissions System</a>
              <a class="side-pill" href="#">WebViewer Navigation</a>
              <a class="side-pill" href="#">Generate List Script</a>
            </div>
          </div>
        </div>
