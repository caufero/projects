...
<head>
  ...
  <title>Implement Report Generation Prompt</title>
</head>
<body>
        ...
        <div class="content-inner">
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Implement Report Generation Prompt</div>
                <div class="hero-sub">Complete workflow for implementing FileMaker report generation with CauferoAppStarter. 5-step process: upload docs, update available links, implement report logic, create filter page, design printable HTML report with ChatGPT. Structured, sequential, production-ready.</div>
              </div>
              ...
              <div class="hero-meta">
                ...
                <span class="chip amber">Workflow</span>
                <span class="chip copper">Report Generation</span>
              </div>
            </div>
          </section>
          ...
          <section class="card section" id="prompt-section">
            <div class="section-head">
              <div class="section-title">
                ...
                <span>Prompt</span>
                <span class="section-sub">5-step implementation workflow.</span>
              </div>
            ...
            <div class="prompt-wrap">
              <textarea class="prompt-box" id="promptBox" readonly spellcheck="false"># Implement Report Generation
...
1) Then implement [_Report](_Report.md)
1) Then implement [+++ Report Filter Page](<+++ Report Filter Page.md>)
1) Design the printable report in FileMaker.
    - Feed this [HTML code of a sample report](<Sample Report Page.html>) to ChatGPT with the following instructions:

    ```
    Below is an html code for a report. It looks good and works nicely. I want you to update the code so the report displays the following:
    ...
    ```</textarea>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">Report Implementation Workflow</div>
        ...
        <div class="rail-body">
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">5-step structured implementation process</div>
            </div>
            <div class="stack">
              <div class="stack-item">Sequential workflow for implementing report generation in FileMaker</div>
              <div class="stack-item">Starts with uploading 3 required documentation files</div>
              <div class="stack-item">Updates available links for navigation consistency</div>
              <div class="stack-item">Implements core report logic and filter page</div>
              <div class="stack-item">Generates printable HTML report using ChatGPT with sample template</div>
              <div class="stack-item">Production-ready, follows CauferoAppStarter patterns</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Workflow Steps (5 total)</div>
            ...
            <div class="stack">
              ...
              <div class="stack-item">Step 3: Implement _Report</div>
              <div class="stack-item">Step 4: Implement +++ Report Filter Page</div>
              <div class="stack-item">Step 5: Design printable report (feed HTML to ChatGPT)</div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Implementation Files (Steps 2-4)</div>
              <div class="panel-sub">3 components to implement</div>
            </div>
            <div class="stack">
              <div class="stack-item">Update Populate Available Links - Navigation system</div>
              <div class="stack-item">_Report - Core report logic and data handling</div>
              <div class="stack-item">+++ Report Filter Page - User filter interface</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">HTML Report Design (Step 5)</div>
              <div class="panel-sub">ChatGPT template update process</div>
            </div>
            <div class="stack">
              <div class="stack-item">Input: Sample Report Page.html template</div>
              <div class="stack-item">Add: Your report description in [REPORT DESCRIPTION]</div>
              <div class="stack-item">Paste: Full HTML code after separator</div>
              <div class="stack-item">ChatGPT generates updated report HTML</div>
              <div class="stack-item">Output: Customized printable report for FileMaker</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">ChatGPT Prompt Template</div>
              <div class="panel-sub">For Step 5 HTML generation</div>
            </div>
            <div class="stack">
              <div class="stack-item">"Below is an html code for a report. It looks good and works nicely."</div>
              <div class="stack-item">"I want you to update the code so the report displays the following:"</div>
              <div class="stack-item">[Insert your report description here]</div>
              <div class="stack-item">"---"</div>
              <div class="stack-item">[Paste HTML code from Sample Report Page.html]</div>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              <span class="pill2">SEQUENTIAL WORKFLOW</span>
              <span class="pill2">REQUIRED DOCS</span>
              <span class="pill2">NAVIGATION UPDATE</span>
              <span class="pill2">FILTER PAGE</span>
              <span class="pill2">HTML TEMPLATE</span>
              <span class="pill2">CHATGPT GENERATION</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              ...
              <div class="stack-item">Step 2 must complete before Steps 3-4 (navigation foundation)</div>
              <div class="stack-item">Steps 3-4 can run in parallel or sequence</div>
              <div class="stack-item">Step 5 requires completion of Steps 3-4 (report logic ready)</div>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="side-grid">
              <a class="side-pill" href="#">Generate Report Script</a>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              ...
              <div class="stack-item">4. Paste the prompt and execute each step sequentially</div>
              <div class="stack-item">5. For Step 5, prepare your report description and Sample Report Page.html</div>
              <div class="stack-item">6. Feed the ChatGPT template with your HTML to generate the report</div>
              <div class="stack-item">7. Integrate all components into FileMaker</div>
            </div>
          </div>
        </div>
