...
<head>
  ...
  <title>App Section Router Script Documentation</title>
</head>
<body>
        ...
        <div class="content-inner">
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Go To App Section Script Documentation</div>
                <div class="hero-sub">Centralized navigation router for CauferoAppStarter. Returns users to the correct internal WebViewer app page after visiting external websites. Uses $$App Section global variable to restore internal app state. Supports list pages (no parameter) and details pages (with record ID parameter). Replaces WebViewer browser history with controlled routing.</div>
              </div>
          ...
          <section class="card section" id="doc-section">
            <div class="section-head">
              <div class="section-title">
                ...
                <span class="section-sub">App Section Router (Return To Previous App Page)</span>
              </div>
            ...
            <div class="prompt-wrap">
              <textarea class="prompt-box" id="promptBox" readonly spellcheck="false"># Script Documentation: App Section Router (Return To Previous App Page)
...
It is effectively the app's internal routing table.</textarea>
            </div>
          </section>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">Go To App Section</div>
        ...
        <div class="rail-body">
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Navigation router for WebViewer apps</div>
            </div>
            <div class="stack">
              <div class="stack-item">Centralized router for returning to internal app pages</div>
              <div class="stack-item">Solves WebViewer navigation after visiting external websites</div>
              <div class="stack-item">Uses $$App Section global to determine target page</div>
              <div class="stack-item">Restores exact record context for details pages</div>
              <div class="stack-item">Replaces unreliable browser history with controlled routing</div>
              <div class="stack-item">Standard pattern in all CauferoAppStarter apps</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Key Global Variables</div>
              <div class="panel-sub">Router state management</div>
            </div>
            <div class="stack">
              <div class="stack-item">$$App Section - Primary routing variable (last internal page key)</div>
              <div class="stack-item">$$Patient ID - Details page record context example</div>
              <div class="stack-item">$$Appointment ID - Another entity record ID</div>
              <div class="stack-item">$$App Name - Special case routing (e.g., "The Bridge")</div>
              <div class="stack-item">All record ID globals follow pattern: $$&lt;Entity&gt; ID</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Routing Types (2 patterns)</div>
              <div class="panel-sub">List vs Details pages</div>
            </div>
            <div class="stack">
              <div class="stack-item">List Pages: No parameter required (e.g., "Patients List")</div>
              <div class="stack-item">Details Pages: Require record ID parameter (e.g., $$Patient ID)</div>
              <div class="stack-item">All routes use "+++ &lt;Page Name&gt; Page" script naming</div>
              <div class="stack-item">Portal variants: "(Doctor's Portal) InPatient Details"</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Typical Usage Flow</div>
              <div class="panel-sub">8-step navigation scenario</div>
            </div>
            <div class="stack">
              <div class="stack-item">1. User is on internal page (e.g., "Patient Details")</div>
              <div class="stack-item">2. App sets $$App Section and $$Patient ID</div>
              <div class="stack-item">3. User clicks button to open external website</div>
              <div class="stack-item">4. WebViewer loads external URL</div>
              <div class="stack-item">5. User clicks Back/Return button</div>
              <div class="stack-item">6. Router detects $$App Section value</div>
              <div class="stack-item">7. Router runs "+++ Patient Details Page" with $$Patient ID</div>
              <div class="stack-item">8. Internal WebViewer UI restored to exact state</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Routing Patterns (5 types)</div>
              <div class="panel-sub">If/Else If branch structures</div>
            </div>
            <div class="stack">
              <div class="stack-item">Pattern A: Dashboard (runs "Go to Dashboard")</div>
              <div class="stack-item">Pattern B: List Page (no parameter)</div>
              <div class="stack-item">Pattern C: Details Page (with $$Entity ID)</div>
              <div class="stack-item">Pattern D: Portal Variants (role-based UI)</div>
              <div class="stack-item">Pattern E: App Name Conditional (multi-app support)</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Required Preconditions</div>
              <div class="panel-sub">Before calling router</div>
            </div>
            <div class="stack">
              <div class="stack-item">$$App Section must be set to current page key</div>
              <div class="stack-item">Record ID globals must be set for details pages</div>
              <div class="stack-item">Page key strings must match exactly (case-sensitive)</div>
              <div class="stack-item">Empty $$Entity ID on details page may cause errors</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Adding New Pages</div>
              <div class="panel-sub">Maintenance pattern</div>
            </div>
            <div class="stack">
              <div class="stack-item">1. Choose canonical page key for $$App Section</div>
              <div class="stack-item">2. Create "+++ &lt;Page Name&gt; Page" script</div>
              <div class="stack-item">3. Add new Else If branch to router</div>
              <div class="stack-item">4. For details pages: create $$&lt;Entity&gt; ID global</div>
              <div class="stack-item">5. Pass ID as parameter in Perform Script</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">AI Agent Behaviors</div>
              <div class="panel-sub">How AI should understand this</div>
            </div>
            <div class="stack">
              <div class="stack-item">This is a navigation router, not a page renderer</div>
              <div class="stack-item">$$App Section is single source of truth for routing</div>
              <div class="stack-item">Do not infer WebViewer browser history usage</div>
              <div class="stack-item">"+++ Page" scripts are UI rendering delegates</div>
              <div class="stack-item">Router performs state restoration via globals</div>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              <span class="pill2">NAVIGATION ROUTER</span>
              <span class="pill2">$$APP SECTION</span>
              <span class="pill2">WEBVIEWER STATE</span>
              <span class="pill2">CONTROLLED ROUTING</span>
              <span class="pill2">PAGE SCRIPTS</span>
              <span class="pill2">RECORD CONTEXT</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="side-grid">
              ...
              <a class="side-pill" href="#">Global Variables Guide</a>
            </div>
          </div>
        </div>
