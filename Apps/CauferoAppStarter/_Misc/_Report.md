...
<head>
  ...
  <title>Generate FileMaker Report Script Prompt</title>
</head>
<body>
        ...
        <div class="content-inner">
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Generate FileMaker Report Script Prompt</div>
                <div class="hero-sub">Study a sample FileMaker report script and generate a new one for your specific report. AI updates all key variables: SQL query with WHERE 1=1, data types, column headers, widths, number columns, summary totals, report title, and back button config. Production-ready FileMaker script with proper parameter passing to display script.</div>
              </div>
              ...
              <div class="hero-meta">
                ...
                <span class="chip amber">Report Generation</span>
                <span class="chip copper">Script Template</span>
              </div>
            </div>
          </section>
          ...
          <section class="card section" id="prompt-section">
            <div class="section-head">
              <div class="section-title">
                ...
                <span>Prompt</span>
                <span class="section-sub">Report description in, FileMaker script out.</span>
              </div>
            ...
            <div class="prompt-wrap">
              <textarea class="prompt-box" id="promptBox" readonly spellcheck="false"># Sample Script for: +++ Report

I want you to study the Filemaker script below. It's a sample FileMaker script that was written receive some parameters from a filter page and prepare some parameters of its own to feed to another FileMaker script to generate a report.
I want you to update this script for the following report:

  - A ______ report that displays ___________

**Note:**
- The main variables whose contents are to be edited are:
  - $SQL
    - When you generate the full query but replace the where condition with Where 1=1.
    - This should be generated with the full FileMaker script in a markdown
    - Then in a separate markdown, display the where condition (what the where condition was supposed to be). The conditions should include one date period condition where a period of records can be filtered
  - $$Data Types
...
Set Variable [ $Parameters ; Value: Substitute ( Get ( ScriptParameter ) ; "|PreviewDetails: " ; "¶" ) ; Repetition: 1 ]
Set Variable [ $Condition ; Value: GetValue ( $Parameters ; 1 ) ; Repetition: 1 ]
Set Variable [ $$Preview Details ; Value: GetValue ( $Parameters ; 2 ) ; Repetition: 1 ]
#
Set Variable [ $SQL ; Value: "SELECT t1.\"Date Scheduled\", t1.\"Time Scheduled\",t2.\"Number\" AS \"Patient Number\",t2.\"Title\"||' '||t2.\"First Name\"||' '||t2.\"Last Name\" AS \"Patient Name\",t1.Reason, SUM(t3.Cost), SUM(\"Paid Amount\") AS \"Amount Paid\"

FROM \"Patient Appointments\" t1
LEFT JOIN Patients t2 ON t1.\"Patient ID\" = t2.ID
LEFT JOIN \"Patient Visit Bill Items\" t3 ON t1.\"ID\" = t3.\"Patient Appointment ID\"
LEFT JOIN \"Patient Payment Options\" t4 ON t1.\"Bill Payment Option ID\" = t4.\"ID\"

Where 1=1

GROUP BY t1.\"Date Scheduled\", t1.\"Time Scheduled\", t2.\"Number\", t2.\"Title\", t2.\"First Name\", t2.\"Last Name\", t1.Reason

ORDER BY t1.\"Date Scheduled\", t1.\"Time Scheduled\"" ; Repetition: 1 ]
Set Variable [ $$Data Types ; Value: "Date,Time,Text,Text,Text,Number,Number" ; Repetition: 1 ]
Set Variable [ $Column Headers ; Value: "Date,Time,Patient #,Patient Name,Visit Reason,Bill Amt (" & $$Preferred Currency & "),Paid Amt (" & $$Preferred Currency & ")" ; Repetition: 1 ]
Set Variable [ $Column Widths ; Value: "12,10,10,30,12,11,15" ; Repetition: 1 ]
Set Variable [ $Columns That Are Numbers ; Value: "6,7" ; Repetition: 1 ]
Set Variable [ $Summary Total Label ; Value: "Total Paid" ; Repetition: 1 ]
Set Variable [ $Summary Total Column ; Value: 7 ; Repetition: 1 ]
Set Variable [ $Report Title ; Value: "Patient Billing Report" ; Repetition: 1 ]
Set Variable [ $Back Button Label ; Value: "Back To Filter" ; Repetition: 1 ]
Set Variable [ $Back Button Script ; Value: "+++ Accountant Report Filter" ; Repetition: 1 ]
#
Perform Script [ "+++ Display Report HTML" ; Parameter: 
  $SQL & ¶ & 
  ...
  $Back Button Script
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">Report Script Generator</div>
        ...
        <div class="rail-body">
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Generate FileMaker report scripts from sample</div>
            </div>
            <div class="stack">
              <div class="stack-item">Paste this prompt and describe your report requirements</div>
              <div class="stack-item">AI studies the sample script structure and parameter pattern</div>
              <div class="stack-item">Generates complete FileMaker script with all variables updated</div>
              <div class="stack-item">SQL query uses WHERE 1=1 pattern for filter flexibility</div>
              <div class="stack-item">Separate markdown shows actual WHERE condition with date filtering</div>
              <div class="stack-item">Ready to paste into FileMaker Script Workspace</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Key Variables (10 total)</div>
              <div class="panel-sub">Variables AI will update</div>
            </div>
            <div class="stack">
              <div class="stack-item">1. $SQL - Full query with WHERE 1=1 placeholder</div>
              <div class="stack-item">2. $$Data Types - Column data types (text, number, date, time)</div>
              <div class="stack-item">3. $Column Headers - Comma-separated header labels</div>
              <div class="stack-item">4. $Column Widths - Percentages for column widths</div>
              <div class="stack-item">5. $Columns That Are Numbers - Positions of numeric columns</div>
              <div class="stack-item">6. $Summary Total Label - Label for summary total row</div>
              <div class="stack-item">7. $Summary Total Column - Column position for grouping</div>
              <div class="stack-item">8. $Report Title - Display title for report</div>
              <div class="stack-item">9. $Back Button Label - Back button text</div>
              <div class="stack-item">10. $Back Button Script - Script name to call on back</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Available Data Types</div>
              <div class="panel-sub">For $$Data Types variable</div>
            </div>
            <div class="pill-row">
              <span class="pill2">text</span>
              <span class="pill2">number</span>
              <span class="pill2">date</span>
              <span class="pill2">time</span>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Sample Report Structure</div>
              <div class="panel-sub">Patient Billing Report example</div>
            </div>
            <div class="stack">
              <div class="stack-item">Columns: Date, Time, Patient #, Patient Name, Visit Reason, Bill Amt, Paid Amt</div>
              <div class="stack-item">Data Types: Date, Time, Text, Text, Text, Number, Number</div>
              <div class="stack-item">Width Distribution: 12%, 10%, 10%, 30%, 12%, 11%, 15%</div>
              <div class="stack-item">Number Columns: Positions 6 and 7 (amounts)</div>
              <div class="stack-item">Summary: Total Paid (column 7)</div>
              <div class="stack-item">Joins: Patients, Bill Items, Payment Options</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">SQL Pattern Notes</div>
              <div class="panel-sub">Query structure requirements</div>
            </div>
            <div class="stack">
              <div class="stack-item">Use WHERE 1=1 as placeholder in main script</div>
              <div class="stack-item">AI outputs actual WHERE condition separately in markdown</div>
              <div class="stack-item">Condition should include date period filtering capability</div>
              <div class="stack-item">GROUP BY all non-aggregate SELECT fields</div>
              <div class="stack-item">ORDER BY defines sort order for report display</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Parameter Passing</div>
              <div class="panel-sub">How script passes data to display script</div>
            </div>
            <div class="stack">
              <div class="stack-item">Receives: Filter conditions and preview toggle</div>
              <div class="stack-item">Sends: 10 parameters separated by ¶ (pilcrow)</div>
              <div class="stack-item">Target: "+++ Display Report HTML" script</div>
              <div class="stack-item">Condition substitution: | converts to " and "</div>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              ...
              <span class="pill2">DATA TYPES</span>
              <span class="pill2">COLUMN WIDTHS</span>
              <span class="pill2">SUMMARY TOTAL</span>
              <span class="pill2">PARAMETER PASSING</span>
              <span class="pill2">DATE FILTERING</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="side-grid">
              <a class="side-pill" href="#">Update ExecuteSQL Query</a>
              <a class="side-pill" href="#">Build Totally New Page</a>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              ...
              <div class="stack-item">2. Fill in the blank: "A ______ report that displays ___________"</div>
              <div class="stack-item">3. Paste into your AI agent</div>
              <div class="stack-item">4. AI generates complete FileMaker script with all 10 variables updated</div>
              <div class="stack-item">5. Review the SQL query (main script shows WHERE 1=1)</div>
              <div class="stack-item">6. Check separate markdown for actual WHERE condition with date filtering</div>
              <div class="stack-item">7. Copy and paste into FileMaker Script Workspace</div>
            </div>
          </div>
        </div>
