...
<head>
  ...
  <title>Implement Entity Management Page Prompt</title>
</head>
<body>
        ...
        <div class="content-inner">
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Implement Entity Management Page Prompt</div>
                <div class="hero-sub">Complete workflow for implementing CRUD entity management pages in FileMaker with CauferoAppStarter. 6-step process: upload docs, update links, optional filter page (500+ records), list page, details page, optional related item modals. Structured, sequential, production-ready entity management.</div>
              </div>
              ...
              <div class="hero-meta">
                ...
                <span class="chip amber">Entity Management</span>
                <span class="chip copper">CRUD Pages</span>
              </div>
            </div>
          </section>
          ...
          <section class="card section" id="prompt-section">
            <div class="section-head">
              <div class="section-title">
                ...
                <span>Prompt</span>
                <span class="section-sub">6-step entity management workflow.</span>
              </div>
            ...
            <div class="prompt-wrap">
              <textarea class="prompt-box" id="promptBox" readonly spellcheck="false"># Implement Entity Management Page

1) Upload these documents first: [Build Apps With CauferoAppStarter](<Build Apps With CauferoAppStarter.md>), [AI Agent Playbook](<AI Agent Playbook.md>) and [My Playbook](<My Playbook.md>)
1) Then implement [Update Populate Available Links](<../../../_Misc/_/AI Prompts/Update Populate Available Links.md>)
1) Then implement [+++Entity Filter Page](<_Misc/_Entity Filter Page.md>) (if the list on the page is very likely to become more than 500 records in the future)
1) Then implement [+++Entity List Page](<_Misc/+++Entity List Page.md>)
1) Then implement [+++Entity Details Page](<_Misc/+++Entity Details Page.md>)
1) If necessary, implement [+++Entity Related Item Modal Page](<_Misc/+++Entity Related Item Modal Page.md>) for any modals that will be needed to view details of related records of the entity</textarea>
            </div>
          </section>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">Entity Management Workflow</div>
        ...
        <div class="rail-body">
          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">About this workflow</div>
              <div class="panel-sub">6-step CRUD implementation process</div>
            </div>
            <div class="stack">
              <div class="stack-item">Complete entity management system for FileMaker applications</div>
              <div class="stack-item">Implements full CRUD operations: Create, Read, Update, Delete</div>
              <div class="stack-item">Optional filter page for high-volume entities (500+ records)</div>
              <div class="stack-item">Core components: List page, Details page, Related item modals</div>
              <div class="stack-item">Follows CauferoAppStarter architecture patterns</div>
              <div class="stack-item">Production-ready entity management with consistent navigation</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Workflow Steps (6 total)</div>
              <div class="panel-sub">Execute in order</div>
            </div>
            <div class="stack">
              <div class="stack-item">Step 1: Upload 3 docs (Build Apps, AI Agent Playbook, My Playbook)</div>
              <div class="stack-item">Step 2: Implement Update Populate Available Links</div>
              <div class="stack-item">Step 3: Implement Entity Filter Page (conditional: 500+ records expected)</div>
              <div class="stack-item">Step 4: Implement Entity List Page</div>
              <div class="stack-item">Step 5: Implement Entity Details Page</div>
              <div class="stack-item">Step 6: Implement Entity Related Item Modal Page (if needed)</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Required Documents (Step 1)</div>
              <div class="panel-sub">3 docs to upload first</div>
            </div>
            <div class="stack">
              <div class="stack-item">1. Build Apps With CauferoAppStarter.md</div>
              <div class="stack-item">2. AI Agent Playbook.md</div>
              <div class="stack-item">3. My Playbook.md</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Core Components (Steps 2-5)</div>
              <div class="panel-sub">Main implementation pages</div>
            </div>
            <div class="stack">
              <div class="stack-item">Update Populate Available Links - Navigation system update</div>
              <div class="stack-item">Entity Filter Page - Search/filter interface (optional, for 500+ records)</div>
              <div class="stack-item">Entity List Page - Browse all entities with actions</div>
              <div class="stack-item">Entity Details Page - View/Edit single entity record</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Conditional Steps</div>
              <div class="panel-sub">When to implement optional components</div>
            </div>
            <div class="stack">
              <div class="stack-item">Filter Page: Implement if entity will have 500+ records</div>
              <div class="stack-item">Helps users find specific records in large datasets</div>
              <div class="stack-item">Related Item Modals: Implement when entity has related records</div>
              <div class="stack-item">Allows viewing related entity details without navigation</div>
              <div class="stack-item">Example: View Patient details from Appointment list</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Page Functions</div>
              <div class="panel-sub">What each page does</div>
            </div>
            <div class="stack">
              <div class="stack-item">Filter Page: Advanced search with date ranges, status, keywords</div>
              <div class="stack-item">List Page: Display all entities, Create new, Edit, Delete, Navigate</div>
              <div class="stack-item">Details Page: Full CRUD for single entity record</div>
              <div class="stack-item">Related Modals: Quick view of related entity data</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Entity Examples</div>
              <div class="panel-sub">Typical entities in FileMaker apps</div>
            </div>
            <div class="pill-row">
              <span class="pill2">PATIENTS</span>
              <span class="pill2">STAFF</span>
              <span class="pill2">DEPARTMENTS</span>
              <span class="pill2">APPOINTMENTS</span>
              <span class="pill2">INVOICES</span>
              <span class="pill2">PRODUCTS</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              <span class="pill2">CRUD OPERATIONS</span>
              <span class="pill2">ENTITY MANAGEMENT</span>
              <span class="pill2">FILTER PAGE</span>
              <span class="pill2">LIST VIEW</span>
              <span class="pill2">DETAILS VIEW</span>
              <span class="pill2">RELATED MODALS</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">What each step requires</div>
            </div>
            <div class="stack">
              <div class="stack-item">Step 1 must complete before Step 2 (docs provide context)</div>
              <div class="stack-item">Step 2 must complete before Steps 3-5 (navigation foundation)</div>
              <div class="stack-item">Steps 3-5 can run in sequence or parallel</div>
              <div class="stack-item">Step 6 requires Step 5 complete (details page links to modals)</div>
              <div class="stack-item">Filter → List → Details is typical user flow</div>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="side-grid">
              <a class="side-pill" href="#">Implement Report Generation</a>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              ...
              <div class="stack-item">2. Gather the 3 required documentation files</div>
              <div class="stack-item">3. Upload all 3 docs to your AI assistant</div>
              <div class="stack-item">4. Decide if you need Filter Page (500+ records?) and Related Modals</div>
              <div class="stack-item">5. Paste the prompt and execute each step sequentially</div>
              <div class="stack-item">6. Test the complete CRUD flow: Create → List → View → Edit → Delete</div>
              <div class="stack-item">7. Integrate all components into FileMaker solution</div>
            </div>
          </div>
        </div>
