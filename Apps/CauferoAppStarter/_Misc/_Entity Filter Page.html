...
<head>
  ...
  <title>Build List Filter Page</title>
</head>
<body>
            ...
            <div class="nav-group-body">
              ...
              <div class="nav-subgroup open" data-label="AI Prompts Development">
                ...
                <div class="nav-subgroup-body">
                  ...
                  <a class="nav-item sub active" href="https://caufero.github.io/projects/Apps/CauferoAppStarter/_Misc/_Entity%20Filter%20Page.md" data-label="AI Prompts Development Build List Filter Page"><span class="dot"></span><span class="nav-text">Build List Filter Page</span></a>
        ...
        <div class="content-inner">
          ...
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Build List Filter Page</div>
                <div class="hero-sub">The reference FileMaker script is displayed below. Pick your option, edit the placeholder, copy the prompt, then copy the FM script separately and provide both to your AI along with the Get Value List docs.</div>
              </div>
              ...
              <div class="hero-meta">
                ...
                <span class="chip violet">Filter Page</span>
          ...
          <section class="card section" id="prompt-section">
            ...
            <div class="opt-toggle">
              <button class="opt-btn active" id="btnOpt1" type="button" onclick="setOption(1)">
                ...
                <div class="opt-text">
                  <div class="opt-label">Named List</div>
                  <div class="opt-sub">You know the list page name</div>
                </div>
              </button>
            ...
            <div class="opt-desc-strip" id="optDescStrip">
              ...
              <span><strong>Option 1 — Named List:</strong> Replace <code>[LIST_PAGE_NAME]</code> with the name of your target list page (e.g., <code>Patient Appointments</code>).</span>
            </div>
          ...
          <section class="card section" id="fm-script-section">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">📄</span>
                <span>Reference FileMaker Script</span>
            ...
            <div class="fm-script-wrap">
              <textarea class="fm-script-box" id="fmScriptBox" readonly spellcheck="false">Set Variable [ $$App Section ; Value: "Projects" ]
Set Variable [ $Generate Report Script ; Value: "+++ Projects List Page" ]
#
# ******************************************
# ******************************************
# GENERATE PAGE (START)
...
#
# CSS
Perform Script [ Specified: From list ; "🖌️ Use Details CSS" ; Parameter:  ]
Set Variable [ $styles ; Value: Get ( ScriptResult ) ]
#
#
# ----------------------------
# Value Lists (CauferoAppStarter)
# Follow pattern used elsewhere: Perform Script "Get Value List"
# ----------------------------
#
#
Perform Script [ Specified: From list ; "Get Value List" ; Parameter: "Dropdown|Project Status" ]
Set Variable [ $Status Dropdown HTML ; Value: Get ( ScriptResult ) ]
#
Perform Script [ Specified: From list ; "Get Value List" ; Parameter: "Dropdown|Project Types" ]
Set Variable [ $Type Dropdown HTML ; Value: Get ( ScriptResult ) ]
#
Perform Script [ Specified: From list ; "Get Value List" ; Parameter: "Dropdown|Project Colour Lines" ]
Set Variable [ $Colour Line Dropdown HTML ; Value: Get ( ScriptResult ) ]
#
Perform Script [ Specified: From list ; "Get Value List" ; Parameter: "Dropdown|Project Responsible" ]
Set Variable [ $Responsible Dropdown HTML ; Value: Get ( ScriptResult ) ]
#
Perform Script [ Specified: From list ; "Get Value List" ; Parameter: "Dropdown|Project Products" ]
Set Variable [ $Product Dropdown HTML ; Value: Get ( ScriptResult ) ]
#
# HTML (Tab1)
Set Variable [ $Tab1 HTML ; Value: 
    "
    <div class='report-filter-page'>
      <div class='report-filter-grid'>
        ...
        <div class='rf-topbar'>
          <div class='rf-titleblock'>
            ...
            <div style='min-width:0;'>
              <h1 class='rf-title'>Projects</h1>
              <div class='rf-subtitle'>Pick your date filter, add optional filters, preview what will be generated, then filter the list.</div>
            </div>
          </div>

          <div class='rf-actions'>
            <button class='rf-chip' data-action='today' type='button' id='chip_today' onclick=\"setQuickDate('today')\">
              <i class='fas fa-bolt'></i> Today
            </button>

            <button class='rf-chip' data-action='yesterday' type='button' id='chip_yesterday' onclick=\"setQuickDate('yesterday')\">
              <i class='fas fa-history'></i> Yesterday
            </button>

            <button class='rf-chip' data-action='this-week' type='button' id='chip_thisweek' onclick=\"setQuickDate('this-week')\">
        ...
        <div class='rf-card'>
          ...
          <div class='rf-card-head'>
            <div>
              <h2>Page Filters</h2>
              <p>Use a single date, or switch to a date range if you want a span.</p>
            </div>

            <div class='rf-badge'>
              <i class='fas fa-shield-alt'></i>
              Clean filters, clean list
            </div>
          </div>
          ...
          <div class='rf-card-body'>
            ...
            <div class='rf-section'>
              <div class='rf-section-title'>
                <h3>Period of Project Creation</h3>
                <div class='hint'>Required</div>
              </div>

              <div class='rf-form-grid rf-date-grid is-single' id='date_grid'>

                <div class='rf-field' id='date_mode_wrap'>
                  <label>Date Mode</label>

                  <div class='rf-segment' id='date_mode'>
                    <button
                      type='button'
                      class='active'
                      data-mode='single'
                      id='btn_date_mode_single'
                    ...
                    <button
                      type='button'
                      data-mode='range'
                      id='btn_date_mode_range'
                      onclick=\"setDateMode('range')\"
                    >Date Range</button>
                  </div>
                </div>

                <div class='rf-field' id='date_single_wrap'>
                  <label for='date_single'>Choose Date</label>
                  <div class='rf-date-wrap'>
                    <input type='text' id='date_single' placeholder='Pick a date' onclick=\"openDatePicker('date_single')\">
                    <i class='fas fa-calendar-alt' id='date_single_icon' onclick=\"openDatePicker('date_single')\"></i>
                  </div>
                </div>

                <div class='rf-field' id='date_from_wrap' style='display:none;'>
                  <label for='date_from'>From</label>
                  <div class='rf-date-wrap'>
                    <input type='text' id='date_from' placeholder='Start date' onclick=\"openDatePicker('date_from')\">
                    <i class='fas fa-calendar-alt' id='date_from_icon' onclick=\"openDatePicker('date_from')\"></i>
                  </div>
                </div>

                <div class='rf-field' id='date_to_wrap' style='display:none;'>
                  <label for='date_to'>To</label>
                  <div class='rf-date-wrap'>
                    <input type='text' id='date_to' placeholder='End date' onclick=\"openDatePicker('date_to')\">
                    <i class='fas fa-calendar-alt' id='date_to_icon' onclick=\"openDatePicker('date_to')\"></i>
                  </div>
                </div>
            ...
            <div class='rf-section'>
              <div class='rf-section-title'>
                ...
                <div class='hint'>Use only if needed</div>
              </div>
              ...
              <div class='rf-form-grid'>
                ...
                <div class='rf-field'>
                  ...
                  <input type='text' id='project_id' placeholder='Example: 1DDC15F0-...' oninput=\"updatePreview(); saveDraft();\">
                </div>

                <div class='rf-field'>
                  <label for='project_code'>Code</label>
                  <input type='text' id='project_code' placeholder='Example: PRJ24002' oninput=\"updatePreview(); saveDraft();\">
                </div>

                <div class='rf-field'>
                  <label for='status'>Status</label>
                  <select id='status' onchange=\"updatePreview(); saveDraft();\">
                ...
                <div class='rf-field'>
                  ...
                  <select id='type' onchange=\"updatePreview(); saveDraft();\">
                    " & $Type Dropdown HTML & "
                  </select>
                </div>

                <div class='rf-field'>
                  <label for='colour_line'>Colour Line</label>
                  <select id='colour_line' onchange=\"updatePreview(); saveDraft();\">
                    " & $Colour Line Dropdown HTML & "
                  </select>
                </div>

                <div class='rf-field'>
                  <label for='responsible'>Responsible</label>
                  <select id='responsible' onchange=\"updatePreview(); saveDraft();\">
                    " & $Responsible Dropdown HTML & "
                  </select>
                </div>

                <div class='rf-field'>
                  <label for='product'>Product</label>
                  <select id='product' onchange=\"updatePreview(); saveDraft();\">
            ...
            <div class='rf-preview'>
              <h4>Preview</h4>
              <div class='rf-kv'>
                <div class='rf-k'>Period</div>
                <div class='rf-v' id='preview_period'>-</div>

                <div class='rf-k'>ID</div>
                <div class='rf-v' id='preview_id'>All</div>

                <div class='rf-k'>Code</div>
                <div class='rf-v' id='preview_code'>All</div>

                <div class='rf-k'>Status</div>
                <div class='rf-v' id='preview_status'>All</div>

                <div class='rf-k'>Type</div>
                <div class='rf-v' id='preview_type'>All</div>

                <div class='rf-k'>Colour Line</div>
                <div class='rf-v' id='preview_colour_line'>All</div>

                <div class='rf-k'>Responsible</div>
                <div class='rf-v' id='preview_responsible'>All</div>

                <div class='rf-k'>Product</div>
                <div class='rf-v' id='preview_product'>All</div>
              </div>
            </div>
          ...
          <div class='rf-footer'>
            <div class='rf-footer-left'>
              <button class='rf-btn-secondary' data-action='clear' type='button' id='btn_clear' onclick=\"clearFilters()\">
                <i class='fas fa-eraser'></i> Clear
              </button>

              <div class='rf-help'>
                Tip: Use Today, Yesterday, or This Week to set dates fast.
              </div>
            </div>

            <button class='rf-btn-primary' data-action='generate' type='button' id='btn_generate' onclick=\"generateReport()\">
              <i class='fas fa-play'></i> Filter List
            </button>
          </div>
    ...
    <div class='rf-toast' id='rf_toast'>
      <i class='fas fa-check-circle'></i>
      <span id='rf_toast_text'>Done.</span>
    </div>
" ]
#
# Full HTML wrapper used by your framework
...
# Javascript
#
Set Variable [ $Filter Helpers Script ; Value: 
"
  /* =========================
     Helpers
  ========================= */

  function rfToast(message) {
    const toast = document.getElementById('rf_toast');
    const text = document.getElementById('rf_toast_text');
    if (!toast || !text) return;

    text.textContent = message || 'Done.';
    toast.classList.add('show');

    window.clearTimeout(window.__rfToastTimer);
    window.__rfToastTimer = window.setTimeout(function () {
      toast.classList.remove('show');
    }, 1600);
  }

  function getMySQLFormattedDateFromReadable(readableDate) {
    if (!readableDate || readableDate === '--') return null;
    const parsedDate = flatpickr.parseDate(readableDate, 'l, j F, Y');
    return parsedDate ? flatpickr.formatDate(parsedDate, 'Y-m-d') : null;
  }

  function setReadableDate(inputEl, dateObj) {
    if (!inputEl) return;
    inputEl.value = flatpickr.formatDate(dateObj, 'l, j F, Y');
  }
...
" ]
Set Variable [ $Filter Date Pickers Script ; Value: 
"
  /* =========================
     Date pickers
  ========================= */
  ...
  function initFlatpickr(fieldId, iconId) {
  ...
  function openDatePicker(fieldId) {
    if (fieldId === 'date_single' && fpSingle) { fpSingle.open(); return; }
    if (fieldId === 'date_from' && fpFrom) { fpFrom.open(); return; }
    if (fieldId === 'date_to' && fpTo) { fpTo.open(); return; }

    const el = document.getElementById(fieldId);
    if (el) el.focus();
  }
" ]
Set Variable [ $MySQL_To_FM_Date ; Value: 
"
  function MySQL_To_FM_Date(mysqlDate) {
    if (!mysqlDate) return '';
    const parts = mysqlDate.split('-');
    if (parts.length !== 3) return '';
    return `${parts[2]}uuuuu${parts[1]}uuuuu${parts[0]}`;
  }
" ]
Set Variable [ $Filter State Script ; Value: 
"
  /* =========================
     State
  ========================= */
  ...
  function getDateMode() {
    const activeBtn = document.querySelector('#date_mode button.active');
    return activeBtn ? activeBtn.getAttribute('data-mode') : 'single';
  }

  function setDateMode(mode) {
    const buttons = document.querySelectorAll('#date_mode button');
    buttons.forEach(function (b) {
      b.classList.remove('active');
      if (b.getAttribute('data-mode') === mode) b.classList.add('active');
    });

    const singleWrap = document.getElementById('date_single_wrap');
    const fromWrap = document.getElementById('date_from_wrap');
    const toWrap = document.getElementById('date_to_wrap');

    const dateGrid = document.getElementById('date_grid');
    if (dateGrid) {
      if (mode === 'range') {
        dateGrid.classList.add('is-range');
        dateGrid.classList.remove('is-single');
      } else {
        dateGrid.classList.add('is-single');
        dateGrid.classList.remove('is-range');
      }
    }
  ...
  function readFilters() {
    ...
    const dateSingleReadable = (document.getElementById('date_single') || {}).value || '';
    const dateFromReadable = (document.getElementById('date_from') || {}).value || '';
    const dateToReadable = (document.getElementById('date_to') || {}).value || '';
    ...
    const colourLine = (document.getElementById('colour_line') || {}).value || '';
    const responsible = (document.getElementById('responsible') || {}).value || '';
    const product = (document.getElementById('product') || {}).value || '';

    return {
      mode: mode,
      dateSingleReadable: dateSingleReadable,
      dateFromReadable: dateFromReadable,
      dateToReadable: dateToReadable,
  ...
  function validateFilters(filters) {
    /* Date is required for this page */
    if (filters.mode === 'range') {
      if (!filters.dateFromReadable || !filters.dateToReadable) {
        alert('Please select both From and To dates.');
        return false;
      }

      const from = getMySQLFormattedDateFromReadable(filters.dateFromReadable);
      const to = getMySQLFormattedDateFromReadable(filters.dateToReadable);
    ...
    if (!filters.dateSingleReadable) {
      alert('Please select a date.');
      return false;
    }

    const d = getMySQLFormattedDateFromReadable(filters.dateSingleReadable);
    if (!d) {
...
" ]
Set Variable [ $Filter Preview Script ; Value: 
"
  /* =========================
     Preview
  ========================= */
  ...
  function updatePreview() {
    ...
    const pPeriod = document.getElementById('preview_period');
    const pId = document.getElementById('preview_id');
    const pCode = document.getElementById('preview_code');
    const pStatus = document.getElementById('preview_status');
    const pType = document.getElementById('preview_type');
    const pColour = document.getElementById('preview_colour_line');
    const pResp = document.getElementById('preview_responsible');
    const pProd = document.getElementById('preview_product');

    let periodText = '-';
    if (f.mode === 'range') {
      const a = f.dateFromReadable || '-';
      const b = f.dateToReadable || '-';
      periodText = a + ' to ' + b;
    } else {
      periodText = f.dateSingleReadable || '-';
    }

    if (pPeriod) pPeriod.textContent = periodText;

    if (pId) pId.textContent = human(f.projectId);
    if (pCode) pCode.textContent = human(f.projectCode);

    if (pStatus) pStatus.textContent = human(f.status);
    if (pType) pType.textContent = human(f.type);
    if (pColour) pColour.textContent = human(f.colourLine);
    if (pResp) pResp.textContent = human(f.responsible);
    if (pProd) pProd.textContent = human(f.product);
  }
" ]
Set Variable [ $Filter Draft Script ; Value: 
"
  /* =========================
     Draft persistence
  ========================= */
  ...
  function saveDraft() {
    try {
      const f = readFilters();
      localStorage.setItem('projects_list_filters', JSON.stringify(f));
    } catch (e) {
      /* ignore */
    }
  }
  ...
  function loadDraft() {
    try {
      const raw = localStorage.getItem('projects_list_filters');
      if (!raw) return;

      const f = JSON.parse(raw);

      if (f.mode) setDateMode(f.mode);

      if (f.dateSingleReadable && fpSingle) fpSingle.setDate(f.dateSingleReadable, true, 'l, j F, Y');
      if (f.dateFromReadable && fpFrom) fpFrom.setDate(f.dateFromReadable, true, 'l, j F, Y');
      if (f.dateToReadable && fpTo) fpTo.setDate(f.dateToReadable, true, 'l, j F, Y');

      const idEl = document.getElementById('project_id');
      const codeEl = document.getElementById('project_code');

      const statusEl = document.getElementById('status');
      const typeEl = document.getElementById('type');
      const colourEl = document.getElementById('colour_line');
      const respEl = document.getElementById('responsible');
      const prodEl = document.getElementById('product');

      if (idEl) idEl.value = f.projectId || '';
      if (codeEl) codeEl.value = f.projectCode || '';

      if (statusEl) statusEl.value = f.status || '';
      if (typeEl) typeEl.value = f.type || '';
      if (colourEl) colourEl.value = f.colourLine || '';
      if (respEl) respEl.value = f.responsible || '';
      if (prodEl) prodEl.value = f.product || '';
...
" ]
Set Variable [ $Filter Actions Script ; Value: 
"
  /* =========================
     Actions (onclick-driven)
  ========================= */
  ...
  function clearFilters() {
    ...
    updatePreview();
    saveDraft();
    rfToast('Filters cleared.');
  }

  function setSingleDate(dateObj) {
    setDateMode('single');

    if (fpSingle) {
      fpSingle.setDate(dateObj, true);
    } else {
      const input = document.getElementById('date_single');
      setReadableDate(input, dateObj);
    }
  ...
  function setRangeDates(fromObj, toObj) {
    setDateMode('range');
    if (fpFrom) fpFrom.setDate(fromObj, true);
    if (fpTo) fpTo.setDate(toObj, true);
    updatePreview();
    saveDraft();
    rfToast('Range set.');
  }
  ...
  function setQuickDate(which) {
    document.querySelectorAll('.rf-chip.active').forEach(function (x) { x.classList.remove('active'); });
    const chip = document.getElementById('chip_' + String(which).replace('-', ''));
    ...
    if (which === 'this-week') {
      ...
      setRangeDates(range.from, range.to);
      return;
    }
  }
" ]
Set Variable [ $Filter Generate Report Script ; Value: 
"/* =========================
   Generate Report (Projects List)
   Builds WHERE condition for:

   SELECT ... FROM CMP t1
   WHERE 1=1 & $$Condition

   Rules:
   - Case-insensitive filtering (LOWER)
   - Date literals must be dd/mm/yyyy
   - mysqlToReadable must NOT include weekday name
========================= */
...
function mysqlToDMY(mysql) {
  const p = String(mysql || '').split('-');
...
/* mysql yyyy-mm-dd -> readable: 22 January, 2026 (NO weekday) */
function mysqlToReadable(mysql) {
  const p = String(mysql || '').split('-');
  if (p.length !== 3) return '';
  const yyyy = Number(p[0]);
  const mm = Number(p[1]);
  const dd = Number(p[2]);
...
function buildWhereCondition(from, to, f) {
  const fromDMY = mysqlToDMY(from);
  const toDMY = mysqlToDMY(to);

  const parts = [];

  /* Required: Date Created period */
  parts.push(`AND t1.\\\"Date Created\\\" >= '${fromDMY}'`);
  parts.push(`AND t1.\\\"Date Created\\\" <= '${toDMY}'`);

  /* Optional: ID (allow partial match) */
  const idRaw = String(f.projectId || '').trim();
  if (idRaw) {
    const q = escapeSqlString(idRaw.toLowerCase());
    parts.push(`AND LOWER(t1.ID) LIKE '%${q}%'`);
  }

  /* Optional: Code (allow partial match) */
  const codeRaw = String(f.projectCode || '').trim();
  if (codeRaw) {
    const q = escapeSqlString(codeRaw.toLowerCase());
    parts.push(`AND LOWER(t1.Code) LIKE '%${q}%'`);
  }

  /* Optional: Status (exact match) */
  const statusRaw = String(f.status || '').trim();
  if (statusRaw) {
    const q = escapeSqlString(statusRaw.toLowerCase());
    parts.push(`AND LOWER(t1.\\\"Status\\\") = '${q}'`);
  }

  /* Optional: Type (exact match) */
  const typeRaw = String(f.type || '').trim();
  if (typeRaw) {
    const q = escapeSqlString(typeRaw.toLowerCase());
    parts.push(`AND LOWER(t1.\\\"Type\\\") = '${q}'`);
  }

  /* Optional: Colour Line (exact match) */
  const colourRaw = String(f.colourLine || '').trim();
  if (colourRaw) {
    const q = escapeSqlString(colourRaw.toLowerCase());
    parts.push(`AND LOWER(t1.\\\"Colour Line\\\") = '${q}'`);
  }

  /* Optional: Responsible (exact match) */
  const respRaw = String(f.responsible || '').trim();
  if (respRaw) {
    const q = escapeSqlString(respRaw.toLowerCase());
    parts.push(`AND LOWER(t1.\\\"Responsible User Name\\\") = '${q}'`);
  }

  /* Optional: Product (exact match) */
  const prodRaw = String(f.product || '').trim();
  if (prodRaw) {
    const q = escapeSqlString(prodRaw.toLowerCase());
    parts.push(`AND LOWER(t1.\\\"Product\\\") = '${q}'`);
  }
...
function generateReport() {
  ...
  if (filters.mode === 'range') {
    from = getMySQLFormattedDateFromReadable(filters.dateFromReadable);
    to = getMySQLFormattedDateFromReadable(filters.dateToReadable);
  } else {
    const single = getMySQLFormattedDateFromReadable(filters.dateSingleReadable);
    from = single;
    to = single;
  }

  if (!from) from = '\" & FMPDateTextToMySQLDate ( Get ( CurrentDate ) ) & \"';
  if (!to) to = '\" & FMPDateTextToMySQLDate ( Get ( CurrentDate ) ) & \"';

  const safe = (v) => String(v || '').replaceAll('|', '/').trim();

  const conditionSQL = buildWhereCondition(from, to, filters);

  const fromReadable = mysqlToReadable(from) || safe(from);
  const toReadable = mysqlToReadable(to) || safe(to);

  const sameDay = String(fromReadable).trim() === String(toReadable).trim();
  const periodText = sameDay ? `${fromReadable}` : `${fromReadable} to ${toReadable}`;

  const previewDetails =
    `PreviewDetails: Period: ${periodText}` +
    ` - ID: ${safe(filters.projectId) || 'All'}` +
    ` - Code: ${safe(filters.projectCode) || 'All'}` +
    ` - Status: ${safe(filters.status) || 'All'}` +
    ` - Type: ${safe(filters.type) || 'All'}` +
    ` - Colour Line: ${safe(filters.colourLine) || 'All'}` +
    ` - Responsible: ${safe(filters.responsible) || 'All'}` +
    ` - Product: ${safe(filters.product) || 'All'}`;

  const parameterToSend =
    safe(conditionSQL) + '|' + previewDetails;

  FileMaker.PerformScript(\"" & $Generate Report Script & "\", parameterToSend);
}
" ]
Set Variable [ $Filter Init Script ; Value: 
"
  /* =========================
     Init (no click listeners)
  ========================= */

  function initReportFilters() {
    fpSingle = initFlatpickr('date_single', 'date_single_icon');
    fpFrom = initFlatpickr('date_from', 'date_from_icon');
    fpTo = initFlatpickr('date_to', 'date_to_icon');
...
$Filter Helpers Script & "¶¶" &
$Filter Date Pickers Script & "¶¶" &
$MySQL_To_FM_Date & "¶¶" &
$Filter State Script & "¶¶" &
$Filter Preview Script & "¶¶" &
$Filter Draft Script & "¶¶" &
$Filter Actions Script & "¶¶" &
$Filter Generate Report Script & "¶¶" &
$Filter Init Script &
...
Refresh Window [ Flush cached join results ; With dialog: Off ]</textarea>
            </div>
          </section>

          <!-- Attachments Reminder -->
          <section class="card section attach-reminder" id="attach-section">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">📎</span>
                <span>Required Attachment</span>
                <span class="section-sub">Upload this file to the AI alongside your prompt.</span>
              </div>
            </div>
            <div class="attach-grid single">
              <a class="attach-item" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Get%20Value%20List.md">
                ...
                <div>
                  <div class="attach-name">Get Value List Documentation</div>
                  <div class="attach-desc">Required if the filter page uses any value list dropdowns.</div>
                </div>
                <span class="attach-badge">Docs</span>
              </a>
            </div>
          </section>
        ...
        <div class="rail-body">
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Reference FM script displayed on this page</div>
            </div>
            <div class="stack">
              <div class="stack-item">The reference FileMaker filter script is displayed in a section below</div>
              <div class="stack-item">Copy the prompt, then copy the FM script separately</div>
              <div class="stack-item">Choose Option 1 if you know the list name, Option 2 if you have a SQL query</div>
              <div class="stack-item">The AI returns a complete, updated FM filter script</div>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              <div class="stack-item">
                ...
                <div><strong>Named List</strong> — you know what list page this filter will drive. The AI infers the relevant fields and filters from context.</div>
              </div>
              <div class="stack-item">
                <span class="mini-pill teal" style="margin-bottom:6px;display:inline-flex;">OPT 2</span>
                <div><strong>Custom SQL</strong> — paste your full ExecuteSQL statement. The AI derives filters directly from your WHERE conditions and table aliases.</div>
              </div>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              <span class="pill2">Option 1: list name</span>
              <span class="pill2">Option 2: SQL query</span>
              <span class="pill2">Get Value List Docs</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              <span class="pill2">Filter Page</span>
              <span class="pill2">Date Mode Toggle</span>
              <span class="pill2">Single / Range</span>
              <span class="pill2">Flatpickr</span>
              <span class="pill2">generateReport()</span>
              <span class="pill2">mysqlToDMY</span>
              <span class="pill2">buildCondition()</span>
              <span class="pill2">Quick Date Chips</span>
              <span class="pill2">Value Lists</span>
              <span class="pill2">saveDraft / loadDraft</span>
              <span class="pill2">dd/mm/yyyy</span>
              <span class="pill2">WHERE conditions</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="side-grid">
              ...
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Get%20Value%20List.md">Get Value List Docs</a>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="side-grid">
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/_/AI%20Prompts/Build%20Report%20Filter%20Page.md">Build Report Filter Page</a>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              ...
              <div class="stack-item">2. Edit the placeholder directly in the textarea — replace <code style="font-size:11px;">[LIST_PAGE_NAME]</code> or <code style="font-size:11px;">[FULL_EXECUTESQL_STATEMENT]</code></div>
              ...
              <div class="stack-item">6. Upload the Get Value List documentation file</div>
              <div class="stack-item">7. Send to the AI</div>
            </div>
          </div>
  ...
  <script>
    (function(){
      ...
      /* ---- Prompt Templates ---- */
      var OPT1_TEMPLATE = [
        'I want you to study the Filemaker script below. It\'s a new FileMaker script that was written to generate a filter page for a list page.',
        '',
        'I want you to update the new filter page (Filemaker script below which is what I\'m using now to generate the filter page) so it generates the [LIST_PAGE_NAME] list page (the actual list page is being handled by another script).',
        '',
        '**Note:**',
        '- The filters should be based on the where conditions used to generate the page',
        '  - This means that the filters that should be displayed on the page should be based on the filters in the where condition of the query above. Meaning the where condition in the query above should be created (keeping their table aliases if any, just like it is in the where condition) and passed in the generateReport() JS function, just like in the FileMaker script below.',
        '  - Make sure filtering should not be case-sensitive',
        '  - The JS function mysqlToDMY should always return date in this order dd/mm/yyyy, just like in the FileMaker script below',
        '  - For the preview details that will be passed generated by the js function mysqlToReadable, don\'t add the day name to the date',
        '- The filters should include date filters like in the FileMaker script below',
        '- Where a value list is needed on this page, follow the uploaded [Get Value List Documentation] to find out how to implement value lists in CauferoAppStarter',
        '- Generate your output as one markdown code',
        '',
        '',
        'FIND BELOW THE FILEMAKER SCRIPT:',
        '',
        '[Paste the reference FileMaker script here, or upload the file as an attachment to the AI]'
      ].join('\n');

      var OPT2_TEMPLATE = [
        'I want you to study the Filemaker script below. It\'s a new FileMaker script that was written to generate a filter page for a list page.',
        '',
        'I want you to update the new filter page (Filemaker script below which is what I\'m using now to generate the filter page) so it generates a list page (the actual list page is being handled by another script) whose recordset is generated with this sql:',
        '',
      ...
      function setOption(n) {
        ...
        if (descStrip) {
          ...
          if (n === 1) {
            descStrip.innerHTML = ico + '<span><strong>Option 1 \u2014 Named List:</strong> Replace <code>[LIST_PAGE_NAME]</code> with the name of your target list page (e.g., <code>Patient Appointments</code>).</span>';
          } else {
            descStrip.innerHTML = ico + '<span><strong>Option 2 \u2014 Custom SQL:</strong> Replace <code>[FULL_EXECUTESQL_STATEMENT]</code> with your full ExecuteSQL query so the AI can derive the correct filters from your WHERE conditions.</span>';
          }
        }
      }
      ...
      function highlightKeywords() {
        ...
        if (!main) return;
        var keywords = ['CauferoAppStarter', 'FileMaker', 'Filter Page', 'ExecuteSQL', 'generateReport', 'mysqlToDMY', 'Value List', 'Flatpickr', 'buildCondition'];
