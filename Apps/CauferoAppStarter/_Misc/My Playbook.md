...
<head>
  ...
  <title>Builder Guide - CauferoAppStarter AI Agent</title>
</head>
<body>
      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text">Documentation › Builder Guide</span>
          </div>
        </div>
        ...
        <div class="content-inner">
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Builder Guide: AI Agent Interaction</div>
                <div class="hero-sub">Your simple playbook for building apps with the CauferoAppStarter AI Agent. Control the build phase by phase. Request, approve, paste, verify, repeat. This guide defines exactly how you interact with the agent from requirements to deployment.</div>
              </div>
              <div class="hero-actions">
                <button class="cta" onclick="window.location.href='#prompts-section'">
              ...
              <div class="hero-meta">
                <span class="chip">Builder Workflow</span>
                <span class="chip violet">Phase-Based</span>
                <span class="chip amber">Copy-Paste Prompts</span>
                <span class="chip copper">Verify & Approve</span>
              </div>
            </div>
          </section>
          ...
          <section class="card section" id="overview-section">
            <div class="section-head">
              <div class="section-title">
                ...
                <span class="section-sub">One phase at a time</span>
              </div>
            </div>

            <div style="padding: 20px; line-height: 1.6;">
              <div style="background: linear-gradient(135deg, rgba(20,122,116,0.15), rgba(65,197,224,0.15)); border-left: 4px solid var(--teal-600); padding: 20px; border-radius: 12px; margin: 16px 0;">
                <h3 style="margin-top: 0; margin-bottom: 12px; font-weight: 850; color: var(--teal-700);">The Golden Rule</h3>
                <p style="font-size: 15px; margin: 0; font-weight: 650;">You ask for one phase at a time, then you implement, verify, and only then move on.</p>
              </div>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">How This Works</h3>
              <ol style="margin-left: 20px;">
                <li><strong>You control the build</strong> - Request each phase explicitly</li>
                <li><strong>The agent builds in phases</strong> - Delivers one complete package at a time</li>
                <li><strong>You paste and run</strong> - Implement the output in FileMaker</li>
                <li><strong>You verify</strong> - Test the results before moving forward</li>
                <li><strong>You approve</strong> - Explicitly signal readiness for the next phase</li>
              </ol>

              <p style="background: rgba(15,23,42,0.06); border-left: 3px solid rgba(15,23,42,0.2); padding: 12px; border-radius: 8px; margin-top: 16px;"><strong>Why phase-based?</strong> Each phase builds on the previous. Skipping verification creates cascading errors. This method ensures quality and prevents rework.</p>
            </div>
          </section>
          ...
          <section class="card section" id="phases-section">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">📊</span>
                <span>The Build Phases</span>
                <span class="section-sub">Phase 0 through Phase 5</span>
              </div>
            </div>
            ...
            <div style="padding: 20px; line-height: 1.6;">
              ...
              <!-- Phase 0 -->
              <div style="border: 2px solid rgba(20,122,116,0.2); background: linear-gradient(180deg, rgba(20,122,116,0.08), rgba(20,122,116,0.04)); border-radius: 14px; padding: 18px; margin-bottom: 20px;">
                <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 12px;">
                  <div style="width: 40px; height: 40px; border-radius: 10px; background: var(--teal-600); color: white; display: flex; align-items: center; justify-content: center; font-weight: 850; font-size: 18px;">0</div>
                  <div>
                    <h3 style="margin: 0; font-weight: 850; font-size: 16px;">Phase 0: Start</h3>
                    <div style="font-size: 13px; color: var(--slate-600); margin-top: 2px;">You paste requirements</div>
                  </div>
                </div>
                
                <p><strong>You send:</strong></p>
                <ul style="margin-left: 20px;">
                  <li>The full client requirements</li>
                  <li>Any screenshots, forms, spreadsheets</li>
                  <li>Roles and permissions (if available)</li>
                </ul>

                <p><strong>Then you say:</strong></p>
                <div style="background: #0f1729; color: #e5e7eb; padding: 12px 16px; border-radius: 8px; font-family: monospace; font-size: 13px; margin-top: 10px;">
                  <strong>Phase 1. Generate tables and fields.</strong>
                </div>
              </div>

              <!-- Phase 1 -->
              <div style="border: 2px solid rgba(91,73,200,0.2); background: linear-gradient(180deg, rgba(91,73,200,0.08), rgba(91,73,200,0.04)); border-radius: 14px; padding: 18px; margin-bottom: 20px;">
                <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 12px;">
                  <div style="width: 40px; height: 40px; border-radius: 10px; background: var(--violet-600); color: white; display: flex; align-items: center; justify-content: center; font-weight: 850; font-size: 18px;">1</div>
                  <div>
                    <h3 style="margin: 0; font-weight: 850; font-size: 16px;">Phase 1: Tables and Fields</h3>
                    <div style="font-size: 13px; color: var(--slate-600); margin-top: 2px;">Schema definition</div>
                  </div>
                </div>
                
                <p><strong>You ask:</strong></p>
                <div style="background: #0f1729; color: #e5e7eb; padding: 12px 16px; border-radius: 8px; font-family: monospace; font-size: 13px; margin-top: 10px;">
                  Phase 1: Based on these requirements and CauferoAppStarter rules, list every table and field needed.
                </div>

                <p style="margin-top: 14px;"><strong>You do:</strong></p>
                <ul style="margin-left: 20px;">
                  <li>Review schema output</li>
                  <li>Approve or correct it</li>
                </ul>

                <p><strong>You reply with either:</strong></p>
                <ul style="margin-left: 20px;">
                  <li><code>Approved. Phase 2.</code></li>
                  <li><code>Adjust schema: (your bullet changes)</code></li>
                </ul>
              </div>

              <!-- Phase 2 -->
              <div style="border: 2px solid rgba(183,121,31,0.2); background: linear-gradient(180deg, rgba(183,121,31,0.08), rgba(183,121,31,0.04)); border-radius: 14px; padding: 18px; margin-bottom: 20px;">
                <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 12px;">
                  <div style="width: 40px; height: 40px; border-radius: 10px; background: var(--amber-600); color: white; display: flex; align-items: center; justify-content: center; font-weight: 850; font-size: 18px;">2</div>
                  <div>
                    <h3 style="margin: 0; font-weight: 850; font-size: 16px;">Phase 2: Pages and Modals Inventory</h3>
                    <div style="font-size: 13px; color: var(--slate-600); margin-top: 2px;">Complete UI inventory</div>
                  </div>
                </div>
                
                <p><strong>You ask:</strong></p>
                <div style="background: #0f1729; color: #e5e7eb; padding: 12px 16px; border-radius: 8px; font-family: monospace; font-size: 13px; margin-top: 10px;">
                  Phase 2: List every page and modal needed. Group by module. For each page, include purpose, primary table, supporting tables, and actions.
                </div>
                ...
                <p><strong>You reply with either:</strong></p>
                <ul style="margin-left: 20px;">
                  <li><code>Approved. Phase 3.</code></li>
                  <li><code>Adjust pages: (your bullet changes)</code></li>
                </ul>
              </div>

              <!-- Phase 3 -->
              <div style="border: 2px solid rgba(216,116,61,0.2); background: linear-gradient(180deg, rgba(216,116,61,0.08), rgba(216,116,61,0.04)); border-radius: 14px; padding: 18px; margin-bottom: 20px;">
                <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 12px;">
                  <div style="width: 40px; height: 40px; border-radius: 10px; background: var(--copper-600); color: white; display: flex; align-items: center; justify-content: center; font-weight: 850; font-size: 18px;">3</div>
                  <div>
                    <h3 style="margin: 0; font-weight: 850; font-size: 16px;">Phase 3: Links Plan and Link Creation</h3>
                    <div style="font-size: 13px; color: var(--slate-600); margin-top: 2px;">Navigation structure</div>
                  </div>
                </div>
                
                <p><strong>You ask:</strong></p>
                <div style="background: #0f1729; color: #e5e7eb; padding: 12px 16px; border-radius: 8px; font-family: monospace; font-size: 13px; margin-top: 10px;">
                  Phase 3: Based on the pages list, generate all links needed and the exact method to create them in CauferoAppStarter. If scripts apply, output the full script.
                </div>

                <p style="margin-top: 14px;"><strong>You do:</strong></p>
                <ul style="margin-left: 20px;">
                  <li>Paste the script (or follow manual steps) in FileMaker</li>
                  <li>Run it</li>
                  <li>Verify the links appear and route correctly</li>
                </ul>

                <p><strong>You reply:</strong></p>
                <div style="background: #0f1729; color: #e5e7eb; padding: 12px 16px; border-radius: 8px; font-family: monospace; font-size: 13px; margin-top: 10px;">
                  Links created. Phase 4.
                </div>
              </div>

              <!-- Phase 4 -->
              <div style="border: 2px solid rgba(44,151,185,0.2); background: linear-gradient(180deg, rgba(44,151,185,0.08), rgba(44,151,185,0.04)); border-radius: 14px; padding: 18px; margin-bottom: 20px;">
                <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 12px;">
                  <div style="width: 40px; height: 40px; border-radius: 10px; background: var(--sky-600); color: white; display: flex; align-items: center; justify-content: center; font-weight: 850; font-size: 18px;">4</div>
                  <div>
                    <h3 style="margin: 0; font-weight: 850; font-size: 16px;">Phase 4: Page-by-Page Build Loop</h3>
                    <div style="font-size: 13px; color: var(--slate-600); margin-top: 2px;">Build one page at a time</div>
                  </div>
                </div>
                
                <p><strong>You ask:</strong></p>
                <div style="background: #0f1729; color: #e5e7eb; padding: 12px 16px; border-radius: 8px; font-family: monospace; font-size: 13px; margin-top: 10px;">
                  Phase 4: Generate the full script for page: [Page Name]. Include dependencies (value lists, custom functions, helper scripts, routing edits) if needed.
                </div>

                <p style="margin-top: 14px;"><strong>You do:</strong></p>
                <ul style="margin-left: 20px;">
                  <li>Create or update the script in FileMaker</li>
                  <li>Run it</li>
                  <li>Verify the page works</li>
                </ul>

                <p><strong>Then you ask the next one:</strong></p>
                <div style="background: #0f1729; color: #e5e7eb; padding: 12px 16px; border-radius: 8px; font-family: monospace; font-size: 13px; margin-top: 10px;">
                  Next page: [Page Name].
                </div>

                <p style="margin-top: 14px;"><strong>Repeat</strong> until all pages are done.</p>
              </div>

              <!-- Phase 5 -->
              <div style="border: 2px solid rgba(180,35,58,0.2); background: linear-gradient(180deg, rgba(180,35,58,0.08), rgba(180,35,58,0.04)); border-radius: 14px; padding: 18px;">
                <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 12px;">
                  <div style="width: 40px; height: 40px; border-radius: 10px; background: var(--rose-700); color: white; display: flex; align-items: center; justify-content: center; font-weight: 850; font-size: 18px;">5</div>
                  <div>
                    <h3 style="margin: 0; font-weight: 850; font-size: 16px;">Phase 5: Edits and Fixes</h3>
                    <div style="font-size: 13px; color: var(--slate-600); margin-top: 2px;">When something changes</div>
                  </div>
                </div>
                
                <p>When a script must be modified, you paste the current script and give bullet points.</p>

                <p><strong>You ask:</strong></p>
                <div style="background: #0f1729; color: #e5e7eb; padding: 12px 16px; border-radius: 8px; font-family: monospace; font-size: 13px; margin-top: 10px;">
                  Phase 5: Modify this script using these points: (bullets). Output the full edited script steps. Also list side impacts.
                </div>

                <p style="margin-top: 14px;"><strong>You do:</strong></p>
                <ul style="margin-left: 20px;">
                  <li>Replace the script steps in FileMaker</li>
                  <li>Test again</li>
                </ul>
              </div>
            </div>
          ...
          <section class="card section" id="approval-section">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">✅</span>
                <span>How You Approve Each Phase</span>
                <span class="section-sub">Keep approvals clean and concise</span>
              </div>
            </div>

            <div style="padding: 20px; line-height: 1.6;">
              <p>Use short approvals to keep the build clean:</p>

              <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 14px; margin-top: 16px;">
                <div style="border: 1px solid var(--line); background: var(--surface2); border-radius: 12px; padding: 14px;">
                  <div style="font-weight: 750; margin-bottom: 6px; color: var(--teal-600);">Simple Approval</div>
                  <code style="display: block; padding: 8px; background: rgba(15,23,42,0.06); border-radius: 6px; font-size: 13px;">Approved. Continue.</code>
                </div>

                <div style="border: 1px solid var(--line); background: var(--surface2); border-radius: 12px; padding: 14px;">
                  <div style="font-weight: 750; margin-bottom: 6px; color: var(--teal-600);">Next Phase</div>
                  <code style="display: block; padding: 8px; background: rgba(15,23,42,0.06); border-radius: 6px; font-size: 13px;">Approved. Next phase.</code>
                </div>

                <div style="border: 1px solid var(--line); background: var(--surface2); border-radius: 12px; padding: 14px;">
                  <div style="font-weight: 750; margin-bottom: 6px; color: var(--amber-600);">Request Changes</div>
                  <code style="display: block; padding: 8px; background: rgba(15,23,42,0.06); border-radius: 6px; font-size: 13px;">Change these 3 things:</code>
                  <div style="font-size: 12px; margin-top: 6px; color: var(--slate-600);">(then bullet points)</div>
                </div>
              </div>
            </div>
          </section>

          <section class="card section" id="requirements-section">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">📝</span>
                <span>What You Must Provide When Asking For a Page</span>
                <span class="section-sub">Required information for Phase 4</span>
              </div>
            </div>

            <div style="padding: 20px; line-height: 1.6;">
              <p>When you request a page, always include:</p>

              <ul style="margin-left: 20px;">
                <li><strong>Page name</strong> (exact)</li>
                <li><strong>What it should show</strong> (columns or sections)</li>
                <li><strong>Key actions needed</strong> (add, edit, delete, view, search, filter)</li>
                <li><strong>Any special widgets</strong> (text editor, dropdown, charts, uploads)</li>
              </ul>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">Example Prompt</h3>
              <div style="background: #0f1729; color: #e5e7eb; padding: 16px; border-radius: 12px; font-family: monospace; font-size: 13px; line-height: 1.6;">
Phase 4: Generate the full script for page: Staff List.
Show columns: Name, Role, Phone, Status.
Actions: Add Staff, View Staff, Disable Staff.
...
Filters: Status.
          ...
          <section class="card section" id="verification-section">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">🔍</span>
                <span>Verification Checklist</span>
                <span class="section-sub">Simple validation per phase</span>
              </div>
            </div>

            <div style="padding: 20px; line-height: 1.6;">
              
              <h3 style="margin-top: 0; margin-bottom: 12px; font-weight: 750;">After Phase 1: Tables & Fields</h3>
              <ul style="margin-left: 20px;">
                <li>☑ Tables exist</li>
                <li>☑ Fields exist with correct types</li>
                <li>☑ Foreign keys exist and are indexed</li>
                <li>☑ Audit fields exist</li>
                <li>☑ Naming matches conventions</li>
              </ul>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">After Phase 2: Pages Inventory</h3>
              <ul style="margin-left: 20px;">
                <li>☑ Every workflow has a screen</li>
                <li>☑ Every entity has list + details</li>
                <li>☑ Child items have modals</li>
                <li>☑ Setup pages exist if needed</li>
              </ul>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">After Phase 3: Links</h3>
              <ul style="margin-left: 20px;">
                <li>☑ Links show in menu</li>
                <li>☑ Ordering is correct</li>
                <li>☑ Parent groups work</li>
                <li>☑ Clicking routes correctly</li>
              </ul>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">After Each Page (Phase 4)</h3>
              <ul style="margin-left: 20px;">
                <li>☑ Page loads without errors</li>
                <li>☑ SQL returns correct rows</li>
                <li>☑ Actions work</li>
                <li>☑ Modals open and close</li>
                <li>☑ Save works and validates</li>
              </ul>
            </div>
          </section>

          <section class="card section" id="prompts-section">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">📋</span>
                <span>Exact Prompts You Will Reuse</span>
                <span class="section-sub">Copy-paste templates</span>
              </div>
            </div>

            <div style="padding: 20px; line-height: 1.6;">
              
              <h3 style="margin-top: 0; margin-bottom: 12px; font-weight: 750;">Phase 1 Prompt</h3>
              <div class="prompt-snippet">
                <div class="prompt-header">
                  <span>Phase 1 - Tables & Fields</span>
                  <button class="copy-snippet-btn" onclick="copySnippet(this, 'phase1')">
                ...
                <div class="prompt-content" id="phase1">Here are the client requirements: [paste].
Phase 1: Generate the complete list of tables and fields needed.
Follow CauferoAppStarter documentation rules.
Also label what must be manual vs script-generated.</div>
              </div>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">Phase 2 Prompt</h3>
              <div class="prompt-snippet">
                <div class="prompt-header">
                  <span>Phase 2 - Pages & Modals</span>
                  <button class="copy-snippet-btn" onclick="copySnippet(this, 'phase2')">
                    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                      <rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect>
                      <path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path>
                    </svg>
                ...
                <div class="prompt-content" id="phase2">Phase 2: Based on requirements and CauferoAppStarter rules, list every single page and modal required.
Group by module.
For each page include: purpose, primary table, supporting tables, actions.</div>
              </div>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">Phase 3 Prompt</h3>
              <div class="prompt-snippet">
                <div class="prompt-header">
                  <span>Phase 3 - Links</span>
                  <button class="copy-snippet-btn" onclick="copySnippet(this, 'phase3')">
                    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                      <rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect>
                      <path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path>
                    </svg>
                ...
                <div class="prompt-content" id="phase3">Phase 3: Based on the pages list, generate all links required and the exact method to create them in CauferoAppStarter.
If scripts apply, output the full FileMaker script steps.</div>
              </div>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">Phase 4 Prompt</h3>
              <div class="prompt-snippet">
                <div class="prompt-header">
                  <span>Phase 4 - Page Build</span>
                  <button class="copy-snippet-btn" onclick="copySnippet(this, 'phase4')">
                    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                      <rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect>
                      <path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path>
                    </svg>
                ...
                <div class="prompt-content" id="phase4">Phase 4: Generate the complete script for this page: [Page Name].
Include SQL, HTML, CSS, JS, actions, and dependencies.
Follow CauferoAppStarter patterns.</div>
              </div>

              <h3 style="margin-top: 24px; margin-bottom: 12px; font-weight: 750;">Phase 5 Prompt</h3>
              <div class="prompt-snippet">
                <div class="prompt-header">
                  <span>Phase 5 - Edits & Fixes</span>
                  <button class="copy-snippet-btn" onclick="copySnippet(this, 'phase5')">
                    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                      <rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect>
                      <path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path>
                    </svg>
                ...
                <div class="prompt-content" id="phase5">Phase 5: Modify this script using these bullet points:
- (bullets)
Return the full edited script steps and list side impacts.</div>
              </div>
            </div>
          </section>

          <section class="card section" id="roles-section">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">👥</span>
                <span>Your Job vs The Agent's Job</span>
                <span class="section-sub">Clear division of responsibilities</span>
              </div>
            </div>
            ...
            <div style="padding: 20px; line-height: 1.6;">
              <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 18px;">
                ...
                <!-- Your Job -->
                <div style="border: 2px solid rgba(20,122,116,0.2); background: linear-gradient(180deg, rgba(20,122,116,0.08), rgba(20,122,116,0.04)); border-radius: 14px; padding: 18px;">
                  <h3 style="margin-top: 0; margin-bottom: 14px; font-weight: 850; color: var(--teal-700);">Your Job</h3>
                  <ul style="margin: 0; padding-left: 20px;">
                    <li>Provide requirements</li>
                    <li>Approve outputs phase by phase</li>
                    <li>Paste scripts into FileMaker</li>
                    <li>Run scripts</li>
                ...
                <!-- Agent's Job -->
                <div style="border: 2px solid rgba(91,73,200,0.2); background: linear-gradient(180deg, rgba(91,73,200,0.08), rgba(91,73,200,0.04)); border-radius: 14px; padding: 18px;">
                  <h3 style="margin-top: 0; margin-bottom: 14px; font-weight: 850; color: var(--violet-600);">Agent's Job</h3>
                  <ul style="margin: 0; padding-left: 20px;">
                    <li>Read docs first</li>
                    <li>Follow CauferoAppStarter rules</li>
                    <li>Output correct phase packet only</li>
                    <li>Include dependencies and edits</li>
                    <li>Give you verification steps</li>
                  </ul>
                </div>
              </div>
            </div>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">Builder Guide</div>
          <div class="rail-actions">
            <a class="rail-btn" href="#">Home</a>
            <a class="rail-btn" href="#phases-section">Phases</a>
            <a class="rail-btn" href="#prompts-section">Prompts</a>
          </div>
        </div>
        ...
        <div class="rail-body">
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Foundation principle</div>
            </div>
            <div class="stack">
              <div class="stack-item">✓ One phase at a time</div>
              <div class="stack-item">✓ Implement before moving on</div>
              <div class="stack-item">✓ Verify results</div>
              <div class="stack-item">✓ Explicit approval required</div>
              <div class="stack-item">✓ No skipping phases</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Phase Overview</div>
              <div class="panel-sub">0 through 5</div>
            </div>
            <div class="stack">
              <div class="stack-item">0️⃣ Start - Paste requirements</div>
              <div class="stack-item">1️⃣ Tables & Fields - Schema definition</div>
              <div class="stack-item">2️⃣ Pages & Modals - UI inventory</div>
              <div class="stack-item">3️⃣ Links - Navigation structure</div>
              <div class="stack-item">4️⃣ Pages - Build loop (one at a time)</div>
              <div class="stack-item">5️⃣ Edits - Modifications & fixes</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Quick Approvals</div>
              <div class="panel-sub">Standard responses</div>
            </div>
            <div class="stack">
              <div class="stack-item">"Approved. Continue."</div>
              <div class="stack-item">"Approved. Next phase."</div>
              <div class="stack-item">"Change these 3 things:"</div>
              <div class="stack-item">"Adjust schema: (bullets)"</div>
              <div class="stack-item">"Adjust pages: (bullets)"</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Page Request Template</div>
              <div class="panel-sub">What to include</div>
            </div>
            <div class="stack">
              <div class="stack-item">✓ Page name (exact)</div>
              <div class="stack-item">✓ Columns/sections to show</div>
              <div class="stack-item">✓ Key actions (add, edit, delete, view)</div>
              <div class="stack-item">✓ Search & filter criteria</div>
              <div class="stack-item">✓ Special widgets (if any)</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Your Checklist</div>
              <div class="panel-sub">Per phase verification</div>
            </div>
            <div class="stack">
              <div class="stack-item">Phase 1: Verify schema matches requirements</div>
              <div class="stack-item">Phase 2: Every workflow has a screen</div>
              <div class="stack-item">Phase 3: Links route correctly</div>
              <div class="stack-item">Phase 4: Page loads and actions work</div>
              <div class="stack-item">Phase 5: Changes don't break other pages</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Phase 4 Loop Pattern</div>
              <div class="panel-sub">Repeat for each page</div>
            </div>
            <div class="stack">
              <div class="stack-item">1. Request page script</div>
              <div class="stack-item">2. Paste in FileMaker</div>
              <div class="stack-item">3. Run and test</div>
              <div class="stack-item">4. Verify all actions</div>
              <div class="stack-item">5. Say "Next page: [name]"</div>
            </div>
          </div>

          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Common Mistakes to Avoid</div>
              <div class="panel-sub">Don't do these</div>
            </div>
            <div class="stack">
              <div class="stack-item">❌ Requesting multiple phases at once</div>
              <div class="stack-item">❌ Skipping verification</div>
              <div class="stack-item">❌ Moving forward with errors</div>
              <div class="stack-item">❌ Vague page requirements</div>
              <div class="stack-item">❌ Not testing before approval</div>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              ...
              <span class="pill2">VERIFY FIRST</span>
              <span class="pill2">ONE AT A TIME</span>
              <span class="pill2">EXPLICIT APPROVAL</span>
              <span class="pill2">COPY-PASTE</span>
              <span class="pill2">TEST ALWAYS</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="side-grid">
              <a class="side-pill" href="#">CauferoAppStarter Rules</a>
              <a class="side-pill" href="#">Script Templates</a>
              <a class="side-pill" href="#">Schema Design</a>
      ...
      window.copySnippet = function(btn, id){
        ...
        if (navigator.clipboard && navigator.clipboard.writeText){
          navigator.clipboard.writeText(text).then(function(){
            btn.innerHTML = '<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg> Copied!';
            setTimeout(function(){
              btn.innerHTML = '<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg> Copy';
            }, 2000);
          });
        } else {
          try{
  ...
  <style>
    ...
    *{box-sizing:border-box;}
    ...
    .page[data-theme="dark"] .prompt-header{
