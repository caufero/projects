      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text"> Giftera   </span>
          </div>
        </div>
        ...
        <div class="content-inner">
          ...
          <section class="hero" id="overview">
            ...
            <div class="hero-inner">
              ...
              <div class="hero-actions">
                <a class="cta ghost" href="_To Dos.md">
                  <span class="cta-ico" aria-hidden="true">
                    <svg viewBox="0 0 24 24" class="ico" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 11l3 3L22 4"></path><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"></path></svg>
                  </span>
                  Open _To Dos
                </a>

                <a class="cta" href="2. Software Proposal.md">
                  <span class="cta-ico" aria-hidden="true">
                    <svg viewBox="0 0 24 24" class="ico" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><path d="M14 2v6h6"></path><path d="M16 13H8"></path><path d="M16 17H8"></path><path d="M10 9H8"></path></svg>
                  </span>
                  Proposal
                </a>

                <a class="cta ghost" href="Timeline.md">
                  <span class="cta-ico" aria-hidden="true">
                    <svg viewBox="0 0 24 24" class="ico" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><path d="M12 6v6l4 2"></path></svg>
                  </span>
                  Timeline
                </a>
              </div>
              ...
              <div class="hero-meta">
                <span class="chip teal">Giftera</span>
                <span class="chip amber">Proposal</span>
                <span class="chip copper">Contract</span>
          ...
          <section class="card section" id="links">
            <div class="section-head">
              <div class="section-title">
                <span>Links To Giftera Documents</span>
              </div>
              <div class="section-actions">
                <a class="btn ghost" href="_To Dos.md">_To Dos</a>
                <a class="btn ghost" href="1. Business Plan.md">Business Plan</a>
                <a class="btn primary" href="2. Software Proposal.md">Proposal</a>
              </div>
            </div>
            ...
            <div class="grid grid-3">
              ...
              <a class="tile app accent-sky" href="1. Business Plan.md"><div class="tile-top"><div class="badge sky">Doc</div><div class="tile-title">Business Plan</div></div><div class="tile-sub">Business plan document</div></a>
              <a class="tile app accent-teal" href="2. Software Proposal.md"><div class="tile-top"><div class="badge teal">Doc</div><div class="tile-title">Software Proposal</div></div><div class="tile-sub">Scope and pricing proposal</div></a>
              <a class="tile app" href="3. Memorandum of Understanding.docx"><div class="tile-top"><div class="badge amber">Legal</div><div class="tile-title">Memorandum of Understanding</div></div><div class="tile-sub">Agreement / legal doc</div></a>
              <a class="tile app" href="Giftera Contract.md"><div class="tile-top"><div class="badge amber">Legal</div><div class="tile-title">Giftera Contract (Caufero + Chara Designs)</div></div><div class="tile-sub">Agreement / legal doc</div></a>
              <a class="tile app" href="4. Points.md"><div class="tile-top"><div class="badge">Notes</div><div class="tile-title">Points</div></div><div class="tile-sub">Pointers and breakdown</div></a>
              <a class="tile app" href="4.1 Website.md"><div class="tile-top"><div class="badge">Doc</div><div class="tile-title">Website</div></div><div class="tile-sub">Open document</div></a>
              <a class="tile app" href="4.2 User Portal.md"><div class="tile-top"><div class="badge">Doc</div><div class="tile-title">User Portal</div></div><div class="tile-sub">Open document</div></a>
              <a class="tile app" href="4.3 Mobile Apps.md"><div class="tile-top"><div class="badge">Doc</div><div class="tile-title">Mobile Apps</div></div><div class="tile-sub">Open document</div></a>
              <a class="tile app" href="4.4 USSD.md"><div class="tile-top"><div class="badge">Doc</div><div class="tile-title">USSD</div></div><div class="tile-sub">Open document</div></a>
              <a class="tile app" href="4.5 Admin Portal.md"><div class="tile-top"><div class="badge">Doc</div><div class="tile-title">Admin Portal</div></div><div class="tile-sub">Open document</div></a>
              <a class="tile app" href="Timeline.md"><div class="tile-top"><div class="badge copper">Plan</div><div class="tile-title">Timeline</div></div><div class="tile-sub">Timeline and milestones</div></a>
            </div>
          </section>
...
<section class="card section" id="instructions">
            ...
            <div class="prose">
              <p class="muted" style="margin-top:0;">
                Use this when you are merging “content above” into “content below”. The goal is one clean document that reads naturally.
              </p>

              <div class="grid grid-2" style="margin-top:14px;">
                <div class="panel-card" style="margin:0;">
                  <div class="panel-head">
                    <div class="panel-title">How to insert the new content</div>
                    <div class="panel-sub">Choose one approach</div>
                  </div>

                  <div class="kv" style="margin-top:12px;">
                    <div class="kv-row">
                      <div class="kv-k">Option A</div>
                      <div class="kv-v"><strong>Insert as one block</strong>. Place the entire “content above” intact in the best location.</div>
                    </div>
                    <div class="kv-row">
                      <div class="kv-k">Option B</div>
                      <div class="kv-v"><strong>Insert in parts</strong>. Split into meaningful pieces and place each piece into the most relevant section(s).</div>
                    </div>
                  </div>

                  <div style="height:10px"></div>
                  <div class="note" style="border-radius:14px;border:1px solid var(--line);background:var(--surface-2);padding:10px 12px;">
                    If there is no suitable section for a piece, create a new section or subsection with a clear heading and place it there.
                  </div>
                </div>

                <div class="panel-card" style="margin:0;">
                  <div class="panel-head">
                    <div class="panel-title">Editing rules</div>
                    <div class="panel-sub">Protect the existing document</div>
                  </div>

                  <ul style="margin:12px 0 0 18px;">
                    <li>Preserve the wording and structure of the content below.</li>
                    <li>Edit only when necessary (smooth insertion, remove duplicates, reduce redundancy).</li>
                    <li>Reorder sections only if it improves overall organization after insertion.</li>
                  </ul>

                  <div style="height:10px"></div>
                  <div class="note" style="border-radius:14px;border:1px solid var(--line);background:rgba(14,51,68,.06);padding:10px 12px;">
                    <strong>Output:</strong> Provide the final merged document in <strong>Markdown (md)</strong>.
                  </div>
                </div>
              </div>
              ...
              <div class="card pad-top" style="margin-top:14px;background:#000;border:1px solid rgba(255,255,255,.12);border-radius:18px;padding:14px 16px;">
                <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;">
                  <div style="color:#fff;font-weight:700;">Quick checklist</div>
                  <a class="btn ghost" href="#request" style="border-color:rgba(255,255,255,.18);color:#fff;">Use Request</a>
                </div>
                <div style="height:10px"></div>
                <ul style="margin:0 0 0 18px;color:#fff;font-size:12px;line-height:1.55;">
                  <li>Inserted the new content in the right place (block or parts).</li>
                  <li>No duplicates, no repeated ideas, no broken flow.</li>
                  <li>Headings make sense and the doc reads like one piece.</li>
                  <li>Final output is Markdown.</li>
                </ul>
              </div>
            </div>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        ...
        <div class="rail-body">
          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Open fast</div>
              <div class="panel-sub">Most used docs</div>
            </div>
            <div class="side-grid">
          ...
          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">Technical sub-docs</div>
              <div class="panel-sub">Deep links</div>
            </div>
            <div class="side-grid">
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Anchors</div>
            </div>
            <div class="pill-row">
              <span class="pill2">Giftera</span>
              <span class="pill2">Business Plan</span>
              <span class="pill2">Proposal</span>
              <span class="pill2">MOU</span>
              <span class="pill2">Contract</span>
              <span class="pill2">Timeline</span>
            </div>
          </div>
        </div>
