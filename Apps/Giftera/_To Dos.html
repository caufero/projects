...
<head>
  ...
  <title>Giftera — To Dos | Caufero Workspace</title>
</head>
<body>
      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text">Giftera — To Dos</span>
          </div>
        </div>
            ...
            <div class="hero-inner">
              <div class="hero-top">
                  <span style="display:inline-flex;align-items:center;gap:10px;">
                    <img src="Giftera.png" alt="Giftera" style="width:34px;height:34px;border-radius:10px;object-fit:cover;box-shadow:0 1px 0 rgba(15,23,42,.08),0 10px 22px rgba(15,23,42,.10);" />
                    <div class="hero-title">Giftera — To Dos</div>
                  </span>   
                <div class="hero-sub">Working plan, task list, and workflow execution for the Giftera project. UI designs in 2 weeks. Screens → Web → Mobile → USSD.</div>
              </div>
              ...
              <div class="hero-meta">
                <span class="chip">GF-TODOS-001</span>
                <span class="chip teal">5 Done</span>
                <span class="chip amber">1 In Progress</span>
                <span class="chip copper">9 Pending</span>
              </div>
            </div>
          </section>
          ...
          <section class="card section" id="overview">
            <div class="section-head">
              <div class="section-title">
                ...
                <span>Overview</span>
                <span class="section-sub">14 tasks total</span>
              </div>
            </div>
            ...
            <div class="grid grid-3" style="margin-bottom:14px;">
              <div class="stat-tile done-tile">
                <div class="stat-tile-top">
                  <div class="stat-tile-num">5</div>
                  <div class="stat-tile-ico done-ico" aria-hidden="true">
                ...
                <div class="stat-tile-hint">Domain check · Logo · UI meeting</div>
              </div>

              <div class="stat-tile progress-tile">
                <div class="stat-tile-top">
                  <div class="stat-tile-num">1</div>
                  <div class="stat-tile-ico progress-ico" aria-hidden="true">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px;">
                ...
                <div class="stat-tile-hint">Screen contents (website done, user portal next)</div>
              </div>

              <div class="stat-tile pending-tile">
                <div class="stat-tile-top">
                  <div class="stat-tile-num">9</div>
                  <div class="stat-tile-ico pending-ico" aria-hidden="true">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px;">
                      <circle cx="12" cy="12" r="10"></circle>
                      <path d="M12 8v4"></path>
                ...
                <div class="stat-tile-hint">MoU · Domains · Designs · Dev · USSD</div>
              </div>
            </div>
            ...
            <div class="progress-wrap">
              <div class="progress-meta">
                ...
                <span class="progress-pct">21%</span>
              </div>
              <div class="progress-track">
                <div class="progress-done" style="width:21.4%"></div>
                <div class="progress-active" style="width:7.2%"></div>
              </div>
          ...
          <section class="card section" id="tasks">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">✅</span>
                <span>All Tasks</span>
                <span class="section-sub">In order of execution</span>
              </div>
            </div>
            ...
            <div class="task-list">
              ...
              <div class="task-item task-done">
                ...
                <div class="task-body">
                  <div class="task-label">Check if giftera.com is available and confirm any other related domains</div>
                  <div class="task-note">giftera.com is taken — <strong>gifteragh.com is available</strong></div>
                </div>
                <div class="task-status ts-done">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:12px;height:12px;margin-right:5px;display:inline-block;vertical-align:middle;"><path d="M20 6L9 17l-5-5"></path></svg>
                  Done
                </div>
              </div>
              ...
              <div class="task-item task-done">
                ...
                <div class="task-body">
                  <div class="task-label">Follow up with Augustine on logo designer selection (based on 2 quotes sent)</div>
                  <div class="task-note">He got someone. Logo ready by <strong>Monday, 5 Jan 2026</strong></div>
                </div>
                <div class="task-status ts-done">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:12px;height:12px;margin-right:5px;display:inline-block;vertical-align:middle;"><path d="M20 6L9 17l-5-5"></path></svg>
                  Done
              ...
              <!-- TASK 3 — DONE (implemented like Task 2) -->
              <div class="task-item task-done">
                <div class="task-num done-num">3</div>
                <div class="task-body">
                  <div class="task-label">Draft Caufero ↔ Developers MoU and send to Jerry to sign</div>
                  <div class="task-note">Included the <strong>2-month grace period</strong> clause from project start</div>
                </div>
                <div class="task-status ts-done">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:12px;height:12px;margin-right:5px;display:inline-block;vertical-align:middle;"><path d="M20 6L9 17l-5-5"></path></svg>
                  Done
              ...
              <div class="task-item">
                ...
                <div class="task-body">
                  <div class="task-label">Buy and set up domains for Website, User Portal, and Admin Portal</div>
                  <div class="task-note">Jerry's team can proceed without waiting for payment</div>
                </div>
                <div class="task-status ts-pending">Pending</div>
              </div>

              <!-- TASK 5 — DONE (implemented like Task 2) -->
              <div class="task-item task-done">
                <div class="task-num done-num">5</div>
                <div class="task-body">
                  <div class="task-label">Put together screen contents (text, labels, messages, instructions)</div>
                  <div class="task-note">Website done · <strong>Next: User Portal</strong> · Then: Admin Portal</div>
                </div>
                <div class="task-status ts-done">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:12px;height:12px;margin-right:5px;display:inline-block;vertical-align:middle;"><path d="M20 6L9 17l-5-5"></path></svg>
                  Done
              ...
              <div class="task-item task-done">
                ...
                <div class="task-body">
                  <div class="task-label">UI designs meeting — sensitise design guy, explain the product, agree on workflow + deadlines</div>
                  <div class="task-note">Jerry confirmed: done with his team</div>
                </div>
                <div class="task-status ts-done">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:12px;height:12px;margin-right:5px;display:inline-block;vertical-align:middle;"><path d="M20 6L9 17l-5-5"></path></svg>
                  Done
              ...
              <div class="task-item">
                ...
                <div class="task-body">
                  <div class="task-label">They do Web UI designs and send for approval</div>
                  <div class="task-note">Screens must be ready in <strong>2 weeks</strong></div>
                </div>
                <div class="task-status ts-pending">Pending</div>
              </div>
              ...
              <div class="task-item">
                ...
                <div class="task-body">
                  <div class="task-label">Approve / send corrections for Web UI designs</div>
                </div>
                <div class="task-status ts-pending">Pending</div>
              </div>
              ...
              <div class="task-item">
                ...
                <div class="task-body">
                  <div class="task-label">They start Web development after approval</div>
                </div>
                <div class="task-status ts-pending">Pending</div>
              </div>
              ...
              <div class="task-item">
                ...
                <div class="task-body">
                  <div class="task-label">They do Mobile UI designs (Android + iOS) after Web UI designs and send for approval</div>
                </div>
                <div class="task-status ts-pending">Pending</div>
              </div>
              ...
              <div class="task-item">
                ...
                <div class="task-body">
                  <div class="task-label">Approve / send corrections for Mobile UI designs</div>
                </div>
                <div class="task-status ts-pending">Pending</div>
              </div>
              ...
              <div class="task-item">
                ...
                <div class="task-body">
                  <div class="task-label">They start Mobile development after approval</div>
                </div>
                <div class="task-status ts-pending">Pending</div>
              </div>
              ...
              <div class="task-item">
                ...
                <div class="task-body">
                  <div class="task-label">They develop USSD — comes last, after Web + Mobile development are done</div>
                </div>
                <div class="task-status ts-pending">Pending</div>
              </div>
              ...
              <div class="task-item">
                ...
                <div class="task-body">
                  <div class="task-label">Provide client company info for USSD registration when requested</div>
                  <div class="task-note">Also covers: Apple App Store + Google Play Store registrations</div>
                </div>
                <div class="task-status ts-pending">Pending</div>
              </div>
          ...
          <section class="card section" id="workflow">
            <div class="section-head">
              <div class="section-title">
                ...
                <span class="section-sub">Step-by-step execution plan</span>
              </div>
            </div>
            ...
            <div class="workflow-grid">
              ...
              <div class="wf-card">
                <div class="wf-head">
                  ...
                  <div class="wf-meta">
                    <div class="wf-title">Talk to Jerry — Kickoff</div>
                    <div class="wf-desc">Working plan, clean and direct</div>
                  </div>
                  <div class="badge sky">Kickoff</div>
                </div>
                <div class="wf-steps">
                  <div class="wf-step"><div class="wf-snum">1</div><div class="wf-stext"><strong>Start with Web UI designs first</strong> — Website + User Portal + Admin Portal</div></div>
                  <div class="wf-step"><div class="wf-snum">2</div><div class="wf-stext">They send Web UI designs for review and approval</div></div>
                  <div class="wf-step"><div class="wf-snum">3</div><div class="wf-stext">I review and approve (or send corrections fast)</div></div>
                  <div class="wf-step"><div class="wf-snum">4</div><div class="wf-stext"><strong>Web development begins immediately</strong> after approval</div></div>
                  <div class="wf-step"><div class="wf-snum">5</div><div class="wf-stext">Move to Mobile UI designs (Android + iOS) after Web UI is done</div></div>
                  <div class="wf-step"><div class="wf-snum">6</div><div class="wf-stext">They send Mobile UI designs for review and approval</div></div>
                  <div class="wf-step"><div class="wf-snum">7</div><div class="wf-stext">I review and approve (or send corrections fast)</div></div>
                  <div class="wf-step"><div class="wf-snum">8</div><div class="wf-stext"><strong>Mobile development begins immediately</strong> after approval</div></div>
                  <div class="wf-step"><div class="wf-snum">9</div><div class="wf-stext"><strong>USSD comes last</strong>, after Web + Mobile are done</div></div>
                  <div class="wf-step"><div class="wf-snum">10</div><div class="wf-stext">When ready for USSD: they request client info → I provide immediately</div></div>
                  <div class="wf-step"><div class="wf-snum">11</div><div class="wf-stext">When ready: Apple App Store + Google Play Store registration</div></div>
                </div>
                <div class="wf-target">
                  <span class="wf-target-ico">🎯</span>
                  <span><strong>Target:</strong> Screens ready in 2 weeks. Domains bought for Website, User Portal, Admin Portal.</span>
                </div>
              </div>
...
<div class="wf-card">
  <div class="wf-head">
    ...
    <div class="wf-meta">
      <div class="wf-title">Screens + Content</div>
      <div class="wf-desc">Give designers sharp words so they don't design pretty nonsense</div>
    </div>
    <div class="badge amber">Content</div>
  </div>

  <div class="wf-steps">
    <!-- Step 1 — DONE -->
    <div class="wf-step wf-done">
      <div class="wf-snum done-num">1</div>
      <div class="wf-stext"><s><strong>Put together screen content</strong> — text, labels, prompts, messages, instructions</s></div>
      <div class="wf-sstatus ss-done">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:12px;height:12px;margin-right:5px;display:inline-block;vertical-align:middle;"><path d="M20 6L9 17l-5-5"></path></svg>
        Done
      </div>
    </div>
        ...
        <!-- Step 2 — DONE -->
        <div class="wf-step wf-done">
          <div class="wf-snum done-num">2</div>
          <div class="wf-stext"><s><strong>Share content with the design guy</strong> so UI is built around correct wording</s></div>
          <div class="wf-sstatus ss-done">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:12px;height:12px;margin-right:5px;display:inline-block;vertical-align:middle;"><path d="M20 6L9 17l-5-5"></path></svg>
            Done
          </div>
        ...
        <div class="wf-step">
          ...
          <div class="wf-stext">Stay available for quick clarifications so nothing stalls the 2-week deadline</div>
        </div>
      </div>
    </div>
    ...
    <div class="wf-card">
      <div class="wf-head">
        ...
        <div class="wf-meta">
          <div class="wf-title">MoU Items</div>
          <div class="wf-desc">The "we don't waste months with vibes" section</div>
        </div>
        <div class="badge rose">Legal</div>
      </div>
      ...
      <div class="wf-steps">
        ...
        <div class="wf-step wf-done">
          <div class="wf-snum done-num">1</div>
          <div class="wf-stext"><s><strong>Sign Augustine's MoU</strong> and send it back</s></div>
          <div class="wf-sstatus ss-done">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:12px;height:12px;margin-right:5px;display:inline-block;vertical-align:middle;"><path d="M20 6L9 17l-5-5"></path></svg>
            Done
          </div>
        ...
        <div class="wf-step wf-done">
          <div class="wf-snum done-num">2</div>
          <div class="wf-stext"><s><strong>Draft Caufero ↔ Developers MoU</strong> — include 2-month grace period. Send to Jerry to sign</s></div>
          <div class="wf-sstatus ss-done">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:12px;height:12px;margin-right:5px;display:inline-block;vertical-align:middle;"><path d="M20 6L9 17l-5-5"></path></svg>
            Done
          </div>
      ...
      <div class="wf-target">
        <span class="wf-target-ico">📋</span>
        <span>Grace period: if client shows good financial commitment within 2 months, project continues full steam.</span>
      </div>
    </div>
    ...
    <div class="wf-card">
      <div class="wf-head">
        ...
        <div class="wf-meta">
          <div class="wf-title">Logo Design</div>
          <div class="wf-desc">Close this loop quickly</div>
        </div>
        <div class="badge teal">Design</div>
      </div>
      ...
      <div class="wf-steps">
        ...
        <div class="wf-step wf-done">
          <div class="wf-snum done-num">1</div>
          <div class="wf-stext"><s><strong>Augustine chooses one designer</strong> from the 2 quotes I sent</s></div>
          <div class="wf-sstatus ss-done">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:12px;height:12px;margin-right:5px;display:inline-block;vertical-align:middle;"><path d="M20 6L9 17l-5-5"></path></svg>
            Done
          </div>
        ...
        <div class="wf-step wf-done">
          <div class="wf-snum done-num">2</div>
          <div class="wf-stext"><s>Once he chooses, <strong>logo work starts</strong></s></div>
          <div class="wf-sstatus ss-done">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:12px;height:12px;margin-right:5px;display:inline-block;vertical-align:middle;"><path d="M20 6L9 17l-5-5"></path></svg>
            Done
          </div>
              ...
              <!-- W5: Once Screens Are Ready -->
              <div class="wf-card">
                <div class="wf-head">
                  <div class="wf-num">5</div>
                  <div class="wf-meta">
                    <div class="wf-title">Once Screens Are Ready</div>
                    <div class="wf-desc">No romance. Just execution.</div>
                  </div>
                  <div class="badge violet">Launch</div>
                </div>
                <div class="wf-steps">
                  <div class="wf-step"><div class="wf-snum">1</div><div class="wf-stext"><strong>Screen review + approval</strong></div></div>
                  <div class="wf-step"><div class="wf-snum">2</div><div class="wf-stext"><strong>Final sign-off</strong></div></div>
                  <div class="wf-step"><div class="wf-snum">3</div><div class="wf-stext"><strong>Dev handoff</strong></div></div>
                  <div class="wf-step"><div class="wf-snum">4</div><div class="wf-stext"><strong>Sprint breakdown</strong> — what we build first, second, third</div></div>
                  <div class="wf-step"><div class="wf-snum">5</div><div class="wf-stext"><strong>UAT plan</strong></div></div>
                  <div class="wf-step"><div class="wf-snum">6</div><div class="wf-stext"><strong>Rollout plan</strong></div></div>
                </div>
              </div>
          ...
          <section class="card section" id="enquiries">
            ...
            <div class="enquiry-empty">
              <div class="enquiry-ico" aria-hidden="true">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" style="width:28px;height:28px;opacity:.45;">
                  <circle cx="12" cy="12" r="10"></circle>
                  <path d="M12 8v4"></path>
                  <path d="M12 16h.01"></path>
                </svg>
      ...
      <!-- ==========================================
           RIGHT RAIL — GIFTERA TO DOS
      =========================================== -->
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          <div class="rail-title">Giftera — To Dos</div>
        ...
        <div class="rail-body">
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">14 tasks across 3 states</div>
            </div>
            <div class="rp-stats">
              <div class="rp-stat">
                <div class="rp-stat-bar done-bar" style="width:21.4%"></div>
                <div class="rp-stat-info">
                  <span class="rp-stat-label">Done</span>
                  <span class="rp-stat-val rp-done-val">5</span>
                </div>
              </div>
              <div class="rp-stat">
                <div class="rp-stat-bar progress-bar-r" style="width:7.2%"></div>
                <div class="rp-stat-info">
                  <span class="rp-stat-label">In Progress</span>
                  <span class="rp-stat-val rp-progress-val">1</span>
                </div>
              </div>
              <div class="rp-stat">
                <div class="rp-stat-bar pending-bar" style="width:71.4%"></div>
                <div class="rp-stat-info">
                  <span class="rp-stat-label">Pending</span>
                  <span class="rp-stat-val rp-pending-val">9</span>
                </div>
              </div>
            </div>
            <div class="rp-track">
              <div class="rp-fill rp-fill-done" style="width:21.4%"></div>
              <div class="rp-fill rp-fill-progress" style="width:7.2%"></div>
            </div>
            <div class="rp-pct">21% complete</div>
          </div>

          <!-- Currently Active -->
          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">✦ Currently Active</div>
              <div class="panel-sub">Task in progress right now</div>
            </div>
            <div class="active-task-card">
              <div class="active-task-num">5</div>
              <div class="active-task-body">
                <div class="active-task-label">Screen Contents</div>
                <div class="active-task-note">Website ✓ · <strong>User Portal next</strong> · Admin Portal after</div>
              </div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Must-hit milestones</div>
            </div>
            <div class="stack">
              <div class="stack-item">UI Screens ready in 2 weeks<div class="stack-sub">Web UI first → Mobile UI after</div></div>
              <div class="stack-item">Domains bought &amp; set up<div class="stack-sub">Website · User Portal · Admin Portal</div></div>
              <div class="stack-item">MoUs signed &amp; in place<div class="stack-sub">Augustine's MoU + Caufero ↔ Dev MoU</div></div>
              <div class="stack-item">USSD last — after Web + Mobile<div class="stack-sub">Plus App Store registrations when ready</div></div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">5 areas of focus</div>
            </div>
            <div class="side-grid">
              <a class="side-pill" href="#workflow">Talk to Jerry</a>
              <a class="side-pill warn" href="#workflow">Screens + Content</a>
              <a class="side-pill" href="#workflow">MoU Items</a>
              <a class="side-pill" href="#workflow">Logo Design</a>
              <a class="side-pill" href="#workflow">Post-Screens Plan</a>
            </div>
          </div>

          <!-- Done tasks quick view -->
          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">✅ Completed</div>
              <div class="panel-sub">3 tasks wrapped up</div>
            </div>
            <div class="stack">
              <div class="stack-item" style="opacity:.78;">
                <span style="color:var(--teal-600);font-weight:900;margin-right:6px;">✓</span> #1 — Domain check (gifteragh.com available)
              </div>
              <div class="stack-item" style="opacity:.78;">
                <span style="color:var(--teal-600);font-weight:900;margin-right:6px;">✓</span> #2 — Logo designer follow-up with Augustine
              </div>
              <div class="stack-item" style="opacity:.78;">
                <span style="color:var(--teal-600);font-weight:900;margin-right:6px;">✓</span> #6 — UI designs meeting with Jerry's team
              </div>
            </div>
          </div>
        ...
        <div class="rail-bottom">
          <div class="rail-foot">
            ...
            <span>Giftera tasks • scroll inside</span>
          </div>
        </div>
      </aside>
    </div>
  ...
  for (var g=0; g<groups.length; g++){
    ...
    if (query && anyHit){
      ...
      function setActiveNav(label){
        if (!navTree) return;
        var links = navTree.querySelectorAll("a.nav-item, a.nav-item.sub");
        for (var i=0;i<links.length;i++){
          links[i].classList.remove("active");
        }
        var target = navTree.querySelector('a[data-label="' + label + '"]');
        if (!target){
          var all = navTree.querySelectorAll("a");
          for (var j=0;j<all.length;j++){
            if (((all[j].textContent||"").trim().toLowerCase()) === "Giftera"){ target = all[j]; break; }
          }
        }
        if (target){
          ...
          while(p && p !== navTree){
            if (p.classList && (p.classList.contains("nav-group") || p.classList.contains("nav-subgroup"))){
  ...
  <style>
    ...
    *{box-sizing:border-box;}
    ...
    .panel-card{
      ...
      box-shadow:0 1px 0 rgba(15,23,42,.04);margin-bottom:12px;
    }
