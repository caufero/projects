    ...
    <div class="shell" id="shell">
      <aside class="rail rail-left" id="railLeft" aria-label="Side menu">
        ...
        <nav class="rail-body" id="navTree">
          ...
          <div class="nav-group open" data-label="Apps">
            ...
            <div class="nav-group-body">
              ...
              <a class="nav-item sub active" href="https://caufero.github.io/projects/Apps/Giftera/_NewAdditions.md" data-label="Apps Giftera"><span class="dot" aria-hidden="true"></span><span class="nav-text">Giftera</span></a>
        ...
        <div class="content-inner">
          ...
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Giftera Project Timeline</div>
                <div class="hero-sub">Development milestones and key decisions for the gift card platform</div>
              </div>
              <div class="hero-meta">
                <span class="chip">Project Timeline</span>
                <span class="chip teal">Development</span>
                <span class="chip amber">Client Meetings</span>
                <span class="chip violet">Giftera</span>
              </div>
            </div>
          </section>

          <!-- Timeline Container -->
          <section class="card section timeline-container">
            ...
            <div class="timeline">
              <!-- Timeline Entry 1 (Oldest) -->
              <div class="tl-entry" id="entry-dec-22">
                <div class="tl-date">
                  <div class="tl-date-day">22</div>
                  <div class="tl-date-month">Dec</div>
                  <div class="tl-date-year">2025</div>
                </div>
                <div class="tl-marker">
                ...
                <div class="tl-content">
                  <div class="tl-time">12:26 PM</div>
                  <div class="tl-card">
                    <div class="tl-header">
                      <div class="tl-title">Meeting with Augustine</div>
                    </div>
                    <div class="tl-body">
                      <div class="tl-section">
                        <div class="tl-section-label">Meeting Notes</div>
                        <div class="tl-text">
                          We had a meeting discussing the project. He mentioned that the templates should include templates for:
                        </div>
                        <ul class="tl-list">
                          <li>Apologies</li>
                          <li>Appreciation</li>
                          <li>Funerals</li>
                          <li>Birthdays</li>
                          <li>Business Gift Cards</li>
                        </ul>
                      </div>

                      <div class="tl-section">
                        <div class="tl-section-label">Monetization Strategy</div>
                        <ul class="tl-list">
                          <li><strong>Template Collections:</strong> GHS1 to GHS5</li>
                          <li><strong>Platform Fees:</strong> 1% of MoMo gift</li>
                        </ul>
                      </div>

                      <div class="tl-section">
                        <div class="tl-section-label">Financial Agreement</div>
                        <div class="tl-highlight">
                          <div class="tl-highlight-row">
                            <span class="tl-highlight-label">Total Project Cost:</span>
                            <span class="tl-highlight-value">GHS 69,800</span>
                          </div>
                          <div class="tl-highlight-row">
                            <span class="tl-highlight-label">First Payment (This Week):</span>
                            <span class="tl-highlight-value">GHS 10,000</span>
                          </div>
                          <div class="tl-highlight-row">
                            <span class="tl-highlight-label">Payment Terms:</span>
                            <span class="tl-highlight-value">As and when</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="tl-section">
                        ...
                        <div class="tl-text">
                          We have agreed that we will try to complete this product by <strong>April, 2026</strong> (2 months before our proposed deadline <strong>June, 2026</strong>).
                        </div>
                      </div>

                      <div class="tl-section">
                        <div class="tl-section-label">Team & Management</div>
                        <div class="tl-text">
                          We agreed that we will take Reggie through the solution and its development so she becomes abreast with it, since she'll be managing it.
                        </div>
                      </div>

                      <div class="tl-section">
                        <div class="tl-section-label">Legal Documents</div>
                        <div class="tl-text">
                          Augustine also shared with me an MOU so we go through (and edit if we want), then sign.
                        </div>
                      </div>
                    </div>
                    <div class="tl-footer">
                      <div class="tl-attachments">
                        <div class="tl-attachment-label">
                          <svg viewBox="0 0 24 24" class="ico sm" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M21.5 11.5l-9 9a5 5 0 0 1-7-7l9-9a3 3 0 0 1 4.2 4.2l-9 9a1 1 0 0 1-1.4-1.4l8.3-8.3"/>
                          </svg>
                          Attachments
                        </div>
                        <div class="tl-attachment">
                          <div class="tl-attachment-icon">
                            <svg viewBox="0 0 24 24" class="ico sm" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                              <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
                              <path d="M14 2v6h6"/>
                              <path d="M12 18v-6"/>
                          ...
                          <div class="tl-attachment-info">
                            <div class="tl-attachment-name">Memorandum of Understanding.docx</div>
                            <div class="tl-attachment-meta">Legal Document</div>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <!-- Timeline Entry 2 (More Recent) -->
              <div class="tl-entry" id="entry-dec-23">
                <div class="tl-date">
                  <div class="tl-date-day">23</div>
                  <div class="tl-date-month">Dec</div>
                  <div class="tl-date-year">2025</div>
                </div>
                <div class="tl-marker">
                ...
                <div class="tl-content">
                  <div class="tl-time">8:40 AM</div>
                  <div class="tl-card">
                    <div class="tl-header">
                      <div class="tl-title">Get the Name of the Product from Augustine</div>
                    </div>
                    <div class="tl-body">
                      <div class="tl-section">
                        <div class="tl-section-label">Initial Contact</div>
                        <div class="tl-text">
                          I spoke to Augustine to find out the name of the product since it's going to determine the domains we go for.
                        </div>
                        <ul class="tl-list">
                          <li>He said he will get back to me later in the day with a name</li>
                        </ul>
                      </div>

                      <div class="tl-section">
                        <div class="tl-section-label">Response & Decision</div>
                        <div class="tl-callout">
                          <div class="tl-callout-header">
                            <div class="tl-callout-icon">
                              <svg viewBox="0 0 24 24" class="ico sm" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/>
                                <path d="M22 4L12 14.01l-3-3"/>
                              </svg>
                            </div>
                            <strong>Product Name Confirmed</strong>
                          </div>
                          <div class="tl-text">
                            He said he'd like to go with <strong>Giftera</strong>. I'll include it in the meeting with Jerry.
                          </div>
                        </div>
                      </div>

                      <div class="tl-section">
                        <div class="tl-section-label">Digital Infrastructure</div>
                        <div class="tl-text">
                          So the domains will look something like this:
                        </div>
                        
                        <div class="tl-subsection">
                          <div class="tl-subsection-title">Primary Domains</div>
                          <div class="tl-domain-list">
                            <div class="tl-domain-item">
                              <div class="tl-domain-label">Website:</div>
                              <a href="https://www.giftera.com" class="tl-domain-link">https://www.giftera.com</a>
                            </div>
                            <div class="tl-domain-item">
                              <div class="tl-domain-label">Admin Portal:</div>
                              <a href="https://www.admin.giftera.com" class="tl-domain-link">https://www.admin.giftera.com</a>
                            </div>
                            <div class="tl-domain-item">
                              <div class="tl-domain-label">Support Email:</div>
                              <a href="mailto:support@giftera.com" class="tl-domain-link">support@giftera.com</a>
                            </div>
                          </div>
                        </div>

                        <div class="tl-subsection">
                          <div class="tl-subsection-title">Social Media Presence</div>
                          <div class="tl-social-grid">
                            <a href="https://facebook.com/giftera" class="tl-social-card">
                              <div class="tl-social-icon facebook">
                                <svg viewBox="0 0 24 24" class="ico sm" fill="currentColor">
                                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                                </svg>
                              </div>
                              <div class="tl-social-name">Facebook</div>
                              <div class="tl-social-handle">/giftera</div>
                            </a>
                            <a href="https://www.instagram.com/giftera/" class="tl-social-card">
                              <div class="tl-social-icon instagram">
                                <svg viewBox="0 0 24 24" class="ico sm" fill="currentColor">
                              ...
                              <div class="tl-social-name">Instagram</div>
                              <div class="tl-social-handle">@giftera</div>
                            </a>
                            <a href="https://www.linkedin.com/company/giftera/" class="tl-social-card">
                              <div class="tl-social-icon linkedin">
                                <svg viewBox="0 0 24 24" class="ico sm" fill="currentColor">
                                  <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                                </svg>
                              </div>
                              <div class="tl-social-name">LinkedIn</div>
                              <div class="tl-social-handle">/company/giftera</div>
                            </a>
                            <a href="https://www.tiktok.com/@giftera" class="tl-social-card">
                              <div class="tl-social-icon tiktok">
                                <svg viewBox="0 0 24 24" class="ico sm" fill="currentColor">
                                  <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"/>
                                </svg>
                              </div>
                              <div class="tl-social-name">TikTok</div>
                              <div class="tl-social-handle">@giftera</div>
                            </a>
                          </div>
                        </div>
              ...
              <!-- Timeline End Marker -->
              <div class="tl-entry tl-end">
                <div class="tl-date">
                  <div class="tl-date-day">•</div>
                  <div class="tl-date-month">More</div>
                  <div class="tl-date-year">Soon</div>
                </div>
                <div class="tl-marker">
                ...
                <div class="tl-content">
                  <div class="tl-card tl-card-muted">
                    <div class="tl-text" style="text-align: center; padding: 20px;">
                      Timeline continues as project develops...
                    </div>
                  </div>
                </div>
              </div>
          ...
          <footer class="footer">
            <div class="footer-left">
              <div class="footer-title">Giftera Timeline</div>
              <div class="footer-sub">Project development milestones</div>
            </div>
            <div class="footer-right">
              <a class="footer-link" href="#">Project Home</a>
      ...
      <!-- ============================================================
           RIGHT RAIL — TIMELINE INFO
           ============================================================ -->
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          <div class="rail-title">Timeline Info</div>
          <div class="rail-sub">Project details & navigation</div>
        </div>
        ...
        <div class="rail-body">
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Navigate to timeline entries</div>
            </div>
            <div class="side-grid">
              <a class="side-pill warn" href="#entry-dec-22">Dec 22 Meeting</a>
              <a class="side-pill warn" href="#entry-dec-23">Dec 23 Name</a>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Key project metrics</div>
            </div>
            <div class="stack">
              <div class="stack-item">Budget<div class="stack-sub">GHS 69,800 total</div></div>
              <div class="stack-item">First Payment<div class="stack-sub">GHS 10,000 (this week)</div></div>
              <div class="stack-item">Target Completion<div class="stack-sub">April 2026</div></div>
              <div class="stack-item">Deadline<div class="stack-sub">June 2026</div></div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">👥 Key Stakeholders</div>
              <div class="panel-sub">Project team members</div>
            </div>
            <div class="stack">
              <div class="stack-item">Augustine<div class="stack-sub">Client • Project Lead</div></div>
              <div class="stack-item">Reggie<div class="stack-sub">Project Manager (Post-Launch)</div></div>
              <div class="stack-item">Jerry<div class="stack-sub">Technical Discussions</div></div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">📦 Core Deliverables</div>
              <div class="panel-sub">What we're building</div>
            </div>
            <div class="pill-row">
              <span class="pill2">Template System</span>
              <span class="pill2">MoMo Integration</span>
              <span class="pill2">Admin Portal</span>
              <span class="pill2">User Platform</span>
              <span class="pill2">Social Media</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">🎨 Template Categories</div>
              <div class="panel-sub">Gift card templates to include</div>
            </div>
            <div class="stack">
              <div class="stack-item">Apologies</div>
              <div class="stack-item">Appreciation</div>
              <div class="stack-item">Funerals</div>
              <div class="stack-item">Birthdays</div>
              <div class="stack-item">Business Gift Cards</div>
            </div>
          </div>
  ...
  <style>
    ...
    *{box-sizing:border-box;}
    ...
    .brand-mark{
      ...
      font-weight:800;letter-spacing:.2px;color:#fff;font-size:16px;
    ...
    .page[data-theme="dark"] .nav-item:hover,.page[data-theme="dark"] .nav-group-head:hover{
    ...
    .nav-group-body{padding-left:6px;margin-top:6px;display:none;}
    ...
    .page[data-theme="dark"] .tl-date-month{color:rgba(241,245,249,.78);}
    ...
    .page[data-theme="dark"] .tl-date-year{color:rgba(241,245,249,.50);}
    ...
    .tl-dot{
      ...
      border-radius:999px;
      background:linear-gradient(135deg, var(--caufero-800), var(--teal-600));
      box-shadow:0 0 0 3px var(--surface), 0 0 0 5px rgba(14,51,68,.15);
      position:relative;
      z-index:2;
      flex-shrink:0;
    }
    ...
    .tl-line{
      width:2px;
      flex:1;
      background:linear-gradient(180deg, rgba(14,51,68,.25), rgba(14,51,68,.08));
      margin-top:6px;
    }
    .page[data-theme="dark"] .tl-line{
      background:linear-gradient(180deg, rgba(65,197,224,.25), rgba(65,197,224,.08));
    }
    ...
    .page[data-theme="dark"] .tl-time{color:rgba(241,245,249,.50);}

    .tl-card{
      border:1px solid var(--line);
      background:linear-gradient(180deg, rgba(255,255,255,.90), rgba(255,255,255,.75));
      border-radius:18px;
      box-shadow:0 2px 0 rgba(15,23,42,.04), 0 12px 28px rgba(15,23,42,.08);
      overflow:hidden;
    }
    .page[data-theme="dark"] .tl-card{
      background:linear-gradient(180deg, rgba(10,14,26,.85), rgba(10,14,26,.70));
    ...
    .page[data-theme="dark"] .tl-header{
    ...
    .page[data-theme="dark"] .tl-section-label{color:rgba(241,245,249,.60);}
    ...
    .page[data-theme="dark"] .tl-text{color:rgba(241,245,249,.88);}

    .tl-text strong{
      font-weight:900;
      color:var(--caufero-800);
    }
    .page[data-theme="dark"] .tl-text strong{color:#a7d7e3;}
    ...
    .page[data-theme="dark"] .tl-list li{color:rgba(241,245,249,.88);}
    ...
    .tl-highlight{
      ...
      background:rgba(20,122,116,.06);
      margin-top:10px;
    }
    .page[data-theme="dark"] .tl-highlight{
    ...
    .page[data-theme="dark"] .tl-highlight-row{
      border-color:rgba(241,245,249,.06);
    }

    .tl-highlight-row:last-child{
      border-bottom:none;
      padding-bottom:0;
    }

    .tl-highlight-row:first-child{
      padding-top:0;
    }
    ...
    .page[data-theme="dark"] .tl-highlight-label{color:rgba(241,245,249,.78);}
    ...
    .page[data-theme="dark"] .tl-highlight-value{color:#a7d7e3;}
    ...
    .page[data-theme="dark"] .tl-callout{
    ...
    .page[data-theme="dark"] .tl-subsection-title{color:rgba(241,245,249,.78);}
    ...
    .page[data-theme="dark"] .tl-domain-label{color:rgba(241,245,249,.60);}
    ...
    .page[data-theme="dark"] .tl-domain-link{color:#a7d7e3;}
    ...
    .tl-social-card:hover{
      text-decoration:none;
      transform:translateY(-2px);
      box-shadow:0 4px 0 rgba(15,23,42,.06), 0 12px 24px rgba(15,23,42,.10);
    }
    ...
    .tl-social-icon.facebook{background:#1877f2;}
    .tl-social-icon.instagram{background:linear-gradient(45deg, #f09433 0%, #e6683c 25%, #dc2743 50%, #cc2366 75%, #bc1888 100%);}
    .tl-social-icon.linkedin{background:#0077b5;}
    .tl-social-icon.tiktok{background:#000;}
    ...
    .page[data-theme="dark"] .tl-social-name{color:rgba(241,245,249,.90);}
    ...
    .page[data-theme="dark"] .tl-social-handle{color:rgba(241,245,249,.60);}
    ...
    .page[data-theme="dark"] .tl-footer{
    ...
    .page[data-theme="dark"] .tl-attachment-label{color:rgba(241,245,249,.60);}
    ...
    .page[data-theme="dark"] .tl-attachment-name{color:rgba(241,245,249,.90);}
    ...
    .page[data-theme="dark"] .tl-attachment-meta{color:rgba(241,245,249,.60);}
    ...
    @media (max-width: 980px){
      ...
      .tl-date-day{font-size:20px;}
      .tl-date-month{font-size:9px;}
      .tl-social-grid{grid-template-columns:1fr;}
    }
    @media (max-width: 560px){
      ...
      .tl-date-day{font-size:16px;}
      .tl-highlight-row{flex-direction:column;align-items:flex-start;gap:4px;}
    }
