      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text"> 4KPAINT </span>
          </div>
        </div>
      ...
      <main class="content" id="content" role="main">
        <div class="content-inner">
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                ...
                <div class="hero-sub">New additions, quick links to docs, and the reusable merge instructions for keeping project docs clean.</div>
              </div>
              <div class="hero-actions">
                <a class="cta ghost" href="_To Dos.md">
                ...
                <a class="cta" href="1.%204KPAINT_Technical_Documentation.md">
                  <span class="cta-ico" aria-hidden="true"><svg viewBox="0 0 24 24" class="ico" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><path d="M14 2v6h6"></path><path d="M16 13H8"></path><path d="M16 17H8"></path><path d="M10 9H8"></path></svg></span>
                  Technical Docs
                </a>
              </div>
              <div class="hero-meta">
                <span class="chip">Project hub</span>
                <span class="chip teal">Docs first</span>
                <span class="chip amber">Fast navigation</span>
                <span class="chip copper">Clean updates</span>
              </div>
            </div>
          </section>
          ...
          <section class="card section" id="links">
            <div class="section-head">
              <div class="section-title">
                <span>Links To 4KPAINT Documents</span>
              </div>
              <div class="section-actions">
                <a class="btn ghost" href="2.%20Solution%20Documentation.md">Solution Docs</a>
                <a class="btn primary" href="3.%20Suggested%20Improvements.md">Suggested Improvements</a>
              </div>
            </div>
            <div class="grid grid-3">
              ...
              <a class="tile app accent-teal" href="1.%204KPAINT_Technical_Documentation.md"><div class="tile-top"><div class="badge teal">Doc</div><div class="tile-title">Technical Documentation</div></div><div class="tile-sub">Core technical reference</div></a>
              <a class="tile app accent-violet" href="2.%20Solution%20Documentation.md"><div class="tile-top"><div class="badge violet">Doc</div><div class="tile-title">Solution Documentation</div></div><div class="tile-sub">Functional overview and system notes</div></a>
              <a class="tile app accent-sky" href="3.%20Suggested%20Improvements.md"><div class="tile-top"><div class="badge sky">Doc</div><div class="tile-title">Suggested Improvements</div></div><div class="tile-sub">Enhancements, refactors, and ideas</div></a>
            </div>
            <div style="height:14px"></div>
            <div class="card pad-top" style="background:var(--surface-2);border:1px solid var(--line);border-radius:18px;padding:16px;">
              <div><div style="font-weight:900;">Inside Technical Documentation</div><div class="muted" style="margin-top:4px;">Deep links to sub-docs that live under the technical umbrella.</div></div>
            </div>
            <div class="grid grid-3" style="margin-top:12px;">
              <a class="mini" href="1.1%204KPAINT_Layout_Object_Inventory.md"><div class="mini-title">Layout Object Inventory</div></a>
              <a class="mini" href="1.2%204KPAINT_Script_Call_Details.md"><div class="mini-title">Script Call Details</div></a>
              <a class="mini" href="1.3%204KPAINT_Field_Dependency_Graph.md"><div class="mini-title">Field Dependency Graph</div></a>
              <a class="mini" href="1.3.1%204KPAINT_Field_Dependency_Fields.dot"><div class="mini-title">Dependency Fields (dot)</div></a>
              <a class="mini" href="1.3.2%204KPAINT_Field_Dependency_Tables.dot"><div class="mini-title">Dependency Tables (dot)</div></a>
              <a class="mini" href="1.4%204KPAINT_Module_Based_Documentation.md"><div class="mini-title">Module Based Documentation</div></a>
            </div>
          </section>
          ...
          <section class="card section" id="instructions">
            <div class="section-head">
              <div class="section-title">
                <span>Instruction for Inserting Content</span>
              </div>
              <div class="section-actions">
                <a class="btn ghost" href="#request">Jump to Request</a>
                <a class="btn primary" href="#rules">Consistency Rules</a>
              </div>
            </div>
            <div class="grid grid-2">
              <div class="panel-card" style="margin:0;">
                <div class="panel-head"><div class="panel-title">Goal</div><div class="panel-sub">Make the final document read like one coherent piece.</div></div>
                <div class="muted">Merge the <b>content above</b> into the <b>content below</b> so the result reads naturally, as one clean document.</div>
              </div>
              <div class="panel-card" style="margin:0;">
                <div class="panel-head"><div class="panel-title">How to insert</div><div class="panel-sub">Use judgment, keep structure.</div></div>
                <div class="muted"><ol style="margin:10px 0 0 18px;"><li><b>Insert as one block</b>, or</li><li><b>Insert in parts</b> into the most relevant sections.</li></ol></div>
              </div>
            </div>
            <div style="height:12px"></div>
            <div class="panel-card" id="rules" style="margin:0;">
              <div class="panel-head"><div class="panel-title">Editing rules for the base document</div><div class="panel-sub">Preserve wording. Edit only when truly necessary.</div></div>
              <ul style="margin:10px 0 0 18px;">
                <li>Preserve the existing wording and structure of the base document.</li>
                <li>Edit only to make insertion flow, or to remove duplication caused by insertion.</li>
                <li>If there is no suitable section, create a new heading and place it there.</li>
                <li>Return the final document in Markdown (md) code.</li>
              </ul>
            </div>
            ...
            <div class="panel-card" id="request" style="margin:0;">
              <div class="panel-head">
                <div class="panel-title">Request (Reusable)</div>
                <div class="panel-sub">This is the exact reusable instruction you paste into ChatGPT.</div>
              </div>

              <!-- ✏️ CHANGED: font-size 10px → 8.5px | max-height 160px → 260px | color explicitly #ffffff -->
...
Return only the final updated document in Markdown (md) code block.</pre>
          ...
          <footer class="footer">
            <div class="footer-left">
              <div class="footer-title">4KPAINT</div>
              <div class="footer-sub">New additions page inside Caufero Workspace skin</div>
            </div>
            <div class="footer-right">
              <a class="footer-link" href="_To Dos.md">_To Dos</a>
              <a class="footer-link" href="1.%204KPAINT_Technical_Documentation.md">Technical Docs</a>
              <a class="footer-link" href="2.%20Solution%20Documentation.md">Solution Docs</a>
            </div>
          </footer>
        </div>
      </main>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          <div class="rail-title">4KPAINT</div>
          ...
          <div class="rail-actions">
            ...
            <a class="rail-btn" href="_To Dos.md">_To Dos</a>
            <a class="rail-btn" href="1.%204KPAINT_Technical_Documentation.md">Tech</a>
          </div>
        </div>
        <div class="rail-body">
          <div class="panel-card">
            ...
            <div class="side-grid">
              ...
              <a class="side-pill" href="1.%204KPAINT_Technical_Documentation.md">Technical Documentation</a>
              <a class="side-pill" href="2.%20Solution%20Documentation.md">Solution Documentation</a>
              <a class="side-pill" href="3.%20Suggested%20Improvements.md">Suggested Improvements</a>
            </div>
          </div>
          <div class="panel-card">
            <div class="panel-head"><div class="panel-title">Technical sub-docs</div><div class="panel-sub">Deep links</div></div>
            <div class="side-grid">
              <a class="side-pill" href="1.1%204KPAINT_Layout_Object_Inventory.md">Layout Object Inventory</a>
              <a class="side-pill" href="1.2%204KPAINT_Script_Call_Details.md">Script Call Details</a>
              <a class="side-pill" href="1.3%204KPAINT_Field_Dependency_Graph.md">Field Dependency Graph</a>
              <a class="side-pill" href="1.4%204KPAINT_Module_Based_Documentation.md">Module Based Docs</a>
            </div>
          </div>
          <div class="panel-card">
            <div class="panel-head"><div class="panel-title">On this page</div><div class="panel-sub">Anchors</div></div>
            <div class="pill-row">
              <a class="pill2" href="#links">Links</a>
              <a class="pill2" href="#instructions">Instruction</a>
              <a class="pill2" href="#request">Reusable Request</a>
              <a class="pill2" href="#rules">Rules</a>
            </div>
          </div>
        </div>
        <div class="rail-bottom">
          <div class="rail-foot">
            <span class="rail-foot-dot" aria-hidden="true"></span>
            <span>Same skin &bull; different canvas</span>
          </div>
        </div>
      </aside>
    </div>
