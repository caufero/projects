...
<head>
  ...
  <title>4KPAINT — To Dos | Caufero Workspace</title>
</head>
<body>
      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text">4KPAINT — To Dos</span>
          </div>
        </div>
    ...
    <div class="shell" id="shell">
        ...
        <nav class="rail-body" id="navTree">
          ...
          <div class="nav-group" data-label="Apps">
            ...
            <div class="nav-group-body">
              <a class="nav-item sub active" href="https://caufero.github.io/projects/Apps/4KPAINT/_NewAdditions.md" data-label="Apps 4KPAINT"><span class="dot" aria-hidden="true"></span><span class="nav-text">4KPAINT</span></a>
          ...
          <div class="nav-group" data-label="Tailwind-Designed Websites">
            <button class="nav-group-head" type="button" data-toggle="group">
              <span class="nav-ico" aria-hidden="true"><svg viewBox="0 0 24 24" class="ico sm" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12c2-6 6-6 8 0s6 6 8 0"></path><path d="M4 18c2-6 6-6 8 0s6 6 8 0"></path></svg></span>
            ...
            <div class="nav-group-body">
              ...
              <div class="nav-subgroup" data-label="Tailwind-Designed Websites AI Agents and Automation">
                <button class="nav-subgroup-head" type="button" data-toggle="subgroup"><span class="mini-pill teal">AI</span><span class="nav-text">AI Agents &amp; Automation</span><span class="chev" aria-hidden="true"><svg viewBox="0 0 24 24" class="ico sm" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18l6-6-6-6"></path></svg></span></button>
                <div class="nav-subgroup-body">
              ...
              <div class="nav-subgroup" data-label="Tailwind-Designed Websites Builders and Platforms">
                <button class="nav-subgroup-head" type="button" data-toggle="subgroup"><span class="mini-pill violet">BLD</span><span class="nav-text">Builders &amp; Platforms</span><span class="chev" aria-hidden="true"><svg viewBox="0 0 24 24" class="ico sm" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18l6-6-6-6"></path></svg></span></button>
                <div class="nav-subgroup-body">
              ...
              <div class="nav-subgroup" data-label="Tailwind-Designed Websites Dev Tools and Docs">
                <button class="nav-subgroup-head" type="button" data-toggle="subgroup"><span class="mini-pill">DEV</span><span class="nav-text">Dev Tools &amp; Docs</span><span class="chev" aria-hidden="true"><svg viewBox="0 0 24 24" class="ico sm" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18l6-6-6-6"></path></svg></span></button>
                <div class="nav-subgroup-body">
              ...
              <div class="nav-subgroup" data-label="Tailwind-Designed Websites Marketing and Growth">
                <button class="nav-subgroup-head" type="button" data-toggle="subgroup"><span class="mini-pill amber">GRW</span><span class="nav-text">Marketing &amp; Growth</span><span class="chev" aria-hidden="true"><svg viewBox="0 0 24 24" class="ico sm" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18l6-6-6-6"></path></svg></span></button>
                <div class="nav-subgroup-body">
              ...
              <div class="nav-subgroup" data-label="Tailwind-Designed Websites Misc and Reference">
                <button class="nav-subgroup-head" type="button" data-toggle="subgroup"><span class="mini-pill slate">MISC</span><span class="nav-text">Misc &amp; Reference</span><span class="chev" aria-hidden="true"><svg viewBox="0 0 24 24" class="ico sm" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18l6-6-6-6"></path></svg></span></button>
                <div class="nav-subgroup-body">
          ...
          <div class="nav-group" data-label="Actions To Automate">
            <button class="nav-group-head" type="button" data-toggle="group">
              <span class="nav-ico" aria-hidden="true"><svg viewBox="0 0 24 24" class="ico sm" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18h6"></path><path d="M10 22h4"></path><path d="M12 2a7 7 0 0 0-4 12c.6.5 1 1.2 1.1 2h5.8c.1-.8.5-1.5 1.1-2A7 7 0 0 0 12 2z"></path></svg></span>
          ...
          <div class="nav-group" data-label="YouTube">
            <button class="nav-group-head" type="button" data-toggle="group">
              <span class="nav-ico" aria-hidden="true"><svg viewBox="0 0 24 24" class="ico sm" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 15l5-3-5-3z"></path><rect x="3" y="6" width="18" height="12" rx="2"></rect></svg></span>
      ...
      <main class="content" id="content" role="main">
        <div class="content-inner">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                  <span style="display:inline-flex;align-items:center;gap:10px;">
                    <img src="4kpaint.png" alt="4KPAINT" style="width:34px;height:34px;border-radius:10px;object-fit:cover;box-shadow:0 1px 0 rgba(15,23,42,.08),0 10px 22px rgba(15,23,42,.10);" />
                    <div class="hero-title">4KPAINT — To Dos</div>
                  </span>                
                <div class="hero-sub">Clear next actions and follow-ups for the 4KPAINT solution improvements.</div>
              </div>
              <div class="hero-actions">
                <a class="cta ghost" href="#tasks">
                  <span class="cta-ico" aria-hidden="true"><svg viewBox="0 0 24 24" class="ico" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 11l3 3L22 4"></path><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"></path></svg></span>
                  All Tasks
                </a>
                <a class="cta" href="#workflow">
                  <span class="cta-ico" aria-hidden="true"><svg viewBox="0 0 24 24" class="ico" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"></path><path d="M12 5l7 7-7 7"></path></svg></span>
                  View Workflow
                </a>
              </div>
              <div class="hero-meta">
                <span class="chip">4KP-TODOS-001</span>
                <span class="chip teal">1 Done</span>
                <span class="section-sub" style="font-size:11px;color:var(--slate-500);display:flex;align-items:center;">1 task total</span>
              </div>
            </div>
          </section>
          ...
          <section class="card section" id="overview">
            <div class="section-head">
              <div class="section-title">
                ...
                <span>Overview</span>
                <span class="section-sub">1 task total</span>
              </div>
            </div>

            <div class="grid grid-3" style="margin-bottom:14px;">
              <div class="stat-tile done-tile">
                <div class="stat-tile-top">
                  <div class="stat-tile-num">1</div>
                  <div class="stat-tile-ico done-ico">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px;"><path d="M20 6L9 17l-5-5"></path></svg>
                  </div>
                </div>
                <div class="stat-tile-label">Done</div>
                <div class="stat-tile-hint">Nothing completed yet</div>
              </div>

              <div class="stat-tile progress-tile">
                <div class="stat-tile-top">
                  <div class="stat-tile-num">0</div>
                  <div class="stat-tile-ico progress-ico">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px;"><circle cx="12" cy="12" r="10"></circle><path d="M12 6v6l4 2"></path></svg>
                  </div>
                </div>
                <div class="stat-tile-label">In Progress</div>
                <div class="stat-tile-hint">Nothing started yet</div>
              </div>

              <div class="stat-tile pending-tile">
                <div class="stat-tile-top">
                  <div class="stat-tile-num">0</div>
                  <div class="stat-tile-ico pending-ico">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px;"><circle cx="12" cy="12" r="10"></circle><path d="M12 8v4"></path><path d="M12 16h.01"></path></svg>
                  </div>
                </div>
                <div class="stat-tile-label">Pending</div>
                <div class="stat-tile-hint">None</div>
              </div>
            </div>
            ...
            <div class="progress-wrap">
              ...
              <div class="progress-legend">
                <span class="legend-item done-legend">Done</span>
                <span class="legend-item active-legend">In Progress</span>
          ...
          <section class="card section" id="tasks">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">✅</span>
                <span>All Tasks</span>
                <span class="section-sub">1 task</span>
              </div>
            </div>
            ...
            <div class="task-list">
              <div class="task-item">
                ...
                <div class="task-body">
                  <div class="task-label">Meet with Joe and Kirk to discuss the proposed improvements and align on next steps</div>
                  <div class="task-note">Walk them through the improvements we're proposing for the 4KPAINT system</div>
                </div>
                <div class="task-status ts-done">Done</div>
              </div>
            </div>
          </section>

          <!-- WORKFLOW -->
          <section class="card section" id="workflow">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">⚡</span>
                <span>What I Need To Do Next</span>
                <span class="section-sub">Workflow completed</span>
              </div>
            </div>
            ...
            <div class="workflow-grid">
              <div class="wf-card">
                <div class="wf-head">
                  ...
                  <div class="wf-meta">
                    <div class="wf-title">Meet with Joe and Kirk</div>
                    <div class="wf-desc">Completed: improvements reviewed and next steps agreed</div>
                  </div>
                  <div class="badge teal">Done</div>
                </div>
                <div class="wf-steps">
                  <div class="wf-step">
                    <div class="wf-snum">1</div>
                    <div class="wf-stext"><strong>Done:</strong> Schedule the meeting with Joe and Kirk</div>
                  </div>
                  <div class="wf-step">
                    <div class="wf-snum">2</div>
                    <div class="wf-stext"><strong>Done:</strong> Walk them through the improvements we're proposing to add to the system</div>
                  </div>
                  <div class="wf-step">
                    <div class="wf-snum">3</div>
                    <div class="wf-stext"><strong>Discuss and align on next steps</strong> — what gets built, in what order, and when</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <!-- ENQUIRIES -->
          <section class="card section" id="enquiries">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">❓</span>
                <span>Enquiries To Make</span>
              </div>
            </div>
            <div class="enquiry-empty">
              <div class="enquiry-ico" aria-hidden="true">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" style="width:28px;height:28px;opacity:.45;"><circle cx="12" cy="12" r="10"></circle><path d="M12 8v4"></path><path d="M12 16h.01"></path></svg>
              </div>
              <div class="enquiry-text">None for now</div>
              <div class="enquiry-sub">Add enquiries here as they come up during the project</div>
            </div>
          </section>
      ...
      <!-- ==========================================
           RIGHT RAIL — 4KPAINT TO DOS
      =========================================== -->
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          <div class="rail-title">4KPAINT — To Dos</div>
          <div class="rail-sub">Task tracking &amp; navigation</div>
          <div class="rail-actions">
            <a class="rail-btn" href="#overview">Overview</a>
            <a class="rail-btn" href="#tasks">Tasks</a>
            <a class="rail-btn" href="#workflow">Workflow</a>
            <a class="rail-btn" href="#enquiries">Enquiries</a>
          </div>
        </div>
        ...
        <div class="rail-body">
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">1 task · completed</div>
            </div>
            <div class="rp-stats">
              <div class="rp-stat">
                <div class="rp-stat-bar done-bar" style="width:100%"></div>
                <div class="rp-stat-info"><span class="rp-stat-label">Done</span><span class="rp-stat-val rp-done-val">1</span></div>
              </div>
              <div class="rp-stat">
                <div class="rp-stat-bar progress-bar-r" style="width:0%"></div>
                <div class="rp-stat-info"><span class="rp-stat-label">In Progress</span><span class="rp-stat-val rp-progress-val">0</span></div>
              </div>
              <div class="rp-stat">
                <div class="rp-stat-bar pending-bar" style="width:0%"></div>
                <div class="rp-stat-info"><span class="rp-stat-label">Pending</span><span class="rp-stat-val rp-pending-val">0</span></div>
              </div>
            </div>
            <div class="rp-track">
              <div class="rp-fill rp-fill-done" style="width:100%"></div>
              <div class="rp-fill rp-fill-progress" style="width:0%"></div>
            </div>
            <div class="rp-pct">100% complete</div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">All caught up</div>
            </div>
            <div class="active-task-card" style="border-color:rgba(20,122,116,.24);background:rgba(20,122,116,.10);">
              <div class="active-task-num" style="background:rgba(20,122,116,.14);border-color:rgba(20,122,116,.26);color:var(--teal-700);">1</div>
              <div class="active-task-body">
                <div class="active-task-label" style="color:var(--teal-700);">Met with Joe &amp; Kirk</div>
                <div class="active-task-note">Done · next steps agreed</div>
              </div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">One clear action item</div>
            </div>
            <div class="stack">
              <div class="stack-item">
                Schedule a meeting with Joe and Kirk
                <div class="stack-sub">Walk them through the proposed system improvements</div>
              </div>
              <div class="stack-item">
                Present and discuss next steps
                <div class="stack-sub">Align on what gets built, in what order</div>
              </div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">📋 Document Info</div>
            </div>
            <div class="stack">
              <div class="stack-item" style="font-size:12px;">
                <span style="color:var(--slate-500);font-weight:750;">ID</span>
                <span style="margin-left:10px;font-weight:900;">4KP-TODOS-001</span>
              </div>
              <div class="stack-item" style="font-size:12px;">
                <span style="color:var(--slate-500);font-weight:750;">Version</span>
                <span style="margin-left:10px;font-weight:900;">v1.0</span>
              </div>
              <div class="stack-item" style="font-size:12px;">
                <span style="color:var(--slate-500);font-weight:750;">Date</span>
                <span style="margin-left:10px;font-weight:900;">15 Feb 2026</span>
              </div>
              <div class="stack-item" style="font-size:12px;">
                <span style="color:var(--slate-500);font-weight:750;">Prepared by</span>
                <span style="margin-left:10px;font-weight:900;">Caufero</span>
              </div>
            </div>
          </div>
        ...
        <div class="rail-bottom">
          <div class="rail-foot">
            ...
            <span>4KPAINT tasks • scroll inside</span>
          </div>
        </div>
      </aside>
    </div>
  ...
  <script>
    (function(){
      var root=document.querySelector(".page"),btnTheme=document.getElementById("btnTheme"),btnMenu=document.getElementById("btnMenu"),railLeft=document.getElementById("railLeft"),railRight=document.getElementById("railRight"),navSearch=document.getElementById("navSearch"),navClear=document.getElementById("navClear"),navTree=document.getElementById("navTree");
      ...
      function filterNav(q){if(!navTree)return;var query=(q||"").trim().toLowerCase();var items=navTree.querySelectorAll("[data-label]");for(var i=0;i<items.length;i++){var el=items[i],label=(el.getAttribute("data-label")||"").toLowerCase(),hit=!query||label.indexOf(query)!==-1;el.classList.toggle("is-hit",hit);el.classList.toggle("is-dim",!!query&&!hit);}var groups=navTree.querySelectorAll(".nav-group,.nav-subgroup");for(var g=0;g<groups.length;g++){var group=groups[g],all=group.querySelectorAll("[data-label]"),anyHit=false;for(var j=0;j<all.length;j++){if(all[j].classList.contains("is-hit")){anyHit=true;break;}}group.classList.toggle("is-dim",!!query&&!anyHit);if(query&&anyHit){group.classList.add("forced-open");}else{group.classList.remove("forced-open");}}}
      function setActiveNav(label){if(!navTree)return;var links=navTree.querySelectorAll("a.nav-item,a.nav-item.sub");for(var i=0;i<links.length;i++)links[i].classList.remove("active");var target=navTree.querySelector('a[data-label="'+label+'"]');if(!target){var all=navTree.querySelectorAll("a");for(var j=0;j<all.length;j++){if(((all[j].textContent||"").trim().toLowerCase())==="4kpaint"){target=all[j];break;}}}if(target){target.classList.add("active");var p=target.parentNode;while(p&&p!==navTree){if(p.classList&&(p.classList.contains("nav-group")||p.classList.contains("nav-subgroup"))){p.classList.add("open");p.classList.remove("closed");}p=p.parentNode;}try{target.scrollIntoView({block:"center"});}catch(e){}}}
      ...
      function highlightKeywords(){var main=document.querySelector(".content-inner");if(!main)return;var keywords=["CauferoAppStarter","Apps","AI Prompts","Themes","Contracts","Modular Solutions","Chats","YouTube","Tailwind","FileMaker"];var skipSel="a,pre,code,script,style,input,textarea,button";function walk(node){if(!node||node.nodeType!==1)return;if(node.matches(skipSel))return;var children=Array.prototype.slice.call(node.childNodes);for(var i=0;i<children.length;i++){var c=children[i];if(c.nodeType===3){var text=c.nodeValue;if(!text||!text.trim())continue;var replaced=text,changed=false;for(var k=0;k<keywords.length;k++){var kw=keywords[k],re=new RegExp("\\b"+kw.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")+"\\b","g");if(re.test(replaced)){replaced=replaced.replace(re,function(m){return"%%KW_START%%"+m+"%%KW_END%%";});changed=true;}}if(changed){var span=document.createElement("span");span.innerHTML=replaced.replace(/%%KW_START%%/g,'<mark class="kw">').replace(/%%KW_END%%/g,"</mark>");c.parentNode.replaceChild(span,c);}}else if(c.nodeType===1){walk(c);}}}walk(main);}
      function closeMobileRailsOnOutsideClick(e){var isMobile=window.matchMedia("(max-width: 980px)").matches;if(!isMobile)return;if(!railLeft||!railRight)return;var t=e.target,insideLeft=!!closest(t,"#railLeft"),insideRight=!!closest(t,"#railRight"),insideBtn=!!closest(t,"#btnMenu");if(!insideLeft&&!insideRight&&!insideBtn){setOpen(railLeft,false);setOpen(railRight,false);}}
      function init(){setTheme(getTheme());wireDisclosure();highlightKeywords();setActiveNav("Apps 4KPAINT");if(btnTheme)btnTheme.addEventListener("click",toggleTheme);if(btnMenu)btnMenu.addEventListener("click",function(){var isMobile=window.matchMedia("(max-width: 980px)").matches;if(isMobile){toggleLeftRail();}else{document.body.classList.toggle("compact-rails");}});if(navClear)navClear.addEventListener("click",function(){if(!navSearch)return;navSearch.value="";filterNav("");navSearch.focus();});if(navSearch)navSearch.addEventListener("input",function(){filterNav(navSearch.value||"");});document.addEventListener("click",closeMobileRailsOnOutsideClick,true);filterNav("");}
  ...
  <style>
    :root{
      --slate-950:#0b1220;--slate-900:#0f172a;--slate-800:#1f2937;--slate-700:#334155;
    ...
    *{box-sizing:border-box;}
    ...
    ============================================= */
    .stat-tile{border:1px solid var(--line);background:linear-gradient(180deg, rgba(255,255,255,.84), rgba(255,255,255,.66));border-radius:16px;padding:16px;box-shadow:0 1px 0 rgba(15,23,42,.04);}
    ...
    .stat-tile-ico{width:34px;height:34px;border-radius:10px;display:flex;align-items:center;justify-content:center;border:1px solid var(--line);flex:0 0 auto;}
    ...
    .done-tile{border-color:rgba(20,122,116,.20);opacity:.6;}
    ...
    .progress-tile{border-color:rgba(183,121,31,.20);opacity:.6;}
    ...
    .pending-tile{border-color:rgba(100,116,139,.20);}
    .pending-tile .stat-tile-num{color:var(--slate-600);}
    .pending-ico{background:rgba(100,116,139,.08);border-color:rgba(100,116,139,.18);color:var(--slate-500);}

    .progress-wrap{border:1px solid var(--line);background:linear-gradient(180deg, rgba(255,255,255,.78), rgba(255,255,255,.60));border-radius:14px;padding:14px;}
    ...
    .progress-track{height:10px;border-radius:999px;background:rgba(15,23,42,.06);overflow:hidden;display:flex;}
    .page[data-theme="dark"] .progress-track{background:rgba(241,245,249,.08);}
    .progress-done{height:100%;background:linear-gradient(90deg, var(--teal-600), var(--teal-500));border-radius:999px;}
    .progress-active{height:100%;background:linear-gradient(90deg, var(--amber-600), rgba(183,121,31,.7));}
    ...
    .task-item{display:flex;align-items:flex-start;gap:12px;padding:13px 14px;border:1px solid var(--line);background:linear-gradient(180deg, rgba(255,255,255,.82), rgba(255,255,255,.62));border-radius:14px;box-shadow:0 1px 0 rgba(15,23,42,.04);transition:transform .1s ease, box-shadow .1s ease;}
    ...
    .task-num{width:28px;height:28px;border-radius:8px;flex:0 0 auto;margin-top:1px;display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:900;border:1px solid var(--line);background:var(--surface2);color:var(--slate-500);}
    .task-body{flex:1 1 auto;min-width:0;}
    .task-label{font-size:13px;font-weight:750;line-height:1.45;color:var(--slate-800);}
    .page[data-theme="dark"] .task-label{color:rgba(241,245,249,.90);}
    .task-note{margin-top:5px;font-size:12px;color:var(--slate-500);line-height:1.45;}
    .page[data-theme="dark"] .task-note{color:rgba(241,245,249,.60);}
    .task-status{flex:0 0 auto;font-size:11px;font-weight:900;padding:5px 10px;border-radius:999px;white-space:nowrap;align-self:flex-start;}
    .ts-pending{border:1px solid var(--line);background:var(--surface2);color:var(--slate-500);}

    .workflow-grid{display:flex;flex-direction:column;gap:12px;}
    .wf-card{border:1px solid var(--line);background:linear-gradient(180deg, rgba(255,255,255,.82), rgba(255,255,255,.62));border-radius:16px;padding:14px;box-shadow:0 1px 0 rgba(15,23,42,.04);}
    ...
    .wf-num{width:30px;height:30px;border-radius:10px;flex:0 0 auto;display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:950;background:linear-gradient(180deg, rgba(14,51,68,.12), rgba(14,51,68,.06));border:1px solid rgba(14,51,68,.18);color:var(--caufero-800);}
    ...
    .wf-snum{width:22px;height:22px;border-radius:6px;flex:0 0 auto;margin-top:1px;display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:900;border:1px solid var(--line);background:var(--surface2);color:var(--slate-500);}
    .wf-stext{font-size:12.5px;line-height:1.5;color:var(--slate-700);padding-top:2px;}
    ...
    .enquiry-empty{display:flex;flex-direction:column;align-items:center;justify-content:center;padding:28px 20px;text-align:center;gap:8px;}
    ...
    .rp-stat-bar{height:6px;border-radius:999px;margin-bottom:4px;min-width:4px;}
    ...
    .rp-track{height:8px;border-radius:999px;background:rgba(15,23,42,.06);overflow:hidden;display:flex;margin-bottom:6px;}
    ...
    .active-task-card{display:flex;align-items:flex-start;gap:10px;border:1px solid rgba(183,121,31,.22);background:rgba(183,121,31,.06);border-radius:12px;padding:10px 12px;}
    .active-task-num{width:26px;height:26px;border-radius:8px;flex:0 0 auto;display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:950;background:rgba(183,121,31,.12);border:1px solid rgba(183,121,31,.25);color:var(--amber-600);}
    ...
    @media (max-width: 560px){ .icon-btn-text{display:none;} .topbar-right{gap:6px;} }
  </style>
</body>
</html>