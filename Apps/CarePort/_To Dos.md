...
<head>
  ...
  <title>CarePort — To Dos | Caufero Workspace</title>
</head>
<body>
  <div class="page" data-theme="auto">
      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text">CarePort — To Dos</span>
          </div>
        </div>
    ...
    <div class="shell" id="shell">
      ...
      <!-- ==========================================
           CENTER CONTENT — CAREPORT TO DOS
      =========================================== -->
            ...
            <div class="hero-inner">
              <div class="hero-top">
                  <span style="display:inline-flex;align-items:center;gap:10px;">
                    ...
                    <div class="hero-title">CarePort — To Dos</div>
                  </span>
                <div class="hero-sub">Working plan, task list, and workflow execution for the CarePort project. Keep it tight, updated, and honest.</div>
              </div>
          ...
          <section class="card section" id="tasks">
            <div class="section-head">
              <div class="section-title">
                ...
                <span class="section-sub">0 tasks</span>
              </div>
            </div>

            <div class="task-list">
              <div class="task-item" style="opacity:.75;">
                <div class="task-num" style="background:rgba(148,163,184,.18);color:var(--slate-700);">1</div>
                <div class="task-body">
                  <div class="task-label"><em>None for now.</em></div>
                  <div class="task-note">Add tasks here as soon as they land so this page stays alive.</div>
                </div>
                <div class="task-status muted">
                  <svg viewBox="0 0 24 24" class="ico sm" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
          ...
          <section class="card section" id="workflow">
            <div class="section-head">
              <div class="section-title">
                ...
                <span class="section-sub">0 steps</span>
              </div>
            </div>

            <div class="enquiry-empty" style="margin-top:4px;">
              ...
              <div class="enquiry-sub">Add the workflow only when the project has a repeatable sequence worth tracking</div>
            </div>
          </section>

          <!-- OVERVIEW / WHAT I NEED TO DO NEXT -->
          <section class="card section" id="overview">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">📌</span>
                <span>What I Need To Do Next</span>
                <span class="section-sub">0 items</span>
              </div>
            </div>
            ...
            <div class="enquiry-empty" style="margin-top:4px;">
              ...
              <div class="enquiry-text">None for now</div>
              <div class="enquiry-sub">When a new task shows up, add it here first so it becomes the next move</div>
            </div>
          </section>
      ...
      <!-- ==========================================
           RIGHT RAIL — CAREPORT TO DOS
      =========================================== -->
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          <div class="rail-title">CarePort — To Dos</div>
        ...
        <div class="rail-body">
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">0 tasks right now</div>
            </div>
            <div class="rp-stats">
              <div class="rp-stat">
                <div class="rp-stat-bar done-bar" style="width:0%"></div>
            ...
            <div class="rp-track">
              <div class="rp-fill rp-fill-done" style="width:0%"></div>
              <div class="rp-fill rp-fill-progress" style="width:0%"></div>
            </div>
            <div class="rp-pct">0% complete</div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="active-task-card" style="opacity:.8;">
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Nothing set yet</div>
            </div>
            <div class="stack">
              <div class="stack-item">None for now
                <div class="stack-sub">Add targets when the project enters delivery mode</div>
              </div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">0 tasks wrapped up</div>
            </div>
            <div class="stack">
              <div class="stack-item" style="opacity:.78;">
                <span style="color:var(--slate-500);font-weight:900;margin-right:6px;">•</span> None yet
              </div>
            </div>
          </div>
        ...
        <div class="rail-bottom">
          <div class="rail-foot">
            ...
            <span>CarePort tasks • scroll inside</span>
          </div>
        </div>
      </aside>
    </div>
    ...
    if (query && anyHit){
      ...
      function setActiveNav(label){
        ...
        if (!target){
          ...
          for (var j=0;j<all.length;j++){
            if (((all[j].textContent||"").trim().toLowerCase()) === "CarePort"){ target = all[j]; break; }
          }
        }
        if (target){
