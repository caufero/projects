      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text"> Elimes Outfit  </span>
          </div>
        </div>
          ...
          <section class="hero" id="overview">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">
                  <span style="display:inline-flex;align-items:center;gap:10px;">
                    <img src="elimes_outfit.png" alt="Elimes Outfit" style="width:34px;height:34px;border-radius:10px;object-fit:cover;box-shadow:0 1px 0 rgba(15,23,42,.08),0 10px 22px rgba(15,23,42,.10);" />
                    <span>Elimes Outfit</span>
                  </span>
                </div>
              ...
              <div class="hero-actions">
                ...
                <a class="cta" href="Software Proposal.md">
                  <span class="cta-ico" aria-hidden="true">
                ...
                <a class="cta ghost" href="Software Requirements Pointers.md">
                  <span class="cta-ico" aria-hidden="true">
              ...
              <div class="hero-meta">
                <span class="chip teal">Elimes Outfit</span>
                <span class="chip amber">Proposal</span>
                <span class="chip copper">Requirements</span>
                <span class="chip">_To Dos</span>
              </div>
            </div>
          </section>
          ...
          <section class="card section" id="links">
            <div class="section-head">
              <div class="section-title">
                <span>Links To Elimes Outfit Documents</span>
              </div>
              <div class="section-actions">
                <a class="btn ghost" href="_To Dos.md">_To Dos</a>
                <a class="btn ghost" href="Software Requirements Pointers.md">Requirements</a>
                <a class="btn primary" href="Software Proposal.md">Proposal</a>
              </div>
            </div>

            <div class="grid grid-3">
              <a class="tile app" href="_To Dos.md"><div class="tile-top"><div class="badge">Doc</div><div class="tile-title">_To Dos</div></div><div class="tile-sub">Open document</div></a>
              <a class="tile app accent-sky" href="Software Requirements Pointers.md"><div class="tile-top"><div class="badge sky">Doc</div><div class="tile-title">Software Requirements Pointers</div></div><div class="tile-sub">Open document</div></a>
              <a class="tile app accent-teal" href="Software Proposal.md"><div class="tile-top"><div class="badge teal">Doc</div><div class="tile-title">Software Proposal</div></div><div class="tile-sub">Open document</div></a>
            </div>
          </section>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        ...
        <div class="rail-body">
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              <span class="pill2">Elimes Outfit</span>
              <span class="pill2">Proposal</span>
              <span class="pill2">Requirements</span>
              <span class="pill2">_To Dos</span>
    ...
    if (query && anyHit){
      ...
      function setActiveNav(label){
        ...
        if (!target){
          ...
          for (var j=0;j<all.length;j++){
            if (((all[j].textContent||"").trim().toLowerCase()) === "Elimes Outfilt"){ target = all[j]; break; }
          }
        }
        if (target){
      ...
      function init(){
        ...
        wireDisclosure();
        highlightKeywords();
        setActiveNav("Apps Elimes Outfit");
