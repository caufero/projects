      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text"> I2D    </span>
          </div>
        </div>
        ...
        <div class="content-inner">
          ...
          <section class="hero" id="overview">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">
                  <span style="display:inline-flex;align-items:center;gap:10px;">
                    <img src="i2d.png" alt="I2D" style="width:34px;height:34px;border-radius:10px;object-fit:cover;box-shadow:0 1px 0 rgba(15,23,42,.08),0 10px 22px rgba(15,23,42,.10);" />
                    <span>I2D</span>
                  </span>
                </div>
              ...
              <div class="hero-meta">
                <span class="chip teal">I2D</span>
                <span class="chip amber">Asset Management</span>
                <span class="chip copper">Meeting</span>
          ...
          <section class="card section">
            <div class="section-head">
              ...
              <div class="section-actions">
                <a class="btn ghost" href="#request">Reusable request</a>
              </div>
            </div>
            ...
            <div class="panel-card" style="margin:0;">
              <div class="panel-head">
                ...
                <div class="panel-sub">Next actions</div>
              </div>
              <ul style="margin:12px 0 0 18px;">
                  <li>Put together all documents that have been shared regarding the Asset Management</li>
                  <li>Contact Ferdinand, and have a meeting with him regarding the Asset Management project</li>
              </ul>
            </div>
          </section>
          ...
          <section class="card section" id="links">
            <div class="section-head">
              <div class="section-title">
                <span>Links To I2D Documents</span>
              </div>
              <div class="section-actions">
                <a class="btn primary" href="_To Dos.md">_To Dos</a>
              </div>
            </div>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        ...
        <div class="rail-body">
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              <span class="pill2">I2D</span>
              <span class="pill2">Asset Mgmt</span>
              <span class="pill2">Docs</span>
              <span class="pill2">Meeting</span>
              <span class="pill2">Ferdinand</span>
            </div>
          </div>
        </div>
    ...
    if (query && anyHit){
      ...
      function setActiveNav(label){
        ...
        if (!target){
          ...
          for (var j=0;j<all.length;j++){
            if (((all[j].textContent||"").trim().toLowerCase()) === "I2D"){ target = all[j]; break; }
          }
        }
        if (target){
