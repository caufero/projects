...
<body>
  <div class="page" data-theme="auto">
      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text">Files Shared</span>
          </div>
        </div>
    ...
    <div class="shell" id="shell">
        ...
        <nav class="rail-body" id="navTree">
          ...
          <div class="nav-group open" data-label="Chats">
            ...
            <div class="nav-group-body">
              ...
              <a class="nav-item sub active" href="https://caufero.github.io/projects/Chats/Files%20Shared.md" data-label="Chats Files Shared"><span class="dot"></span><span class="nav-text">Files Shared</span></a>
      ...
      <!-- CENTER COLUMN — CONTAINER INFO CONTENT -->
        ...
        <div class="content-inner">
          ...
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Files Shared Chat</div>
                <div class="hero-sub">Deep dive into container storage, security, and best practices • Reference document from 2016 with modern updates</div>
              </div>
              <div class="hero-meta">
                <span class="chip">Technical Discussion</span>
                <span class="chip teal">Container Fields</span>
                <span class="chip amber">Storage Strategy</span>
                <span class="chip copper">Security</span>
              </div>
            </div>
          </section>

          <!-- Initial Share -->
          <section class="card section" id="chat-initial-share">
            <div class="section-head">
              ...
              <div class="section-actions">
                <span class="chip">3:50 PM</span>
              </div>
            </div>

            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">3:50 PM</span></div>
                <div class="ct-bubble">
                  <strong>Container Info</strong><br><br>
                  <span style="opacity:.75"><em>(Shared an infographic titled "FileMaker Container Fields / Containers: Under the Hood".)</em></span>
                </div>
              </div>
            </div>
            ...
            <div class="ct-callout">
              <div class="ct-callout-head">
                ...
                <div class="ct-callout-title">Container Fields Reference Share</div>
              </div>
              <div class="ct-callout-body">
                Kirk shared a comprehensive "cheat sheet" image about FileMaker <strong>container fields</strong>. The purpose is to quickly teach or remind the team how containers work, especially storage types (embedded vs external), secure vs open storage, server handling, backups, performance, and gotchas like file paths, filenames, streaming, and caching.
              </div>
            </div>
          </section>

          <!-- Container Types -->
          <section class="card section" id="container-types">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">📦</span>
                <span>Container Types — The Basic Ways FileMaker Can Store a File</span>
              </div>
            </div>

            <div class="stack">
              <p style="font-size:13px;color:var(--slate-800);line-height:1.55;margin:0 0 12px 0;">
                A <strong>container field</strong> is a field that stores files like photos, PDFs, videos, Word documents, or any other file type. FileMaker offers three fundamental storage approaches:
              </p>

              <div style="padding:12px 14px;border-radius:14px;border:1px solid var(--line);background:rgba(255,255,255,.70);">
                <h3 style="margin:0 0 8px 0;font-size:13px;font-weight:850;color:var(--slate-800);">A) Embedded Storage</h3>
                <ul class="ul">
                  <li>The file is stored <strong>inside</strong> the FileMaker database.</li>
                  <li>The database file can become very large.</li>
                  <li>Everything stays together, but performance can suffer with many large files.</li>
                </ul>
              </div>

              <div style="padding:12px 14px;border-radius:14px;border:1px solid var(--line);background:rgba(255,255,255,.70);">
                <h3 style="margin:0 0 8px 0;font-size:13px;font-weight:850;color:var(--slate-800);">B) File Reference</h3>
                <ul class="ul">
                  <li>FileMaker does <strong>not</strong> store the file itself.</li>
                  <li>It stores a "pointer" (a link/path) to where the file is on the computer.</li>
                  <li><strong>Warning:</strong> If the file is moved or renamed, the container may break because the pointer is now wrong.</li>
                </ul>
              </div>

              <div style="padding:12px 14px;border-radius:14px;border:1px solid rgba(20,122,116,.22);background:rgba(20,122,116,.08);">
                <h3 style="margin:0 0 8px 0;font-size:13px;font-weight:850;color:var(--teal-700);">C) External Storage (Managed Storage) — RECOMMENDED</h3>
                <ul class="ul">
                  <li>The file is stored <strong>outside</strong> the database in a folder FileMaker manages.</li>
                  <li>The database keeps track of it automatically.</li>
                  <li>This is usually the modern and recommended style for serious solutions.</li>
                  <li>Keeps database size manageable while maintaining full control.</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <!-- Storage Security -->
          <section class="card section" id="storage-security">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">🔒</span>
                <span>Secure Storage vs Open Storage</span>
              </div>
            </div>

            <div class="stack">
              <p style="font-size:13px;color:var(--slate-800);line-height:1.55;margin:0 0 12px 0;">
                When using external storage, FileMaker provides two security approaches:
              </p>

              <div style="padding:12px 14px;border-radius:14px;border:1px solid rgba(91,73,200,.22);background:rgba(91,73,200,.08);">
                <h3 style="margin:0 0 8px 0;font-size:13px;font-weight:850;color:var(--violet-600);">Secure Storage</h3>
                <ul class="ul">
                  <li>FileMaker stores the file outside the database <strong>but encrypts it</strong>.</li>
                  <li>This is safer — files cannot be accessed directly from the file system.</li>
                  <li>Originally used AES-128 encryption (2016), upgraded in recent versions.</li>
                  <li>Folder structure has been consolidated in newer FileMaker versions for better performance.</li>
                </ul>
              </div>

              <div style="padding:12px 14px;border-radius:14px;border:1px solid rgba(183,121,31,.22);background:rgba(183,121,31,.08);">
                <h3 style="margin:0 0 8px 0;font-size:13px;font-weight:850;color:var(--amber-600);">Open Storage</h3>
                <ul class="ul">
                  <li>FileMaker stores the file outside the database <strong>without encrypting it</strong>.</li>
                  <li>It can be faster and easier to work with.</li>
                  <li>Files can be accessed directly from the file system.</li>
                  <li>But it needs good security (permissions, firewall, etc.) because files are more "open".</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <!-- Base Directory -->
          <section class="card section" id="base-directory">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">📁</span>
                <span>Base Directory — The Main Folder</span>
              </div>
            </div>

            <div class="stack">
              <p style="font-size:13px;color:var(--slate-800);line-height:1.55;margin:0;">
                When you use external storage, FileMaker needs a main folder called the <strong>Base Directory</strong>:
              </p>
              <ul class="ul">
                <li>All container files go inside that folder.</li>
                <li>FileMaker organizes files automatically within this directory.</li>
                <li>You can change or move this folder, but you must do it the right way through FileMaker settings.</li>
                <li>The base directory should be on a reliable, backed-up storage system.</li>
              </ul>
            </div>
          </section>

          <!-- Server Management -->
          <section class="card section" id="server-management">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">🖥️</span>
                <span>FileMaker Server Management</span>
              </div>
            </div>

            <div class="stack">
              <p style="font-size:13px;color:var(--slate-800);line-height:1.55;margin:0;">
                If you are using FileMaker Server, it provides powerful management features:
              </p>
              <ul class="ul">
                <li>The server can upload and download container files correctly</li>
                <li>The server includes these files in backups automatically</li>
                <li>Incremental backups are smart: if a file did not change, the server does not waste time copying it again</li>
                <li>Server-side scripts can manage containers efficiently</li>
                <li>Proper caching ensures fast performance for remote users</li>
              </ul>
            </div>
          </section>

          <!-- Converting Storage -->
          <section class="card section" id="converting-storage">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">🔄</span>
                <span>Converting Container Storage</span>
              </div>
            </div>

            <div class="stack">
              <p style="font-size:13px;color:var(--slate-800);line-height:1.55;margin:0 0 12px 0;">
                You can convert container fields from one storage type to another. The conversion process:
              </p>
              <ul class="ul">
                <li>Can move from old embedded style to external managed storage</li>
                <li>Is <strong>transactional</strong> (safer, can be committed or rolled back)</li>
                <li>Is <strong>reversible</strong> (can be undone if needed)</li>
                <li>Shows progress during conversion</li>
                <li>Can be restored if something goes wrong</li>
              </ul>

              <div style="margin-top:12px;padding:12px 14px;border-radius:14px;border:1px solid rgba(20,122,116,.22);background:rgba(20,122,116,.06);">
                <p style="font-size:12px;font-weight:850;color:var(--teal-700);margin:0 0 8px 0;">Pro Tip: Script-Based Conversion</p>
                <p style="font-size:13px;line-height:1.55;margin:0;color:var(--slate-800);">
                  A clever trick for forcing conversion:
                </p>
                <ul class="ul" style="margin-top:8px;">
                  <li>Take the container content into a variable</li>
                  <li>Then put it back into the field</li>
                  <li>This forces FileMaker to store it again in the new style</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <!-- Thumbnails & Caching -->
          <section class="card section" id="thumbnails-caching">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">🖼️</span>
                <span>Thumbnails and Caching — Why Images Load Fast</span>
              </div>
            </div>

            <div class="stack">
              <p style="font-size:13px;color:var(--slate-800);line-height:1.55;margin:0;">
                For images stored in containers, FileMaker optimizes performance:
              </p>
              <ul class="ul">
                <li>FileMaker often sends a smaller version (a thumbnail) first</li>
                <li>That makes screens load faster, especially in list views</li>
                <li>FileMaker also uses caching (it keeps copies in memory so it doesn't re-download the same image again and again)</li>
                <li>The full-size image is downloaded only when needed</li>
                <li>Containers can be very fast if you set them up well</li>
              </ul>
            </div>
          </section>

          <!-- Inserting Files -->
          <section class="card section" id="inserting-files">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">⬆️</span>
                <span>Inserting Files — How Files Enter a Container</span>
              </div>
            </div>

            <div class="stack">
              <p style="font-size:13px;color:var(--slate-800);line-height:1.55;margin:0 0 8px 0;">
                Common ways to add files to containers:
              </p>
              <ul class="ul">
                <li>Drag and drop a file directly into the field</li>
                <li>Insert from a URL (web-based sources)</li>
                <li>Scripts can insert files programmatically</li>
                <li>Users can select files through the Insert File dialog</li>
              </ul>

              <p style="font-size:13px;color:var(--slate-800);line-height:1.55;margin:12px 0 8px 0;">
                Additional options available:
              </p>
              <ul class="ul">
                <li>Allowing only certain file types (validation)</li>
                <li>Compression (zipping) for smaller storage</li>
                <li>File size limits to prevent abuse</li>
          ...
          <section class="card section" id="interactive-containers">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">▶️</span>
                <span>Interactive Containers</span>
              </div>
            </div>

            <div class="stack">
              <p style="font-size:13px;color:var(--slate-800);line-height:1.55;margin:0;">
                A container field is not only for storage. It can also provide rich viewing experiences:
              </p>
              <ul class="ul">
                <li>Display PDFs with native viewers</li>
                <li>Play videos directly in the field</li>
                <li>Show animated GIFs with animation</li>
                <li>Allow PDF search and text copy (platform-dependent)</li>
                <li>Audio playback controls</li>
              </ul>

              <div style="margin-top:12px;padding:12px 14px;border-radius:14px;border:1px solid rgba(183,121,31,.22);background:rgba(183,121,31,.06);">
                <p style="font-size:12px;font-weight:850;color:var(--amber-600);margin:0 0 8px 0;">FileMaker Go Behavior</p>
                <p style="font-size:13px;line-height:1.55;margin:0;color:var(--slate-800);">
                  On FileMaker Go (iPhone/iPad), containers behave differently. Many are interactive by default. Always test container behavior on mobile platforms to ensure the expected user experience.
                </p>
              </div>
            </div>
          </section>
          ...
          <!-- Folder Rules -->
          <section class="card section" id="folder-rules">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">⚠️</span>
                <span>Server File Paths and Names</span>
              </div>
            </div>

            <div class="stack">
              <p style="font-size:13px;color:var(--slate-800);line-height:1.55;margin:0;">
                When FileMaker stores container files in folders, it follows important rules:
              </p>
              <ul class="ul">
                <li>Builds a folder structure based on the base directory plus rules you set</li>
                <li>Tries to keep filenames safe and compatible across platforms</li>
                <li>Warns you to avoid bad characters (slashes, colons, etc.)</li>
                <li>Avoid certain "special" Windows names (CON, PRN, AUX, etc.)</li>
              </ul>

              <div style="margin-top:12px;padding:12px 14px;border-radius:14px;border:1px solid rgba(213,67,46,.22);background:rgba(213,67,46,.08);">
                <p style="font-size:12px;font-weight:900;color:var(--danger);margin:0 0 8px 0;">IMPORTANT WARNINGS</p>
                <ul class="ul">
                  <li><strong>Do not put too many files in one folder:</strong> Huge folders (512+ files on Windows) become slow and messy</li>
                  <li><strong>Do not put many same-name files in one folder:</strong> Name collisions cause problems (this has been improved in newer FileMaker versions)</li>
                  <li>Be careful how you name files and folders</li>
                  <li>Design your storage paths well from the start</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <!-- Tamper Detection -->
          <section class="card section" id="tamper-detection">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">🔐</span>
                <span>Tamper Detection — VerifyContainer()</span>
              </div>
            </div>

            <div class="stack">
              <p style="font-size:13px;color:var(--slate-800);line-height:1.55;margin:0;">
                FileMaker provides the <code style="padding:2px 6px;border-radius:7px;font-size:11.5px;background:rgba(14,51,68,.08);border:1px solid rgba(14,51,68,.12);font-family:ui-monospace,monospace;">VerifyContainer()</code> function to check file integrity:
              </p>
              <ul class="ul">
                <li>Can tell you: "This file is safe and unchanged"</li>
                <li>Or: "Someone modified this file outside FileMaker"</li>
                <li>This is important for security and compliance</li>
                <li>Helps detect unauthorized modifications</li>
                <li>Useful for audit trails and data integrity verification</li>
              </ul>
            </div>
          </section>

          <!-- Streaming Warnings -->
          <section class="card section" id="streaming-warnings">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">📡</span>
                <span>Audio/Video Streaming Warnings</span>
              </div>
            </div>

            <div class="stack">
              <p style="font-size:13px;color:var(--slate-800);line-height:1.55;margin:0;">
                FileMaker can stream media files, but careful setup is required:
              </p>

              <div style="padding:12px 14px;border-radius:14px;border:1px solid rgba(213,67,46,.22);background:rgba(213,67,46,.06);margin-bottom:12px;">
                <p style="font-size:12px;font-weight:900;color:var(--danger);margin:0 0 8px 0;">Security Considerations</p>
                <ul class="ul">
                  <li><strong>Original (2016):</strong> Streaming could be unencrypted HTTP on port 16000</li>
                  <li><strong>Modern (2025):</strong> Now uses HTTPS on port 443</li>
                  <li>Direct URLs could still expose files if security is poor</li>
                  <li>Knowing or guessing a URL remains a potential concern</li>
                  <li>Streaming needs careful configuration and access control</li>
                </ul>
              </div>
              ...
              <ul class="ul">
                <li>Use secure storage for sensitive media</li>
                <li>Implement proper authentication and authorization</li>
                <li>Monitor streaming URLs for unauthorized access attempts</li>
                <li>Consider using FileMaker's built-in security features</li>
              </ul>
            </div>
          </section>

          <!-- Follow-up Discussion -->
          <section class="card section" id="chat-follow-up">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">💬</span>
                <span>Follow-up Discussion — Modern Updates</span>
              </div>
              <div class="section-actions">
                <span class="chip">Dec 30 • 4:23 AM – 1:14 PM</span>
              </div>
            </div>

            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Cyril</span><span class="ct-sep">·</span><span class="ct-time">4:23 AM</span></div>
                <div class="ct-bubble">
                  <strong>To:</strong> Kirk<br>
                  <strong>Topic:</strong> Container Info<br><br>
                  Hi Kirk, thanks for sharing this container fields sheet. Great info.<br><br>
                  I just noticed it was last updated in 2016, so I wanted to confirm whether these points are still valid today:<br><br>
                  • <strong>Secure Storage:</strong> It mentions <strong>AES-128</strong> encryption. Is this still the case today?<br><br>
                  • <strong>Media streaming:</strong> It talks about <strong>port 16000</strong> and says streaming is <strong>unencrypted HTTP</strong>, plus the warning about using direct URLs. Is this still what happens today?<br><br>
                  • <strong>Folder structure:</strong> The warning about <strong>too many files in one folder</strong> and <strong>same-name files</strong>. Is this still the best practice today?
                </div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">1:14 PM</span></div>
                <div class="ct-bubble">
                  Good questions. Here's what's changed:<br><br>
                  • <strong>Secure storage:</strong> There were some significant upgrades in FileMaker a couple versions back that increased security. I do not know the details on this area, but I can find out.<br><br>
                  • <strong>Media streaming:</strong> It is <strong>port 443</strong> now and <strong>HTTPS</strong>, although knowing or guessing a URL is still a potential concern.<br><br>
                  • <strong>Duplicate file names:</strong> This has been resolved. With secure storage, it used to be broken up into a huge number of subdirectories. The latest version consolidates the secure storage directory structure.<br><br>
                  • <strong>Folder size warning (Windows):</strong> There is a long-standing Windows issue (20+ years) where having <strong>more than 512 files</strong> in a single directory can make file access slow because the file list gets re-read repeatedly. I do not know if current Windows versions still have this issue.<br><br>
                  He also adds: there is no good reason to use a Windows machine. 😄
                </div>
              </div>
            </div>
            ...
            <div class="ct-callout">
              <div class="ct-callout-head">
                ...
                <div class="ct-callout-title">Modernization Check-in</div>
              </div>
              <div class="ct-callout-body">
                Cyril is verifying whether a 2016 FileMaker container storage document is still accurate today. He asks about encryption (AES-128), how media streaming works (port 16000 and unencrypted HTTP), and whether folder structure warnings are still best practice. Kirk confirms that FileMaker security has improved in newer versions, media streaming now uses <strong>HTTPS on port 443</strong>, duplicate filenames are no longer an issue, and secure storage folders are now more consolidated. He warns that Windows may still slow down when a folder has over 512 files, but this is a Windows limitation, not a FileMaker one.
              </div>
            </div>
          </section>

          <!-- Key Takeaway -->
          <section class="card section" id="key-takeaway">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">💡</span>
                <span>The Main Point</span>
              </div>
            </div>

            <div class="stack">
              <div style="padding:16px;border-radius:16px;border:1px solid rgba(20,122,116,.25);background:linear-gradient(135deg, rgba(20,122,116,.10), rgba(14,51,68,.06), rgba(255,255,255,.60));">
                <p style="font-size:14px;font-weight:850;color:var(--slate-900);margin:0;line-height:1.55;">
                  Container fields look simple on the surface, but <strong>storage choice, security, backup strategy, performance optimization, and folder management rules matter a lot</strong> for production systems.
                </p>
                <p style="font-size:13px;color:var(--slate-800);margin:12px 0 0 0;line-height:1.55;">
                  The right decisions here can make the difference between a fast, secure, maintainable system and one that struggles with performance, security vulnerabilities, or data loss risks.
                </p>
              </div>
            </div>
          </section>
          ...
          <footer class="footer">
            <div class="footer-left">
              <div class="footer-title">Files Shared Chat</div>
              <div class="footer-sub">Files Shared Chat • 2016 reference with 2025 updates</div>
            </div>
            <div class="footer-right">
              <a class="footer-link" href="#">Container Fields</a>
              <a class="footer-link" href="#">Storage Best Practices</a>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">Quick navigation & key topics</div>
          <div class="rail-actions">
            <a class="rail-btn" href="#chat-initial-share">Initial Share</a>
            <a class="rail-btn" href="#chat-follow-up">Follow-up</a>
            <a class="rail-btn" href="#key-takeaway">Main Point</a>
          </div>
        </div>
        ...
        <div class="rail-body">
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              <span class="pill2">Embedded storage</span>
              <span class="pill2">External storage</span>
              <span class="pill2">Secure vs Open</span>
              <span class="pill2">Base directory</span>
              <span class="pill2">AES encryption</span>
              <span class="pill2">HTTPS streaming</span>
              <span class="pill2">Port 443</span>
              <span class="pill2">VerifyContainer()</span>
              <span class="pill2">Folder limits</span>
              <span class="pill2">Thumbnails</span>
              <span class="pill2">Caching</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">What this discussion covers</div>
            </div>
            <div class="stack">
              <div class="stack-item">Storage Types<div class="stack-sub">Embedded • File Reference • External Managed</div></div>
              <div class="stack-item">Security Levels<div class="stack-sub">Secure (encrypted) vs Open storage</div></div>
              <div class="stack-item">Server Features<div class="stack-sub">Backups • Incremental saves • Upload/download</div></div>
              <div class="stack-item">Performance<div class="stack-sub">Thumbnails • Caching • Folder organization</div></div>
              <div class="stack-item">Security Updates<div class="stack-sub">AES encryption • HTTPS streaming • Port 443</div></div>
              <div class="stack-item">Modern Changes<div class="stack-sub">Consolidated folders • Resolved duplicate names</div></div>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              <div class="stack-item">Kirk<div class="stack-sub">Shared container info sheet • Provided modern updates</div></div>
              <div class="stack-item">Cyril<div class="stack-sub">Verified 2016 info against current best practices</div></div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Best practices summary</div>
            </div>
            <div class="stack">
              <div class="stack-item">Use External Managed Storage<div class="stack-sub">Recommended for production systems</div></div>
              <div class="stack-item">Enable Secure Storage<div class="stack-sub">For sensitive data requiring encryption</div></div>
              <div class="stack-item">Plan Folder Structure<div class="stack-sub">Avoid 512+ files per folder on Windows</div></div>
              <div class="stack-item">Use HTTPS for Streaming<div class="stack-sub">Modern FileMaker defaults to port 443</div></div>
              <div class="stack-item">Test on All Platforms<div class="stack-sub">Especially FileMaker Go for mobile users</div></div>
              <div class="stack-item">Monitor with VerifyContainer()<div class="stack-sub">Check integrity of critical files</div></div>
            </div>
          </div>
