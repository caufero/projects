      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text">TipsTricksTraps</span>
          </div>
        </div>
        ...
        <nav class="rail-body" id="navTree">
          ...
          <div class="nav-group open" data-label="Chats">
            ...
            <div class="nav-group-body">
              ...
              <a class="nav-item sub active" href="https://caufero.github.io/projects/Chats/TipsTricksTraps.md" data-label="Chats TipsTricksTraps"><span class="dot"></span><span class="nav-text">TipsTricksTraps</span></a>
        ...
        <div class="content-inner">
          ...
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Chat Group: TipsTricksTraps</div>
                <div class="hero-sub">Group chat extract • FileMaker development techniques and best practices</div>
              </div>
              <div class="hero-meta">
                <span class="chip">Dev Tips</span>
                <span class="chip teal">FileMaker</span>
                <span class="chip amber">Best Practices</span>
                <span class="chip copper">Code Examples</span>
              </div>
            </div>
          </section>
          ...
          <section class="card section">
            ...
            <div class="ct-callout">
              <div class="ct-callout-head">
                <div class="badge teal">Legend</div>
                <div class="ct-callout-title">Chat Participants</div>
              </div>
              <div class="ct-callout-body">
                <ul class="ul">
                  <li><strong>Kirk</strong> = Kirk (Senior Developer, sharing tips and techniques)</li>
                  <li><strong>Joe</strong> = Joe (Developer, asking questions and validating approaches)</li>
                  <li><strong>Oz</strong> = Oz (Developer, implementing techniques)</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <!-- Day 1: 12 Dec 2025 -->
          <section class="card section" id="chat-dec-12">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">💬</span>
                <span>Thursday, 12 Dec 2025</span>
              </div>
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">8:00:08 PM</span></div>
                <div class="ct-bubble">Placing this script on a button bar segment hidden from all non-development users is a quick method of ensuring that all the fields on a layout are coming from the right TOG. For this to be most effective, TOG naming conventions need to clearly identify which TOG the field comes from.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">8:00:08 PM</span></div>
                <div class="ct-code-block">
                  <div class="ct-code-lang">FileMaker Script</div>
                  <div class="ct-pre"><code># List Fields on Layout)
Set Variable [ $ListFields ; Value: GetFieldsOnLayout ( Get (LayoutName) ) ]
Set Variable [ $ListFields ; Value: Substitute ( $ListFields ; "," ; "¶" ) ]
Show Custom Dialog [ $ListFields ]</code></div>
                </div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">8:55:46 PM</span></div>
                <div class="ct-bubble">When you click on a button bar segment in a list (portal or list view), the button segment highlights for ALL rows. The way around this is to set the segment to "true" or 1, which forces only the selected row to highlight.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Oz</span><span class="ct-sep">·</span><span class="ct-time">9:10:48 PM</span></div>
                <div class="ct-bubble">You and Joe walked me through this trick before. I will put it to use again.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">10:32:02 PM</span></div>
                <div class="ct-bubble">Yep. TipTricksTraps is meant to be a repository of those items. Once you are familiar with Virola, we are planning on shutting off comments in this channel, and only posting the discoveries from other discussions. (I think.... still working out the best way to work this).</div>
              </div>
            </div>
          </section>

          <!-- Day 2: 16 Dec 2025 -->
          <section class="card section" id="chat-dec-16">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">💬</span>
                <span>Monday, 16 Dec 2025</span>
              </div>
              <div class="section-actions">
                <span class="chip">UTC</span>
              </div>
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">5:16:59 PM</span></div>
                <div class="ct-bubble">Trick for converting from 24 hour time to 12 hour.<br><br>Converts the hours portion of a time from 24-hour notation to 12-hour notation. When the 24hTime field contains 16:</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">5:16:59 PM</span></div>
                <div class="ct-code-block">
                  <div class="ct-code-lang">FileMaker Calculation</div>
                  <div class="ct-pre"><code>Mod ( 24hTime ; 12 )</code></div>
                </div>
                <div class="ct-bubble" style="margin-top:10px;">returns 4.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">5:20:13 PM</span></div>
                <div class="ct-bubble">Simple way to implement a transaction. This technique is common for when you do NOT want an implicit commit when a user clicks outside of a field, but only want the fields to be saved on an explicit commit derived from a script execution.<br><br>Typical use case: Card Window Edit, where you don't know if the client wants to accept the changes or opened the edit card by mistake.<br><br><a class="ct-link" href="https://www.fitchandfitch.com/2020/05/modern-commitment/" target="_blank" rel="noreferrer noopener">https://www.fitchandfitch.com/2020/05/modern-commitment/</a></div>
              </div>
            </div>
          </section>
          ...
          <section class="card section" id="chat-dec-18">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">💬</span>
                <span>Wednesday, 18 Dec 2025</span>
              </div>
              <div class="section-actions">
                <span class="chip">UTC</span>
              </div>
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">4:35:06 PM</span></div>
                <div class="ct-bubble"><a class="ct-link" href="https://www.twdesigns.com/filemaker-features/" target="_blank" rel="noreferrer noopener">https://www.twdesigns.com/filemaker-features/</a></div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Oz</span><span class="ct-sep">·</span><span class="ct-time">4:37:11 PM</span></div>
                <div class="ct-bubble">Okay @kirk Thanks</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">4:39:50 PM</span></div>
                <div class="ct-bubble">A productivity gain can often be had by having more than 1 copy of FM open at the same time: one for dev changes, and the other to review the result of the change, all without switching modes. To do this on Mac, you can run this CLI command:</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">4:39:50 PM</span></div>
                <div class="ct-code-block">
                  <div class="ct-code-lang">Bash</div>
                  <div class="ct-pre"><code>open -n /Applications/FM_Folder/'FileMaker Pro.app'</code></div>
                </div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">4:40:42 PM</span></div>
                <div class="ct-bubble">Place this into an automator script (Run Shell Script) if you want easy access.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">4:42:36 PM</span></div>
                <div class="ct-bubble">The price/performance reasons why we use Macs as FMS servers.</div>
              </div>
            </div>
          </section>

          <!-- Day 4: 26 Dec 2025 -->
          <section class="card section" id="chat-dec-26">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">💬</span>
                <span>Thursday, 26 Dec 2025</span>
              </div>
              <div class="section-actions">
                <span class="chip">UTC</span>
              </div>
    ...
    List ( F ; "" ) 
              ...
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">5:47:56 PM</span></div>
                <div class="ct-bubble">It's worth noting that list does not return empty values. If you have 10 related records and 2 of the fields that you are accessing are empty you will only get 8 items in the list.</div>
              </div>
            </div>
          </section>

          <!-- Day 5: 27 Dec 2025 -->
          <section class="card section" id="chat-dec-27">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">💬</span>
                <span>Friday, 27 Dec 2025</span>
              </div>
              <div class="section-actions">
                <span class="chip">UTC</span>
              </div>
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">5:12:21 AM</span></div>
                <div class="ct-bubble">Question: What is the purpose using the List function on a variable that you set as the result of another List function on a set of related values?</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">1:50:42 PM</span></div>
                <div class="ct-bubble">For removing blank lines from multi-line text. (From an FMSoup post)</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">2:01:51 PM</span></div>
                <div class="ct-bubble">oh I see... so the first list returns all values from the related child table including blank lines when the field score is blank. This is a feature of FM: using the List Function on a T.O. group returns every line even when blank.<br><br>Then by running the List Function again on that first list you got, which is now a variable in memory the example calls F, you now can specify two variables, ie F and "" (blank) in the List Function parameters (which is calling list on two or more values, not a related field like the first List function) and List will filter out the blanks and just return the list items in F that have real values.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">2:03:38 PM</span></div>
                <div class="ct-bubble">Assuming this is true, I haven't tested it yet but I have no reason to doubt it, what do you mean by your last paragraph in the example:</div>
                <div class="ct-quote">"It's worth noting that list does not return empty values. If you have 10 related records and 2 of the fields that you are accessing are empty you will only get 8 items in the list."</div>
                <div class="ct-bubble" style="margin-top:10px;">It would seem that when LIST is used with a T.O. group it DOES return empty fields and it is only when you run it the 2nd time against a variable with a parameter of "" that it DOES NOT.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">2:05:39 PM</span></div>
                <div class="ct-bubble">Idk but was intrigued as I always built a loop of getvalue tests to rebuild the text without blanks.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">2:08:07 PM</span></div>
                <div class="ct-bubble">The list commands by default returns a list of non blank values but a text field with blank lines would likely be a good use case.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">2:44:41 PM</span></div>
                <div class="ct-bubble">Okay so in the example from the FMSoup Post, the whole idea of using a Let Statement is unnecessary, perhaps, because this:</div>
                <ul class="ul" style="margin-top:8px;">
                  <li><code>List ( child::score )</code> is valid on its own... no blanks returned</li>
                  <li>And then when you have a variable that you are not sure about, then this:</li>
                  <li><code>F = List(F ; "")</code> is also valid on its own... no blanks returned</li>
                </ul>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">3:03:08 PM</span></div>
                <div class="ct-bubble">I think that is valid. Need to test it but that would be a clean way of removing blank lines.</div>
              </div>
            </div>
            ...
            <div class="ct-callout">
              <div class="ct-callout-head">
                ...
                <div class="ct-callout-title">Understanding List Function Behavior</div>
              </div>
              <div class="ct-callout-body">
                This discussion reveals an important nuance about FileMaker's List() function. When List() is used directly on a related table occurrence group field, it returns all values including blank lines. However, when you use List() on two or more values (like a variable and an empty string), it automatically filters out the blanks. This double-List pattern is a clever way to remove blank lines without needing a loop with GetValue tests.
              </div>
            </div>
          </section>
          ...
          <section class="card section" id="chat-dec-29">
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">6:07:36 PM</span></div>
                <div class="ct-bubble">Sort records by field with no field specified will use the current field. So if you were to place a field from a list into the header, pad it way to the right and set an OnObjectEnter trigger for that field, it would sort the list.<br><br>Limitation: it only works for a single field sort. It uses $$SortOrder to toggle ascending or descending.<br><br>Optionally, the script contains $$Global fields that can be used to create a header presentation of what is being sorted and in what order.</div>
              </div>
              ...
              <div class="ct-msg">
                ...
                <div class="ct-code-block">
                  <div class="ct-code-lang">FileMaker Script</div>
                  <div class="ct-pre"><code>Set Variable [ $PreviousSortField ; Value: $$SortField ]
...
Close Popover</code></div>
            ...
            <div class="ct-callout">
              <div class="ct-callout-head">
                ...
                <div class="ct-callout-title">Click-to-Sort Header Pattern</div>
              </div>
              <div class="ct-callout-body">
                Kirk shares a technique for creating clickable column headers that sort list views. By placing a field in the header with an OnObjectEnter trigger, you can use "Sort Records by Field" without specifying a field name — it automatically uses the active field. The script tracks the previous sort field in $$SortField and toggles between ascending/descending order. This creates a user-friendly sorting experience similar to spreadsheet applications.
              </div>
            </div>
          </section>

          <!-- Day 7: 31 Dec 2025 -->
          <section class="card section" id="chat-dec-31">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">💬</span>
                <span>Tuesday, 31 Dec 2025</span>
              </div>
              <div class="section-actions">
                <span class="chip">UTC</span>
              </div>
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">2:43:53 PM</span></div>
                <div class="ct-bubble">From the esteemed FM developer, Dr. Ray Cologon, on Globals (written 2 decades ago). This is the bible on how globals work. #9 is the basis for the trigger field that evolved into a LET statement variable set from a timestamp.</div>
              </div>
              ...
              <div class="ct-msg">
                ...
                <div class="ct-bubble">
                  <ol class="ul" style="margin-top:8px;">
                    <li>A global calc will update automatically if it references a global field that is located in the same table and that field is edited by the current user.</li>
                    <li>A global calc will update automatically if it references a regular field that is located in the same table (and referenced directly) when that field is edited on any record by the current user. In this instance, the value of the global calc will depend on the value of the referenced field in the record in which that field has most recently been edited. When the global calc references multiple regular fields, its value will depend on the values in the instances of those fields located on the particular record where the most recently edited (by the current user) of any of those fields resides.</li>
                    <li>A global calc will NOT update if it references a global field that is located in another table, if that field is edited by the current user.</li>
                    <li>A global calc will NOT update if it references a global field (in the same table and referenced directly, or in another table) that is edited by different user (users see their own separate global values...).</li>
                    <li>A global calc will NOT update automatically if it references a regular field that is located in the same table (and referenced directly) when that field is edited on any record by another user.</li>
                    <li>A global calc will NOT update automatically if it references a regular field that is located in a related table (even if a self-relation) if that field is edited on any record by the current user or by another user.</li>
                    <li>If a global calc references one or more related fields (as per 3 and 6 above) and ALSO directly references a local field, either global or regular, the value of the global calc will depend on the related values which are current (for the current user) at the time when the local (to the table in which the global calc resides) value/s are edited.</li>
                    <li>The value of a global calc when a solution is opened remotely will be the value that it had on the host when last closed (sound familiar?!).</li>
                    <li>The values of global calcs in a hosted solution can be "tickled" at login by changing a local field which they reference. Example: if there are several dozen global calcs with formulae constructed along the lines of: <code>If ( not IsEmpty ( GlobalsTable::RegularTriggerField ) ; RelatedTable::dataField )</code> then they will all update to reflect the current (related) values at start-up if the start-up script includes: <code>Set Field [ GlobalsTable::RegularTriggerField ; "1" ]</code></li>
                    <li>Changes made to referenced regular fields on another workstation will not appear in global calc results until a refresh event (eg as per 9 above) has occurred on the current workstation - eg the next time the start-up script runs. If there is no triggering mechanism (as per point 9) then the changes will not appear at all until the solution is taken offline, updated in a client session, closed and reopened on the server, as is the case with non-calc globals.</li>
                  </ol>
                </div>
                <div class="ct-bubble" style="margin-top:10px;">As usual, you can take information like this from Dr. Ray to the bank.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">2:48:11 PM</span></div>
                <div class="ct-bubble">I was reading this over yesterday and ALMOST shared it but then I thought... hmmm... some of these may be outdated because of newer changes. But now that it's here, we should look over each one to be sure. Something in that list made me pause yesterday...</div>
              </div>
            </div>
            ...
            <div class="ct-callout">
              <div class="ct-callout-head">
                ...
                <div class="ct-callout-title">Dr. Ray Cologon's Global Field Rules</div>
              </div>
              <div class="ct-callout-body">
                Kirk shares a classic reference document from Dr. Ray Cologon about how global calculations behave in FileMaker, written two decades ago. The ten rules cover when global calcs do and don't update automatically, how they behave in multi-user environments, and the "trigger field" technique (rule #9) for forcing global calcs to refresh at startup by changing a local field they reference. Joe notes they should validate these rules against modern FileMaker behavior, as some details may have changed over the years.
              </div>
            </div>
          </section>

          <!-- Day 8: 02 Jan 2026 -->
          <section class="card section" id="chat-jan-02">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">💬</span>
                <span>Friday, 02 Jan 2026</span>
              </div>
              <div class="section-actions">
                <span class="chip">UTC</span>
              </div>
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">5:44 PM</span></div>
                <div class="ct-bubble">Note: There are 3 script engines on the server, each with their own internal user. The one we commonly run into run away programs on (because us programmers make mistakes and server side errors are not graceful like from the desktop) is the internal user FMSE, which we sometimes have to kill the process to gracefully recover.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">5:58 PM</span></div>
                <div class="ct-bubble">For scripts that are written to run as scheduled scripts, they would ideally be in a folder near the top of the script workspace list of scripts. As solutions garner lots of scripts, being able to FIND in the scheduled script selection window, those scripts appropriate for server side execution makes life easier. There is no search in the script selection window for script scheduler.</div>
              </div>
            </div>
            ...
            <div class="ct-callout">
              <div class="ct-callout-head">
                ...
                <div class="ct-callout-title">Server Script Management Best Practices</div>
              </div>
              <div class="ct-callout-body">
                Kirk gives practical advice about running and managing scripts on FileMaker Server. The server has 3 different script engines, each with its own internal user. The FMSE engine is prone to "runaway" scripts that need to be killed. He recommends organizing scheduled scripts in a dedicated folder near the top of the Script Workspace because the server's script selection window has no search function. This simple organizational pattern makes scheduling faster, reduces mistakes, and keeps server operations cleaner.
              </div>
            </div>
          </section>
          ...
          <footer class="footer">
            <div class="footer-left">
              <div class="footer-title">TipsTricksTraps</div>
              <div class="footer-sub">FileMaker development techniques • Caufero Workspace layout</div>
            </div>
            <div class="footer-right">
              <a class="footer-link" href="#">TipTricksTraps Chat</a>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">Quick navigation & resources</div>
          <div class="rail-actions">
            <a class="rail-btn" href="#chat-dec-12">Dec 12</a>
            <a class="rail-btn" href="#chat-dec-16">Dec 16</a>
            <a class="rail-btn" href="#chat-dec-18">Dec 18</a>
            <a class="rail-btn" href="#chat-dec-26">Dec 26</a>
            <a class="rail-btn" href="#chat-dec-27">Dec 27</a>
            <a class="rail-btn" href="#chat-dec-29">Dec 29</a>
            <a class="rail-btn" href="#chat-dec-31">Dec 31</a>
            <a class="rail-btn" href="#chat-jan-02">Jan 02</a>
          </div>
        </div>
        ...
        <div class="rail-body">
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              <span class="pill2">TOG validation</span>
              <span class="pill2">Button bar highlighting</span>
              <span class="pill2">Time conversion</span>
              <span class="pill2">Transaction pattern</span>
              <span class="pill2">Multiple FM instances</span>
              <span class="pill2">List function</span>
              <span class="pill2">Blank line removal</span>
              <span class="pill2">Click-to-sort</span>
              <span class="pill2">Global calcs</span>
              <span class="pill2">Server scripts</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Referenced links from the chat</div>
            </div>
            <div class="side-grid">
              <a class="side-pill" href="https://www.fitchandfitch.com/2020/05/modern-commitment/" target="_blank" rel="noreferrer noopener">Modern Commitment Pattern</a>
              <a class="side-pill" href="https://www.twdesigns.com/filemaker-features/" target="_blank" rel="noreferrer noopener">TW Designs FM Features</a>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              <div class="stack-item">Field validation script<div class="stack-sub">Check fields come from correct TOG</div></div>
              <div class="stack-item">Button bar behavior<div class="stack-sub">Fix highlighting in lists/portals</div></div>
              <div class="stack-item">Time conversion<div class="stack-sub">24-hour to 12-hour format</div></div>
              <div class="stack-item">Transaction pattern<div class="stack-sub">Explicit vs implicit commits</div></div>
              <div class="stack-item">Development workflow<div class="stack-sub">Multiple FileMaker instances on Mac</div></div>
              <div class="stack-item">List function behavior<div class="stack-sub">Removing blank lines from lists</div></div>
              <div class="stack-item">Sorting pattern<div class="stack-sub">Click-to-sort headers</div></div>
              <div class="stack-item">Global calculations<div class="stack-sub">Dr. Ray Cologon's 10 rules</div></div>
              <div class="stack-item">Server management<div class="stack-sub">Script engines & organization</div></div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">🔧 Key Techniques</div>
              <div class="panel-sub">Reusable patterns</div>
            </div>
            <div class="stack">
              <div class="stack-item">GetFieldsOnLayout()<div class="stack-sub">Validate TOG usage on layouts</div></div>
              <div class="stack-item">Mod ( 24hTime ; 12 )<div class="stack-sub">Convert 24-hour to 12-hour time</div></div>
              <div class="stack-item">List ( F ; "" )<div class="stack-sub">Remove blank lines from lists</div></div>
              <div class="stack-item">Sort Records by Field<div class="stack-sub">Sort by active field</div></div>
              <div class="stack-item">Trigger field pattern<div class="stack-sub">Refresh global calcs on startup</div></div>
            </div>
          </div>
