      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text">Mobile</span>
          </div>
        </div>
    ...
    <div class="shell" id="shell">
        ...
        <nav class="rail-body" id="navTree">
          ...
          <div class="nav-group open" data-label="Chats">
            ...
            <div class="nav-group-body">
              ...
              <a class="nav-item sub active" href="https://caufero.github.io/projects/Chats/Mobile.md" data-label="Chats Mobile"><span class="dot"></span><span class="nav-text">Mobile</span></a>
        ...
        <div class="content-inner">
          ...
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Chat Group: Mobile</div>
                <div class="hero-sub">Key requirements for mobile application design and deployment • Offline-first architecture discussion</div>
              </div>
              <div class="hero-meta">
                <span class="chip">Architecture</span>
                <span class="chip teal">Mobile Development</span>
                <span class="chip violet">Offline-First</span>
                <span class="chip amber">iPhone Priority</span>
              </div>
            </div>
          </section>
          ...
          <section class="card section" id="chat-dec-30">
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">3:41 PM</span></div>
                <div class="ct-bubble">
                  <strong>Key Application Architecture required attributes for mobile apps</strong> (independent of deployment environment):
                  
                  <ol class="ct-list" style="margin-top:12px;">
                    <li>Be able to operate in untethered (no internet connection) with at least field operational requirements available</li>
                    <li>Be able to allow application upgrade in place, without loss of existing mobile data
                      <ul class="ct-sublist">
                        <li>Option 1 - ideally without a server connection</li>
                        <li>Option 2 - with FMS server, but may negate the cost benefit of a single user mobile app</li>
                      </ul>
                    </li>
                    <li>Be able to push new data (e.g. updated work assignments) to the mobile devices when connected</li>
                    <li>Be able to be transitioned relatively easily to a client-server SYNC model, but retain the untethered operational capabilities</li>
                    <li>In a client-server model configuration, where back office functionality is to be executable, needs to be defined.</li>
                    <li>Design-first imperative to mobile, with iPhone as the primary target (due to availability of voice communications independent of cellular data connectivity)</li>
                  </ol>
                </div>
              </div>
              ...
              <div class="ct-msg">
                ...
                <div class="ct-bubble">
                  <div class="ct-quote">
                    <strong>Additional factors</strong><br><br>
                    • iPhone NITS (brightness) on 14 Pro, all 15 and 17 models is 2000 NITS<br>
                    • vs 500 for an iPad and 700 for an iPad Pro<br>
                    • iPhone 17 is 3000 NITS<br>
                    • the iPad is almost unusable in direct sunlight
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="ct-callout">
              <div class="ct-callout-head">
                ...
                <div class="ct-callout-title">Mobile Architecture Requirements</div>
              </div>
              <div class="ct-callout-body">
                Kirk is listing the must-have requirements for the mobile app architecture. The app should work <strong>offline in the field</strong>, update without losing data, and sync or receive new work assignments when the device reconnects. He also wants the design to make it easy to move to a <strong>client-server sync setup later</strong>, and to clearly define what back-office actions will run on the server. Finally, he is pushing for <strong>iPhone-first design</strong> because iPhones are much brighter and more usable outdoors than iPads, especially in direct sunlight.
                <br><br>
                Key takeaways:
                <ul class="ul">
                  <li><strong>Offline-first:</strong> App must work without internet connection</li>
                  <li><strong>In-place upgrades:</strong> Update app without losing mobile data</li>
                  <li><strong>Sync capability:</strong> Push new assignments when connected</li>
                  <li><strong>Future-proof:</strong> Easy transition to client-server sync model</li>
                  <li><strong>iPhone priority:</strong> 2000-3000 NITS vs iPad's 500-700 NITS makes iPhone far superior for outdoor field work</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <footer class="footer">
            <div class="footer-left">
              ...
              <div class="footer-sub">Requirements for offline-first mobile development</div>
            </div>
            <div class="footer-right">
              <a class="footer-link" href="#">Mobile Chat</a>
              <a class="footer-link" href="#">4K Project</a>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">Chat navigation</div>
        ...
        <div class="rail-body">
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              ...
              <span class="pill2">In-place upgrade</span>
              <span class="pill2">Sync model</span>
              <span class="pill2">iPhone priority</span>
              <span class="pill2">NITS brightness</span>
              <span class="pill2">Field operations</span>
              <span class="pill2">Client-server</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">6 essential architecture attributes</div>
            </div>
            <div class="stack">
              <div class="stack-item">Offline Operation<div class="stack-sub">Must work untethered in the field</div></div>
              <div class="stack-item">In-Place Upgrades<div class="stack-sub">Update without data loss</div></div>
              <div class="stack-item">Data Push<div class="stack-sub">Receive assignments when connected</div></div>
              <div class="stack-item">Sync Transition<div class="stack-sub">Easy move to client-server model</div></div>
              <div class="stack-item">Back Office Definition<div class="stack-sub">Clarify server-side functionality</div></div>
              <div class="stack-item">iPhone-First<div class="stack-sub">Primary target platform</div></div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">📱 Device Brightness</div>
              <div class="panel-sub">NITS comparison for outdoor use</div>
            </div>
            <div class="stack">
              <div class="stack-item">iPhone 14 Pro, 15, 16<div class="stack-sub">2000 NITS</div></div>
              <div class="stack-item">iPhone 17<div class="stack-sub">3000 NITS</div></div>
              <div class="stack-item">iPad<div class="stack-sub">500 NITS</div></div>
              <div class="stack-item">iPad Pro<div class="stack-sub">700 NITS</div></div>
              <div class="stack-item warn">⚠️ iPad Issue<div class="stack-sub">Almost unusable in direct sunlight</div></div>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              <div class="stack-item">Kirk<div class="stack-sub">Architecture requirements • Mobile strategy</div></div>
            </div>
          </div>
