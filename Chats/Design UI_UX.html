        ...
        <nav class="rail-body" id="navTree">
          ...
          <div class="nav-group open" data-label="Chats">
            ...
            <div class="nav-group-body">
              ...
              <a class="nav-item sub active" href="https://caufero.github.io/projects/Chats/Design%20UI_UX.md" data-label="Chats Design UI_UX"><span class="dot"></span><span class="nav-text">Design UI_UX</span></a>
        ...
        <div class="content-inner">
          ...
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">UX/UI Design Resources Discussion</div>
                <div class="hero-sub">Professional design standards and workflow frameworks for FileMaker development</div>
              </div>
              <div class="hero-actions">
                <a class="cta" href="https://developer.apple.com/design/human-interface-guidelines/" target="_blank">
                ...
                <a class="cta ghost" href="https://www.fmdesignuniversity.com/" target="_blank">
                  <span class="cta-ico" aria-hidden="true">
                    <svg viewBox="0 0 24 24" class="ico" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                      <path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path>
                      <path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path>
              ...
              <div class="hero-meta">
                <span class="chip">Design Resources</span>
                <span class="chip teal">UX/UI Standards</span>
                <span class="chip amber">Workflow Design</span>
                <span class="chip copper">FileMaker</span>
              </div>
            </div>
          </section>

          <!-- Chat Section: 30 Dec 2025 -->
          <section class="card section" id="chat-dec-30">
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta">
                  ...
                  <span class="ct-time">5:53:10 PM</span>
                </div>
                <div class="ct-bubble">Apple Human Interface Guidelines link</div>
              </div>
              ...
              <div class="ct-msg">
                <div class="ct-meta">
                  <span class="ct-name">Joe</span>
                  <span class="ct-sep">·</span>
                  <span class="ct-time">5:53:11 PM</span>
                </div>
                <div class="ct-bubble">
                  <a class="ct-link" href="https://developer.apple.com/design/human-interface-guidelines/" target="_blank" rel="noopener">https://developer.apple.com/design/human-interface-guidelines/</a>
                </div>
              </div>
              ...
              <div class="ct-msg">
                <div class="ct-meta">
                  <span class="ct-name">Joe</span>
                  <span class="ct-sep">·</span>
                  <span class="ct-time">5:59:07 PM</span>
                </div>
                <div class="ct-bubble">
                  The Workflow Design Framework by FM Design University (Alexis Allen, Toronto, CA). Teaching UX and UI design, and why that matters.
                </div>
              </div>
              ...
              <div class="ct-msg">
                <div class="ct-meta">
                  <span class="ct-name">Joe</span>
                  <span class="ct-sep">·</span>
                  <span class="ct-time">5:59:37 PM</span>
                </div>
                <div class="ct-bubble">
                  <a class="ct-link" href="https://www.fmdesignuniversity.com/" target="_blank" rel="noopener">https://www.fmdesignuniversity.com/</a>
                </div>
              </div>
            </div>
            ...
            <div class="ct-callout">
              <div class="ct-callout-head">
                ...
                <div class="ct-callout-title">Design Standards &amp; Workflow Framework</div>
              </div>
              <div class="ct-callout-body">
                Joe drops two resources. Two simple links. One clear agenda: design your screens and workflows like a pro.
                <ul class="ul">
                  <li><strong>First link: Apple Human Interface Guidelines.</strong> This is the clean interface playbook. It teaches consistency, spacing, clarity, and interaction patterns that feel natural to users.</li>
                  <li><strong>Second link: FM Design University.</strong> This one is FileMaker-focused. It is about workflow design. It teaches you how to think through steps, reduce friction, and build layouts that guide people smoothly.</li>
                  <li><strong>The purpose is straight.</strong> Use Apple HIG as your standard for interface quality. Use FM Design University to translate that quality into FileMaker workflows that feel obvious, fast, and professional.</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <section class="card section" id="markdown-reference">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">📝</span>
            ...
            <div class="ct-prompt">
              <div class="ct-prompt-title">Copyable Markdown Format</div>
              <div class="ct-pre"><code>### Group Chat Excerpt (30 Dec 2025)

**[30/12/2025 5:53:10 PM +0000] Joe:**  
Apple Human Interface Guidelines link

**[30/12/2025 5:53:11 PM +0000] Joe:**  
https://developer.apple.com/design/human-interface-guidelines/

**[30/12/2025 5:59:07 PM +0000] Joe:**  
The Workflow Design Framework by FM Design University (Alexis Allen, Toronto, CA). Teaching UX and UI design, and why that matters.

**[30/12/2025 5:59:37 PM +0000] Joe:**  
https://www.fmdesignuniversity.com/</code></div>
            </div>
          </section>
          ...
          <footer class="footer">
            <div class="footer-left">
              <div class="footer-title">UX/UI Design Resources Chat</div>
              <div class="footer-sub">Professional standards for FileMaker development</div>
            </div>
            <div class="footer-right">
              <a class="footer-link" href="https://developer.apple.com/design/human-interface-guidelines/" target="_blank">Apple HIG</a>
              <a class="footer-link" href="https://www.fmdesignuniversity.com/" target="_blank">FM Design Uni</a>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">Quick reference & resources</div>
          <div class="rail-actions">
            <a class="rail-btn" href="#chat-dec-30">Chat</a>
            <a class="rail-btn" href="#markdown-reference">Markdown</a>
          </div>
        </div>
        ...
        <div class="rail-body">
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              <span class="pill2">Apple HIG</span>
              <span class="pill2">UX/UI</span>
              <span class="pill2">Design standards</span>
              <span class="pill2">Workflow</span>
              <span class="pill2">FileMaker</span>
              <span class="pill2">Interface quality</span>
              <span class="pill2">Professional</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">External design resources</div>
            </div>
            <div class="side-grid">
              <a class="side-pill warn" href="https://developer.apple.com/design/human-interface-guidelines/" target="_blank">Apple HIG</a>
              <a class="side-pill warn" href="https://www.fmdesignuniversity.com/" target="_blank">FM Design Uni</a>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">About this conversation</div>
            </div>
            <div class="stack">
              <div class="stack-item">Participant<div class="stack-sub">Joe • Shared design resources</div></div>
              <div class="stack-item">Date<div class="stack-sub">30 Dec 2025 • ~6 minutes duration</div></div>
              <div class="stack-item">Topic<div class="stack-sub">UX/UI design standards and workflow frameworks</div></div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Essential points</div>
            </div>
            <div class="stack">
              <div class="stack-item">Apple HIG<div class="stack-sub">Standard for clean, consistent interface design</div></div>
              <div class="stack-item">FM Design University<div class="stack-sub">FileMaker-specific workflow design framework</div></div>
              <div class="stack-item">Professional Quality<div class="stack-sub">Combine both resources for production-grade FileMaker apps</div></div>
            </div>
          </div>
