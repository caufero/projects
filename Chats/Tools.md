...
<body>
  <div class="page" data-theme="auto">
      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text">Tools</span>
          </div>
        </div>
    ...
    <div class="shell" id="shell">
        ...
        <nav class="rail-body" id="navTree">
          ...
          <div class="nav-group open" data-label="Chats">
            ...
            <div class="nav-group-body">
              ...
              <a class="nav-item sub active" href="https://caufero.github.io/projects/Chats/Tools.md" data-label="Chats Tools"><span class="dot"></span><span class="nav-text">Tools</span></a>
            </div>
          </div>
        ...
        <div class="content-inner">
          ...
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Group Chat: Tools</div>
                <div class="hero-sub">Group chat discussing development tools, OTTO stack, workflow organization, and WebViewer utilities</div>
              </div>
              <div class="hero-actions">
                ...
                <a class="cta" href="https://www.proofgeist.com/" target="_blank">
                  <span class="cta-ico" aria-hidden="true">
                    <svg viewBox="0 0 24 24" class="ico" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              ...
              <div class="hero-meta">
                <span class="chip">Tool Inventory</span>
                <span class="chip teal">Dev Workflow</span>
                <span class="chip amber">OTTO Stack</span>
                <span class="chip copper">Proof+Geist</span>
              </div>
            </div>
          </section>

          <!-- Section: Server Update -->
          <section class="card section" id="chat-server-update">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">🖥️</span>
                <span>Server Update Required</span>
              </div>
              <div class="section-actions">
                <span class="chip">Dec 6, 2025</span>
              </div>
            </div>
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                ...
                <div class="ct-bubble">OttoFMS and ottodeploy needs to be updated on PBTS dev server</div>
              </div>
            </div>

            <div class="ct-callout">
              <div class="ct-callout-head">
                <div class="badge violet">Action Item</div>
                <div class="ct-callout-title">Development Server Maintenance</div>
              </div>
              <div class="ct-callout-body">
                Kirk identifies that the PBTS development server needs updates to its OTTO tooling. This is a maintenance task to keep the deployment and server management tools current.
              </div>
            </div>
          </section>

          <!-- Section: FMPerception Tools -->
          <section class="card section" id="chat-perception-tools">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">🔍</span>
                <span>FMPerception & Development Tools</span>
              </div>
              <div class="section-actions">
                <span class="chip">Dec 29, 2025</span>
              </div>
            </div>

            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">2:18 PM</span></div>
                <div class="ct-bubble">As we all know, Proof and Geist have some pretty awesome developer support tools. One of them, FMPerception, Kirk and I currently use and it is a paid subscription. The current cost for a 5 seat license is $900 per year or $180 per person or $15 per user per month.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">2:25 PM</span></div>
                <div class="ct-bubble">Along with FM Perception comes another tool called FMComparison. We also use this tool although I do not use it much currently, it is good for multi-user development environments. It allows one to compare one FM application against another one. What it produces is an ACTIONABLE list of differences between those two FM applications. So for example, if we are working together on the development copy of the 4K Painting application, we could run a comparison with the production application and get a list of the changes that have been made.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">2:27 PM</span></div>
                <div class="ct-bubble">There is also FMLayoutLens (incl with FMPerception license), which produces a 3d wireframe of any given layout. Really useful for debugging layout issues</div>
              </div>
            </div>

            <div class="ct-callout">
              <div class="ct-callout-head">
                <div class="badge teal">Tool Suite</div>
                <div class="ct-callout-title">FMPerception Development Package</div>
              </div>
              <div class="ct-callout-body">
                Joe introduces the FMPerception tool suite that the American team currently uses. This is a paid subscription service from Proof+Geist.
                <ul class="ul">
                  <li><strong>FMPerception:</strong> Main development support tool - $900/year for 5 seats ($15/user/month)</li>
                  <li><strong>FMComparison:</strong> Included with FMPerception - compares two FileMaker files and produces an actionable list of differences. Essential for multi-developer workflows to track what changed between dev and production.</li>
                  <li><strong>FMLayoutLens:</strong> Also included - generates 3D wireframes of layouts for debugging layout issues</li>
                </ul>
                These tools are particularly valuable when multiple developers work on the same FileMaker solution.
              </div>
            </div>
          </section>

          <!-- Section: Integrations -->
          <section class="card section" id="chat-integrations">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">🔗</span>
                <span>Integration Tools & API Utilities</span>
              </div>
              <div class="section-actions">
                <span class="chip">Dec 29, 2025</span>
              </div>
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">2:32 PM</span></div>
                <div class="ct-bubble">Another paid tool that I currently have licensed for another month is called LEDGERLINK. This is a way to connect FM apps to the Quickbooks ONLINE application. It costs $500 per year. There are over 5 million users of Quickbooks Online worldwide. So far I have used this in two different applications: the one Kirk and I did for the aerospace company in Arizona a few years back and for my own application for AZSafetySupply currently code named HedgeHog. It takes a bit of getting used to but it's a real time saver and well worth it IF your client uses Quickbooks and needs/wants this real time connectivity.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">2:33 PM</span></div>
                <div class="ct-bubble">Also if you are running PAW (now named RapidAPI) instead of PostMan, this plug in from proof-Geist adds auto conversion from standard cURL to FM syntax <a class="ct-link" href="https://www.proofgeist.com/blog/2019/04/20/filemaker-code-generator-for-paw/" target="_blank">https://www.proofgeist.com/blog/2019/04/20/filemaker-code-generator-for-paw/</a></div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">2:36 PM</span></div>
                <div class="ct-bubble">Cool free utility - <a class="ct-link" href="https://www.proofgeist.com/utilities-mod-log/" target="_blank">https://www.proofgeist.com/utilities-mod-log/</a> - takes your xml output and tells you everything that was changed since the last xml save along with who did it when</div>
              </div>
            </div>

            <div class="ct-callout">
              <div class="ct-callout-head">
                <div class="badge amber">Integration Tools</div>
                <div class="ct-callout-title">QuickBooks, API Development & Change Tracking</div>
              </div>
              <div class="ct-callout-body">
                <ul class="ul">
                  <li><strong>LedgerLink:</strong> Paid tool ($500/year) for connecting FileMaker to QuickBooks Online. Joe has used it successfully in multiple projects. Worth the investment if clients need real-time QuickBooks integration.</li>
                  <li><strong>PAW/RapidAPI Plugin:</strong> Free utility that converts standard cURL commands to FileMaker syntax - speeds up API development work.</li>
                  <li><strong>Mod Log:</strong> Free utility that analyzes XML exports to show what changed since the last save, including who made the changes and when. Excellent for version control and change tracking.</li>
                </ul>
              </div>
            </div>
          </section>

          <!-- Section: Utilities & Workflow -->
          <section class="card section" id="chat-utilities">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">🛠️</span>
                <span>Tool Awareness & Workflow Organization</span>
              </div>
              <div class="section-actions">
                <span class="chip">Dec 29, 2025</span>
              </div>
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">3:56 PM</span></div>
                <div class="ct-bubble">I thought it would be good to put these out here for reference and just to make Caufero aware of the tools we have access to and experience in. So I will continue listing a few others.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">3:59 PM</span></div>
                <div class="ct-bubble">The ones above are just Proof-Geist stuff too!!</div>
              </div>
            </div>

            <div class="ct-callout">
              <div class="ct-callout-head">
                <div class="badge slate">Context</div>
                <div class="ct-callout-title">Purpose of This Discussion</div>
              </div>
              <div class="ct-callout-body">
                Joe explains this is a knowledge-sharing session to make Caufero aware of all the tools the American team has access to and experience with. Kirk emphasizes that these are just the Proof+Geist tools - there are more tools from other sources as well. This is building a shared reference library for the entire team.
              </div>
            </div>
          </section>

          <!-- Section: New Groups -->
          <section class="card section" id="chat-groups">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">📁</span>
                <span>New Topic Groups</span>
              </div>
              <div class="section-actions">
                <span class="chip">Dec 29, 2025</span>
              </div>
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">4:01 PM</span></div>
                <div class="ct-bubble">I am also going to add (4) New Groups: OTTO, Javascript, APIs & Webhooks and OData. There will be some overlap between these four. For example, Otto implements Webhooks and Proof Geist has some free tools to handle Javascript. And yet API/Webhooks is a topic that extends much farther than tool usage and so is Javascript, etc.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">4:01 PM</span></div>
                <div class="ct-bubble">Works for me :-)</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">4:17 PM</span></div>
                <div class="ct-bubble"><strong>Proof and Geist tools (con't)</strong><br><br>OTTO - which includes OttoMatic, OttoFMS and OttoDeploy<br><br>These are VERY important to understand and I will go over them in more detail in the group I'm making for OTTO</div>
              </div>
            </div>

            <div class="ct-callout">
              <div class="ct-callout-head">
                <div class="badge violet">Organization</div>
                <div class="ct-callout-title">Four New Discussion Groups</div>
              </div>
              <div class="ct-callout-body">
                Joe announces he's creating four new topic-focused groups to organize team knowledge:
                <ul class="ul">
                  <li><strong>OTTO:</strong> Covers Ottomatic, OttoFMS, and OttoDeploy - critical server management and deployment tools</li>
                  <li><strong>JavaScript:</strong> JavaScript development and WebViewer work</li>
                  <li><strong>APIs & Webhooks:</strong> API integration and webhook implementation</li>
                  <li><strong>OData:</strong> OData protocol and usage</li>
                </ul>
                Joe acknowledges there will be overlap (e.g., OTTO implements webhooks, Proof+Geist has JavaScript tools), but each topic deserves its own focused discussion since they extend beyond just tool usage.
              </div>
            </div>
          </section>

          <!-- Section: SVG & WebViewer -->
          <section class="card section" id="chat-svg-webviewer">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">🎨</span>
                <span>SVG Tools & WebViewer Utilities</span>
              </div>
              <div class="section-actions">
                <span class="chip">Dec 29, 2025</span>
              </div>
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">4:23 PM</span></div>
                <div class="ct-bubble"><strong>Miscellaneous Tools from Proof & Geist.</strong><br><br>These are basically utilities and one offs. For example Mod Log as Kirk mentioned above.<br><br>There is also FMSvg which Kirk showed to Cyril the other day which allows you to take an existing SVG file and convert it into a form that works better with FM. There was a discussion on this earlier about black and white icons in FM and screens, etc. Kirk is a great source to go to for questions. All we need to know now is that if Caufero grabs an SVG file from somewhere, like the svgrepo dot com website Cyril shared, dropping it into the online FMSVGinator will add some code that is good for FM. However if your SVGs are looking good without that, you won't need to do it.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">4:25 PM</span></div>
                <div class="ct-bubble">Without the additional SVG grammar, state color settings will not be available - assuming you want to use colors in icons</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">4:27 PM</span></div>
                <div class="ct-bubble">There are also a number of free tools for use with Javascript and the Web viewer FM under advanced tools. Do not confuse these with the new Proof_Kit from P&G because that is a pnpm script that is used to launch a Next.js web application. A tool, kind of, but more in line with connecting a Next.js web application to FM.</div>
              </div>
            </div>

            <div class="ct-callout">
              <div class="ct-callout-head">
                <div class="badge teal">Utilities</div>
                <div class="ct-callout-title">SVG Processing & WebViewer Tools</div>
              </div>
              <div class="ct-callout-body">
                <ul class="ul">
                  <li><strong>FMSVGinator (FMSvg):</strong> Free online tool that converts standard SVG files into FileMaker-optimized format. Kirk demonstrated this to Cyril recently. Important note from Kirk: without the additional SVG grammar this tool adds, you won't have state-based color control for icons.</li>
                  <li><strong>JavaScript & WebViewer Tools:</strong> Proof+Geist offers free utilities for JavaScript and WebViewer work in FileMaker.</li>
                  <li><strong>Proof_Kit:</strong> Joe warns not to confuse the small utilities with Proof_Kit, which is actually a pnpm script for launching Next.js applications connected to FileMaker - a different category of tool.</li>
                </ul>
              </div>
            </div>
          </section>

          <!-- Section: Raycast & SimpleQ -->
          <section class="card section" id="chat-raycast-simpleq">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">⚡</span>
                <span>Raycast Snippets & SimpleQ Webhooks</span>
              </div>
              <div class="section-actions">
                <span class="chip">Dec 29, 2025</span>
              </div>
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">4:31 PM</span></div>
                <div class="ct-bubble">Also there is a free add-on to use with RayCast called FileMaker Snippets. I use this to add code snippets to FM applications as I showed you guys last week. There is also a library of free filemaker code snippets from P&G that you can download from Github to use WITH the FileMaker Snippets app in RayCast. I prefer to write my own code but I downloaded it anyway so I could look over how they code and maybe learn from it or use some of it.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">4:36 PM</span></div>
                <div class="ct-bubble">Finally, at least for my additions here, there is an FM application called SimpleQ which Kirk mentioned last week. I'm keeping this one separate because I would like us all to do a session sometime where we explore the SimpleQ concept in more depth. Also a bonus is that if we integrate this into any of our FM apps, it is designed to work with the Webhooks facility that's built into Otto.<br><br>So again there is overlap in some of these areas. Webhooks are more in the family of APIs. Otto is more of a server management tool that allows you to manage APIs and Webhooks. But in order to be able to manage APIs and Webhooks, we have to know what they are and why and when to use them. SimpleQ is just one FM app that uses Webhooks to do what it does. So it's a good piece for us not only to possibly use but it is also a simple learning platform for how to use webhooks.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">4:38 PM</span></div>
                <div class="ct-bubble">Even though you can, and should, read about all these add-ons, utilities and tools from the Proof & Geist website, I wanted to list them all here one time for reference and so that we are all on the same page when it comes to this subset of tools just from P&G. :)</div>
              </div>
            </div>

            <div class="ct-callout">
              <div class="ct-callout-head">
                <div class="badge amber">Workflow Tools</div>
                <div class="ct-callout-title">Code Snippets & Webhook Learning</div>
              </div>
              <div class="ct-callout-body">
                <ul class="ul">
                  <li><strong>Raycast FileMaker Snippets:</strong> Free add-on for Raycast that Joe demonstrated last week. Lets you save and quickly insert FileMaker code snippets. Proof+Geist provides a free snippet library on GitHub that works with this tool.</li>
                  <li><strong>SimpleQ:</strong> FileMaker application that Kirk mentioned. Joe wants to explore this as a team in a future session because it's both potentially useful AND a great learning platform for webhooks. SimpleQ is designed to work with OTTO's webhook facility, making it perfect for understanding how webhooks work in practice.</li>
                  <li><strong>Key Insight:</strong> Joe explains the relationships between these tools: Webhooks are part of the API family, OTTO manages APIs and webhooks, but to use these tools effectively, the team needs to understand the underlying concepts - which is why he's organizing dedicated discussion groups.</li>
                </ul>
                <strong>Final Note:</strong> This list represents just the Proof+Geist tools the team has experience with, serving as a shared reference so everyone is on the same page.
              </div>
            </div>
          </section>
          ...
          <footer class="footer">
            <div class="footer-left">
              ...
              <div class="footer-sub">Development tools, OTTO stack, and workflow organization</div>
            </div>
            <div class="footer-right">
              <a class="footer-link" href="https://www.proofgeist.com/" target="_blank">Proof+Geist</a>
              <a class="footer-link" href="#">Tools Reference</a>
      ...
      <!-- ============================================================
           RIGHT RAIL — TOOLS CHAT SPECIFIC
           ============================================================ -->
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          <div class="rail-title">Right Panel</div>
          <div class="rail-sub">Tools chat navigation</div>
          <div class="rail-actions">
            <a class="rail-btn" href="#chat-perception-tools">FMPerception</a>
            <a class="rail-btn" href="#chat-integrations">Integrations</a>
            <a class="rail-btn" href="#chat-groups">New Groups</a>
            <a class="rail-btn" href="#chat-raycast-simpleq">SimpleQ</a>
          </div>
        </div>
        ...
        <div class="rail-body">
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              <span class="pill2">FMPerception</span>
              <span class="pill2">FMComparison</span>
              <span class="pill2">OTTO Stack</span>
              <span class="pill2">LedgerLink</span>
              <span class="pill2">Mod Log</span>
              <span class="pill2">Webhooks</span>
              <span class="pill2">SimpleQ</span>
              <span class="pill2">Raycast</span>
              <span class="pill2">FMSVGinator</span>
              <span class="pill2">API Tools</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="side-grid">
              <a class="side-pill warn" href="https://www.proofgeist.com/" target="_blank">Proof+Geist Website</a>
              <a class="side-pill warn" href="https://www.proofgeist.com/utilities-mod-log/" target="_blank">Mod Log Utility</a>
              <a class="side-pill" href="https://www.proofgeist.com/blog/2019/04/20/filemaker-code-generator-for-paw/" target="_blank">PAW Plugin</a>
              <a class="side-pill" href="#tools-perception">FMPerception</a>
              <a class="side-pill" href="#tools-otto">OTTO Stack</a>
              <a class="side-pill" href="#chat-raycast-simpleq">SimpleQ</a>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              <div class="stack-item">Joe<div class="stack-sub">Tool curator • Creating reference library for team</div></div>
              <div class="stack-item">Kirk<div class="stack-sub">Technical expert • Tool usage insights</div></div>
              <div class="stack-item">Caufero Team<div class="stack-sub">Learning about available tools and workflows</div></div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">🛠️ Tools Covered</div>
              <div class="panel-sub">Complete tool inventory</div>
            </div>
            <div class="stack">
              <div class="stack-item">FMPerception Suite<div class="stack-sub">Paid • $900/year for 5 seats • Includes FMComparison & FMLayoutLens</div></div>
              <div class="stack-item">LedgerLink<div class="stack-sub">Paid • $500/year • QuickBooks Online integration</div></div>
              <div class="stack-item">OTTO Stack<div class="stack-sub">OttoFMS, OttoDeploy, Ottomatic • Server & deployment management</div></div>
              <div class="stack-item">Mod Log<div class="stack-sub">Free • XML change tracking utility</div></div>
              <div class="stack-item">FMSVGinator<div class="stack-sub">Free • SVG optimization for FileMaker</div></div>
              <div class="stack-item">PAW/RapidAPI Plugin<div class="stack-sub">Free • cURL to FileMaker conversion</div></div>
              <div class="stack-item">Raycast Snippets<div class="stack-sub">Free • Code snippet management</div></div>
              <div class="stack-item">SimpleQ<div class="stack-sub">FileMaker app • Webhook learning platform</div></div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">📁 New Discussion Groups</div>
              <div class="panel-sub">Topics being organized</div>
            </div>
            <div class="stack">
              <div class="stack-item">OTTO<div class="stack-sub">Ottomatic, OttoFMS, OttoDeploy - deployment & server management</div></div>
              <div class="stack-item">JavaScript<div class="stack-sub">JavaScript development & WebViewer work</div></div>
              <div class="stack-item">APIs & Webhooks<div class="stack-sub">API integration & webhook implementation</div></div>
              <div class="stack-item">OData<div class="stack-sub">OData protocol usage & best practices</div></div>
            </div>
          </div>
