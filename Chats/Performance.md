      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text">Performance</span>
          </div>
        </div>
    ...
    <div class="shell" id="shell">
        ...
        <nav class="rail-body" id="navTree">
          ...
          <div class="nav-group open" data-label="Chats">
            ...
            <div class="nav-group-body">
              ...
              <a class="nav-item sub active" href="https://caufero.github.io/projects/Chats/Performance.md" data-label="Chats Performance"><span class="dot"></span><span class="nav-text">Performance</span></a>
        ...
        <div class="content-inner">
          ...
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Group Chat: Performance</div>
                <div class="hero-sub">Performance charts, server recommendations, and deployment practicalities discussion</div>
              </div>
              <div class="hero-meta">
                <span class="chip">Performance Analysis</span>
                <span class="chip teal">Server Hardware</span>
                <span class="chip amber">Mac vs Windows</span>
                <span class="chip copper">Deployment Strategy</span>
              </div>
            </div>
          </section>

          <!-- Performance Charts Section -->
          <section class="card section" id="performance-charts">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">📊</span>
                <span>Performance Charts Discussion</span>
              </div>
              <div class="section-actions">
                <span class="chip">Tue Dec 30, 2025</span>
              </div>
            </div>

            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">3:51 PM</span></div>
                <div class="ct-bubble">
                  <strong>Unstored vs Stored Fields</strong><br><br>
                  <div class="ct-image-note">📎 Image: Stored_vs_UnstoredCalcs(1).png</div>
                </div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">3:52 PM</span></div>
                <div class="ct-bubble">
                  The price/performance reasons why we use Macs as FMS servers<br><br>
                  <div class="ct-image-note">📎 Image: FMS_Benchmarks.png</div>
                </div>
              </div>
            </div>
            ...
            <div class="ct-callout">
              <div class="ct-callout-head">
                ...
                <div class="ct-callout-title">What This Chat Is About</div>
              </div>
              <div class="ct-callout-body">
                Kirk is sharing two performance charts to explain why FileMaker can feel fast or slow depending on two big choices: server hardware and field design.
                <ul class="ul">
                  <li><strong>Chart 1 (Unstored vs Stored):</strong> Stored calculations are way faster than unstored ones. Unstored fields force FileMaker to keep recalculating and making thousands of extra "remote calls" between the client and the server, which increases network traffic and slows screens, lists, and reports. Stored fields cut the time drastically and reduce network chatter.</li>
                  <li><strong>Chart 2 (Apple silicon vs Intel on FileMaker Server):</strong> With multiple users connected, Apple silicon (like M1) completes many common FileMaker actions faster than the Intel machine in the test.</li>
                  <li><strong>Purpose:</strong> He is giving the team a simple performance argument: use Mac servers for strong price-to-performance, and avoid unstored calcs where possible so the system stays snappy for users.</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <!-- Chart 1 Explained -->
          <section class="card section" id="chart-explained-1">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">💻</span>
                <span>FileMaker Server: Apple silicon vs Intel</span>
              </div>
            </div>

            <div class="stack">
              <p>This is a <strong>speed test</strong> comparing FileMaker Server running on two different computer types:</p>
              <ul class="ul">
                <li><strong>Blue = Apple M1</strong></li>
                <li><strong>Green = Intel Xeon W</strong></li>
              </ul>
              <p>The test is done with <strong>10 people connected at the same time</strong> ("10 concurrent connections").</p>

              <div class="ct-subsection">
                <div class="ct-subsection-title">How to read it</div>
                <ul class="ul">
                  <li>Each line is a common FileMaker action: <strong>add record, edit, delete, find, sort, import, export</strong>, etc.</li>
                  <li><strong>Shorter bar = faster</strong></li>
                  <li><strong>Longer bar = slower</strong></li>
                </ul>
              </div>

              <div class="ct-subsection">
                <div class="ct-subsection-title">What it means</div>
                <ul class="ul">
                  <li>In many of the actions shown, the <strong>Apple M1 (blue) finishes faster</strong> than the Intel machine (green).</li>
                  <li>Some tasks are closer, and a few may be similar, but the big message is:
                    <ul class="ul">
                      <li><strong>Hardware choice affects how fast FileMaker feels</strong>, especially when multiple users are connected.</li>
                      <li><strong>Apple silicon can perform very well for FileMaker Server style workloads</strong> in these tests.</li>
                    </ul>
                  </li>
                </ul>
              </div>
              ...
              <div class="ct-note">
                Think of it like two delivery bikes doing the same delivery route with 10 customers waiting. The one that finishes each stop quicker gives everyone a smoother experience.
              </div>
            </div>
          </section>

          <!-- Chart 2 Explained -->
          <section class="card section" id="chart-explained-2">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">⚡</span>
                <span>Unstored vs Stored Calculations</span>
              </div>
            </div>

            <div class="stack">
              <p>This one is about <strong>calculation fields in FileMaker</strong>.</p>

              <div class="ct-subsection">
                <div class="ct-subsection-title">Simple meaning</div>
                <ul class="ul">
                  <li><strong>Stored calculation</strong>: FileMaker calculates the value and <strong>saves it</strong>. Later it can reuse it quickly.</li>
                  <li><strong>Unstored calculation</strong>: FileMaker <strong>re-calculates it every time</strong> it is needed (when you view a list, sort, find, load a portal, open a record, etc.).</li>
                </ul>
              </div>

              <div class="ct-subsection">
                <div class="ct-subsection-title">What the chart shows</div>
                <ul class="ul">
                  <li><strong>Stored is massively faster</strong> in this test:
                    <ul class="ul">
                      <li>It says <strong>99.3% faster</strong>.</li>
                      <li>Total time: roughly <strong>107.24</strong> (unstored) versus <strong>4.8</strong> (stored).</li>
                    </ul>
                  </li>
                  <li><strong>Unstored causes lots of extra back and forth between client and server</strong>:
                    <ul class="ul">
                      <li>Remote calls: <strong>4,030</strong> (unstored) versus <strong>17</strong> (stored).</li>
                      <li>Data sent and received is far higher with unstored.</li>
                    </ul>
                  </li>
                </ul>
              </div>
              ...
              <div class="ct-subsection">
                <div class="ct-subsection-title">What it means in real life</div>
                <ul class="ul">
                  <li>If you use <strong>unstored calcs in list views, dashboards, reports, portals, or sorts</strong>, the system can feel slow because:
                    <ul class="ul">
                      <li>The server keeps doing repeated work</li>
                      <li>The network gets busy sending results back and forth</li>
                    </ul>
                  </li>
                  <li>If you can make a calc <strong>stored</strong>, FileMaker can:
                    <ul class="ul">
                      <li>Use it quickly</li>
                      <li>Reduce server load</li>
                      <li>Reduce network traffic</li>
                      <li>Make screens load faster</li>
                    </ul>
                  </li>
                </ul>
              </div>
              ...
              <div class="ct-note">
                ...
                <ul class="ul">
                  <li><strong>Stored</strong> is like cooking rice once and keeping it in a warmer.</li>
                  <li><strong>Unstored</strong> is like cooking the rice again every time someone wants one spoon.</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <!-- Combined Message -->
          <section class="card section" id="combined-message">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">🎯</span>
                <span>The Combined Message</span>
              </div>
            </div>

            <div class="stack">
              <ol class="ul">
                <li><strong>Good hardware helps</strong> (Apple silicon looks strong in these tests).</li>
                <li><strong>Good database design helps even more</strong>: avoiding heavy <strong>unstored calculations</strong> can remove a huge amount of waiting, server work, and network traffic.</li>
              </ol>

              <div class="ct-highlight">
                If you tell me what part of your solution feels slow (lists, dashboards, finds, sorts, reports), I can tell you the most likely places where unstored calcs are causing pain.
              </div>
            </div>
          </section>

          <!-- Mac Recommendation Discussion -->
          <section class="card section" id="mac-recommendation">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">💬</span>
                <span>Mac vs Windows Server Recommendation</span>
              </div>
              <div class="section-actions">
                <span class="chip">Wed Dec 31, 2025</span>
              </div>
            </div>

            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Cyril</span><span class="ct-sep">·</span><span class="ct-time">4:40 PM</span></div>
                <div class="ct-bubble">So is it safe to say it's better to recommend an apple server (say mac mini) to a client over a windows server? (that's if they're looking to purchasing an on-prem server)</div>
              </div>
            </div>
          </section>

          <!-- Kirk's Detailed Response -->
          <section class="card section" id="kirk-detailed-response">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">📝</span>
                <span>Kirk's Detailed Response</span>
              </div>
            </div>

            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">4:52 PM</span></div>
                <div class="ct-bubble">
                  IMHO, yes. The performance alone justifies it, but the price clinches the deal. Combined with the fact that Mac software updates are cleaner, less disruptive and far fewer, and SIP (System Integrity Protection) of MacOS makes the OS read only, impervious to any malware. Windows, on the other hand, reached the 10 million active malware count in 2008, and has not gotten better. Patch Tuesday is a weekly Windows event that costs time.<br><br>
                  In my IT executive days, I had lots of empirical data on IT operational costs. On average, a Mac support costs are 14.6% of a windows machine, the lifecycle of a Mac is twice as long, an acquisition cost, at least for a corporate class Windows machine, is more expensive than the equivalent Mac, if you can even find a Mac that is as slow as the best Windows small company server. A typical Windows server required 34 times as much system administration hours as a Mac.<br><br>
                  I have a Mac FMS server at a client that has been running, without interruption, since 2014. We just took it off line earlier this year, due to SSL current requirements not being able to run on that machine MacOS max supported version anymore.<br><br>
                  So here is a robust Mac performance config: <strong>2 base Mac Minis (M4s) @ $499 USD each</strong>, one <strong>Mirrorsync FMS&lt;&gt;FMS license, @ $1,600 USD</strong>, and now you have a <strong>HAFT (High Availability, Fault Tolerant) high performance server</strong>, that requires little hand on oversight.
                </div>
              </div>
            </div>
            ...
            <div class="ct-callout">
              <div class="ct-callout-head">
                <div class="badge violet">Key Points</div>
                <div class="ct-callout-title">Kirk's Mac Recommendation Summary</div>
              </div>
              <div class="ct-callout-body">
                Kirk's answer is "yes" in his opinion, and his reasons are:
                <ul class="ul">
                  <li><strong>Performance + cost:</strong> Macs can deliver strong FileMaker Server performance for the money, so the value is better.</li>
                  <li><strong>Less IT headache:</strong> Mac updates are usually less frequent and less disruptive, and Macs typically need far less ongoing system administration than Windows servers.</li>
                  <li><strong>Security:</strong> He believes macOS is harder to mess up and more resistant to malware due to system protections, while Windows tends to need more constant patching and security attention.</li>
                  <li><strong>Proven stability:</strong> He gives an example of a Mac FileMaker Server that ran continuously from 2014 until it was retired mainly due to newer SSL requirements.</li>
                  <li><strong>Suggested setup:</strong> For higher reliability, he proposes <strong>two Mac minis</strong> plus a <strong>MirrorSync server-to-server setup</strong> to create a high-availability, fault-tolerant FileMaker environment with low maintenance.</li>
                </ul>
              </div>
            </div>
          </section>

          <!-- Wim Decorte's Advice -->
          <section class="card section" id="wim-decorte-advice">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">💡</span>
                <span>Joe Shares Wim Decorte's Expert Advice</span>
              </div>
            </div>

            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Cyril</span><span class="ct-sep">·</span><span class="ct-time">5:00 PM</span></div>
                <div class="ct-bubble">Great info Kirk. We've had our fair experience with windows on-prem servers and it's a hustle almost all the time. Lol. Thanks.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">5:08 PM</span></div>
                <div class="ct-bubble">
                  This is a very good and practical question and I feel that Kirk gave a very good and practical answer. I would say that for the market we are targeting and for the number of users and use cases we seem to mostly handle, that this is the best answer.<br><br>
                  That being said, as we all know, there are different reasons at times to use different types of servers and it is possible that a Windows server might be a good choice given the other software involved and the existing infrastructure like MS Office and Exchange Server for example. But sometimes even then, especially if you are just targeting a specific department in a larger organization, the Mac Mini is great.<br><br>
                  Here is a post from Wim Decorte of Soliant Consulting who is to Kirk and my mind one of, if not THE expert on FM Server. This is taken from the Claris community and is two years old but I think it still holds true:
                </div>
              </div>
            </div>

            <div class="ct-quote">
              <div class="ct-quote-author">Wim Decorte (Soliant Consulting)</div>
              <div class="ct-quote-body">
                "You'll get lots of opinions especially about macOS, but at the end of the day there is only one way to decide what kind of hardware will work for you: your current logs.<br><br>
                Make sure you are currently using all three logs (they are off by default):
                <ul class="ul">
                  <li>regular stats.log</li>
                  <li>topcallstats.log</li>
                  <li>clientstats.log</li>
                </ul>
                And if you are worried about the warning that the console throws up, read this:<br>
                <a class="ct-link" href="https://www.soliantconsulting.com/blog/log-in-filemaker-server/">https://www.soliantconsulting.com/blog/log-in-filemaker-server/</a><br><br>
                Those logs are your baseline and will tell you what resource to prioritize: processing power (both in # of cores and clock speed) or disk i/o.<br><br>
                Memory and networking (as in: ethernet speed at the machine) are not an issue unless you go ridiculously low (&lt; 8GB of RAM).<br><br>
                If I were you I'd test some AWS linux servers so that you can do some real-world tests with your own solution; because without knowing your solution everybody will just be guessing."
              </div>
            </div>

            <div class="ct-callout">
              <div class="ct-callout-head">
                <div class="badge amber">Expert Guidance</div>
                <div class="ct-callout-title">How to Decide for Real</div>
              </div>
              <div class="ct-callout-body">
                Joe adds a practical warning: sometimes <strong>Windows can still make sense</strong> when a company already depends heavily on Microsoft infrastructure (like Exchange), though a Mac mini can still be a strong choice even inside a larger organization if FileMaker is for one department.<br><br>
                Wim Decorte's key rule: <strong>do not guess based on opinions, use your server logs.</strong> Turn on and use these logs: <code>stats.log</code>, <code>topcallstats.log</code>, <code>clientstats.log</code>. Those logs tell you what to prioritize, CPU power (cores and speed) or disk I/O. He also notes memory and network are usually fine unless you go very low on RAM. He recommends testing on AWS Linux servers with your own solution to get real-world proof.
              </div>
            </div>
          </section>

          <!-- Deployment Practicalities -->
          <section class="card section" id="deployment-practicalities">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">🔧</span>
                <span>Deployment Practicalities</span>
              </div>
            </div>

            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">5:46 PM</span></div>
                <div class="ct-bubble">Minimum technology diversity = maximum manageability = lowest cost. Life cycle costs trump acquisition costs 100% of the time.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">5:47 PM</span></div>
                <div class="ct-bubble">If they have IT in house and it is a windows shop, go windows ..... just release server management to their IT</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">6:20 PM</span></div>
                <div class="ct-bubble">Ran a benchmark; 10 year old Mac mini on a gigabit connection vs a windows 8 core 4ghz i7 NVMe raid ssd on a 100 mbit connection.<br>Remote user. Mac &gt;2x faster. Network critical.<br>Lots of FM design considerations can change that equation. Need to document performance design factors......</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">7:17 PM</span></div>
                <div class="ct-bubble">There is a good reason to run a Mac FMS in a windows shop; few windows IT staff know anything about database server requirements. Having it in a Mac keeps them from screwing things up.<br>Typical problem; IT backs up the server without pausing the database; database goes corrupt. FMS to blame in their eyes. Bad for FMDevs.</div>
              </div>
            </div>

            <div class="ct-callout">
              <div class="ct-callout-head">
                <div class="badge slate">Final Wisdom</div>
                <div class="ct-callout-title">What Keeps FileMaker Server Fast, Stable, and Cheap to Live With</div>
              </div>
              <div class="ct-callout-body">
                This chat is really about one thing: <strong>what keeps FileMaker Server fast, stable, and cheap to live with</strong>, year after year.<br><br>
                Kirk's main frame is simple. <strong>Fewer moving parts means fewer problems.</strong> When you mix too many technologies, you create more things to babysit. More babysitting means more cost. And those life cycle costs beat the purchase price every single time.<br><br>
                <strong>Key insights:</strong>
                <ul class="ul">
                  <li><strong>Match the server to the real-world environment:</strong> If the client has in-house IT and they run Windows, Windows can be practical because their team can own it.</li>
                  <li><strong>The trap:</strong> Many Windows IT staff don't think like database server people. They can follow normal Windows habits that are deadly for databases (like backing up without pausing the database, causing corruption).</li>
                  <li><strong>Network matters more than raw power:</strong> Kirk's benchmark showed a 10-year-old Mac mini on gigabit was 2x faster than a powerful Windows machine on 100 mbit for remote users.</li>
                  <li><strong>Solution design shifts the equation:</strong> Stored vs unstored calcs, schema choices, and performance design decisions can make a fast server feel slow or a modest server feel elite.</li>
                </ul>
                <strong>The purpose:</strong> Better decisions by choosing the platform that's easiest to manage long-term, respecting the network, designing FileMaker to reduce server strain, and avoiding setups where the wrong people can accidentally break database rules.
              </div>
            </div>
          </section>
          ...
          <footer class="footer">
            <div class="footer-left">
              <div class="footer-title">Performance</div>
              <div class="footer-sub">Mac vs Windows • Performance • Deployment</div>
            </div>
            <div class="footer-right">
              <a class="footer-link" href="#performance-charts">Charts</a>
              <a class="footer-link" href="#mac-recommendation">Recommendations</a>
              <a class="footer-link" href="#deployment-practicalities">Deployment</a>
            </div>
          </footer>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">Key takeaways and links</div>
        </div>
        ...
        <div class="rail-body">
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              <span class="pill2">Apple silicon</span>
              <span class="pill2">Intel</span>
              <span class="pill2">Stored calcs</span>
              <span class="pill2">Unstored calcs</span>
              <span class="pill2">Remote calls</span>
              <span class="pill2">Network speed</span>
              <span class="pill2">Mac mini</span>
              <span class="pill2">HAFT setup</span>
              <span class="pill2">MirrorSync</span>
              <span class="pill2">Server logs</span>
              <span class="pill2">Lifecycle costs</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Important numbers from the discussion</div>
            </div>
            <div class="stack">
              <div class="stack-item">
                <strong>99.3% faster</strong>
                <div class="stack-sub">Stored vs unstored calculations</div>
              </div>
              <div class="stack-item">
                <strong>4,030 vs 17</strong>
                <div class="stack-sub">Remote calls: unstored vs stored</div>
              </div>
              <div class="stack-item">
                <strong>14.6%</strong>
                <div class="stack-sub">Mac support costs vs Windows</div>
              </div>
              <div class="stack-item">
                <strong>34x</strong>
                <div class="stack-sub">Windows admin hours vs Mac</div>
              </div>
              <div class="stack-item">
                <strong>2x faster</strong>
                <div class="stack-sub">Old Mac mini (gigabit) vs powerful Windows (100mbit)</div>
              </div>
              <div class="stack-item">
                <strong>$1,598</strong>
                <div class="stack-sub">Two M4 Mac minis + MirrorSync = HAFT setup</div>
              </div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">
                ...
                Recommended HAFT Setup
              </div>
              <div class="panel-sub">High Availability, Fault Tolerant</div>
            </div>
            <div class="stack">
              <div class="stack-item">
                2x Mac Mini M4 Base
                <div class="stack-sub">$499 USD each = $998</div>
              </div>
              <div class="stack-item">
                MirrorSync FMS↔FMS
                <div class="stack-sub">$1,600 USD license</div>
              </div>
              <div class="stack-item">
                <strong>Total: ~$2,598</strong>
                <div class="stack-sub">High performance, low maintenance</div>
              </div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Enable these for baseline data</div>
            </div>
            <div class="stack">
              <div class="stack-item">
                stats.log
                <div class="stack-sub">Regular statistics</div>
              </div>
              <div class="stack-item">
                topcallstats.log
                <div class="stack-sub">Top call statistics</div>
              </div>
              <div class="stack-item">
                clientstats.log
                <div class="stack-sub">Client connection stats</div>
              </div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Expert guidance and documentation</div>
            </div>
            <div class="side-grid">
              <a class="side-pill" href="https://www.soliantconsulting.com/blog/log-in-filemaker-server/" target="_blank" rel="noopener">Soliant: FM Server Logs</a>
              <a class="side-pill" href="#wim-decorte-advice">Wim Decorte's Advice</a>
              <a class="side-pill" href="#kirk-detailed-response">Kirk's Analysis</a>
              <a class="side-pill" href="#performance-charts">Performance Charts</a>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">👥 Discussion Participants</div>
              <div class="panel-sub">People in this conversation</div>
            </div>
            <div class="stack">
              <div class="stack-item">Kirk<div class="stack-sub">Performance analysis + Mac recommendations</div></div>
              <div class="stack-item">Cyril<div class="stack-sub">Questions about server recommendations</div></div>
              <div class="stack-item">Joe<div class="stack-sub">Context + Wim Decorte's expert advice</div></div>
            </div>
          </div>
        ...
        <div class="rail-bottom">
          <div class="rail-foot">
            ...
            <span>Quick reference • scroll inside</span>
          </div>
        </div>
      </aside>
    </div>
