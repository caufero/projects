      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text">Server</span>
          </div>
        </div>
        ...
        <nav class="rail-body" id="navTree">
          ...
          <div class="nav-group open" data-label="Chats">
            ...
            <div class="nav-group-body">
              ...
              <a class="nav-item sub active" href="https://caufero.github.io/projects/Chats/Server.md" data-label="Chats Server"><span class="dot"></span><span class="nav-text">Server</span></a>
        ...
        <div class="content-inner">
          ...
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Group Chat: Server</div>
                <div class="hero-sub">Kirk's practical guidelines + team discussion on LastError handling and scheduled script management</div>
              </div>
              <div class="hero-actions">
                <a class="cta" href="#">
                  ...
                  View Full Server Docs
                </a>
              </div>
              <div class="hero-meta">
                <span class="chip">Documentation</span>
                <span class="chip teal">PSOS</span>
                <span class="chip amber">Server Scripts</span>
                <span class="chip copper">Error Handling</span>
              </div>
            </div>
          </section>

          <!-- Kirk's Notes Section -->
          <section class="card section" id="kirks-notes">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">📝</span>
                <span>Kirk's Notes: FileMaker PSOS Rules</span>
              </div>
              <div class="section-actions">
                <span class="chip">Essential</span>
              </div>
            </div>
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-bubble">
                  <strong>Core PSOS Rules — The Non-Negotiables:</strong>
                  <ul class="ul" style="margin-top:10px;">
                    <li><strong>PSOS runs as a unique user</strong> (commonly an account like <code>fmse</code>).</li>
                    <li><strong>Client context is not automatically available on the server:</strong>
                      <ul class="ul nest" style="margin-top:6px;">
                        <li>The server-side script does <strong>not</strong> know your <strong>layout context</strong> by default.</li>
                        <li>The server-side script does <strong>not</strong> have your <strong>found set</strong> by default.</li>
                      </ul>
                    </li>
                    <li><strong>Any script step that requires user interaction will hang</strong> (because the server cannot show dialogs or wait for clicks).</li>
                    <li><strong>Global fields are not carried over</strong> (globals are user/session-specific, so they are not passed into PSOS automatically).</li>
                    <li><strong>Use Script Parameters and Exit Script</strong> to pass information <strong>to</strong> the server-side script and get results <strong>back</strong>.</li>
                    <li><strong>No debugger for server-side scripts.</strong></li>
                    <li><strong>If a server-side script hits an error without graceful recovery, it can hang.</strong></li>
                    <li><strong>Scheduled scripts have the same constraints.</strong></li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div class="ct-callout">
              <div class="ct-callout-head">
                <div class="badge teal">Why This Matters</div>
                <div class="ct-callout-title">The Server is Cold — No Client Handholding</div>
              </div>
              <div class="ct-callout-body">
                When you run a script on FileMaker Server (either through PSOS or scheduled), the server doesn't see what the user sees. There's no layout, no found set, no globals. The script runs in isolation as a special server user account (usually <code>fmse</code>).
                <ul class="ul">
                  <li><strong>No dialogs:</strong> Any Show Custom Dialog, Input Field, or interactive step will freeze the script because there's no one to click "OK".</li>
                  <li><strong>No context inheritance:</strong> You must explicitly pass everything the script needs via script parameters.</li>
                  <li><strong>No debugging:</strong> You can't step through server scripts in Data Viewer. Build robust error handling from the start.</li>
                  <li><strong>Graceful errors:</strong> If your script doesn't handle errors properly, it can hang indefinitely on the server.</li>
                </ul>
                Bottom line: Server scripts demand discipline. Pass what you need in, do the work without user interaction, return results via Exit Script, and handle every error explicitly.
              </div>
            </div>
          </section>

          <!-- Chat Extract Section -->
          <section class="card section" id="chat-extract">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">💬</span>
                <span>Saturday, 01 Feb 2026 — Team Discussion</span>
              </div>
              <div class="section-actions">
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">5:32 PM</span></div>
                <div class="ct-bubble">
                  Note: In scheduled script the admin console reports the last status. However, in many cases of a FAILED status, the failure is a non-issue (like no records found meeting the criteria of the scheduled script function).<br><br>
                  In this case, one method of resolving the error status, is add to your code a <code>Get ( LastError ) > 0</code> and if true, set a variable, which (if the docs are correct) will reset the error state. If you want to be more specific, the evaluation of <code>Get ( LastError )</code> can be for the code you expect on an error (like a 401 error).<br><br>
                  Also of note: A recent function added to FM, is the new <code>Get ( LastErrorDetail )</code> - not played with it yet, but I suspect this will be invaluable info.<br><br>
                  <strong>TRAP:</strong> Setting a variable to <code>Get ( LastError )</code>, removes the error that would provide the detail error info. To avoid this, grab both in one step. You can set the LET calc to 1 (or true) to create a throw away variable and both are set in the code individually (based on the <code>$</code> sign in the name), or concatenate the 2 (as shown in the following example) and pass that single variable out.
                </div>
              </div>
              ...
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">5:32 PM</span></div>
                <div class="ct-bubble">
                  <strong>Step immediately after the operation you're checking</strong>
                  <div class="ct-code-block">
                    <div class="ct-code-header">
                      <span class="ct-code-lang">FileMaker Script Step</span>
                      <span class="ct-code-label">Error Capture Pattern</span>
                    </div>
                    <pre class="ct-code">Set Variable [ $errorInfo ; Value
    Let (
        [
            $lastError       = Get ( LastError ) ;
            $lastErrorDetail = Get ( LastErrorDetail )
        ] 
;
        $lastError &¶& $lastErrorDetail
              ...
              <div class="ct-msg">
                ...
                <div class="ct-bubble">
                  Suggest we standardize (not a term I use lightly) on a full access (or new Developer constrained) account NAME and PASSWORD for:
                  <ol class="ol" style="margin-top:8px;">
                    <li>Server scheduled scripts</li>
                    <li>Shortcut Donations</li>
                  </ol>
                  That way, all script schedules will be from the same account, regardless of which solution we are talking about.<br><br>
                  <strong>Advantages:</strong>
                  <ul class="ul" style="margin-top:6px;">
                    <li>Creating and editing script schedules will all have a commonly known one account credential everyplace</li>
                  </ul>
                </div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">6:56 PM</span></div>
                <div class="ct-bubble">
                  Hi Kirk,<br><br>
                  Are we sure that the IF statement actually resets the last error? If it does not then maybe don't need to have a LET Statement that combines both the LastError and the LastErrorDetail into one new field.<br><br>
                  Here is what the Claris Reference online says:<br><br>
                  <div class="ct-quote">
                    The following control script steps do not clear the last error condition reported by FileMaker Pro: If, Else, Else If, End If, Loop, Exit Loop If, End Loop, Exit Script, and Halt Script.<br><br>
              ...
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">6:57 PM</span></div>
                <div class="ct-bubble">
                  Another thing I don't understand and maybe you do. I think that I have also heard that this <code>Get ( LastErrorDetail )</code> script step is new. But the documentation says it originated in Version 6.0 or earlier. Do you know what this is about?
                </div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">6:57 PM</span></div>
                <div class="ct-bubble">
                  The assumption was IF you collect the LastError into a variable, LastErrorDetail at the next step, would be empty
                </div>
              </div>
              ...
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">6:57 PM</span></div>
                <div class="ct-bubble">
                  Yes but I'm not sure this assumption is true.
                </div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">6:59 PM</span></div>
                <div class="ct-bubble">
                  It may be true but the docs don't say that explicitly.
                </div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">6:59 PM</span></div>
                <div class="ct-bubble">
                  The purpose - in the context of server - is to reflect in Admin console, the scheduled script status to NOT be failed, if the error is inconsequential
                </div>
              </div>
              ...
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">6:59 PM</span></div>
                <div class="ct-bubble">
                  Like a 401 error - no records found
                </div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">7:00 PM</span></div>
                <div class="ct-bubble">
                  The purpose of putting this post in this Group called Server, I definitely understand.
                </div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">7:01 PM</span></div>
                <div class="ct-bubble">
                  The message is: be careful to trap for inconsequential errors because IF they are not the very last step in your PSOS script, then they will make the script halt or fail right at that point where the error occurs.
                </div>
              </div>
              ...
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">7:01 PM</span></div>
                <div class="ct-bubble">
                  Server side scripts are tricky.
                </div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">7:02 PM</span></div>
                <div class="ct-bubble">
                  One of the reason the first post is the guidelines for what works
                </div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">7:04 PM</span></div>
                <div class="ct-bubble">
                  I'm just not sure about the one little part about the Get function. In other words do we have to worry about the script step <code>Get ( LastError )</code> wiping out the actual error so that the very next line that sets a variable using <code>Get ( LastErrorDetail )</code> will not really work.<br><br>
                  Have you tried this yourself? Is it really true? I only ask because the FileMaker documentation should really let us know that on one or both of these script steps and they don't. Instead they seem to say that certain things do not reset the error code. So I'm thinking that maybe we don't need a LET Statement if we set variables with an IF statement?
                </div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">7:06 PM</span></div>
                <div class="ct-bubble">
                  There is value to NOT using the LET statement code you mention above. It's easier to have two separate variables that contain two separate pieces of information, than it is to have one combined variable which we might need to parse out later.<br><br>
                  That's my thinking anyway. I might misunderstand the problem or be misreading the online documentation.
                </div>
              </div>
            </div>
            ...
            <div class="ct-callout">
              <div class="ct-callout-head">
                ...
                <div class="ct-callout-title">LastError Handling Debate</div>
              </div>
              <div class="ct-callout-body">
                The team is wrestling with how to properly capture error information from scheduled server scripts without losing detail.
                <ul class="ul">
                  <li><strong>The Problem:</strong> Admin Console shows "FAILED" status even for harmless errors like "no records found" (401). This makes real failures hard to spot.</li>
                  <li><strong>Kirk's Solution:</strong> Trap expected/harmless errors by checking <code>Get(LastError)</code>, then store it in a variable to clear the error state so Admin Console shows success instead of failure.</li>
                  <li><strong>The Complication:</strong> Kirk worries that reading <code>Get(LastError)</code> into a variable might wipe out the error state before <code>Get(LastErrorDetail)</code> can be read. So he suggests grabbing both in one Let() statement to be safe.</li>
                  <li><strong>Joe's Pushback:</strong> Joe questions whether this assumption is true. The FileMaker docs say control steps (If, Loop, Exit Script) do NOT clear error state. So maybe you can safely set two separate variables without a Let() wrapper, which would be simpler.</li>
                  <li><strong>Kirk's Real Goal:</strong> Prevent Admin Console from showing FAILED when the "error" is actually expected behavior (like finding zero records in a cleanup script).</li>
                  <li><strong>Secondary Topic:</strong> Kirk proposes standardizing one server account (name + password) across all solutions for scheduled scripts and shortcuts. Makes credential management simpler.</li>
                </ul>
                The core tension: Does <code>Get(LastError)</code> clear error state immediately, or only when certain script steps run? The docs are vague, so the team is debating whether Kirk's defensive Let() pattern is necessary or overkill.
              </div>
            </div>
          </section>
          ...
          <footer class="footer">
            <div class="footer-left">
              <div class="footer-title">Server</div>
              <div class="footer-sub">FileMaker Server Script Documentation</div>
            </div>
            <div class="footer-right">
              <a class="footer-link" href="#">Server Chat</a>
              <a class="footer-link" href="#">ScriptsCalcs</a>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">Quick navigation</div>
          <div class="rail-actions">
            <a class="rail-btn" href="#kirks-notes">Kirk's Notes</a>
            <a class="rail-btn" href="#chat-extract">Chat Extract</a>
          </div>
        </div>
        ...
        <div class="rail-body">
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Key concepts to look for</div>
            </div>
            <div class="pill-row">
              <span class="pill2">PSOS</span>
              <span class="pill2">Server user</span>
              <span class="pill2">No context</span>
              <span class="pill2">No dialogs</span>
              <span class="pill2">Script parameters</span>
              <span class="pill2">LastError</span>
              <span class="pill2">LastErrorDetail</span>
              <span class="pill2">Admin Console</span>
              <span class="pill2">Error trapping</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="side-grid">
              <a class="side-pill warn" href="#">Server Chat</a>
              <a class="side-pill warn" href="#">Performance</a>
              <a class="side-pill" href="#">ScriptsCalcs</a>
              <a class="side-pill" href="#">Error Handling</a>
              <a class="side-pill" href="#">Deployment</a>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Who's in this discussion</div>
            </div>
            <div class="stack">
              <div class="stack-item">Kirk<div class="stack-sub">Server script expert • Proposed error handling pattern</div></div>
              <div class="stack-item">Joe<div class="stack-sub">Questions assumptions • Advocates simpler approach</div></div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">What this document covers</div>
            </div>
            <div class="stack">
              <div class="stack-item">PSOS constraints<div class="stack-sub">No context, no dialogs, no globals</div></div>
              <div class="stack-item">Server user accounts<div class="stack-sub">Scripts run as fmse or similar</div></div>
              <div class="stack-item">Error handling<div class="stack-sub">LastError vs LastErrorDetail debate</div></div>
              <div class="stack-item">Admin Console status<div class="stack-sub">Preventing false FAILED indicators</div></div>
              <div class="stack-item">Credential standardization<div class="stack-sub">One account for all scheduled scripts</div></div>
            </div>
          </div>
