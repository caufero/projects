...
<body>
  <div class="page" data-theme="auto">
      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text">JS in FM</span>
          </div>
        </div>
    ...
    <div class="shell" id="shell">
        ...
        <nav class="rail-body" id="navTree">
          ...
          <div class="nav-group open" data-label="Chats">
            ...
            <div class="nav-group-body">
              ...
              <a class="nav-item sub active" href="https://caufero.github.io/projects/Chats/JS%20In%20FM.md" data-label="Chats JS In FM"><span class="dot"></span><span class="nav-text">JS In FM</span></a>
      ...
      <!-- CENTER COLUMN — JS IN FM CHAT CONTENT -->
        ...
        <div class="content-inner">
          ...
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Chat Group: JS in FM</div>
                <div class="hero-sub">Discussions about JavaScript frameworks, tools, and techniques for FileMaker development</div>
              </div>
              <div class="hero-actions">
                <a class="cta" href="https://www.jsinfm.com/">
                ...
                <a class="cta ghost" href="https://www.jsinfmcourse.dev/">
                  <span class="cta-ico" aria-hidden="true">
                    <svg viewBox="0 0 24 24" class="ico" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              ...
              <div class="hero-meta">
                <span class="chip">Chat Log</span>
                <span class="chip teal">JavaScript</span>
                <span class="chip violet">FileMaker</span>
                <span class="chip amber">Web Development</span>
              </div>
            </div>
          </section>

          <!-- Day 1: Tuesday 30 Dec 2025 -->
          <section class="card section" id="chat-dec-30">
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">6:04 PM</span></div>
                <div class="ct-bubble">
                  Build FileMaker widgets in Javascript, a website by Jeremy Brown. Includes a course and a community.
                </div>
              </div>
              ...
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">6:04 PM</span></div>
                <div class="ct-bubble">
                  <a class="ct-link" href="https://www.jsinfm.com/">https://www.jsinfm.com/</a>
                </div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">6:16 PM</span></div>
                <div class="ct-bubble">
                  How to build a Next.js web app that is FileMaker aware. This kit comes with all the code needed to launch a node js project, access it using the Visual Studio Code IDE and have all the libraries needed to connect to a FileMaker server.<br><br>
                  This is NOT a framework like say Ruby on Rails but it is a command line tool that will give you a quickstart to building your own javascript web app that uses data from FileMaker. It requires a tech stack and you will be programming in javascript. The tech stack includes, besides FileMaker Server, Node.js, Tailwind CSS, Shaden/ui component library for React, tanstack query, zod, clerk,etc. Basically if you were working for Proof & Geist and was going to use their chosen tech tools to develop javascript web apps, this is the setup program to download everything you need.
                </div>
              </div>
              ...
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">6:16 PM</span></div>
                <div class="ct-bubble">
                  <a class="ct-link" href="https://proofkit.dev">https://proofkit.dev</a>
                </div>
              </div>
            </div>
            ...
            <div class="ct-callout">
              <div class="ct-callout-head">
                ...
                <div class="ct-callout-title">JS in FM Introduction</div>
              </div>
              <div class="ct-callout-body">
                Joe introduces two key resources for JavaScript development with FileMaker:
                <ul class="ul">
                  <li><strong>JS in FM (jsinfm.com)</strong> - Jeremy Brown's website for building FileMaker widgets in JavaScript, featuring a course and community</li>
                  <li><strong>ProofKit (proofkit.dev)</strong> - A command-line tool for creating Next.js web apps that connect to FileMaker. Not a full framework, but a quickstart kit with a complete tech stack including Node.js, Tailwind CSS, Shadcn/ui, Tanstack Query, Zod, and Clerk. This is the same stack Proof & Geist uses for their JavaScript web development.</li>
                </ul>
              </div>
            </div>
          </section>

          <!-- Day 2: Wednesday 31 Dec 2025 -->
          <section class="card section" id="chat-dec-31">
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">1:08 PM</span></div>
                <div class="ct-bubble">
                  Carafe dot fm is a tool by Soliant Consulting that is open sourced and attempts to establish a standard for sharing Javascript bundles for use by any developer in the FileMaker community. Check out the Tutorial page to learn more about it.
                </div>
              </div>
              ...
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">1:08 PM</span></div>
                <div class="ct-bubble">
                  <a class="ct-link" href="https://carafe.fm/">https://carafe.fm/</a>
                </div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">1:19 PM</span></div>
                <div class="ct-bubble">
                  I'm seeing a rapid adoption of HTMX replacing React and the ancillary stuff that goes with it. Not related to FM (yet) but the tech trend adoption curve seems to be quickly headed that way. Request hackers new release was a rewrite from react to htmx and the tech press is all afire about htmx
                </div>
              </div>
              ...
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">1:19 PM</span></div>
                <div class="ct-bubble">
                  <a class="ct-link" href="https://htmx.org/">https://htmx.org/</a>
                </div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">1:38 PM</span></div>
                <div class="ct-bubble">
                  HTMX is a server driven UI that relies on HTML attributes. It does not and cannot replace React with all its components and libraries for complex applications. It is designed to be a lightweight alternative for simple application not a React replacement.<br><br>
                  There is a lot of buzz in the js developer world about HTMX and real positivity as we all long for simpler and lighter weight ways of handling tasks. Also the marketing around HTMX is grass roots and fun so in this way it's similar to the Ruby community or the old Apple communities in the early days where people like the little guy over the Goliaths of the corporate world. But HTMX will not be replacing React or any of the heavier component and library filled JS Frameworks anytime soon. It is however carving out its own little niche and like all software tools: it's project dependent.<br><br>
                  So for basic applications, HTMX is great and may even be preferred because now you can do more with basic HTML attributes than ever before which is basically HOW javascript came into being in the first place. In that sense it's more like the continuous cycle of web development in the browser changing and growing.
                </div>
              </div>
              ...
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">1:38 PM</span></div>
                <div class="ct-bubble">
                  <a class="ct-link" href="https://www.builder.io/blog/htmx-vs-react">https://www.builder.io/blog/htmx-vs-react</a>
                </div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">1:41 PM</span></div>
                <div class="ct-bubble">
                  The above review is a really positive review of HTMX and it explains things quite well visually. It's both big picture and a bit granular so I think you get the full picture. More tech..yay 😁
                </div>
              </div>
            </div>
            ...
            <div class="ct-callout">
              <div class="ct-callout-head">
                ...
                <div class="ct-callout-title">Carafe & HTMX Discussion</div>
              </div>
              <div class="ct-callout-body">
                The conversation covers two important topics:
                <ul class="ul">
                  <li><strong>Carafe.fm</strong> - An open-source tool by Soliant Consulting that establishes a standard for sharing JavaScript bundles across the FileMaker community.</li>
                  <li><strong>HTMX vs React</strong> - Kirk notes the growing adoption of HTMX in the broader tech world. Joe provides important context: HTMX is a server-driven UI framework using HTML attributes that's great for simple applications, but it's not replacing React for complex apps. It's gaining popularity for being lightweight and grassroots, similar to early Ruby/Apple communities. The key insight: it's project-dependent, filling a niche for simpler applications while React remains essential for complex component-heavy applications.</li>
                </ul>
              </div>
            </div>
          </section>

          <!-- Day 3: Saturday 17 Jan 2026 -->
          <section class="card section" id="chat-jan-17">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">💬</span>
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">5:04 PM</span></div>
                <div class="ct-bubble">
                  I'm finally restarting the JS in FM course with Jeremy Brown today after being away for almost 10 months since last March. The course is currently only $199 and I think access is unlimited. Anyway this is the course website fyi → <a class="ct-link" href="https://www.jsinfmcourse.dev/">https://www.jsinfmcourse.dev/</a>
                </div>
              </div>
            </div>
            ...
            <div class="ct-callout">
              <div class="ct-callout-head">
                ...
                <div class="ct-callout-title">Course Restart Announcement</div>
              </div>
              <div class="ct-callout-body">
                Joe announces he's restarting the JS in FM course by Jeremy Brown after a 10-month break. The course is available for $199 with unlimited access at <a href="https://www.jsinfmcourse.dev/">jsinfmcourse.dev</a>.
              </div>
            </div>
          </section>

          <!-- Day 4: Tuesday 27 Jan 2026 -->
          <section class="card section" id="chat-jan-27">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">💬</span>
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">12:28 PM</span></div>
                <div class="ct-bubble">
                  Deep Dive into the Webviewer by Jeremy Brown at the 2024 Claris Engage: <a class="ct-link" href="https://www.youtube.com/watch?v=AVwEPADvEik">https://www.youtube.com/watch?v=AVwEPADvEik</a>
                </div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">12:47 PM</span></div>
                <div class="ct-bubble">
                  @cyril - if you've never seen this video on the webviewer you will like it. It answers a few questions you had yesterday by showing examples but it's just good all around. :)
                </div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Cyril</span><span class="ct-sep">·</span><span class="ct-time">2:57 PM</span></div>
                <div class="ct-bubble">
                  O nice. Thanks @joe; will take a look at it
                </div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">3:22 PM</span></div>
                <div class="ct-bubble">
                  Love the new MBS FORMAT button in the data viewer for JSON - no need to add the extra code line to see the formatted JSON results
                </div>
              </div>
            ...
            <div class="ct-callout">
              <div class="ct-callout-head">
                ...
                <div class="ct-callout-title">Webviewer Deep Dive & MBS Update</div>
              </div>
              <div class="ct-callout-body">
                Joe shares a valuable resource: Jeremy Brown's "Deep Dive into the Webviewer" presentation from Claris Engage 2024. The video provides comprehensive examples that answer common webviewer questions. Kirk also mentions a useful new feature in the MBS (MonkeyBread Software) data viewer - a FORMAT button for JSON that eliminates the need to add extra code for viewing formatted JSON results. Joe notes he needs to update his MBS to get this feature.
              </div>
            </div>
          </section>
          ...
          <footer class="footer">
            <div class="footer-left">
              <div class="footer-title">JS in FM Chat Log</div>
              <div class="footer-sub">JavaScript development resources for FileMaker</div>
            </div>
            <div class="footer-right">
              <a class="footer-link" href="https://www.jsinfm.com/">JS in FM</a>
              <a class="footer-link" href="https://www.jsinfmcourse.dev/">Course</a>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">JS in FM navigation</div>
          <div class="rail-actions">
            <a class="rail-btn" href="#chat-dec-30">Dec 30</a>
            <a class="rail-btn" href="#chat-dec-31">Dec 31</a>
            <a class="rail-btn" href="#chat-jan-17">Jan 17</a>
            <a class="rail-btn" href="#chat-jan-27">Jan 27</a>
          </div>
        </div>
        ...
        <div class="rail-body">
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              <span class="pill2">JS in FM</span>
              <span class="pill2">ProofKit</span>
              <span class="pill2">Carafe</span>
              <span class="pill2">HTMX vs React</span>
              <span class="pill2">Webviewer</span>
              <span class="pill2">MBS Tools</span>
              <span class="pill2">Jeremy Brown</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Key resources mentioned</div>
            </div>
            <div class="side-grid">
              <a class="side-pill warn" href="https://www.jsinfm.com/" target="_blank">JS in FM Website</a>
              <a class="side-pill warn" href="https://www.jsinfmcourse.dev/" target="_blank">JS in FM Course</a>
              <a class="side-pill" href="https://proofkit.dev" target="_blank">ProofKit</a>
              <a class="side-pill" href="https://carafe.fm/" target="_blank">Carafe.fm</a>
              <a class="side-pill" href="https://htmx.org/" target="_blank">HTMX</a>
              <a class="side-pill" href="https://www.builder.io/blog/htmx-vs-react" target="_blank">HTMX vs React</a>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              <div class="stack-item">Joe<div class="stack-sub">Sharing resources • Course participant</div></div>
              <div class="stack-item">Kirk<div class="stack-sub">Tech trends observer • MBS user</div></div>
              <div class="stack-item">Cyril<div class="stack-sub">Learning webviewer techniques</div></div>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              <div class="stack-item">JS in FM Platform<div class="stack-sub">Jeremy Brown's website for FileMaker JavaScript widgets</div></div>
              <div class="stack-item">ProofKit<div class="stack-sub">Next.js starter for FileMaker-aware web apps</div></div>
              <div class="stack-item">Carafe.fm<div class="stack-sub">Soliant's open-source JS bundle sharing standard</div></div>
              <div class="stack-item">HTMX Discussion<div class="stack-sub">Comparison with React • Use cases • Adoption trends</div></div>
              <div class="stack-item">Course Restart<div class="stack-sub">JS in FM course at $199 • Unlimited access</div></div>
              <div class="stack-item">Webviewer Deep Dive<div class="stack-sub">Claris Engage 2024 presentation by Jeremy Brown</div></div>
              <div class="stack-item">MBS Tools<div class="stack-sub">New FORMAT button for JSON in data viewer</div></div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">🛠️ Tech Stack Mentioned</div>
              <div class="panel-sub">Technologies discussed</div>
            </div>
            <div class="stack">
              <div class="stack-item">Next.js<div class="stack-sub">React framework for web apps</div></div>
              <div class="stack-item">Node.js<div class="stack-sub">JavaScript runtime environment</div></div>
              <div class="stack-item">Tailwind CSS<div class="stack-sub">Utility-first CSS framework</div></div>
              <div class="stack-item">Shadcn/ui<div class="stack-sub">React component library</div></div>
              <div class="stack-item">Tanstack Query<div class="stack-sub">Data fetching library</div></div>
              <div class="stack-item">Zod<div class="stack-sub">TypeScript schema validation</div></div>
              <div class="stack-item">Clerk<div class="stack-sub">Authentication & user management</div></div>
              <div class="stack-item">HTMX<div class="stack-sub">Lightweight HTML-attribute-based framework</div></div>
            </div>
          </div>
