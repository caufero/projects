...
<body>
  <div class="page" data-theme="auto">
    ...
    <div class="shell" id="shell">
        ...
        <nav class="rail-body" id="navTree">
          ...
          <div class="nav-group open" data-label="Chats">
            ...
            <div class="nav-group-body">
              ...
              <a class="nav-item sub active" href="https://caufero.github.io/projects/Chats/Deployment.md" data-label="Chats Deployment"><span class="dot"></span><span class="nav-text">Deployment</span></a>
      ...
      <!-- ============================================================
           CENTER COLUMN — 4K CHAT LOG CONTENT
           ============================================================ -->
...
<section class="hero">
      ...
      <div class="hero-inner">
        <div class="hero-top">
          <div class="hero-title">FileMaker Deployment Model</div>
          <div class="hero-sub">Chart + team discussion • Formatted like a real chat transcript • Built for fast scanning</div>
        </div>
        <div class="hero-actions">
          <a class="cta ghost" href="#filemaker-deployment-model-chart">
          ...
          <a class="cta" href="#chat-2025-12-31">
            <span class="cta-ico" aria-hidden="true">
              <svg viewBox="0 0 24 24" class="ico" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M21 15a4 4 0 0 1-4 4H8l-5 3V7a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4z"></path>
              </svg>
        ...
        <div class="hero-meta">
          ...
          <span class="chip teal">Team Workflow</span>
          <span class="chip amber">Manual vs OTTO</span>
          <span class="chip copper">Best Practices</span>
        </div>
      </div>
    </section>

    <section class="card section" id="chat-2025-12-31">
      ...
      <div class="ct-thread">
        ...
        <div class="ct-msg">
          <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">1:33 PM</span></div>
          <div class="ct-bubble"><p>@cyril the 13 steps of moving changes between files manually are VERY CRITICAL in their sequence. Not completed in order creates errors to be resolved. This has to do with the underlying model where every object has unique ID thereby removing most issues with name changes</p></div>
        </div>

        <div class="ct-msg">
          <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">2:43 PM</span></div>
          <div class="ct-bubble"><p><strong>DEPLOYMENT - some thoughts</strong></p>
<p>In the world of text based coding languages, GitHub is one of the better known version managers. The way it works is basically this:</p>
<p>There is a main version of any program. It is the latest and greatest APPROVED version. All developers on the team work with copies of this version. No developer touches the approved version.</p>
<p>Instead they "check out" a branch of the program, make changes to that and then request that someone in authority take a look at their changes and decide whether to commit those changes to the main copy. This works great with text based code languages because it's really easy to check and update text.</p>
<p><strong>STATEMENT of the PROBLEM</strong></p>
<p><strong>FileMaker</strong> is a completely different animal obviously. First of all the Scripts are not text based but are available as XML packages. This is one hurdle.</p>
<p>The other is that because a FileMaker application is itself one huge code base with a lot of moving parts. There are layouts which are application objects and then there are fields and buttons and labels, etc on the layouts that are layout objects. Finally there are Tables and Queries which we call Table Occurences plus other miscellaneous items like Menus, etc.</p>
<p>Any and all of these objects as well as scripts could be changed by a developer. So when you are working with only one developer there's no issue. All changes are committed and everything is fine. But once you add a 2nd developer or any number n developers, the number of changes across many areas increases. And the ability to track those changes is not easy or straightforward.</p>
<p>There is a utility that allows us to compare one version against another but just having a list of changes does NOT automatically mean that these changes are good or necessary, etc. Also certain changes affect the entire database materially while others are very lightweight. Changing a color on a button is a lightweight issue. Changing a field type, table name or relationship is a material change which affects the whole program. It's bad enough when single developer does this but at least it's up to them to think it through and correct any errors in code or on layouts. But when you are in a multiple database environment changes like this require a whole other set of steps to inform others and bring up a raft of potential new tests.</p>
<p>Speaking of tests, I haven't seen Kirk's 13 step model yet but I'm sure I'm a bit familiar with it from the past working with him on major projects. I've asked him to send it to me and I've just received it. I will look it over and get back to this post on thoughts because my guess is that his document is very technical and my way of thinking about it will be more at the ground level so to speak, ie how do we actually organize areas of responsibility to keep us from stepping on each other's toes. Be right back.</p></div>
        </div>

        <div class="ct-msg">
          <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">2:48 PM</span></div>
          <div class="ct-bubble"><p>From Todd Geist - Manual Change Integration / Move to Production</p>
<ol class="olist">
<li>Custom Functions - Copy and Paste or Import</li>
<li>Tables - Copy and Paste or Import</li>
<li>Graph - Manual Fix. Make sure relationships and names are setup correctly</li>
<li>Adjust Fields - Any fields that needed relationships will be need to be adjusted. One way to do this is to delete all the fields and re-copy and paste the fields from the old file to the new. That will break relationships, but those might be easier to fix than all of the broken calcs.</li>
<li>Layouts - Manual make the layouts with the correct names. Skip content for now. That comes later</li>
<li>Scripts - Copy and Paste or Import</li>
<li>Value Lists - Manual</li>
<li>Themes - Import (Technically these can go any time before step 9)</li>
<li>Layout Contents - Copy and Paste content, manually set sizes and parts.</li>
<li>LayoutBasedScriptTriggers - Manual</li>
<li>Security Account and Privilege sets - Manual</li>
<li>Custom Menus - Manual</li>
<li>File Options - Default Passwords and Window Based Script Triggers</li>
</ol></div>
        </div>

        <div class="ct-msg">
          <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">2:55 PM</span></div>
          <div class="ct-bubble"><p>hmmm...this just brings up a slew more questions.</p>
<ol class="olist">
<li>Custom Functions - why?</li>
<li>Tables - needs subcats right, like Add New table, Change Existing table: major or minor</li>
<li>Graph - Manual Fix...this should only be for new relationships right? But then again, wouldn't they come across in the whole OttoFMS deploy scenario? I mean the data in a new table wouldn't be there but I don't know why a new table and any new relationship graphs wouldn't make it fine with the clone...very confusing</li>
<li>Adjust Fields - this also shouldn't always be necessary if at all</li>
</ol>
<p>Is this whole thing just a mental exercise in how to do this manually so we know how valuable OttoFMS is to deployment or are you really putting this forth as something we need to know and practice??</p>
<p>I'm confused...but I may go one with my thought above on deployement and ignore this for now.</p></div>
        </div>

        <div class="ct-msg">
          <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">2:57 PM</span></div>
          <div class="ct-bubble"><p>In the diagram, OTTO avoids ALL these things - this is the steps IF you were going to transfer between one version and another manually</p></div>
        </div>

        <div class="ct-msg">
          <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">2:57 PM</span></div>
          <div class="ct-bubble"><p>You really should preface your posts with things like that...lol</p></div>
        </div>

        <div class="ct-msg">
          <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">2:57 PM</span></div>
          <div class="ct-bubble"><p>Just dropping it in here through me for a loop...lol</p></div>
        </div>

        <div class="ct-msg">
          <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">2:58 PM</span></div>
          <div class="ct-bubble"><p>AND if you chose to do live development AND OTTO, this is what needs to happen to roll live changes into the development copy. The 13 steps was one box from the diagram</p></div>
        </div>

        <div class="ct-msg">
          <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">3:01 PM</span></div>
          <div class="ct-bubble"><p>Right...in other words: either do LIVE DEVELOPMENT or don't do LIVE DEVELOPMENT</p>
<p>However, as you chart indicates in the Red Box entitled Live Code Changes, when you must do a live code change, these are the steps to follow.</p>
<p>However, in my experience the only time we are pushed to do a live code change is when our end user has a bug that cannot wait for a new version to be deployed...they are down and we need to fix it right away. That is when we need to make the change in the Production database and then be sure to go into the Development database and make the exact same change.</p></div>
        </div>

        <div class="ct-msg">
          <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">3:03 PM</span></div>
          <div class="ct-bubble"><p>Which brings up something I never thought about: User Management, ie Step #11</p>
<p>Yesterday Chalon had me add (3) new users to the Security model. If I don't go into our development server for 4K and manually add those same (3) users, that would become a problem down the road.</p></div>
        </div>

        <div class="ct-msg">
          <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">3:03 PM</span></div>
          <div class="ct-bubble"><p>Need to add the server side scripts to generate the save as xml - that where we can have a timestamped file of change deltas, and tools like the ModLog from Geist can read this file listing that changes and sequence</p>
<p>Especially since Ver 20, where this script step is now available on the server</p></div>
        </div>

        <div class="ct-msg">
          <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">3:09 PM</span></div>
          <div class="ct-bubble"><p>Help me understand this. Are you proposing a script that runs server side to generate some type of time stamped file OR are you saying that we need to save the Scheduled Scripts on Server to a time stamped file?</p></div>
        </div>

        <div class="ct-msg">
          <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">3:12 PM</span></div>
          <div class="ct-bubble"><p>Neither/both??? A scheduled script - maybe on a short cycle - that does a SAVE AS XML, so that transferring changes from one version to another manually, has a list of what changes were made.</p>
<p>Maybe this should be standard practice to run this just prior to having to manually migrate a change, so that you cover all the same steps?</p></div>
        </div>

        <div class="ct-msg">
          <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">3:22 PM</span></div>
          <div class="ct-bubble"><p><strong>DEPLOYMENT - some thoughts (con't)</strong></p>
<p><strong>FILEMAKER DEPLOYMENT MODEL</strong></p>
<p>This is a great document and reflects a good deal of time and effort and a lot of thinking and discussion. I remember when Kirk first started putting this together for our client and the many discussions we had between ourselves and another developer.</p>
<p>To recap the MAJOR steps briefly:</p>
<ol class="olist">
<li>Take an ACTION ie Make a change (which are categorized from low to high impact)</li>
<li>Do a CODE REVIEW which can either be Accepted or Rejected</li>
<li>When accepted, FREEZE the CODE, ie no more changes can be made</li>
<li>Run OttoFMS deployment</li>
</ol></div>
        </div>

        <div class="ct-msg">
          <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">3:23 PM</span></div>
          <div class="ct-bubble"><p>Or create a build of that freeze point if the client notification of change is required or to avoid unnecessary disruption</p></div>
        </div>

        <div class="ct-msg">
          <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">3:24 PM</span></div>
          <div class="ct-bubble"><p>Yes. The build can then be queued up to send in the future and we can continue working on the Development copy, right?</p></div>
        </div>

        <div class="ct-msg">
          <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">3:25 PM</span></div>
          <div class="ct-bubble"><p>Correct - a build is basically a freeze point of what is hopefully a validated release. That allows you to continue further development on the dev version without impacting the validated build whether it has been deployed or not</p></div>
        </div>

        <div class="ct-msg">
          <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">3:26 PM</span></div>
          <div class="ct-bubble"><p>So the FOUR MAJOR steps in brief are:</p>
<p>MAKE CHANGES, REVIEW CHANGES, FREEZE APP, BUILD/DEPLOY</p></div>
        </div>

        <div class="ct-msg">
          <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">3:28 PM</span></div>
          <div class="ct-bubble"><p>It is the first part of this process: MAKE CHANGES or ACTION where I want to elaborate.</p>
<p>This is the real meat and potatoes of the whole process when it comes to overcoming the shortcomings inherent in FileMaker Team Development.</p>
<p>And this is where a little up front harmonization will be most beneficial.</p></div>
        </div>

        <div class="ct-msg">
          <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">3:37 PM</span></div>
          <div class="ct-bubble"><p>A good part of our discussion at that point of time was using specific comment markers in code, specifically to support code reviews. Team development communication is more than messaging; it includes code readability on changes</p>
<pre class="pre"><code># #################################  Comment Block
# ---------------------------------  Sub-Functional Visual Break
# =================================  Major Functional Change Break
# xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx  End of Code
# ?????????????????????????????????  Indicator of Code Review Question/Concern
# *********************************  Alternative Approach Block
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  Concern over code content
# TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT  TEST code - not for production</code></pre></div>
        </div>

        <div class="ct-msg">
          <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">3:46 PM</span></div>
          <div class="ct-bubble"><p>FWIIW - I do NOT use white space in my code, but I do use the more informative code breaks shown above as comments. It makes code readability - at least for me - much improved, as I can tell where there are functional actions broken out in code visually.</p>
<p>It also allows me - using FMPerception - to search these "tags" on any aspects of the code that are in process, questionable, or test code, and clear these up prior to production release.</p></div>
        </div>

        <div class="ct-msg">
          <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">5:27 PM</span></div>
          <div class="ct-bubble"><p><strong>JOE's TWO CENTS on Coding Standards</strong></p>
<p>I think that syntax and code readability are both very important. I also think that it's good to follow standards as much as possible.</p>
<p>That being said however, and especially at this point, I am MORE interested in how we keep CODE either separate or at least well documented for Code Reviews if we are all going to work in the same application. We can pick up syntax in Code Reviews and we can discuss the value of using one technique or another as we proceed.</p>
<p>But for now I'm more interested in THAT we proceed than looking over your shoulder at your code. I want the (4) of us to be free to write scripts the way we are most comfortable and makes the most sense to us and then we can start to all maybe come together on certain points. And of course having code snippets in Raycast that we can all share is one practical way to get here also. We are all professional FM coders and we are all seasoned, experienced and tested so I'm not worrying so much about that.</p>
<p>I am more interested in the White Paper discussions surrounding Table Occurence Groups more than anything. This is fundamental and basic and is hard to change or refactor once it's done. So my emphasis will be there and then maybe a bit of talk about the consistent use of themes and other naming conventions for fields and value lists, layouts, etc. But overall, I still want to get back to the ONE THING I've been driving at all morning since I started this discussion hours ago....so I will get back to that soon because I think it's our primary challenge and once that is solved the others fall back in place.</p>
<p>That topic is: Assigning Tasks...more to come.</p></div>
        </div>
      </div>
    </section>
  </div>
      ...
      <!-- ============================================================
           RIGHT RAIL — 4K CHAT PAGE SPECIFIC
           ============================================================ -->
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          <div class="rail-title">Right Panel</div>
          <div class="rail-sub">FileMaker Deployment Model navigation</div>
          <div class="rail-actions">
            <div class="rail-actions">
            <a class="rail-btn" href="#filemaker-deployment-model-chart">Chart</a>
            <a class="rail-btn" href="#chat-2025-12-31">Dec 31</a>
          </div>
        </div>
        ...
        <div class="rail-body">
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              ...
              <span class="pill2">Dev/Test naming</span>
              <span class="pill2">OttoDeploy</span>
              <span class="pill2">OData</span>
              <span class="pill2">File naming</span>
              <span class="pill2">User licensing</span>
              <span class="pill2">Inventory design</span>
              <span class="pill2">SKU strategy</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">
                ...
                <a href="https://caufero.github.io/projects/Chats/4K.md">Quick Links</a>
              </div>
              <div class="panel-sub">Jump to the surfaces you use most</div>
            </div>
            <div class="side-grid">
              <a class="side-pill warn" href="https://caufero.github.io/projects/Apps/4KPAINT/_NewAdditions.md">4KPAINT New Additions</a>
              <a class="side-pill warn" href="https://caufero.github.io/projects/Chats/4K.md">4K Chat File</a>
              <a class="side-pill" href="https://caufero.github.io/projects/Chats/_To%20Dos%20From%20Chats.md">To Dos From Chats</a>
              <a class="side-pill" href="https://caufero.github.io/projects/Chats/Deployment.md">Deployment Chat</a>
              <a class="side-pill" href="https://caufero.github.io/projects/Chats/OData.md">OData Chat</a>
              <a class="side-pill" href="https://caufero.github.io/projects/_Misc/_/_Stuff.md#">Home</a>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              <div class="stack-item">Joe<div class="stack-sub">Project manager on 4K • Organizer</div></div>
              <div class="stack-item">Kirk<div class="stack-sub">Dev process + inventory design input</div></div>
              <div class="stack-item">Cyril + Oz<div class="stack-sub">Assigned to learn the table structure on sandbox server</div></div>
              <div class="stack-item">Chalon<div class="stack-sub">4K client • User additions + training</div></div>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              <div class="stack-item">Dev/test server setup<div class="stack-sub">azsafety.fmcloud.fm • OttoFMS + OttoDeploy</div></div>
              <div class="stack-item">Build freeze process<div class="stack-sub">Who calls it • File naming conventions (_dev / _test)</div></div>
              <div class="stack-item">Meeting agenda<div class="stack-sub">Caufero's involvement review • Suggested Improvements PDF</div></div>
              <div class="stack-item">OData explained<div class="stack-sub">vs plain API • Filtering/sorting in the call • FMTraining.tv videos</div></div>
              <div class="stack-item">Inventory design notes<div class="stack-sub">SKU numbering • BoM vs formula • Batch tracking • RMA</div></div>
              <div class="stack-item">User licensing<div class="stack-sub">~18 active users • Likely still under 25</div></div>
            </div>
          </div>
