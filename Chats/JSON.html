...
<body>
  <div class="page" data-theme="auto">
      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text">JSON</span>
          </div>
        </div>
    ...
    <div class="shell" id="shell">
        ...
        <nav class="rail-body" id="navTree">
          ...
          <div class="nav-group open" data-label="Chats">
            ...
            <div class="nav-group-body">
              ...
              <a class="nav-item sub active" href="https://caufero.github.io/projects/Chats/JSON.md" data-label="Chats JSON"><span class="dot"></span><span class="nav-text">JSON</span></a>
      ...
      <!-- ============================================================
           CENTER COLUMN — JSON DEFINITION CHAT CONTENT
           ============================================================ -->
        ...
        <div class="content-inner">
          ...
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Group Chat: JSON</div>
                <div class="hero-sub">Knowledge base entry • Simple explanation for team reference • Formatted from group chat</div>
              </div>
              ...
              <div class="hero-meta">
                <span class="chip">Extract</span>
                <span class="chip teal">JSON</span>
                <span class="chip amber">Knowledge Base</span>
                <span class="chip copper">Team Reference</span>
              </div>
            </div>
          </section>

          <!-- Main Chat Section: Tuesday, 30 Dec 2025 -->
          <section class="card section" id="chat-dec-30">
            <div class="section-head">
              ...
              <div class="section-actions">
                <span class="chip">10:55 PM</span>
              </div>
            </div>

            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">10:55 PM</span></div>
                <div class="ct-bubble">JSON, or JavaScript Object Notation, is a lightweight, text-based format used for storing and exchanging data. It is easy for humans to read and write, and for machines to parse and generate, making it a popular choice for data interchange in web applications.</div>
              </div>
            </div>
            ...
            <div class="ct-callout">
              <div class="ct-callout-head">
                ...
                <div class="ct-callout-title">What JSON Is &amp; Why It Matters</div>
              </div>
              <div class="ct-callout-body">
                This message is Joe giving a simple definition of <strong>JSON</strong> for the team's shared knowledge base.
                <ul class="ul">
                  <li><strong>What he is saying:</strong></li>
                  <li style="margin-left: 20px;">JSON is a simple text format used to store and send data between systems.</li>
                  <li style="margin-left: 20px;">People can read it easily, and computers can also process it easily.</li>
                  <li style="margin-left: 20px;">Because of that, JSON is a very common format used when websites, apps, and servers exchange information.</li>
                  <li><strong>Why it matters to your work:</strong></li>
                  <li style="margin-left: 20px;">In FileMaker and integrations, JSON is often the format used when sending or receiving data through APIs or webhooks, so the team needs to understand it.</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <footer class="footer">
            <div class="footer-left">
              <div class="footer-title">JSON</div>
              <div class="footer-sub">Knowledge base extract • Team reference</div>
            </div>
            <div class="footer-right">
              <a class="footer-link" href="#">Knowledge Base</a>
              <a class="footer-link" href="#">Chat Logs</a>
      ...
      <!-- ============================================================
           RIGHT RAIL — JSON CHAT SPECIFIC
           ============================================================ -->
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          <div class="rail-title">Right Panel</div>
          <div class="rail-sub">Quick navigation & context</div>
          <div class="rail-actions">
            <a class="rail-btn" href="#chat-dec-30">Chat Message</a>
            <a class="rail-btn" href="#chat-prompt">Prompt Used</a>
          </div>
        </div>
        ...
        <div class="rail-body">
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Keywords and topics to look for</div>
            </div>
            <div class="pill-row">
              <span class="pill2">JSON</span>
              <span class="pill2">JavaScript Object Notation</span>
              <span class="pill2">Data format</span>
              <span class="pill2">APIs</span>
              <span class="pill2">Webhooks</span>
              <span class="pill2">FileMaker</span>
              <span class="pill2">Data exchange</span>
              <span class="pill2">Knowledge base</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="side-grid">
              <a class="side-pill warn" href="#">JSON Resources</a>
              <a class="side-pill warn" href="#">API Documentation</a>
              <a class="side-pill" href="#">FileMaker Integration</a>
              <a class="side-pill" href="#">Data Formats Guide</a>
              <a class="side-pill" href="#">Knowledge Base</a>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">What you need to know</div>
            </div>
            <div class="stack">
              <div class="stack-item">JSON Format<div class="stack-sub">Lightweight text format for data storage and exchange</div></div>
              <div class="stack-item">Human & Machine Readable<div class="stack-sub">Easy for both people and computers to understand</div></div>
              <div class="stack-item">Web Applications<div class="stack-sub">Most common format for API data exchange</div></div>
              <div class="stack-item">FileMaker Use<div class="stack-sub">Essential for integrations via APIs and webhooks</div></div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">About this extract</div>
            </div>
            <div class="stack">
              <div class="stack-item">Source<div class="stack-sub">Group chat message from Joe</div></div>
              <div class="stack-item">Date<div class="stack-sub">Tuesday, 30 Dec 2025 at 10:55 PM</div></div>
              <div class="stack-item">Purpose<div class="stack-sub">Knowledge base entry for team reference</div></div>
              <div class="stack-item">Format<div class="stack-sub">Definition with detailed explanation</div></div>
            </div>
          </div>
