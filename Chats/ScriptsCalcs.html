...
<body>
  <div class="page" data-theme="auto">
      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text">ScriptsCalcs</span>
          </div>
        </div>
    ...
    <div class="shell" id="shell">
        ...
        <nav class="rail-body" id="navTree">
          ...
          <div class="nav-group open" data-label="Chats">
            ...
            <div class="nav-group-body">
              ...
              <a class="nav-item sub active" href="https://caufero.github.io/projects/Chats/ScriptsCalcs.md" data-label="Chats ScriptsCalcs"><span class="dot"></span><span class="nav-text">ScriptsCalcs</span></a>
      ...
      <!-- ============================================================
           CENTER COLUMN — SCRIPTSCALCS CHAT CONTENT
           ============================================================ -->
        ...
        <div class="content-inner">
          ...
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Group Chat: ScriptsCalcs</div>
                <div class="hero-sub">Copied log • Formatted like a real chat transcript • Includes section briefs</div>
              </div>
              <div class="hero-actions">
                ...
                <a class="cta" href="#">
                  ...
                  Open Script Techniques Notes
                </a>
              </div>
              <div class="hero-meta">
                <span class="chip">Copied log</span>
                <span class="chip teal">FileMaker Scripts</span>
                <span class="chip amber">Development Techniques</span>
                <span class="chip copper">ScriptsCalcs Project</span>
              </div>
            </div>
          </section>

          <!-- Day 1: Monday 12 Jan 2026 -->
          <section class="card section" id="chat-jan-12">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">💬</span>
                <span>Monday, 12 Jan 2026</span>
              </div>
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">7:30 PM</span></div>
                <div class="ct-bubble">
                  In order to account for development issues on layouts with the EXPLICIT COMMIT onCommit trigger, the following script steps as the opening to the script allows a full access account to hold down any modifier key and force an exit.
                  
                  <div class="ct-code-block">
                    <div class="ct-code-header">
                      <span class="ct-code-title"># Explicit Commit Force</span>
                      <span class="ct-code-lang">FileMaker Script</span>
                    </div>
                    <div class="ct-code-content"><code>Set Variable [ $param ; Value: Get (ScriptParameter) ]
# ——————————————————————————————————————————————————
If [ IsEmpty ( $param ) ]
    # ——————————————————————————————————————————————————
    If [ PatternCount ( Get ( AccountPrivilegeSetName ) ; "Full" ) > 0 ]
        # ——————————————————————————————————————————————————
        Set Variable [ $KeyPress ; Value: Get (ActiveModifierKeys) ]
        # ——————————————————————————————————————————————————
        If [  $KeyPress ≠ 0 ]
    ...
    # ——————————————————————————————————————————————————</code></div>
            ...
            <div class="ct-callout">
              <div class="ct-callout-head">
                ...
                <div class="ct-callout-title">Explicit Commit Force Exit Script</div>
              </div>
              <div class="ct-callout-body">
                <strong>Kirk</strong> shares a clever development technique for layouts that use the <strong>EXPLICIT COMMIT onCommit trigger</strong>.
                <ul class="ul">
                  <li><strong>The Problem:</strong> During development, explicit commit triggers can make it hard to exit records without committing changes, which can be frustrating when testing.</li>
                  <li><strong>The Solution:</strong> Add these script steps at the beginning of your onCommit script. They check if the current user has "Full" access privileges and if any modifier key (Shift, Option, Cmd, Ctrl) is being held down.</li>
                  <li><strong>How It Works:</strong> If both conditions are true (Full access + modifier key pressed), the script exits with True, bypassing the normal commit logic. This gives developers a quick escape hatch during development.</li>
                  <li><strong>Safety:</strong> Regular users without Full access won't be able to use this shortcut, maintaining data integrity in production.</li>
                  <li><strong>Best Practice:</strong> The script uses <code>Get(ScriptParameter)</code> to optionally bypass this check when needed, and <code>Get(ActiveModifierKeys)</code> to detect any modifier key press.</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <section class="card section" id="chat-context">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">📚</span>
                <span>Additional Context &amp; Best Practices</span>
              </div>
            </div>

            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">System Note</span><span class="ct-sep">·</span><span class="ct-time">Info</span></div>
                <div class="ct-bubble">
                  <strong>Understanding Explicit Commit Triggers</strong><br><br>
                  When working with FileMaker's explicit commit model, the onCommit script trigger fires whenever a user attempts to commit a record. This is powerful for validation and data processing, but can create challenges during development.<br><br>
                  <strong>Common Use Cases:</strong>
                  <ul class="ul" style="margin-top:8px;">
                    <li><strong>Data Validation:</strong> Verify required fields are filled before allowing commit</li>
                    <li><strong>Related Record Updates:</strong> Update timestamps, calculations, or related records automatically</li>
                    <li><strong>Audit Trails:</strong> Log who made changes and when</li>
                    <li><strong>Business Logic:</strong> Enforce complex business rules that can't be handled by simple validation</li>
                  </ul>
                  <br>
                  <strong>Developer Tips:</strong>
                  <ul class="ul" style="margin-top:8px;">
                    <li>Always provide a way for developers to bypass complex onCommit logic during testing</li>
                    <li>Use <code>Get(AccountPrivilegeSetName)</code> to differentiate between developers and end users</li>
                    <li>Consider using script parameters to control script behavior without modifying the script itself</li>
                    <li>Document any "secret" modifier key combinations in your development documentation</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div class="ct-callout">
              <div class="ct-callout-head">
                <div class="badge teal">Pro Tip</div>
                <div class="ct-callout-title">Testing Modifier Key Detection</div>
              </div>
              <div class="ct-callout-body">
                The <code>Get(ActiveModifierKeys)</code> function returns different values for different key combinations:
                <ul class="ul">
                  <li><strong>0</strong> = No modifier keys pressed</li>
                  <li><strong>1</strong> = Shift key</li>
                  <li><strong>2</strong> = Caps Lock</li>
                  <li><strong>4</strong> = Control key (Windows) / Command key (Mac)</li>
                  <li><strong>8</strong> = Option key (Mac) / Alt key (Windows)</li>
                </ul>
                <br>
                Multiple keys pressed will return the sum of their values. Kirk's script checks for <em>any</em> modifier key by simply checking if the value is not zero (<code>≠ 0</code>), making it easy to trigger regardless of which modifier key you press.
              </div>
            </div>
          </section>

          <!-- Related Topics -->
          <section class="card section" id="chat-related">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">🔗</span>
                <span>Related Script Patterns</span>
              </div>
            </div>

            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Reference</span><span class="ct-sep">·</span><span class="ct-time">Info</span></div>
                <div class="ct-bubble">
                  <strong>Similar Development Shortcuts:</strong><br><br>
                  
                  <strong>1. Debug Mode Toggle</strong><br>
                  Many developers use a similar pattern with a global variable to enable/disable debug features:
                  <div class="ct-code-inline">If [ $$DEBUG_MODE = 1 ; Exit Script ]</div><br>
                  
                  <strong>2. Script Parameter Bypass</strong><br>
                  Pass a special parameter to skip certain validation:
                  <div class="ct-code-inline">If [ $param = "SKIP_VALIDATION" ; Exit Script ]</div><br>
                  
                  <strong>3. Developer Account Detection</strong><br>
                  Check for specific account names rather than privilege sets:
                  <div class="ct-code-inline">If [ Get(AccountName) = "Developer" ; /* allow bypass */ ]</div><br>
                  
                  <strong>4. Environment-Based Logic</strong><br>
                  Use different behavior in different database files (dev vs prod):
                  <div class="ct-code-inline">If [ Get(FileName) = "MyApp_DEV.fmp12" ; /* dev mode */ ]</div>
                </div>
              </div>
            </div>
          </section>
          ...
          <footer class="footer">
            <div class="footer-left">
              <div class="footer-title">ScriptsCalcs</div>
              <div class="footer-sub">Clean transcript • Caufero Workspace layout</div>
            </div>
            <div class="footer-right">
              <a class="footer-link" href="#">ScriptsCalcs Chat</a>
              <a class="footer-link" href="#">Script Techniques Notes</a>
      ...
      <!-- ============================================================
           RIGHT RAIL — SCRIPTSCALCS SPECIFIC
           ============================================================ -->
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          <div class="rail-title">Right Panel</div>
          <div class="rail-sub">ScriptsCalcs navigation</div>
          <div class="rail-actions">
            <a class="rail-btn" href="#chat-jan-12">Jan 12</a>
            <a class="rail-btn" href="#chat-context">Context</a>
            <a class="rail-btn" href="#chat-related">Related</a>
          </div>
        </div>
        ...
        <div class="rail-body">
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              <span class="pill2">Explicit Commit</span>
              <span class="pill2">onCommit Trigger</span>
              <span class="pill2">Modifier Keys</span>
              <span class="pill2">Development</span>
              <span class="pill2">Full Access</span>
              <span class="pill2">Script Exit</span>
              <span class="pill2">Bypass Logic</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="side-grid">
              <a class="side-pill warn" href="#">ScriptsCalcs Chat File</a>
              <a class="side-pill warn" href="#">Script Techniques Notes</a>
              <a class="side-pill" href="#">To Dos From Chats</a>
              <a class="side-pill" href="#">DEV Chat</a>
              <a class="side-pill" href="#">FileMaker Scripts</a>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              <div class="stack-item">Kirk<div class="stack-sub">FileMaker developer • Script techniques expert</div></div>
              <div class="stack-item">Joe<div class="stack-sub">Project lead • Solution architect</div></div>
              <div class="stack-item">Cyril<div class="stack-sub">Developer • Implementation specialist</div></div>
              <div class="stack-item">Oz<div class="stack-sub">Developer • Technical support</div></div>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              <div class="stack-item">Explicit Commit Triggers<div class="stack-sub">onCommit script trigger behavior & challenges</div></div>
              <div class="stack-item">Developer Shortcuts<div class="stack-sub">Modifier key detection for development bypass</div></div>
              <div class="stack-item">Privilege Detection<div class="stack-sub">Using Get(AccountPrivilegeSetName) for access control</div></div>
              <div class="stack-item">Script Parameters<div class="stack-sub">Optional bypass mechanisms via parameters</div></div>
              <div class="stack-item">Best Practices<div class="stack-sub">Development vs production script logic</div></div>
              <div class="stack-item">Error Handling<div class="stack-sub">Graceful exits and return values</div></div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">🔧 FileMaker Functions Used</div>
              <div class="panel-sub">Key functions in this script</div>
            </div>
            <div class="stack">
              <div class="stack-item">Get(ScriptParameter)<div class="stack-sub">Retrieves parameter passed to script</div></div>
              <div class="stack-item">Get(AccountPrivilegeSetName)<div class="stack-sub">Returns current user's privilege set</div></div>
              <div class="stack-item">Get(ActiveModifierKeys)<div class="stack-sub">Detects which modifier keys are pressed</div></div>
              <div class="stack-item">IsEmpty( )<div class="stack-sub">Checks if value is empty or not provided</div></div>
              <div class="stack-item">PatternCount( )<div class="stack-sub">Searches for text pattern within string</div></div>
            </div>
          </div>
    ...
    *{box-sizing:border-box;}
    ...
    .bg{
      ...
      background:
        ...
        radial-gradient(860px 520px at 100% 10%, rgba(91,73,200,.12), transparent 58%),
    ...
    .page[data-theme="dark"] .bg{
      background:
        ...
        radial-gradient(860px 520px at 100% 10%, rgba(91,73,200,.10), transparent 60%),
    ...
    .ct-code-block{
      margin-top:12px;
      border:1px solid rgba(91,73,200,.18);
      background:rgba(91,73,200,.04);
      border-radius:14px;
      overflow:hidden;
    }
    .page[data-theme="dark"] .ct-code-block{
      border-color:rgba(91,73,200,.25);
    ...
    .page[data-theme="dark"] .ct-code-header{
    ...
    .page[data-theme="dark"] .ct-code-content code{
    ...
    .ct-code-inline{
      ...
      border-radius:8px;
      font-size:12px;
      background:rgba(91,73,200,.08);
      border:1px solid rgba(91,73,200,.16);
      font-family:ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace;
      display:inline-block;
      margin:4px 0;
    }
    .page[data-theme="dark"] .ct-code-inline{
      background:rgba(91,73,200,.12);
      border-color:rgba(91,73,200,.22);
    }
