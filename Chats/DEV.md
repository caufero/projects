...
<body>
  <div class="page" data-theme="auto">
      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text">DEV Chat</span>
          </div>
        </div>
    ...
    <div class="shell" id="shell">
        ...
        <nav class="rail-body" id="navTree">
          ...
          <div class="nav-group open" data-label="Chats">
            ...
            <div class="nav-group-body">
              ...
              <a class="nav-item sub active" href="https://caufero.github.io/projects/Chats/DEV.md" data-label="Chats DEV"><span class="dot"></span><span class="nav-text">DEV</span></a>
      ...
      <!-- ============================================================
           CENTER COLUMN — GROUP CHAT CONTENT
           ============================================================ -->
        ...
        <div class="content-inner">
          ...
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">DEV Chat</div>
                <div class="hero-sub">Chat excerpt from Dec 27-30, 2025 • Covers inventory architecture, SKU strategy, team workflow, and development standards</div>
              </div>
              ...
              <div class="hero-meta">
                ...
                <span class="chip teal">Inventory Design</span>
                <span class="chip amber">Collaboration</span>
                <span class="chip violet">Dev Workflow</span>
              </div>
            </div>
          </section>

          <!-- Main Chat Section -->
          <section class="card section" id="main-chat">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">💬</span>
                <span>Main Chat (Dec 27-30, 2025)</span>
              </div>
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">27/12/2025 5:52:02 PM</span></div>
                <div class="ct-bubble">I need help on refactoring my Product Group/Product SKU table occurence groups in the AZ Safety database. Anyone interested please let me know. I would like to set up a time where I can show you what I have now and why it's not the best and then I would like to hear any suggestions you might have.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Cyril</span><span class="ct-sep">·</span><span class="ct-time">27/12/2025 5:56:49 PM</span></div>
                <div class="ct-bubble">Joe, I'll be happy to help</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">27/12/2025 6:00:59 PM</span></div>
                <div class="ct-bubble">The basic hurdle that I need to overcome is what is the best design for a matrix of variants for products.<br><br>What this means is that one PRODUCT, let's say a T-Shirt as an example, will come in many sizes and colors.<br><br>So the model or product called Men's Premium Tee with Pocket is just one product but it comes in 8 colors and 8 sizes. This means that potentially that one PRODUCT can have 64 SKUs.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">27/12/2025 6:03:45 PM</span></div>
                <div class="ct-bubble">I have done this for many years and made it work successfully. HOWEVER, I think that my current design is NOT the best one. And before I go and sell this First Aid program or even work on another generic program with Kirk, I need to have a kind of whiteboard, brainstorming session about the different ways to handle this from a TO group and design perspective.<br><br>I'm not concerned with the user interface aspect of it for the user. That's important of course but it's a second step to the foundation of the data design itself.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">27/12/2025 6:05:48 PM</span></div>
                <div class="ct-bubble">And then an adjunct to this challenge is how to design the inventory management aspect of each SKU so that we can get counts of Size Large Blue Men's Premium Tees for each warehouse they are in. Or maybe for each van they are in, ie a mobile warehouse.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">27/12/2025 6:07:12 PM</span></div>
                <div class="ct-bubble">I KNOW the basics and I have done this for many years now in other applications as well as FileMaker and for at least 2 different companies but I need to have another discussion again of the basics with a few different minds so I can get input not only on the best design from a data point of view but also the best design for the FileMaker tool itself.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">27/12/2025 6:09:41 PM</span></div>
                <div class="ct-bubble">As a side note, there is currently a developer out that that Kirk knows who will sell you a complete inventory package in FileMaker for $25,000 and then you can use it anywhere you like in your own software. That's good because it is worth it BUT I have almost the same thing he has already and I definitely KNOW as much as he does about the process...not necessarily as good in FileMaker as he is but I KNOW inventory management very well having handled many stock items worth anywhere from 100K to 950K dollars and had to do the whole cycle: replenish, hold, sell, etc</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">27/12/2025 6:13:00 PM</span></div>
                <div class="ct-bubble">So rather than pay this person the $25,000, I want some outside looks at the last project I've done and see if we can't design our own database for inventory management that is as good...or better...but won't cost us money to buy or resell to others.<br><br>I think if we do it right, this could become a key part of our generic software application in the future, if not THE KEY part because there are NOT MANY FileMaker developers that I have ran into online over the past 8 years who have made this work the way it does in the real world.<br><br>In fact, although every FM application does a little inventory management and some invoices, etc. the whole idea of TRUE Inventory mgmt and TRUE Order Management...that process is not well understood at all.<br><br>IMHO<br><br>If nothing else, it could be good learning just to go over it together.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Cyril</span><span class="ct-sep">·</span><span class="ct-time">27/12/2025 6:21:16 PM</span></div>
                <div class="ct-bubble">I'm happy to look at what you currently have, then brainstorm some other approaches with you. I can see the hurdle being the best normalization approach that will prevent redundant data, and still be able to manage the SKUs as actual products that can be managed, no matter how deep their categorization hierarchies go. I'm excited to look at that</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">27/12/2025 6:22:20 PM</span></div>
                <div class="ct-bubble">great...and you already see the heart of the issue: "no matter how deep"</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">27/12/2025 6:23:25 PM</span></div>
                <div class="ct-bubble">which maybe we do need to limit the number of variations to a more reasonable number. I have done that before and in practical terms not many products really need more than 3 or 4 variations at the most<br><br>that does simplify the problem space...</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Cyril</span><span class="ct-sep">·</span><span class="ct-time">27/12/2025 6:24:12 PM</span></div>
                <div class="ct-bubble">I also agree with you. Your extensive knowledge in inventory management together with the team's development skills should be employed to create a solution like this; which can be used as a generic software in the future. I like the sound of this too</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">27/12/2025 6:25:46 PM</span></div>
                <div class="ct-bubble">I think that you and Oz have already encountered a number of clients who have a need for this and for order management<br><br>The trick will be to design the application with enough user preferences or developer preferences that we can handle the simplest store to a complicated distribution network<br><br>the design is the same but the user interface can be SIMPLE or very DETAILED</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Cyril</span><span class="ct-sep">·</span><span class="ct-time">27/12/2025 6:26:26 PM</span></div>
                <div class="ct-bubble">Yes we have, and there's always the temptation to create a hierarchical tree in the products table (to allow any level of depth), but doing it that way also introduces not too clean of the overall data.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">27/12/2025 6:27:43 PM</span></div>
                <div class="ct-bubble">yes..that hierarchical tree or any tree structure is actually a very basic programming structure BUT it is not always intuitive nor does it have a simple way to implement it in an FM app</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">27/12/2025 6:29:08 PM</span></div>
                <div class="ct-bubble">I will show you one sample that I played with 6 years ago with Kirk...it is NOT necessarlily what I would do today BUT it shows the concept of what I call: "Walking the Nodes in a tree structure"<br><br>NODES are a key concept to understanding the web/tree structure that is free form</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Cyril</span><span class="ct-sep">·</span><span class="ct-time">27/12/2025 6:29:54 PM</span></div>
                <div class="ct-bubble">Mmm, sounds interesting. Will love to see that</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Cyril</span><span class="ct-sep">·</span><span class="ct-time">27/12/2025 6:32:20 PM</span></div>
                <div class="ct-bubble">What time do you think we can set aside to take a look at this?</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">27/12/2025 6:34:56 PM</span></div>
                <div class="ct-bubble">well anytime really but is it too late to show you a little bit of it now? I could share my screen<br><br>or even later I mean after you have supper maybe...or not...we can do it tomorrow or Monday, etc<br><br>I'm in no rush</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Cyril</span><span class="ct-sep">·</span><span class="ct-time">27/12/2025 6:35:40 PM</span></div>
                <div class="ct-bubble">No we can do it now</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">27/12/2025 6:35:58 PM</span></div>
                <div class="ct-bubble">okay I'll share my screen</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">27/12/2025 6:36:54 PM</span></div>
                <div class="ct-bubble">you might need to put on your headset so we can talk...or at least the eyeball to see I think</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Oz</span><span class="ct-sep">·</span><span class="ct-time">27/12/2025 6:37:00 PM</span></div>
                <div class="ct-bubble">I am out of Accra and I'm experiencing terrible network. If it looks stable, I will join in</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">27/12/2025 6:37:21 PM</span></div>
                <div class="ct-bubble">okay...Hi Oz!</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Oz</span><span class="ct-sep">·</span><span class="ct-time">27/12/2025 6:37:32 PM</span></div>
                <div class="ct-bubble">Hahaha…Hi Joe</div>
              </div>

              <div style="height:20px;"></div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">29/12/2025 8:44:46 PM</span></div>
                <div class="ct-bubble"><strong>DEVELOPER TALK - Monday, Dec 29th: Current State of Development Server for Blue Collar</strong><br><br>So it may be that we are going to use a server that Kirk has as a development Server and the azsafety.fmcloud.fm server as a sandbox or test platform instead. We'll see where that goes and how quickly we can get there.<br><br>Today, however, the Blue Collar Dev Server at azsafety.fmcloud.fm is up and running and I wanted to make you aware of some of the utilities that are already installed there. Maybe you won't have time to look at ALL these applications but maybe some of them you will find helpful and enlightening. Certainly there are a few from Proof & Geist that we will be using and of course the 4K Painting application is here as well. But there are other useful apps here that will at the LEAST be useful as launching pads for discussion on important areas of FM development, ie bug or issue tracking, style sheets, etc.<br><br>Also, each one of you has a login name and password for the following applications. For Cyril and Osbert, you will need to use your first name as the login (all lowercase) and Caufero123 as the password. Of course you will be prompted to change your password. For Kirk, I think you know your password already but it is the one you usually use. But let me know if any of you are locked out of any of the apps.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">29/12/2025 8:44:46 PM (continued)</span></div>
                <div class="ct-bubble">
                  <strong>Available Applications:</strong>
                  <ul class="ul" style="margin-top:8px;">
                    <li><strong>4K Painting & Drywall</strong>: client application for testing/learning.</li>
                    <li><strong>OttoDeploy</strong>: tracks builds and deployments with OttoMatic and OttoFMS.</li>
                    <li><strong>BCS_d1</strong>: includes a <strong>SKU Builder</strong> layout that demos building SKU variation sets using categories, tree nodes, and nested loops.</li>
                    <li><strong>barcode_test</strong>: barcode reading demo using iOS camera / container image.</li>
                    <li><strong>BCS_StyleSheetTheme</strong>: explores standardizing FileMaker style/theme naming.</li>
                    <li><strong>ActionTrack_R1</strong>: older bug tracker example for tracking issues and feature requests.</li>
                    <li><strong>CodeSnips</strong>: database for Monkey Bread Software's Code Snippet facility.</li>
                    <li><strong>Item Collection</strong>: value-list style concept using Collection/Parent/Child/Sort, plus UI patterns like breadcrumbs and tree navigation.</li>
                    <li><strong>InfoTools Helper</strong>: Kirk's helper app explaining philosophy/constraints/constructs + install.</li>
                    <li><strong>JSONQuery 2.1</strong>: custom function for querying/transforming JSON (Steve Senft-Herrera / FileMaker Hacks).</li>
                    <li><strong>Time_Picker</strong>: demo time picker app.</li>
                    <li><strong>TaskControl</strong>: Kirk's multi-project, multi-user task app.</li>
                    <li><strong>OData Examples</strong>: 45 examples of OData usage with FileMaker (syntax/URLs/cURL + demo data).</li>
                    <li><strong>SimpleQ</strong>: Proof & Geist messaging broker (Publisher/Subscribers) + demo files (admin/admin).</li>
                  </ul>
                </div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">29/12/2025 8:56:45 PM</span></div>
                <div class="ct-bubble">Note: The TimePicker needs a rewrite, as it is a Javascript object in a web viewer in a popover that does not work in WebDirect. I have a new version that does work - I'll find that and add it.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">30/12/2025 8:03:27 PM</span></div>
                <div class="ct-bubble">@cyril - I haven't forgotten about the inventory discussion we started above, but I'm going to put it on the back burner for a bit especially since the 4K project doesn't really need it right now</div>
              </div>
            </div>
            ...
            <div class="ct-callout">
              <div class="ct-callout-head">
                ...
                <div class="ct-callout-title">Inventory Design & Collaboration Discussion</div>
              </div>
              <div class="ct-callout-body">
                This chat is about two main topics: <strong>inventory design</strong> and <strong>how the team will work together on projects</strong>. The purpose is to make sure everyone is aligned on the important inventory concepts (so the system is built correctly), and also to set clear collaboration rules (so team work does not become messy when more people join).
                <br><br>
                <strong>1) Inventory: what they are saying and why it matters</strong>
                <ul class="ul">
                  <li><strong>The core challenge:</strong> How to design a FileMaker database that handles product variants properly. Example: a T-shirt that comes in 8 colors × 8 sizes = 64 different SKUs from one base product.</li>
                  <li><strong>The normalization problem:</strong> Finding the best way to structure the data so you avoid redundancy but can still track each variant independently across multiple warehouses or mobile warehouses (vans).</li>
                  <li><strong>Tree structure vs flat:</strong> They discuss hierarchical tree structures for product categorization, which is powerful but complex to implement in FileMaker.</li>
                  <li><strong>Walking the nodes:</strong> Joe mentions a concept called "Walking the Nodes in a tree structure" - a technique for navigating hierarchical data that he experimented with 6 years ago with Kirk.</li>
                  <li><strong>The business case:</strong> Joe has deep inventory management experience (handled $100K-$950K in stock) and wants to build a reusable inventory system instead of buying one for $25,000. This could become a key part of their generic software offering.</li>
                </ul>
                <strong>2) Collaboration: how they want the team to work</strong>
                <ul class="ul">
                  <li><strong>Development server setup:</strong> They're using azsafety.fmcloud.fm as a development/sandbox server with OttoFMS, OttoDeploy, and various utility applications installed.</li>
                  <li><strong>Learning resources:</strong> Joe has set up multiple demo applications (SKU Builder, barcode test, style sheets, bug tracker, etc.) for the team to explore and learn from.</li>
                  <li><strong>Access credentials:</strong> Cyril and Oz get standard logins (firstname/Caufero123) to access all the development tools.</li>
                  <li><strong>Meeting approach:</strong> Joe offers flexible timing for collaboration - willing to share screen immediately or schedule for later, showing a collaborative working style.</li>
                </ul>
              </div>
            </div>
          </section>

          <!-- Inventory Extract Section -->
          <section class="card section" id="inventory-extract">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">📦</span>
                <span>Extract — Inventory Discussion (Kirk's Four Messages)</span>
              </div>
            </div>

            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">31/12/2025 1:45:19 PM</span></div>
                <div class="ct-bubble">MOVING FOUR of KIRK's MESSAGES out of 4K and into this Group. They all concern inventory.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">31/12/2025 1:45:59 PM</span></div>
                <div class="ct-bubble"><strong>#1: SKU Numbering Strategies</strong><br><br>There are 2 basic schools of thought on part (sku) numbering; one where the first few digits are a product ID and all the variants are just a serialized concatenation with the ID. The second is where the number is metadata - data about data encoded into the data itself; each digit contains information to specifically identify the variant.<br><br>Both are equally prevalent however personally and professionally, I lean strongly to the latter.<br><br>A great example of this is VIN code - vehicle identification numbers which also adds item serialization into the code as a suffix.<br><br><a class="ct-link" href="https://goodcar.com/vehicle-history/how-to-decode-a-vin-number">goodcar.com — How to Decode a VIN Number</a></div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">31/12/2025 1:46:45 PM</span></div>
                <div class="ct-bubble"><strong>#2: Inventory Types - BoM vs Formula-Based</strong><br><br>Beyond the SKU, there are also a couple of inventory types; Bill of materials and formula based.<br><br>A BoM can be a discrete item or an assembly of discrete or sub-assemblies. The assembly can be broken down into atomic level inventory item.<br><br>In formula based inventory (think cake mix), once the discrete items are combined there is no option to disassemble the combined item. In this case, there are strong arguments to retain batch information on the discrete components of the formula.<br><br><strong>Case in point:</strong> some years ago Tylenol had to recall 100% of the product because they found contamination in one batch of a competent chemical and could not trace which final products contained chemicals from this batch. There are hundreds of nutraceutical products sold at health food retailers that lack this capability as inventory software with this capability is both rare and expensive.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">31/12/2025 1:47:19 PM</span></div>
                <div class="ct-bubble"><strong>#3: Item Serialization</strong><br><br>Item serialization is another aspect that comes to play in many inventory scenarios especially on bigger ticket items and assemblies</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">31/12/2025 1:47:38 PM</span></div>
                <div class="ct-bubble"><strong>#4: RMA (Return Material Authorization)</strong><br><br>And in many inventory systems out there, they neglected to account for RMA Return Mateial Authorization - to put things back in stock. Sometimes laws do not allow a returned product, even unopened, to be sold as new (US commerce law on computers for instance) so an inventory designation needs to exist to account for this possibility</div>
              </div>

              <div style="height:20px;"></div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">31/12/2025 6:29:54 PM</span></div>
                <div class="ct-bubble">Who is going to take on setting up a shared GitHub repository for FM Snippets / Raycast?</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">31/12/2025 6:37:59 PM</span></div>
                <div class="ct-bubble">I can do that. Is that how they are shared?</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">31/12/2025 6:40:24 PM</span></div>
                <div class="ct-bubble">Yes. Raycast app store FMSnippets, links to the GitHub page that describes setting up your own repository</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">31/12/2025 7:10:19 PM</span></div>
                <div class="ct-bubble">I have a SDLC (Software development life cycle) document I wrote that I could share…..but may be overkill. Some subset would be valid though.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">31/12/2025 9:15:20 PM</span></div>
                <div class="ct-bubble">I'm sure it will be overkill but it doesn't hurt to expose Cyril and Oz to a bunch of high level stuff. The more experience they get with seeing what's out there and how this IT and programming world looks in America, the better.<br><br>But in practical use, I am guessing that for at least the start, you and I will be the Project Managers (PM). So I'm more concerned that you and I provide clear oversight and direction up front to what we need/want/expect in any project that we all collaborate on.<br><br>It's been easier for you and I to do this because we have worked together for years and we know each other and it's easy for two people to plan together. Four people adds some complexity and I want to make the transition as easy as possible and smooth because right now it's the end of the year and it's slow. I'm guessing that we could all get very busy in another month or so.<br><br>It will also be easy for Oz and Cyril to collaborate together because they know each other and have already started down this path awhile ago. Also Oz may actually be able to help the rest of us with his recent experience with the company he worked for Kiza. They of course had a very detailed system to be able to work with a number of contract type employees mostly from the African continent as I understand it.<br><br>In fact that should be another agenda item in addition to 1) Task Manager and 2) 4K Project. We should have Oz share with us exactly how Kiza trained him to do this exact same thing. We will learn both what he already knows and also maybe get some good ideas.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">31/12/2025 10:31:35 PM</span></div>
                <div class="ct-bubble"><strong>Basic rules for team development in a DEV environment</strong><br><br>
                  <ol class="ol" style="margin-top:8px;">
                    <li>Duplicate the script or layout before editing. This is your validated backup / recovery point. Optionally, add a BACKUP suffix to the name</li>
                    <li>Edit in the original; as the internal ID is the basis, then the changes will be linked to everything else. Optionally, add WIP (Work-In-Process) suffix to the name</li>
                    <li>If the changes are validated, you can optionally delete the BACKUP</li>
                    <li>If the changes have NOT been validated and a code freeze needs to occur, duplicate the edited copy, then copy the CONTENT of the script or layout from the backup, onto the original, and you'll be back to the starting point.</li>
                  </ol>
                  <br>These efforts are a safety net for EXISTING CODE, to keep fixes/updates that may not be workable (yet) from screwing up what was working, or at least giving you a restore point, and still work within the existing workflow.<br><br>For PRODUCTION LIVE CODE edits, everything is the same EXCEPT that you edit in the copy (so as to not disrupt production), and manually deal with connections to other places in testing the result. Once working, you can copy the CONTENT of the copy into the original script or layout.<br><br>Another partial workable option: Make a DDR prior to every change session and, using FMPerception, the code (not the layouts) from the DDR can be copied back into the solution.
                </div>
              </div>
            </div>
            ...
            <div class="ct-callout">
              <div class="ct-callout-head">
                <div class="badge violet">Brief Summary</div>
                <div class="ct-callout-title">Inventory & Collaboration Setup Details</div>
              </div>
              <div class="ct-callout-body">
                This extract covers <strong>Kirk's four key messages about inventory design</strong> plus important discussions about <strong>team collaboration setup</strong>.
                <br><br>
                <strong>Inventory Design Concepts (Kirk's Four Messages):</strong>
                <ul class="ul">
                  <li><strong>SKU Numbering Strategies:</strong> Two approaches exist - simple ID concatenation vs meaningful metadata in the code itself. Kirk strongly prefers metadata-based SKUs (like VIN numbers) where each digit tells you something about the variant.</li>
                  <li><strong>BoM vs Formula Inventory:</strong> Bill of Materials can be disassembled; formula-based inventory (like cake mix) cannot. Formula inventory needs batch tracking for recalls - Kirk cites the Tylenol recall as a critical example of why this matters.</li>
                  <li><strong>Item Serialization:</strong> Important for expensive items and assemblies - each individual unit gets its own serial number for tracking.</li>
                  <li><strong>RMA Returns:</strong> Many systems forget about returns. Legal restrictions (e.g., US computer law) may prevent returned items from being sold as "new" even if unopened, requiring separate inventory status.</li>
                </ul>
                <strong>Collaboration & Team Workflow:</strong>
                <ul class="ul">
                  <li><strong>GitHub Repository:</strong> Team needs a shared GitHub repo for FM Snippets/Raycast. Joe volunteers to set it up.</li>
                  <li><strong>Project Management Structure:</strong> Joe and Kirk will serve as Project Managers initially, providing oversight and clear expectations for deliverables and standards.</li>
                  <li><strong>Learning from Experience:</strong> Joe wants Oz to share how Kiza trained him and managed collaborative work, so the team can adopt best practices.</li>
                  <li><strong>Development Safety Rules:</strong> Kirk provides detailed rules for safe FileMaker development: duplicate before editing, edit the original (to preserve internal IDs), keep backups, use DDR for recovery. Different process for DEV vs PRODUCTION environments.</li>
                </ul>
              </div>
            </div>
          </section>

          <!-- Workflow Extract Section -->
          <section class="card section" id="workflow-extract">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">🔄</span>
                <span>Extract — DEV → TEST → PRODUCTION Workflow</span>
              </div>
            </div>

            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">Fri Jan 2 2026 5:05 PM</span></div>
                <div class="ct-bubble">Typically in the traditional Dev→Test/Production server structure (supported by Claris's 3 server license with any multi-user setup),<br><br>
                  <ol class="ol" style="margin-top:8px;">
                    <li>DEV is where developers make changes</li>
                    <li>when a freeze is ready, that indicated that code review and some preliminary - typically UNIT but sometimes SYSTEM test is complete</li>
                    <li>A BUILD is pushed to TEST often with recent production data orignally seeded on TEST</li>
                    <li>Test is performed</li>
                    <li>if all defined validation is successful, the DEV BUILD version tested, is pushed to Production.</li>
                  </ol>
                </div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">Fri Jan 2 2026 5:06 PM</span></div>
                <div class="ct-bubble">Note that OTTODeploy contains features to allow a quick code rollback to the prior version.</div>
              </div>
            </div>

            <div class="ct-callout">
              <div class="ct-callout-head">
                <div class="badge amber">Brief Summary</div>
                <div class="ct-callout-title">Professional Release Workflow</div>
              </div>
              <div class="ct-callout-body">
                Kirk is describing the standard way teams safely move FileMaker changes into the live system, using three environments: DEV, TEST, and PRODUCTION. The goal is to reduce risk, prevent broken updates from reaching users, and make sure changes are verified before they go live.
                <br><br>
                <strong>How the flow works (the main idea):</strong>
                <ul class="ul">
                  <li><strong>DEV (Development):</strong> Developers build and change things here.</li>
                  <li><strong>Freeze moment:</strong> Work is considered ready for review and early testing.</li>
                  <li><strong>Code review + early testing:</strong> Unit testing, and sometimes system testing.</li>
                  <li><strong>Build goes to TEST:</strong> A specific build moves from DEV into TEST, often with seeded production-like data.</li>
                  <li><strong>Testing happens in TEST:</strong> Validate features and acceptance checks.</li>
                  <li><strong>Push to PRODUCTION:</strong> The same tested build is deployed to the live system.</li>
                </ul>
                <strong>Extra point (safety):</strong> OttoDeploy can do quick rollback to the prior version if a deployment causes issues.
                <br><br>
                <strong>Purpose:</strong> Controlled releases that are tested, repeatable, and reversible. This prevents the "it worked on my machine" problem and ensures production stability.
              </div>
            </div>
          </section>
          ...
          <footer class="footer">
            <div class="footer-left">
              <div class="footer-title">Group Chat Log</div>
              <div class="footer-sub">Inventory design & team collaboration • Dec 27-30, 2025</div>
            </div>
      ...
      <!-- ============================================================
           RIGHT RAIL — GROUP CHAT SPECIFIC
           ============================================================ -->
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          <div class="rail-title">Right Panel</div>
          <div class="rail-sub">Quick reference & navigation</div>
          <div class="rail-actions">
            <a class="rail-btn" href="#main-chat">Main Chat</a>
            <a class="rail-btn" href="#inventory-extract">Inventory</a>
            <a class="rail-btn" href="#workflow-extract">Workflow</a>
          </div>
        </div>
        ...
        <div class="rail-body">
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Key concepts to watch for</div>
            </div>
            <div class="pill-row">
              <span class="pill2">SKU variants</span>
              <span class="pill2">Normalization</span>
              <span class="pill2">Tree structures</span>
              <span class="pill2">BoM vs Formula</span>
              <span class="pill2">Serialization</span>
              <span class="pill2">RMA returns</span>
              <span class="pill2">GitHub repo</span>
              <span class="pill2">Dev safety</span>
              <span class="pill2">Build freeze</span>
              <span class="pill2">OttoDeploy</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">External references</div>
            </div>
            <div class="side-grid">
              <a class="side-pill" href="https://goodcar.com/vehicle-history/how-to-decode-a-vin-number" target="_blank" rel="noopener noreferrer">VIN Decode Guide</a>
              <a class="side-pill" href="#">Raycast Setup</a>
              <a class="side-pill" href="#">GitHub Repo</a>
              <a class="side-pill" href="#">SDLC Docs</a>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              <div class="stack-item">Joe<div class="stack-sub">Inventory expert • Project lead</div></div>
              <div class="stack-item">Kirk<div class="stack-sub">FileMaker architect • Workflow design</div></div>
              <div class="stack-item">Cyril<div class="stack-sub">Developer • Data normalization focus</div></div>
              <div class="stack-item">Oz<div class="stack-sub">Developer • Kiza experience</div></div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              <div class="panel-title">📌 Topics Covered</div>
              <div class="panel-sub">What this chat addresses</div>
            </div>
            <div class="stack">
              <div class="stack-item">Product variant design<div class="stack-sub">T-shirt example: 8 colors × 8 sizes = 64 SKUs</div></div>
              <div class="stack-item">SKU numbering strategies<div class="stack-sub">Simple ID vs metadata-based (VIN-style)</div></div>
              <div class="stack-item">Inventory types<div class="stack-sub">BoM (disassemblable) vs Formula (permanent mix)</div></div>
              <div class="stack-item">Batch tracking<div class="stack-sub">Tylenol recall example</div></div>
              <div class="stack-item">Tree structures<div class="stack-sub">Walking the nodes concept</div></div>
              <div class="stack-item">Team collaboration<div class="stack-sub">GitHub, PM structure, learning from Kiza</div></div>
              <div class="stack-item">Dev safety rules<div class="stack-sub">Backup → Edit → Validate → Restore workflow</div></div>
              <div class="stack-item">Release workflow<div class="stack-sub">DEV → TEST → PRODUCTION pipeline</div></div>
            </div>
          </div>
