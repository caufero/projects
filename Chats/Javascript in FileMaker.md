      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text">Javascript in FileMaker</span>
          </div>
        </div>
    ...
    <div class="shell" id="shell">
        ...
        <nav class="rail-body" id="navTree">
          ...
          <div class="nav-group open" data-label="Chats">
            ...
            <div class="nav-group-body">
              ...
              <a class="nav-item sub active" href="https://caufero.github.io/projects/Chats/Javascript%20in%20FileMaker.md" data-label="Chats Javascript in FileMaker"><span class="dot"></span><span class="nav-text">Javascript in FileMaker</span></a>
        ...
        <div class="content-inner">
          ...
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Chat Group: Javascript in FileMaker</div>
                <div class="hero-sub">Tech shares from Joe and Kirk covering FileMaker JS tools and modern web framework trends</div>
              </div>
              <div class="hero-meta">
                <span class="chip">Tech Share</span>
                <span class="chip teal">JavaScript</span>
                <span class="chip amber">FileMaker</span>
                <span class="chip copper">Web Dev Trends</span>
              </div>
            </div>
          </section>

          <!-- Day 1: Dec 30 Part 1 - JS Resources -->
          <section class="card section" id="chat-dec-30-part1">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">💬</span>
                <span>Monday, 30 Dec 2025 — FileMaker JavaScript Resources</span>
              </div>
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                ...
                <div class="ct-bubble">Build FileMaker widgets in Javascript, a website by Jeremy Brown. Includes a course and a community.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">6:04 PM</span></div>
                <div class="ct-bubble"><a class="ct-link" href="https://www.jsinfm.com/" target="_blank" rel="noreferrer noopener">https://www.jsinfm.com/</a></div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">6:16 PM</span></div>
                <div class="ct-bubble">How to build a Next.js web app that is FileMaker aware. This kit comes with all the code needed to launch a node js project, access it using the Visual Studio Code IDE and have all the libraries needed to connect to a FileMaker server.<br><br>This is NOT a framework like say Ruby on Rails but it is a command line tool that will give you a quickstart to building your own javascript web app that uses data from FileMaker. It requires a tech stack and you will be programming in javascript.<br><br>The tech stack includes, besides FileMaker Server, Node.js, Tailwind CSS, Shadcn/ui component library for React, tanstack query, zod, clerk, etc. Basically if you were working for Proof & Geist and was going to use their chosen tech tools to develop javascript web apps, this is the setup program to download everything you need.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">6:16 PM</span></div>
                <div class="ct-bubble"><a class="ct-link" href="https://proofkit.dev/" target="_blank" rel="noreferrer noopener">https://proofkit.dev/</a></div>
              </div>
            </div>
            ...
            <div class="ct-callout">
              <div class="ct-callout-head">
                ...
                <div class="ct-callout-title">Two JavaScript Resources for FileMaker</div>
              </div>
              <div class="ct-callout-body">
                Joe shares two important JavaScript resources for FileMaker developers:
                <ul class="ul">
                  <li><strong>JS in FM (jsinfm.com)</strong> — A website by Jeremy Brown focused on building JavaScript widgets that run inside FileMaker's WebViewer. Includes courses and a community for learning how to create interactive UI components within FileMaker.</li>
                  <li><strong>ProofKit (proofkit.dev)</strong> — A command-line tool that sets up a complete Next.js web application stack that can connect to FileMaker Server. Not a full framework, but a quickstart template that includes Node.js, Tailwind CSS, Shadcn/ui (React components), Tanstack Query, Zod, Clerk auth, and other tools used by companies like Proof & Geist.</li>
                  <li>The key difference: <strong>JS in FM</strong> is for widgets <em>inside</em> FileMaker; <strong>ProofKit</strong> is for building external web apps that <em>connect to</em> FileMaker.</li>
                </ul>
              </div>
            </div>
          </section>

          <!-- Day 2: Dec 31 - Carafe and HTMX Discussion -->
          <section class="card section" id="chat-dec-31">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">💬</span>
                <span>Wednesday, 31 Dec 2025 — Carafe.fm + HTMX vs React</span>
              </div>
              <div class="section-actions">
                <span class="chip">UTC</span>
              </div>
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                ...
                <div class="ct-bubble">Carafe dot fm is a tool by Soliant Consulting that is open sourced and attempts to establish a standard for sharing Javascript bundles for use by any developer in the FileMaker community. Check out the Tutorial page to learn more about it.<br><br><a class="ct-link" href="https://carafe.fm/" target="_blank" rel="noreferrer noopener">https://carafe.fm/</a></div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">1:19 PM</span></div>
                <div class="ct-bubble">I'm seeing a rapid adoption of HTMX replacing React and the ancillary stuff that goes with it. Not related to FM (yet) but the tech trend adoption curve seems to be quickly headed that way.<br><br>Request Trackers new release was a rewrite from react to htmx and the tech press is all afire about htmx.<br><br><a class="ct-link" href="https://htmx.org/" target="_blank" rel="noreferrer noopener">https://htmx.org/</a></div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">1:38 PM</span></div>
                <div class="ct-bubble">HTMX is a server driven UI that relies on HTML attributes. It does not and cannot replace React with all its components and libraries for complex applications. It is designed to be a lightweight alternative for simple application not a React replacement.<br><br>There is a lot of buzz in the js developer world about HTMX and real positivity as we all long for simpler and lighter weight ways of handling tasks. Also the marketing around HTMX is grass roots and fun so in this way it's similar to the Ruby community or the old Apple communities in the early days where people like the little guy over the Goliaths of the corporate world.<br><br>But HTMX will not be replacing React or any of the heavier component and library filled JS Frameworks anytime soon. It is however carving out its own little niche and like all software tools: it's project dependent. So for basic applications, HTMX is great and may even be preferred because now you can do more with basic HTML attributes than ever before which is basically HOW javascript came into being in the first place. In that sense it's more like the continuous cycle of web development in the browser changing and growing.<br><br><a class="ct-link" href="https://www.builder.io/blog/htmx-vs-react" target="_blank" rel="noreferrer noopener">https://www.builder.io/blog/htmx-vs-react</a></div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">1:41 PM</span></div>
                <div class="ct-bubble">The above review is a really positive review of HTMX and it explains things quite well visually. It's both big picture and a bit granular so I think you get the full picture. More tech...yay 😜</div>
              </div>
            </div>
            ...
            <div class="ct-callout">
              <div class="ct-callout-head">
                ...
                <div class="ct-callout-title">Carafe.fm + The HTMX vs React Reality Check</div>
              </div>
              <div class="ct-callout-body">
                This conversation covers two topics:
                <ul class="ul">
                  <li><strong>Carafe.fm</strong> — An open-source tool by Soliant Consulting that creates a standard for sharing JavaScript bundles within the FileMaker community. Think of it as a package manager or library system for FileMaker JS components that any developer can use and contribute to.</li>
                  <li><strong>HTMX vs React debate</strong> — Kirk mentions seeing rapid HTMX adoption and thinks it's replacing React. Joe provides important context: HTMX is a lightweight, server-driven approach using HTML attributes — great for simple applications, but <em>not</em> a replacement for React in complex apps that need full component libraries and frameworks.</li>
                  <li><strong>The nuance</strong>: HTMX is gaining buzz because it's simpler and has grassroots, underdog appeal (like early Ruby or Apple communities). It's carving out a niche for basic applications where you don't need React's complexity. But for enterprise-level, complex web apps, React and similar frameworks remain the better choice. As always with development tools: <strong>it's project-dependent</strong>.</li>
                  <li>Joe recommends the Builder.io article for a balanced, visual explanation of when to use each approach.</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <footer class="footer">
            <div class="footer-left">
              <div class="footer-title">Javascript in FileMaker</div>
              <div class="footer-sub">FileMaker JavaScript resources and web framework discussions</div>
            </div>
            <div class="footer-right">
              <a class="footer-link" href="https://www.jsinfm.com/" target="_blank">JS in FM</a>
              <a class="footer-link" href="https://proofkit.dev/" target="_blank">ProofKit</a>
              <a class="footer-link" href="https://carafe.fm/" target="_blank">Carafe.fm</a>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-sub">Quick navigation and resources</div>
          <div class="rail-actions">
            <a class="rail-btn" href="#chat-dec-30-part1">Dec 30</a>
        ...
        <div class="rail-body">
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              ...
              <span class="pill2">Carafe.fm</span>
              <span class="pill2">HTMX</span>
              <span class="pill2">React</span>
              <span class="pill2">WebViewer</span>
              <span class="pill2">Next.js</span>
              <span class="pill2">FileMaker Server</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">Links mentioned in the chat</div>
            </div>
            <div class="side-grid">
              <a class="side-pill warn" href="https://www.jsinfm.com/" target="_blank">JS in FM</a>
              <a class="side-pill warn" href="https://proofkit.dev/" target="_blank">ProofKit</a>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">People in this chat</div>
            </div>
            <div class="stack">
              <div class="stack-item">Joe<div class="stack-sub">Sharing FileMaker JS resources + providing context on HTMX</div></div>
              <div class="stack-item">Kirk<div class="stack-sub">Observing HTMX adoption trends</div></div>
            </div>
          </div>
          ...
          <div class="panel-card">
            <div class="panel-head">
              ...
              <div class="panel-sub">What this log contains</div>
            </div>
            <div class="stack">
              <div class="stack-item">JS in FM<div class="stack-sub">Building JavaScript widgets inside FileMaker WebViewer</div></div>
              <div class="stack-item">ProofKit<div class="stack-sub">Next.js starter for FileMaker-connected web apps</div></div>
              <div class="stack-item">Carafe.fm<div class="stack-sub">Open-source JS bundle sharing for FileMaker community</div></div>
              <div class="stack-item">HTMX vs React<div class="stack-sub">When to use each • Project-dependent choices</div></div>
              <div class="stack-item">Tech trends<div class="stack-sub">Grassroots tools vs enterprise frameworks</div></div>
            </div>
          </div>
