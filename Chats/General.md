...
<body>
  <div class="page" data-theme="auto">
      ...
      <div class="topbar-inner">
        ...
        <div class="topbar-center">
          <div class="page-chip">
            ...
            <span class="page-chip-text">Chat Group: General</span>
          </div>
        </div>
    ...
    <div class="shell" id="shell">
        ...
        <nav class="rail-body" id="navTree">
          ...
          <div class="nav-group open" data-label="Chats">
            ...
            <div class="nav-group-body">
              ...
              <a class="nav-item sub active" href="https://caufero.github.io/projects/Chats/General.md" data-label="Chats General"><span class="dot"></span><span class="nav-text">General</span></a>
      ...
      <!-- CENTER COLUMN — VIROLA CHAT CONTENT -->
        ...
        <div class="content-inner">
          ...
          <section class="hero">
            ...
            <div class="hero-inner">
              <div class="hero-top">
                <div class="hero-title">Chat Group: General</div>
                <div class="hero-sub">Copied log • Technical discussions, FileMaker updates, and tool recommendations</div>
              </div>
              <div class="hero-actions">
                <a class="cta" href="https://www.youtube.com/@virolamessenger" target="_blank" rel="noreferrer noopener">
              ...
              <div class="hero-meta">
                <span class="chip">Copied log</span>
                <span class="chip teal">Technical Discussion</span>
                <span class="chip violet">FileMaker 26.1</span>
                <span class="chip amber">Dev Tools</span>
              </div>
            </div>
          </section>

          <!-- Day 1: Wednesday 10 Dec 2025 -->
          <section class="card section" id="chat-dec-10">
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">9:50 PM</span></div>
                <div class="ct-bubble"><a class="ct-link" href="https://www.youtube.com/@virolamessenger" target="_blank" rel="noreferrer noopener">https://www.youtube.com/@virolamessenger</a></div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">9:51 PM</span></div>
                <div class="ct-bubble">All the official videos</div>
              </div>
            </div>
          </section>

          <!-- Day 2: Friday 12 Dec 2025 -->
          <section class="card section" id="chat-dec-12">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">💬</span>
                <span>Friday, 12 Dec 2025</span>
              </div>
              <div class="section-actions">
                <span class="chip">UTC</span>
              </div>
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Cyril</span><span class="ct-sep">·</span><span class="ct-time">1:19 AM</span></div>
                <div class="ct-bubble">Thanks Kirk</div>
              </div>
            </div>
          </section>

          <!-- Day 3: Sunday 21 Dec 2025 -->
          <section class="card section" id="chat-dec-21">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">💬</span>
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">6:55 PM</span></div>
                <div class="ct-bubble">If running Virola on iOS on an iPhone, in portrait mode many screen open where you can't get to the top area controls. Switch to landscape and all is well. :-)</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Oz</span><span class="ct-sep">·</span><span class="ct-time">6:58 PM</span></div>
                <div class="ct-bubble">@kirk Thanks for the tip. I have it also installed on my phone. I hope your weekend is going well</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">11:38 PM</span></div>
                <div class="ct-bubble">Working on taking joes excellent autocomplete search entry routines and making them portable using virtual lists. Should have something ready to test tomorrow</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">11:39 PM</span></div>
                <div class="ct-bubble">Built a script that takes all value lists and converts them into a key pair table. However there needs to be some naming discipline in value list creation to exclude dynamic (field based) value lists.</div>
              </div>
            </div>
          </section>

          <!-- Day 4: Thursday 25 Dec 2025 -->
          <section class="card section" id="chat-dec-25">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">🎄</span>
                <span>Thursday, 25 Dec 2025</span>
              </div>
              <div class="section-actions">
                <span class="chip">UTC</span>
              </div>
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">6:30 PM</span></div>
                <div class="ct-bubble">Merry Christmas everyone. :-)</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Oz</span><span class="ct-sep">·</span><span class="ct-time">6:32 PM</span></div>
                <div class="ct-bubble">@kirk cc @joe cc @cyril Thank you very much Kirk and many happy returns. Merry Christmas to everyone !</div>
              </div>
            </div>
          </section>

          <!-- Day 5: Friday 26 Dec 2025 -->
          <section class="card section" id="chat-dec-26">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">💬</span>
                <span>Friday, 26 Dec 2025</span>
              </div>
              <div class="section-actions">
                <span class="chip">UTC</span>
              </div>
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">5:13 PM</span></div>
                <div class="ct-bubble">FMP 26.1 (ETS)</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">5:13 PM</span></div>
                <div class="ct-bubble"><strong>Select Window by UUID</strong> — The Select Window script step can now select window by UUID. The UUID can be looked up with the new calculation function <code>Get(WindowUUID)</code>.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">5:14 PM</span></div>
                <div class="ct-bubble">In FMP 26.1 (ETS - currently in beta) Specify Table Occurrence or portal name in <code>GetRecordIDsFromFoundSet()</code>. An <code>optionalName</code> parameter has been added, so that the new syntax is <code>GetRecordIDsFromFoundSet( type {; optionalName })</code>. When <code>optionalName</code> specifies a Table Occurrence or portal name, a list of related record IDs from that TO or portal will be returned. <code>type</code>: A numeric value 0 through 4.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">5:15 PM</span></div>
                <div class="ct-bubble">Major flack in the dev community with the new inspector palette changes - going from 4 to 2, and making styles almost unusable.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">5:21 PM</span></div>
                <div class="ct-bubble"><strong>Execute URL script step</strong> — The new Execute URL script step asynchronously gets the content from a URL, then passes it to a callback script as a parameter. This is intended to streamline REST API calls, but may also be useful for other purposes as well.<br><br>The supported cURL options should match those of Insert from URL. The asynchronous nature of this script step is a new paradigm, allowing the application to continue to be used while the network call is taking place. Because of this, the state of the application, files, and record data may be different from when the script step started.<br><br>Since this script step is designed to immediately return while the HTTP GET request is in progress, subsequent steps should not assume that the request has completed. The advantage is that multiple requests can run in parallel.<br><br>Some time after the request is complete, the specified script will be invoked with the results passed as a parameter, which can be accessed with <code>Get(ScriptParameter)</code>.<br><br><strong>Known Issues:</strong> A. XML serialize/deserialize not implemented (also affects copy/paste)</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">5:23 PM</span></div>
                <div class="ct-bubble">There is a LOT of changes - many more than the above - in the next version.........</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">8:06 PM</span></div>
                <div class="ct-bubble">26.1 ETS - there are only two inspector palettes on the right, IF you are looking at a data element. However, the content of the inspector is dynamic - it knows what object type you are on, and changes the available options to match what you can do with that object. Otherwise, there is only one inspector.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">8:07 PM</span></div>
                <div class="ct-bubble">That being said, styles is the biggest casualty - the style selection option is far more limiting, as it is a single drop down, instead of a pick list. Still testing features.......</div>
              </div>
            </div>
            ...
            <div class="ct-callout">
              <div class="ct-callout-head">
                ...
                <div class="ct-callout-title">FileMaker 26.1 (ETS) Updates</div>
              </div>
              <div class="ct-callout-body">
                Kirk shares major updates coming in FileMaker 26.1 (currently in beta):
                <ul class="ul">
                  <li><strong>Select Window by UUID:</strong> New ability to select windows using their unique identifier via <code>Get(WindowUUID)</code></li>
                  <li><strong>Enhanced GetRecordIDsFromFoundSet():</strong> Now accepts an optional parameter to specify Table Occurrence or portal name, making it easier to get related record IDs</li>
                  <li><strong>Execute URL script step:</strong> A game-changing asynchronous script step that gets URL content and passes it to a callback script. This allows multiple API calls to run in parallel without blocking the UI - a completely new paradigm for FileMaker</li>
                  <li><strong>Inspector Palette Changes:</strong> The inspector has been reduced from 4 palettes to 2 (or 1), with dynamic content based on the selected object type. The dev community is unhappy about this, especially regarding styles which changed from a pick list to a single dropdown</li>
                </ul>
              </div>
            </div>
          </section>

          <!-- Day 6: Saturday 27 Dec 2025 -->
          <section class="card section" id="chat-dec-27">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">💬</span>
                <span>Saturday, 27 Dec 2025</span>
              </div>
              <div class="section-actions">
                <span class="chip">UTC</span>
              </div>
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">5:16 AM</span></div>
                <div class="ct-bubble">Merry Merry! 🎅🏽</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Cyril</span><span class="ct-sep">·</span><span class="ct-time">2:06 PM</span></div>
                <div class="ct-bubble">Many Happy returns 🎉🎈🎁</div>
              </div>
            </div>
          </section>

          <!-- Day 7: Tuesday 30 Dec 2025 -->
          <section class="card section" id="chat-dec-30">
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">4:20 PM</span></div>
                <div class="ct-bubble">@cyril @oz On the dev server <code>dev.performancebts.com</code> is a file "Task_List.fmp" Oz and Cyril - you both now have a login to this app I wrote a couple years ago. Play with it a bit - there is NO current data in there, so no harm can come to anything. You default user is Oz and Cyril, and the temp password is Caufero. Let's go over this at some point, and see what you might think about using this for task management??</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Oz</span><span class="ct-sep">·</span><span class="ct-time">4:25 PM</span></div>
                <div class="ct-bubble">@kirk Awesome! Thanks. We will take a look at it and let you know that we've successfully accessed it.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Oz</span><span class="ct-sep">·</span><span class="ct-time">7:38 PM</span></div>
                <div class="ct-bubble">@kirk cc @joe We've been able to log into the Task List File</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">7:39 PM</span></div>
                <div class="ct-bubble">Have fun! There are a few bugs in it to be resolved, but it works. My favorite part is the STEPS popover portal with ghost record entry :-)</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Oz</span><span class="ct-sep">·</span><span class="ct-time">7:40 PM</span></div>
                <div class="ct-bubble">:)</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Oz</span><span class="ct-sep">·</span><span class="ct-time">7:42 PM</span></div>
                <div class="ct-bubble">Taking a tour around</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">7:48 PM</span></div>
                <div class="ct-bubble">Any heading will sort the list, but the green ones create sub-summary versions</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Oz</span><span class="ct-sep">·</span><span class="ct-time">7:48 PM</span></div>
                <div class="ct-bubble">Oh Okay</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">8:22 PM</span></div>
                <div class="ct-bubble">What do you guys use for creating diagrams?</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Cyril</span><span class="ct-sep">·</span><span class="ct-time">8:24 PM</span></div>
                <div class="ct-bubble">Personally I used Omnigraffle, but don't have it currently with my new machine. It helped me with diagrams like flowcharts</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">8:30 PM</span></div>
                <div class="ct-bubble">In recent years, I have used <a class="ct-link" href="https://diagrams.net" target="_blank" rel="noreferrer noopener">diagrams.net</a> (drawio.com) - a very robust drawing tool, operating in a browser, or download locally, can save locally or in the cloud, supports imported graphics - a solid tool. However, some recent online discussions have alluded to the increased use of the browser-only based <a class="ct-link" href="https://excalidraw.com" target="_blank" rel="noreferrer noopener">Excalidraw.com</a>, mostly because of the live collaboration, simplicity and ease of use. Pretty basic, but does the trick. Both are free :-)</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Cyril</span><span class="ct-sep">·</span><span class="ct-time">8:33 PM</span></div>
                <div class="ct-bubble">That's great. Will try out both tools and give you feedback on what I think about them</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Joe</span><span class="ct-sep">·</span><span class="ct-time">9:53 PM</span></div>
                <div class="ct-bubble">I have been using Canva for the past year but my subscription comes due next month so maybe I'll check out others...Canva is great though for so many things!</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">9:54 PM</span></div>
                <div class="ct-bubble">@cyril @oz Are you guys familiar with virtual lists?</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">9:56 PM</span></div>
                <div class="ct-bubble">Note: Virola is case sensitive on all user names.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Oz</span><span class="ct-sep">·</span><span class="ct-time">10:14 PM</span></div>
                <div class="ct-bubble">Virtual list? Oh yes, we are. We use for reporting. Joe took me through at some point and I'm quite familiar with it. I remember introducing Cyril to it as well. @kirk</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">10:15 PM</span></div>
                <div class="ct-bubble">It's late - get some sleep!!!! I use virtual lists all the time in portal pick lists. Working on an example file to share soon.</div>
              </div>

              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Oz</span><span class="ct-sep">·</span><span class="ct-time">10:20 PM</span></div>
                <div class="ct-bubble">Okay :)</div>
              </div>
            </div>
            ...
            <div class="ct-callout">
              <div class="ct-callout-head">
                ...
                <div class="ct-callout-title">Task List App Access & Tool Discussions</div>
              </div>
              <div class="ct-callout-body">
                Kirk gives Cyril and Oz access to his Task_List.fmp application on the dev server for them to explore as a potential task management solution. He highlights the "STEPS popover portal with ghost record entry" as his favorite feature and explains that green headings create sub-summary versions.
                <ul class="ul">
                  <li><strong>Diagram Tools Discussion:</strong> The team discusses various diagramming tools:
                    <ul class="ul">
                      <li>Cyril mentions using OmniGraffle for flowcharts</li>
                      <li>Kirk recommends diagrams.net (browser or local) and Excalidraw (browser-only with live collaboration) - both free</li>
                      <li>Joe uses Canva (subscription-based) for various tasks</li>
                    </ul>
                  </li>
                  <li><strong>Virtual Lists:</strong> Kirk checks if the team is familiar with virtual lists. Oz confirms they use them for reporting, having learned from Joe and then taught Cyril. Kirk mentions he uses them extensively in portal pick lists and is preparing an example file to share</li>
                  <li><strong>Technical Note:</strong> Virola usernames are case-sensitive</li>
                </ul>
              </div>
            </div>
          </section>

          <!-- Day 8: Wednesday 31 Dec 2025 -->
          <section class="card section" id="chat-dec-31">
            <div class="section-head">
              <div class="section-title">
                <span class="section-emoji" aria-hidden="true">💬</span>
                <span>Wednesday, 31 Dec 2025</span>
              </div>
              <div class="section-actions">
                <span class="chip">UTC</span>
              </div>
            ...
            <div class="ct-thread">
              <div class="ct-msg">
                <div class="ct-meta"><span class="ct-name">Kirk</span><span class="ct-sep">·</span><span class="ct-time">3:16 PM</span></div>
                <div class="ct-bubble">Chris Irvine - (of Idiomatic FileMaker fame) - just did a FM recover on a 27gb file. Comparing the process on 2 Mac minis, the M2 took 4.8 hours vs the M4 to 2.9 hours. The M4 in every configuration beat out an M3 Ultra Mac Studio for a fraction of the cost 👍</div>
              </div>
            </div>
            ...
            <div class="ct-callout">
              <div class="ct-callout-head">
                ...
                <div class="ct-callout-title">Mac Hardware Performance Benchmark</div>
              </div>
              <div class="ct-callout-body">
                Kirk shares impressive performance results from Chris Irvine's FileMaker recovery benchmark. Testing on a massive 27GB database file showed:
                <ul class="ul">
                  <li><strong>M2 Mac mini:</strong> 4.8 hours to complete recovery</li>
                  <li><strong>M4 Mac mini:</strong> 2.9 hours to complete recovery (40% faster)</li>
                  <li><strong>Cost-Performance Winner:</strong> The M4 Mac mini outperformed even the M3 Ultra Mac Studio in every configuration, while costing significantly less</li>
                </ul>
                This demonstrates that for heavy FileMaker operations like database recovery, the newer M4 chip provides substantial time savings and better value than more expensive Mac Studio configurations.
              </div>
            </div>
          </section>
          ...
          <footer class="footer">
            <div class="footer-left">
              <div class="footer-title">Chat Group: General</div>
              <div class="footer-sub">Clean transcript • Caufero Workspace layout</div>
            </div>
            <div class="footer-right">
              <a class="footer-link" href="https://www.youtube.com/@virolamessenger" target="_blank" rel="noreferrer noopener">Virola YouTube</a>
      ...
      <aside class="rail rail-right" id="railRight" aria-label="Right panel">
        <div class="rail-top">
          ...
          <div class="rail-actions">
            <a class="rail-btn" href="#chat-dec-10">Dec 10</a>
            <a class="rail-btn" href="#chat-dec-21">Dec 21</a>
        ...
        <div class="rail-body">
          ...
          <div class="panel-card">
            ...
            <div class="pill-row">
              <span class="pill2">Virola tips</span>
              <span class="pill2">FileMaker 26.1</span>
              <span class="pill2">Virtual lists</span>
              <span class="pill2">Task_List.fmp</span>
              <span class="pill2">Execute URL</span>
              <span class="pill2">Inspector changes</span>
              <span class="pill2">Diagram tools</span>
              <span class="pill2">Mac performance</span>
              <span class="pill2">M4 vs M2</span>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="side-grid">
              <a class="side-pill warn" href="https://www.youtube.com/@virolamessenger" target="_blank" rel="noreferrer noopener">Virola YouTube</a>
              <a class="side-pill" href="https://diagrams.net" target="_blank" rel="noreferrer noopener">diagrams.net</a>
              <a class="side-pill" href="https://excalidraw.com" target="_blank" rel="noreferrer noopener">Excalidraw</a>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              <div class="stack-item">Kirk<div class="stack-sub">Main contributor • FileMaker updates • Tool recommendations</div></div>
              <div class="stack-item">Oz<div class="stack-sub">Testing Task_List.fmp • Virtual lists knowledge</div></div>
              <div class="stack-item">Cyril<div class="stack-sub">Testing Task_List.fmp • Diagram tool user</div></div>
              <div class="stack-item">Joe<div class="stack-sub">Canva user • Virtual lists mentor</div></div>
            </div>
          </div>
          ...
          <div class="panel-card">
            ...
            <div class="stack">
              <div class="stack-item">Virola resources<div class="stack-sub">Official YouTube channel • iPhone UI tips</div></div>
              <div class="stack-item">FileMaker 26.1 updates<div class="stack-sub">Window UUID • GetRecordIDsFromFoundSet • Execute URL • Inspector changes</div></div>
              <div class="stack-item">Task_List.fmp app<div class="stack-sub">Dev server access • Ghost record entry • Sub-summaries</div></div>
              <div class="stack-item">Diagram tools<div class="stack-sub">OmniGraffle • diagrams.net • Excalidraw • Canva</div></div>
              <div class="stack-item">Virtual lists<div class="stack-sub">Usage in portal pick lists • Reporting applications</div></div>
              <div class="stack-item">Hardware performance<div class="stack-sub">M4 vs M2 Mac mini • FileMaker recovery benchmarks</div></div>
            </div>
          </div>
